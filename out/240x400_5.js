...
(lib._240x400_5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(66).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regX:0.1,regY:0.1,y:357.6},0).to({scaleX:1.1,scaleY:1.1,x:120.1,y:357.5,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(66).to({_off:false},0).to({regX:0,scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regX:0.1,regY:0.1,y:51},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,y:50.9,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1,scaleY:1,y:48.1,alpha:1},6,cjs.Ease.get(1)).wait(52).to({regX:0.1,regY:0.1,x:120.1},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:120,y:48,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(137));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(137));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/240x400_5_atlas_.png?1486756636204", id:"240x400_5_atlas_"}
	],
	preloads: []
};

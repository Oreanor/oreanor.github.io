...
lib.ssMetadata = [
		{name:"300x300_atlas_P_", frames: [[0,0,212,28],[0,57,215,20],[0,30,215,25]]},
		{name:"300x300_atlas_NP_", frames: [[0,0,300,300],[0,302,300,214],[0,518,300,214]]}
];
...
(lib._300x300 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(150,197,1,0.1,0,0,0,0,0.5);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(160.5,66);
	this.instance_1.alpha = 0;
	...
	this.instance_2.setTransform(167.5,96.5);
	...
	this.instance_3.setTransform(161.5,130.5);
	...
	this.instance_4.setTransform(159.8,147.9);
	...
	this.instance_5.setTransform(160,120.9);
	...
	this.instance_6.setTransform(159.4,94.1);
	...
	this.instance_7.setTransform(160,53.2);
	...
	this.instance_12.setTransform(160,136);
	...
	this.instance_13.setTransform(160.3,80.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(10).to({_off:false},0).to({x:150.3,alpha:1},8,cjs.Ease.get(1)).wait(61).to({x:140.3,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(166));

	// Символ 10
	this.instance_14 = new lib.Символ10();
	this.instance_14.parent = this;
	this.instance_14.setTransform(160,52.2);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(6).to({_off:false},0).to({x:150,alpha:1},8,cjs.Ease.get(1)).wait(64).to({x:140,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(167));

	// Символ 9
	this.instance_15 = new lib.Символ9();
	this.instance_15.parent = this;
	this.instance_15.setTransform(159.9,23.4);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({x:149.9,alpha:1},8,cjs.Ease.get(1)).wait(67).to({x:139.9,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(168));

	// Слой 4
	this.instance_16 = new lib.Символ8();
	this.instance_16.parent = this;
	this.instance_16.setTransform(156.5,194.5,1,0.1,0,0,0,0,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x300_atlas_P_.png?1504039122692", id:"300x300_atlas_P_"},
		{src:"images/300x300_atlas_NP_.jpg?1504039122693", id:"300x300_atlas_NP_"}
	],
	preloads: []
};

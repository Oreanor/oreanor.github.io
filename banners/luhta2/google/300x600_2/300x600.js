...
}).prototype = getMCSymbolPrototype(lib.Символ22, new cjs.Rectangle(-120,-200,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ21, new cjs.Rectangle(-120,-200,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ20, new cjs.Rectangle(-120,-200,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ8, new cjs.Rectangle(-129,-18,257,35), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(198).to({_off:false},0).to({regX:0,regY:0,scaleY:1.2,x:149.8},6,cjs.Ease.get(1)).wait(41).to({regX:0.1,regY:0.8,scaleY:0.12,x:149.9},6,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(179).to({_off:false},0).to({x:150.4,alpha:1},8,cjs.Ease.get(1)).wait(54).to({x:138.4,alpha:0},6,cjs.Ease.get(1)).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(189).to({_off:false},0).to({regX:0.1,regY:0.1,x:148.8,alpha:1},8,cjs.Ease.get(1)).wait(45).to({regX:0,regY:0},0).to({x:136.8,alpha:0},6,cjs.Ease.get(1)).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(182).to({_off:false},0).to({x:151.6,alpha:1},8,cjs.Ease.get(1)).wait(53).to({x:139.6,alpha:0},6,cjs.Ease.get(1)).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(116).to({_off:false},0).to({x:149.5,alpha:1},8,cjs.Ease.get(1)).wait(45).to({x:137.5,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(111).to({_off:false},0).to({x:149.8,alpha:1},8,cjs.Ease.get(1)).wait(49).to({x:137.8,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(77));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(105).to({_off:false},0).to({x:149,alpha:1},8,cjs.Ease.get(1)).wait(54).to({x:137,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90).to({_off:false},0).to({x:149.8,alpha:1},9,cjs.Ease.get(1)).wait(67).to({x:137.8,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(79));

	// Слой 17
	this.instance_8 = new lib.Анимация3("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(161.8,256.2,1.2,1.2);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.instance_9 = new lib.Анимация4("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(149.8,256.2,1.2,1.2);

	this.instance_10 = new lib.Анимация1("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(149.8,256.2,1.2,1.2);
	this.instance_10._off = true;

	this.instance_11 = new lib.Анимация2("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(137.8,256.2,1.2,1.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(35).to({_off:false},0).to({_off:true,x:149.8,alpha:1},9,cjs.Ease.get(1)).wait(208));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(81).to({_off:false},0).to({_off:true,x:137.8,alpha:0},6,cjs.Ease.get(1)).wait(165));

	// Символ 12
	this.instance_12 = new lib.Символ12();
	this.instance_12.parent = this;
	this.instance_12.setTransform(161.8,233.7,1.2,1.2);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(31).to({_off:false},0).to({x:149.8,alpha:1},9,cjs.Ease.get(1)).wait(40).to({x:137.8,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(165));

	// Символ 11
	this.instance_13 = new lib.Символ11();
	this.instance_13.parent = this;
	this.instance_13.setTransform(162.1,164,1.2,1.2);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(10).to({_off:false},0).to({x:150.1,alpha:1},8,cjs.Ease.get(1)).wait(61).to({x:138.1,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(166));

	// Символ 10
	this.instance_14 = new lib.Символ10();
	this.instance_14.parent = this;
	this.instance_14.setTransform(161.8,129.6,1.2,1.2);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(6).to({_off:false},0).to({x:149.8,alpha:1},8,cjs.Ease.get(1)).wait(64).to({x:137.8,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(167));

	// Символ 9
	this.instance_15 = new lib.Символ9();
	this.instance_15.parent = this;
	this.instance_15.setTransform(161.7,95,1.2,1.2);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({x:149.7,alpha:1},8,cjs.Ease.get(1)).wait(67).to({x:137.7,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(168));

	// Слой 4
	this.instance_16 = new lib.Символ8();
	this.instance_16.parent = this;
	this.instance_16.setTransform(147.6,511.6,1,0.119,0,0,0,0.1,0.8);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(50).to({_off:false},0).to({regY:0.1,scaleY:1},6,cjs.Ease.get(1)).wait(110).to({regY:0.8,scaleY:0.12},6,cjs.Ease.get(1)).to({_off:true},1).wait(79));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(178).to({_off:false},0).to({alpha:1},8,cjs.Ease.get(1)).wait(66));

	// bg2.jpg
	this.instance_18 = new lib.Символ21();
	this.instance_18.parent = this;
	this.instance_18.setTransform(120,200);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(89).to({_off:false},0).to({alpha:1},8,cjs.Ease.get(1)).wait(155));

	// bg.jpg
	this.instance_19 = new lib.Символ20();
	this.instance_19.parent = this;
	this.instance_19.setTransform(120,200);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_atlas_P_.png?1504213191495", id:"300x600_atlas_P_"},
		{src:"images/300x600_atlas_NP_.jpg?1504213191495", id:"300x600_atlas_NP_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		...
		{name:"300x250_atlas_NP_", frames: [[0,0,300,250],[0,252,300,250],[0,504,300,250]]}
];
...
}).prototype = getMCSymbolPrototype(lib.Символ22, new cjs.Rectangle(-120,-200,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ21, new cjs.Rectangle(-120,-200,300,250), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ20, new cjs.Rectangle(-120,-200,300,250), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_15.setTransform(156.5,194.5,1,0.1,0,0,0,0,0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(178).to({_off:false},0).to({alpha:1},8,cjs.Ease.get(1)).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(89).to({_off:false},0).to({alpha:1},8,cjs.Ease.get(1)).wait(155));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_atlas_P_.png?1504213557348", id:"300x250_atlas_P_"},
		{src:"images/300x250_atlas_NP_.jpg?1504213557348", id:"300x250_atlas_NP_"}
	],
	preloads: []
};

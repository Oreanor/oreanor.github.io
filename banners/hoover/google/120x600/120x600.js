...
lib.ssMetadata = [
		{name:"120x600_atlas_P_", frames: [[0,91,23,2],[152,0,50,225],[0,0,150,89]]},
...
(lib.pic2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-21,-152);

	this.instance_1 = new lib.pic2b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-95,60,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.pic2, new cjs.Rectangle(-95,-152,135,292.1), null);

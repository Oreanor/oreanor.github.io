...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.addr2.setTransform(3.5,434.4,1.12,1.12);
	this.addr2.alpha = 0;
	...
	this.instance.parent = this;
	this.instance.setTransform(133.9,398.8,1.12,1.12);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(133.9,223.6,1.12,1.12);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(56,57.1,0.567,0.567,0,0,0,0.2,0.4);
	...
	var mask_graphics_11 = new cjs.Graphics().p("EgcYAi+MADvhF5MA1CAAAMAAABF5g");
	var mask_graphics_62 = new cjs.Graphics().p("EghAAi+MAAAhF5MBCCAAAMgYJBF5g");
	var mask_graphics_63 = new cjs.Graphics().p("EgcIAi+MAAAhF5MA4RAAAMgUlBF5g");
	var mask_graphics_64 = new cjs.Graphics().p("EgXtAi+MAAAhF5MAvbAAAMgRWBF5g");
	var mask_graphics_65 = new cjs.Graphics().p("EgTwAi+MAAAhF5MAnhAAAMgOdBF5g");
	var mask_graphics_66 = new cjs.Graphics().p("EgQQAi+MAAAhF5MAghAAAMgL5BF5g");
	var mask_graphics_67 = new cjs.Graphics().p("EgNOAi+MAAAhF5IadAAMgJrBF5g");
	var mask_graphics_68 = new cjs.Graphics().p("EgKqAi+MAAAhF5IVVAAMgHzBF5g");
	var mask_graphics_69 = new cjs.Graphics().p("EgIkAi+MAAAhF5IRJAAMgGRBF5g");
	var mask_graphics_70 = new cjs.Graphics().p("EgG8Ai+MAAAhF5IN5AAMgFFBF5g");
	var mask_graphics_71 = new cjs.Graphics().p("EgFxAi+MAAAhF5ILjAAMgEOBF5g");
	var mask_graphics_72 = new cjs.Graphics().p("EgFGAi+MAAAhF5IKKAAMgDuBF5g");
	var mask_graphics_73 = new cjs.Graphics().p("EgFJAi+MAAAhF5IJtAAMgDjBF5g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:479.3,y:223.9}).wait(1).to({graphics:mask_graphics_1,x:422.6,y:223.9}).wait(1).to({graphics:mask_graphics_2,x:371.3,y:223.9}).wait(1).to({graphics:mask_graphics_3,x:325.4,y:223.9}).wait(1).to({graphics:mask_graphics_4,x:285,y:223.9}).wait(1).to({graphics:mask_graphics_5,x:249.9,y:223.9}).wait(1).to({graphics:mask_graphics_6,x:220.2,y:223.9}).wait(1).to({graphics:mask_graphics_7,x:195.9,y:223.9}).wait(1).to({graphics:mask_graphics_8,x:177,y:223.9}).wait(1).to({graphics:mask_graphics_9,x:163.5,y:223.9}).wait(1).to({graphics:mask_graphics_10,x:155.4,y:223.9}).wait(1).to({graphics:mask_graphics_11,x:152.7,y:223.8}).wait(1).to({graphics:null,x:0,y:0}).wait(50).to({graphics:mask_graphics_62,x:211.4,y:223.8}).wait(1).to({graphics:mask_graphics_63,x:168.7,y:223.8}).wait(1).to({graphics:mask_graphics_64,x:130,y:223.8}).wait(1).to({graphics:mask_graphics_65,x:95.4,y:223.8}).wait(1).to({graphics:mask_graphics_66,x:64.9,y:223.8}).wait(1).to({graphics:mask_graphics_67,x:38.4,y:223.8}).wait(1).to({graphics:mask_graphics_68,x:16,y:223.8}).wait(1).to({graphics:mask_graphics_69,x:-2.3,y:223.8}).wait(1).to({graphics:mask_graphics_70,x:-16.6,y:223.8}).wait(1).to({graphics:mask_graphics_71,x:-26.8,y:223.8}).wait(1).to({graphics:mask_graphics_72,x:-32.7,y:223.8}).wait(1).to({graphics:mask_graphics_73,x:-33,y:223.8}).wait(287));

	// text0
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgVASIAPgiIAbgBIgdAjg");
	this.shape_1.setTransform(92,174.9,0.806,0.806);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgUASIAOgjIAbAAIgdAjg");
	this.shape_2.setTransform(96,144.8,0.806,0.806);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgVASIAPgiIAcgBIgeAjg");
	this.shape_3.setTransform(71.5,129.3,0.806,0.806);
	...
	this.shape_7.setTransform(97.7,181.3,0.806,0.806);
	...
	this.shape_8.setTransform(90.4,181.3,0.806,0.806);
	...
	this.shape_9.setTransform(83.1,181.3,0.806,0.806);
	...
	this.shape_10.setTransform(75.7,181.3,0.806,0.806);
	...
	this.shape_11.setTransform(67.5,181.4,0.806,0.806);
	...
	this.shape_18.setTransform(145.9,166.4,0.806,0.806);
	...
	this.shape_19.setTransform(136,166.4,0.806,0.806);
	...
	this.shape_20.setTransform(127.5,167.7,0.806,0.806);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgmAtIAAhYIAUAAIAAA0IA0g2IAFAAIAABYIgUAAIAAgzIg0A1g");
	this.shape_21.setTransform(119.3,166.4,0.806,0.806);
	...
	this.shape_22.setTransform(109.9,166.3,0.806,0.806);
	...
	this.shape_26.setTransform(70.6,166.4,0.806,0.806);
	...
	this.shape_27.setTransform(63.5,166.4,0.806,0.806);
	...
	this.shape_28.setTransform(56.2,166.4,0.806,0.806);
	...
	this.shape_29.setTransform(49.6,166.4,0.806,0.806);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#FFFFFF").s().p("AASArIAAglIgjAAIAAAlIgUAAIAAhWIAUAAIAAAhIAjAAIAAghIAUAAIAABWg");
	this.shape_30.setTransform(41.9,166.4,0.806,0.806);
	...
	this.shape_34.setTransform(101.8,151.5,0.806,0.806);
	...
	this.shape_35.setTransform(94.5,151.5,0.806,0.806);
	...
	this.shape_36.setTransform(87.2,151.5,0.806,0.806);
	...
	this.shape_37.setTransform(79.9,151.5,0.806,0.806);
	...
	this.shape_38.setTransform(71.7,151.6,0.806,0.806);
	...
	this.shape_39.setTransform(62.9,151.5,0.806,0.806);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#FFFFFF").s().p("AARAsIAAhFIghAAIAABFIgVAAIAAhXIBLAAIAABXg");
	this.shape_40.setTransform(54,151.5,0.806,0.806);
	...
	this.shape_45.setTransform(103.8,136.6,0.806,0.806);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#FFFFFF").s().p("AgDAsIgnhXIAVAAIAVA0IAWg0IAVAAIgoBXg");
	this.shape_46.setTransform(96.4,136.7,0.806,0.806);
	...
	this.shape_47.setTransform(90.2,136.6,0.806,0.806);
	...
	this.shape_48.setTransform(83.9,136.7,0.806,0.806);
	...
	this.shape_52.setTransform(48.8,136.6,0.806,0.806);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#FFFFFF").s().p("AgDAsIgohXIAXAAIAUA0IAWg0IAVAAIgnBXg");
	this.shape_53.setTransform(41.4,136.7,0.806,0.806);
	...
	this.shape_54.setTransform(34.1,136.6,0.806,0.806);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(200,0,0.896,0.896);
	...
	mask_1._off = true;
	var mask_1_graphics_62 = new cjs.Graphics().p("EgMGAi+MAYJhF5MAp6AAAMAAABF5g");
	...
	var mask_1_graphics_73 = new cjs.Graphics().p("EgcYAi+MADvhF5MA1CAAAMAAABF5g");
	var mask_1_graphics_137 = new cjs.Graphics().p("EghAAi+MAAAhF5MBCCAAAMgYJBF5g");
	var mask_1_graphics_138 = new cjs.Graphics().p("EgcIAi+MAAAhF5MA4RAAAMgUlBF5g");
	var mask_1_graphics_139 = new cjs.Graphics().p("EgXtAi+MAAAhF5MAvbAAAMgRWBF5g");
	var mask_1_graphics_140 = new cjs.Graphics().p("EgTwAi+MAAAhF5MAnhAAAMgOdBF5g");
	var mask_1_graphics_141 = new cjs.Graphics().p("EgQQAi+MAAAhF5MAghAAAMgL5BF5g");
	var mask_1_graphics_142 = new cjs.Graphics().p("EgNOAi+MAAAhF5IadAAMgJrBF5g");
	var mask_1_graphics_143 = new cjs.Graphics().p("EgKqAi+MAAAhF5IVVAAMgHzBF5g");
	var mask_1_graphics_144 = new cjs.Graphics().p("EgIkAi+MAAAhF5IRJAAMgGRBF5g");
	var mask_1_graphics_145 = new cjs.Graphics().p("EgG8Ai+MAAAhF5IN5AAMgFFBF5g");
	var mask_1_graphics_146 = new cjs.Graphics().p("EgFxAi+MAAAhF5ILjAAMgEOBF5g");
	var mask_1_graphics_147 = new cjs.Graphics().p("EgFGAi+MAAAhF5IKKAAMgDuBF5g");
	var mask_1_graphics_148 = new cjs.Graphics().p("EgFJAi+MAAAhF5IJtAAMgDjBF5g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(62).to({graphics:mask_1_graphics_62,x:345.3,y:223.8}).wait(1).to({graphics:mask_1_graphics_63,x:422.6,y:223.9}).wait(1).to({graphics:mask_1_graphics_64,x:371.3,y:223.9}).wait(1).to({graphics:mask_1_graphics_65,x:325.4,y:223.9}).wait(1).to({graphics:mask_1_graphics_66,x:285,y:223.9}).wait(1).to({graphics:mask_1_graphics_67,x:249.9,y:223.9}).wait(1).to({graphics:mask_1_graphics_68,x:220.2,y:223.9}).wait(1).to({graphics:mask_1_graphics_69,x:195.9,y:223.9}).wait(1).to({graphics:mask_1_graphics_70,x:177,y:223.9}).wait(1).to({graphics:mask_1_graphics_71,x:163.5,y:223.9}).wait(1).to({graphics:mask_1_graphics_72,x:155.4,y:223.9}).wait(1).to({graphics:mask_1_graphics_73,x:152.7,y:223.8}).wait(1).to({graphics:null,x:0,y:0}).wait(63).to({graphics:mask_1_graphics_137,x:211.4,y:223.8}).wait(1).to({graphics:mask_1_graphics_138,x:168.7,y:223.8}).wait(1).to({graphics:mask_1_graphics_139,x:130,y:223.8}).wait(1).to({graphics:mask_1_graphics_140,x:95.4,y:223.8}).wait(1).to({graphics:mask_1_graphics_141,x:64.9,y:223.8}).wait(1).to({graphics:mask_1_graphics_142,x:38.4,y:223.8}).wait(1).to({graphics:mask_1_graphics_143,x:16,y:223.8}).wait(1).to({graphics:mask_1_graphics_144,x:-2.3,y:223.8}).wait(1).to({graphics:mask_1_graphics_145,x:-16.6,y:223.8}).wait(1).to({graphics:mask_1_graphics_146,x:-26.8,y:223.8}).wait(1).to({graphics:mask_1_graphics_147,x:-32.7,y:223.8}).wait(1).to({graphics:mask_1_graphics_148,x:-33,y:223.8}).wait(212));

	// text1
	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#FFFFFF").s().p("AgJAKQgFgDAAgHQAAgFAFgEQAEgFAFAAQAHAAADAFQAFAEAAAFQAAAHgFADQgDAFgHAAQgFAAgEgFg");
	this.shape_61.setTransform(138,152.2,0.887,0.887);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#FFFFFF").s().p("AgdAsIAAhXIA7AAIAAASIgnAAIAABFg");
	this.shape_62.setTransform(132.3,149.3,0.887,0.887);
	...
	this.shape_63.setTransform(119.8,147.9,0.887,0.887);
	...
	this.shape_64.setTransform(111.2,147.9,0.887,0.887);
	...
	this.shape_65.setTransform(102.5,147.9,0.887,0.887);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#FFFFFF").s().p("AABA8IAAhVIgXAPIAAgVQAWgLAOgRIAJAAIAAB3g");
	this.shape_66.setTransform(93.5,147.9,0.887,0.887);
	...
	this.shape_67.setTransform(81.2,149.3,0.887,0.887);
	...
	this.shape_68.setTransform(68.7,149.3,0.887,0.887);
	...
	this.shape_69.setTransform(60.7,149.3,0.887,0.887);
	...
	this.shape_70.setTransform(52.6,149.3,0.887,0.887);
	...
	this.shape_71.setTransform(44.5,149.3,0.887,0.887);
	...
	this.shape_72.setTransform(35.5,149.3,0.887,0.887);
	...
	this.shape_76.setTransform(83.2,133,0.887,0.887);
	...
	this.shape_77.setTransform(75.2,132.9,0.887,0.887);
	...
	this.shape_78.setTransform(66.5,134.3,0.887,0.887);
	...
	this.shape_79.setTransform(58.2,132.9,0.887,0.887);
	...
	this.shape_80.setTransform(50.6,132.9,0.887,0.887);
	...
	this.shape_81.setTransform(42.5,132.9,0.887,0.887);
	...
	this.shape_82.setTransform(28.7,132.9,0.887,0.887);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#FFFFFF").s().p("AgCA8IgZhAIgMA/IgVAAIAYh2IALAAIAZBPIAZhPIAMAAIAYB2IgVAAIgMg/IgYBAg");
	this.shape_83.setTransform(17.5,131.6,0.887,0.887);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#FFFFFF").s().p("AiMEGICOoLICLAAIiOILg");
	this.shape_84.setTransform(162.8,118.7,0.806,0.806);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#CB0927").s().p("AigDSIBwmkIDRAAIhxGkg");
	this.shape_85.setTransform(162.3,150.2,0.806,0.806);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#D1D1D1").s().p("AjtFhIBJkXIDSAAIBymqIBOAAIhyGqIgBAAIhLEXg");
	this.shape_86.setTransform(162.4,161.7,0.806,0.806);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#DC052B").s().p("AuIEVIgBopIcTABIiVIog");
	this.shape_87.setTransform(90.4,140);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(258.2,147.9,0.91,0.91);
	...
	mask_2._off = true;
	var mask_2_graphics_137 = new cjs.Graphics().p("EgMGAi+MAYJhF5MAp6AAAMAAABF5g");
	...
	var mask_2_graphics_148 = new cjs.Graphics().p("EgcYAi+MADvhF5MA1CAAAMAAABF5g");
	var mask_2_graphics_211 = new cjs.Graphics().p("EghAAi+MAAAhF5MBCCAAAMgYJBF5g");
	var mask_2_graphics_212 = new cjs.Graphics().p("EgcIAi+MAAAhF5MA4RAAAMgUlBF5g");
	var mask_2_graphics_213 = new cjs.Graphics().p("EgXtAi+MAAAhF5MAvbAAAMgRWBF5g");
	var mask_2_graphics_214 = new cjs.Graphics().p("EgTwAi+MAAAhF5MAnhAAAMgOdBF5g");
	var mask_2_graphics_215 = new cjs.Graphics().p("EgQQAi+MAAAhF5MAghAAAMgL5BF5g");
	var mask_2_graphics_216 = new cjs.Graphics().p("EgNOAi+MAAAhF5IadAAMgJrBF5g");
	var mask_2_graphics_217 = new cjs.Graphics().p("EgKqAi+MAAAhF5IVVAAMgHzBF5g");
	var mask_2_graphics_218 = new cjs.Graphics().p("EgIkAi+MAAAhF5IRJAAMgGRBF5g");
	var mask_2_graphics_219 = new cjs.Graphics().p("EgG8Ai+MAAAhF5IN5AAMgFFBF5g");
	var mask_2_graphics_220 = new cjs.Graphics().p("EgFxAi+MAAAhF5ILjAAMgEOBF5g");
	var mask_2_graphics_221 = new cjs.Graphics().p("EgFGAi+MAAAhF5IKKAAMgDuBF5g");
	var mask_2_graphics_222 = new cjs.Graphics().p("EgFJAi+MAAAhF5IJtAAMgDjBF5g");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(137).to({graphics:mask_2_graphics_137,x:345.3,y:223.8}).wait(1).to({graphics:mask_2_graphics_138,x:422.6,y:223.9}).wait(1).to({graphics:mask_2_graphics_139,x:371.3,y:223.9}).wait(1).to({graphics:mask_2_graphics_140,x:325.4,y:223.9}).wait(1).to({graphics:mask_2_graphics_141,x:285,y:223.9}).wait(1).to({graphics:mask_2_graphics_142,x:249.9,y:223.9}).wait(1).to({graphics:mask_2_graphics_143,x:220.2,y:223.9}).wait(1).to({graphics:mask_2_graphics_144,x:195.9,y:223.9}).wait(1).to({graphics:mask_2_graphics_145,x:177,y:223.9}).wait(1).to({graphics:mask_2_graphics_146,x:163.5,y:223.9}).wait(1).to({graphics:mask_2_graphics_147,x:155.4,y:223.9}).wait(1).to({graphics:mask_2_graphics_148,x:152.7,y:223.8}).wait(1).to({graphics:null,x:0,y:0}).wait(62).to({graphics:mask_2_graphics_211,x:211.4,y:223.8}).wait(1).to({graphics:mask_2_graphics_212,x:168.7,y:223.8}).wait(1).to({graphics:mask_2_graphics_213,x:130,y:223.8}).wait(1).to({graphics:mask_2_graphics_214,x:95.4,y:223.8}).wait(1).to({graphics:mask_2_graphics_215,x:64.9,y:223.8}).wait(1).to({graphics:mask_2_graphics_216,x:38.4,y:223.8}).wait(1).to({graphics:mask_2_graphics_217,x:16,y:223.8}).wait(1).to({graphics:mask_2_graphics_218,x:-2.3,y:223.8}).wait(1).to({graphics:mask_2_graphics_219,x:-16.6,y:223.8}).wait(1).to({graphics:mask_2_graphics_220,x:-26.8,y:223.8}).wait(1).to({graphics:mask_2_graphics_221,x:-32.7,y:223.8}).wait(1).to({graphics:mask_2_graphics_222,x:-33,y:223.8}).wait(138));

	// pic2
	this.instance_5 = new lib.pic2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(225.8,139.2,1.009,1.008,0,0,0,0.6,0.6);
	...
	this.shape_88.setTransform(110.5,167.8,0.887,0.887);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("#FFFFFF").s().p("AgmAuIAAhZIAUAAIAAA0IA0g2IAFAAIAABZIgUAAIAAg0Ig0A2g");
	this.shape_89.setTransform(103.5,164.9,0.887,0.887);
	...
	this.shape_90.setTransform(95.3,164.9,0.887,0.887);
	...
	this.shape_91.setTransform(86.9,166.3,0.887,0.887);
	...
	this.shape_92.setTransform(78.1,164.9,0.887,0.887);
	...
	this.shape_95.setTransform(49,164.9,0.887,0.887);
	...
	this.shape_101.setTransform(121.5,148.5,0.887,0.887);
	...
	this.shape_102.setTransform(113.4,148.5,0.887,0.887);
	...
	this.shape_103.setTransform(105.8,148.5,0.887,0.887);
	...
	this.shape_104.setTransform(92.7,148.5,0.887,0.887);
	...
	this.shape_105.setTransform(84,148.6,0.887,0.887);
	...
	this.shape_106.setTransform(75.3,149.9,0.887,0.887);

	this.shape_107 = new cjs.Shape();
	this.shape_107.graphics.f("#FFFFFF").s().p("AgmAtIAAhYIAUAAIAAA0IAzg2IAGAAIAABYIgUAAIAAgzIg0A1g");
	this.shape_107.setTransform(61.8,148.5,0.887,0.887);
	...
	this.shape_108.setTransform(52.6,148.6,0.887,0.887);
	...
	this.shape_109.setTransform(44.2,148.5,0.887,0.887);
	...
	this.shape_110.setTransform(35.3,149.9,0.887,0.887);
	...
	this.shape_111.setTransform(26.5,148.5,0.887,0.887);
	...
	this.shape_112.setTransform(16.9,148.5,0.887,0.887);
	...
	this.shape_113.setTransform(93.3,132.1,0.887,0.887);
	...
	this.shape_114.setTransform(83.7,132.1,0.887,0.887);
	...
	this.shape_115.setTransform(75.5,132.1,0.887,0.887);

	this.shape_116 = new cjs.Shape();
	this.shape_116.graphics.f("#FFFFFF").s().p("AgdAsIAAhXIA7AAIAAASIgnAAIAABFg");
	this.shape_116.setTransform(68.3,132.1,0.887,0.887);
	...
	this.shape_117.setTransform(60.8,132.1,0.887,0.887);
	...
	this.shape_118.setTransform(52,132.2,0.887,0.887);
	...
	this.shape_119.setTransform(43.2,133.5,0.887,0.887);
	...
	this.shape_120.setTransform(34.4,132.1,0.887,0.887);
	...
	var mask_3_graphics_222 = new cjs.Graphics().p("EgcYAi+MADvhF5MA1CAAAMAAABF5g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(211).to({graphics:mask_3_graphics_211,x:345.3,y:223.8}).wait(1).to({graphics:mask_3_graphics_212,x:422.6,y:223.9}).wait(1).to({graphics:mask_3_graphics_213,x:371.3,y:223.9}).wait(1).to({graphics:mask_3_graphics_214,x:325.4,y:223.9}).wait(1).to({graphics:mask_3_graphics_215,x:285,y:223.9}).wait(1).to({graphics:mask_3_graphics_216,x:249.9,y:223.9}).wait(1).to({graphics:mask_3_graphics_217,x:220.2,y:223.9}).wait(1).to({graphics:mask_3_graphics_218,x:195.9,y:223.9}).wait(1).to({graphics:mask_3_graphics_219,x:177,y:223.9}).wait(1).to({graphics:mask_3_graphics_220,x:163.5,y:223.9}).wait(1).to({graphics:mask_3_graphics_221,x:155.4,y:223.9}).wait(1).to({graphics:mask_3_graphics_222,x:152.7,y:223.8}).wait(1).to({graphics:null,x:0,y:0}).wait(137));

	// text3
	this.shape_123 = new cjs.Shape();
	this.shape_123.graphics.f("#FFFFFF").s().p("AgJAKQgFgEAAgGQAAgFAFgFQAEgDAFAAQAHAAADADQAFAFAAAFQAAAGgFAEQgDAFgHAAQgFAAgEgFg");
	this.shape_123.setTransform(87.6,168.2,0.887,0.887);

	this.shape_124 = new cjs.Shape();
	this.shape_124.graphics.f("#FFFFFF").s().p("AgeAiQgLgLAAgWQAAgUAMgNQANgMARAAQARgBANAMQALALAAASIgBAKIg+AAQABALAHAFQAGAGALABQANAAAHgIIAIAQQgLAIgUAAQgUAAgLgLgAgUgIIAqAAQgCgUgTAAQgRAAgEAUg");
	this.shape_124.setTransform(80.8,165.3,0.887,0.887);

	this.shape_125 = new cjs.Shape();
	this.shape_125.graphics.f("#FFFFFF").s().p("AASArIAAglIgjAAIAAAlIgVAAIAAhVIAVAAIAAAgIAjAAIAAggIAVAAIAABVg");
	this.shape_125.setTransform(72.1,165.3,0.887,0.887);

	this.shape_126 = new cjs.Shape();
	this.shape_126.graphics.f("#FFFFFF").s().p("AgmBDIAAhXIAUAAIAAAzIA0g1IAFAAIAABXIgUAAIAAg0Ig0A2gAgRgsQgJgHgBgMIARgEQACAQAKgBQANAAABgOIAQADQgCAMgJAHQgHAGgMAAQgMAAgHgGg");
	this.shape_126.setTransform(63.3,163.3,0.887,0.887);

	this.shape_127 = new cjs.Shape();
	this.shape_127.graphics.f("#FFFFFF").s().p("AATAqQgDgDgCgEQgDAFgHACQgFAEgIgBQgOAAgIgHQgIgGAAgNQAAgPALgIQALgJAVAAIAIABQAAgQgSAAQgLAAgJAFIgEgQQAKgGAPABQATgBAJAKQAKAJAAAZIAAASQAAASAHAEQgDAFgDAAQgDABgEAAQgDAAgFgDgAgTARQAAAMAOAAQARAAAAgSIAAgIIgIgBQgXAAAAAPg");
	this.shape_127.setTransform(55,165.3,0.887,0.887);

	this.shape_128 = new cjs.Shape();
	this.shape_128.graphics.f("#FFFFFF").s().p("AgiAkIAKgQQAKAJAOAAQAOAAAAgLQAAgMgQAAIgMAAIAAgPIAOABQAMAAAAgKQAAgFgDgCQgEgDgFAAQgLAAgMAHIgGgQQAPgIAPABQANAAAKAGQAIAHAAALQAAAPgOAEQAHABAFAGQAFAFAAAHQAAANgJAHQgMAHgPAAQgUAAgNgJg");
	this.shape_128.setTransform(47.3,165.3,0.887,0.887);

	this.shape_129 = new cjs.Shape();
	this.shape_129.graphics.f("#FFFFFF").s().p("AgmAtIAAhXIAUAAIAAAzIAzg1IAGAAIAABXIgUAAIAAgzIg0A1g");
	this.shape_129.setTransform(39.4,165.3,0.887,0.887);

	this.shape_130 = new cjs.Shape();
	this.shape_130.graphics.f("#FFFFFF").s().p("AAfA7IAAgfIg8AAIAAAfIgSAAIAAgvIAIAAQAIgKAGgQQAEgRABgQIAAgLIA4AAIAABGIAMAAIAAAvgAgTAMIAkAAIAAg2IgUAAQgCAigOAUg");
	this.shape_130.setTransform(30.3,166.6,0.887,0.887);

	this.shape_131 = new cjs.Shape();
	this.shape_131.graphics.f("#FFFFFF").s().p("AgmAtIAAhXIAUAAIAAAzIA0g1IAFAAIAABXIgUAAIAAgzIgzA1g");
	this.shape_131.setTransform(16.8,165.3,0.887,0.887);

	this.shape_132 = new cjs.Shape();
	this.shape_132.graphics.f("#FFFFFF").s().p("AAUAsIgUgeIgUAeIgYAAIAigsIgggrIAYAAIASAcIAUgcIAWAAIgfAqIAiAtg");
	this.shape_132.setTransform(111.5,148.9,0.887,0.887);

	this.shape_133 = new cjs.Shape();
	this.shape_133.graphics.f("#FFFFFF").s().p("AglAsIAAgRIADABQAEAAABgFQABgGAFgGQAFgFAHgCQgVgEAAgSQAAgLAIgHQAJgIARAAIAkACIAABWIgUAAIAAghIgFAAQgWAAgDATQgCAPgPAAgAgIgZQgDAEAAAFQAAAFAFAEQAFADAGAAIANAAIAAgYIgQAAQgGAAgEADg");
	this.shape_133.setTransform(103,148.9,0.887,0.887);

	this.shape_134 = new cjs.Shape();
	this.shape_134.graphics.f("#FFFFFF").s().p("AgmAuIAAhZIAVAAIAAA0IAzg2IAFAAIAABZIgUAAIAAg0Ig0A2g");
	this.shape_134.setTransform(94.7,148.9,0.887,0.887);

	this.shape_135 = new cjs.Shape();
	this.shape_135.graphics.f("#FFFFFF").s().p("AgdAsIAAhXIA7AAIAAASIgnAAIAABFg");
	this.shape_135.setTransform(87.1,148.9,0.887,0.887);

	this.shape_136 = new cjs.Shape();
	this.shape_136.graphics.f("#FFFFFF").s().p("AgeAhQgLgMAAgVQAAgTAMgNQALgMASAAQAUAAALAMQALANAAATQAAAWgLALQgMAMgTAAQgTAAgLgMgAgOgUQgGAHAAANQAAAdAUAAQAJAAAGgIQAGgIAAgNQAAgcgVAAQgIAAgGAIg");
	this.shape_136.setTransform(79.2,148.9,0.887,0.887);

	this.shape_137 = new cjs.Shape();
	this.shape_137.graphics.f("#FFFFFF").s().p("AgqAaQAJAAAFgGQAFgFAEgPQAEgSAAgUIAAgFIA6AAIAABWIgUAAIAAhGIgWAAQAAAQgDARQgEAQgFAIQgHAJgGACQgHADgLAAg");
	this.shape_137.setTransform(70.2,148.9,0.887,0.887);

	this.shape_138 = new cjs.Shape();
	this.shape_138.graphics.f("#FFFFFF").s().p("AgeAhQgLgMAAgVQAAgTAMgNQAKgMATAAQAUAAALAMQALANAAATQAAAVgLAMQgNAMgSAAQgTAAgLgMgAgOgUQgGAHAAANQAAAdAUAAQAJAAAGgIQAGgIAAgNQgBgcgUAAQgJAAgFAIg");
	this.shape_138.setTransform(61.9,148.9,0.887,0.887);

	this.shape_139 = new cjs.Shape();
	this.shape_139.graphics.f("#FFFFFF").s().p("AASAsIAAgmIgjAAIAAAmIgVAAIAAhXIAVAAIAAAhIAjAAIAAghIAVAAIAABXg");
	this.shape_139.setTransform(53.3,148.9,0.887,0.887);

	this.shape_140 = new cjs.Shape();
	this.shape_140.graphics.f("#FFFFFF").s().p("AAVAsIgVgeIgUAeIgYAAIAigsIgfgrIAXAAIASAcIAUgcIAXAAIghAqIAjAtg");
	this.shape_140.setTransform(44.7,148.9,0.887,0.887);

	this.shape_141 = new cjs.Shape();
	this.shape_141.graphics.f("#FFFFFF").s().p("AgeAiQgMgLABgWQgBgUANgNQAMgMARAAQAUAAALALQALALAAASIgBAKIg9AAQAAALAHAFQAGAGALAAQANAAAIgHIAIAQQgMAIgVAAQgSAAgMgLgAgTgIIApAAQgDgTgSAAQgRAAgDATg");
	this.shape_141.setTransform(36.4,148.9,0.887,0.887);

	this.shape_142 = new cjs.Shape();
	this.shape_142.graphics.f("#FFFFFF").s().p("AgJAsIAAhFIgZAAIAAgSIBFAAIAAASIgZAAIAABFg");
	this.shape_142.setTransform(28.5,148.9,0.887,0.887);

	this.shape_143 = new cjs.Shape();
	this.shape_143.graphics.f("#FFFFFF").s().p("AgkAsIAAhWIAmgBQAOAAAJAGQAIAHAAALQAAAFgDAFQgDAFgHADQARAFAAAQQAAAMgJAFQgJAHgQAAgAgQAcIARABQAQAAAAgMQAAgGgFgDQgFgCgGAAIgRAAgAgQgbIAAATIAQAAQAOAAAAgKQAAgEgEgDQgDgDgGAAg");
	this.shape_143.setTransform(16.6,148.8,0.887,0.887);

	this.shape_144 = new cjs.Shape();
	this.shape_144.graphics.f("#FFFFFF").s().p("AAfArIAAhWIAUAAIAABWgAgyArIAAhWIATAAIAAAfIAQAAQAPAAAJAHQAJAHAAAOQAAAbghAAgAgfADIAAAYIAOABQAJAAADgDQAEgFAAgFQAAgFgEgEQgEgEgIAAg");
	this.shape_144.setTransform(117.3,132.5,0.887,0.887);

	this.shape_145 = new cjs.Shape();
	this.shape_145.graphics.f("#FFFFFF").s().p("AAfA7IAAgfIg9AAIAAAfIgRAAIAAgvIAIAAQAJgMAFgPQAFgRAAgPIAAgLIA4AAIAABGIAMAAIAAAvgAgTAMIAkAAIAAg2IgVAAQgBAjgOATg");
	this.shape_145.setTransform(107.1,133.8,0.887,0.887);

	this.shape_146 = new cjs.Shape();
	this.shape_146.graphics.f("#FFFFFF").s().p("AASArIAAglIgjAAIAAAlIgVAAIAAhWIAVAAIAAAiIAjAAIAAgiIAVAAIAABWg");
	this.shape_146.setTransform(98.1,132.5,0.887,0.887);

	this.shape_147 = new cjs.Shape();
	this.shape_147.graphics.f("#FFFFFF").s().p("AgeAiQgMgMABgVQgBgUANgMQANgNARAAQASAAAMALQAMALAAASIgCAKIg9AAQABALAGAGQAGAFALAAQAOAAAHgHIAIAQQgLAIgWAAQgSAAgMgLgAgUgIIAqAAQgCgTgTAAQgQAAgFATg");
	this.shape_147.setTransform(89.4,132.5,0.887,0.887);

	this.shape_148 = new cjs.Shape();
	this.shape_148.graphics.f("#FFFFFF").s().p("AgnA+IAAh5IAUAAIAAAGQAIgIALAAQApAAAAAuQAAAVgMALQgLAMgUAAQgKAAgHgEIAAAlgAgTgmIAAAtQAFAFAIAAQANAAAGgHQAHgFgBgPQAAgPgFgHQgHgGgNAAQgHAAgGAFg");
	this.shape_148.setTransform(81.1,133.9,0.887,0.887);

	this.shape_149 = new cjs.Shape();
	this.shape_149.graphics.f("#FFFFFF").s().p("AgJArIAAhFIgZAAIAAgRIBFAAIAAARIgZAAIAABFg");
	this.shape_149.setTransform(72.9,132.5,0.887,0.887);

	this.shape_150 = new cjs.Shape();
	this.shape_150.graphics.f("#FFFFFF").s().p("AgDAtIgYgvIgBAAIgHAuIgUAAIARhYIAIAAIAeA9IAgg9IAHAAIAQBYIgUAAIgHgpIgBgFIgBAAIgCAHIgVAog");
	this.shape_150.setTransform(59.5,132.5,0.887,0.887);

	this.shape_151 = new cjs.Shape();
	this.shape_151.graphics.f("#FFFFFF").s().p("AgeAiQgMgLAAgWQABgUAMgMQANgNAQAAQAUAAALALQALAMAAARIgBAKIg9AAQAAAKAHAHQAFAFAMAAQAOAAAGgHIAJAQQgLAIgWAAQgSAAgMgLgAgUgIIAqAAQgCgTgTAAQgQAAgFATg");
	this.shape_151.setTransform(49.9,132.5,0.887,0.887);

	this.shape_152 = new cjs.Shape();
	this.shape_152.graphics.f("#FFFFFF").s().p("AATAqQgDgDgCgEQgCAEgHAEQgIACgGAAQgPAAgHgHQgIgGAAgOQAAgOALgIQAMgJAUAAIAIABQAAgPgSAAQgLAAgIAEIgFgQQALgFAOAAQAUAAAJAJQAJAJAAAZIAAASQAAASAHAEQgDAEgCABIgIABQgEAAgEgDgAgSARQAAAMANAAQASAAAAgSIAAgIIgIgBQgXAAAAAPg");
	this.shape_152.setTransform(41.7,132.5,0.887,0.887);

	this.shape_153 = new cjs.Shape();
	this.shape_153.graphics.f("#FFFFFF").s().p("AAfA7IAAgfIg8AAIAAAfIgSAAIAAgvIAJAAQAIgMAFgPQAFgPAAgRIAAgLIA4AAIAABGIAMAAIAAAvgAgTAMIAkAAIAAg2IgUAAQgCAigOAUg");
	this.shape_153.setTransform(33.1,133.8,0.887,0.887);

	this.shape_154 = new cjs.Shape();
	this.shape_154.graphics.f("#FFFFFF").s().p("AAUAqQgDgCgCgFQgDAFgHADQgIACgFAAQgPAAgIgHQgIgHAAgNQAAgNALgJQAMgJAUAAIAJABQAAgPgTAAQgKAAgJAEIgFgQQALgFAOAAQAUAAAJAJQAJAJAAAZIAAASQAAASAHAEQgDAFgCAAIgIABQgEAAgDgDgAgSARQAAAMANAAQASAAAAgSIAAgIIgIgBQgXAAAAAPg");
	this.shape_154.setTransform(24.6,132.5,0.887,0.887);

	this.shape_155 = new cjs.Shape();
	this.shape_155.graphics.f("#FFFFFF").s().p("AgoA1IAJgTQAOAKAOAAQAKAAAGgFQAGgFAAgJQAAgKgHgGQgIgGgLAAIgMABIAAgQIAMAAQAKAAAGgEQAGgFAAgIQAAgGgFgEQgGgEgHAAQgLAAgNAIIgIgSQASgIAQAAQAQAAALAIQAKAJAAAOQAAAJgEAHQgFAHgHADQALAEAEAGQAGAHAAAMQAAARgMAKQgMAKgVAAQgVAAgPgJg");
	this.shape_155.setTransform(16.3,131,0.887,0.887);

	this.instance_7 = new lib.xxxc();
	this.instance_7.parent = this;
	this.instance_7.setTransform(75.7,157.3,0.806,0.806,0,0,0,113.1,78.2);

	var maskedShapeInstanceList = [this.shape_123,this.shape_124,this.shape_125,this.shape_126,this.shape_127,this.shape_128,this.shape_129,this.shape_130,this.shape_131,this.shape_132,this.shape_133,this.shape_134,this.shape_135,this.shape_136,this.shape_137,this.shape_138,this.shape_139,this.shape_140,this.shape_141,this.shape_142,this.shape_143,this.shape_144,this.shape_145,this.shape_146,this.shape_147,this.shape_148,this.shape_149,this.shape_150,this.shape_151,this.shape_152,this.shape_153,this.shape_154,this.shape_155,this.instance_7];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_3;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.shape_155},{t:this.shape_154},{t:this.shape_153},{t:this.shape_152},{t:this.shape_151},{t:this.shape_150},{t:this.shape_149},{t:this.shape_148},{t:this.shape_147},{t:this.shape_146},{t:this.shape_145},{t:this.shape_144},{t:this.shape_143},{t:this.shape_142},{t:this.shape_141},{t:this.shape_140},{t:this.shape_139},{t:this.shape_138},{t:this.shape_137},{t:this.shape_136},{t:this.shape_135},{t:this.shape_134},{t:this.shape_133},{t:this.shape_132},{t:this.shape_131},{t:this.shape_130},{t:this.shape_129},{t:this.shape_128},{t:this.shape_127},{t:this.shape_126},{t:this.shape_125},{t:this.shape_124},{t:this.shape_123}]},211).to({state:[]},87).wait(62));

	// pic3
	this.instance_8 = new lib.eeer();
	this.instance_8.parent = this;
	this.instance_8.setTransform(253.9,139.7,0.7,0.7,0,0,0,120.2,83.6);
	...
	this.shape_156.graphics.lf(["#DBDBDB","#E9E9E9","#8A8A8A"],[0,0.514,0.984],122.1,-313.5,-51,131.1).s().p("Aq6cMMAOZg4XIHcAAMgOaA4Xg");
	this.shape_156.setTransform(287.5,139.3,0.525,0.849,4,0,0,-0.5,0.2);

	this.shape_157 = new cjs.Shape();
	this.shape_157.graphics.lf(["#DBDBDB","#E9E9E9","#8A8A8A"],[0,0.514,0.984],122.1,-313.5,-51,131.1).s().p("Aq6cMMAOZg4XIHcAAMgOaA4Xg");
	this.shape_157.setTransform(36.7,139.3,0.525,0.849,4,0,0,-0.4,0.2);

	this.instance_9 = new lib.bg2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-1,0,0.606,0.761);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9},{t:this.shape_157},{t:this.shape_156}]}).wait(360));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(156.8,127.2,347.8,304);
// library properties:
lib.properties = {
	width: 336,
	height: 280,

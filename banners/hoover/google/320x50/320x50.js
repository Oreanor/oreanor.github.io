...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	this.shape_12.setTransform(260.2,40.6,0.225,0.225);
	...
	this.shape_13.setTransform(257,40.6,0.225,0.225);
	...
	this.shape_14.setTransform(254.1,40.6,0.225,0.225);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.instance}]}).wait(360));

	// Слой 19
	this.instance_1 = new lib.ghggg();
	this.instance_1.parent = this;
	this.instance_1.setTransform(10,179.9,0.495,0.495,0,0,0,0.1,0.1);
	...
	this.shape_15.setTransform(160,25,1.333,0.125);

	this.timeline.addTween(cjs.Tween.get(this.shape_15).wait(360));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(151.3,-50.4,329.2,185.4);
// library properties:
lib.properties = {
	width: 320,
	height: 50,

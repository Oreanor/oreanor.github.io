...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off:false},0).to({alpha:1},6).wait(47).to({y:186},11,cjs.Ease.get(1)).to({_off:true},239).wait(48));
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(226,63.8);

...
(lib.dfgdfggg = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(153.8,197.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgNAYQgFgEAAgHIAHgBQABAGADACQADADAEAAQAFAAADgEQAEgEgBgGQABgGgEgDQgDgDgFAAQgDAAgDACQgDABgBACIgHgBIAGgdIAbAAIAAAHIgWAAIgDAPQAGgDAEAAQAHAAAFAFQAGAEAAAIQAAAIgEAGQgGAHgJAAQgHAAgGgFg");
	this.shape_1.setTransform(149.4,197.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAFAdIAAgOIgYAAIAAgGIAZglIAGAAIAAAlIAIAAIAAAGIgIAAIAAAOgAgMAJIARAAIAAgZg");
	this.shape_2.setTransform(144.7,197.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgMAXQgGgHAAgQQABgJACgGQACgHADgDQAFgDAFAAQAEAAAEACQADABADAEIADAIIACANQgBAKgCAGQgCAGgDAEQgFADgGAAQgIAAgEgGgAgHgSQgDAFgBANQABAOADAFQADAEAEAAQAFAAADgEQADgFABgOQgBgNgDgFQgDgEgFAAQgEAAgDAEg");
	this.shape_3.setTransform(140.4,197.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgKAcQAAgHADgJQACgKAFgIQAEgIAGgHIgbAAIAAgGIAkAAIAAAFQgGAGgGAKQgFAIgCALQgCAHgBAIg");
	this.shape_4.setTransform(136,197.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgMAXQgGgHABgQQAAgJACgGQABgHAEgDQAFgDAFAAQAEAAAEACQADABADAEIAEAIIABANQAAAKgDAGQgCAGgDAEQgFADgGAAQgIAAgEgGgAgHgSQgEAFAAANQAAAOAEAFQADAEAEAAQAFAAADgEQADgFABgOQgBgNgDgFQgDgEgFAAQgEAAgDAEg");
	this.shape_5.setTransform(131.5,197.8);
	...
	this.shape_6.setTransform(127.1,197.8);
	...
	this.shape_7.setTransform(122.6,197.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgJAcQAAgHACgJQADgKAEgIQAEgIAGgHIgbAAIAAgGIAkAAIAAAFQgGAGgFAKQgGAIgCALQgCAHgBAIg");
	this.shape_8.setTransform(118.2,197.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgKAcQABgHACgJQACgKAFgIQAEgIAFgHIgbAAIAAgGIAkAAIAAAFQgFAGgGAKQgFAIgCALQgCAHAAAIg");
	this.shape_9.setTransform(113.8,197.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AAFAdIAAgOIgYAAIAAgGIAZglIAGAAIAAAlIAIAAIAAAGIgIAAIAAAOgAgMAJIARAAIAAgZg");
	this.shape_10.setTransform(109.1,197.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgMAXQgFgHAAgQQAAgJABgGQACgHAFgDQAEgDAFAAQAFAAADACQAEABACAEIAEAIIABANQgBAKgBAGQgDAGgEAEQgDADgHAAQgIAAgEgGgAgHgSQgEAFABANQgBAOAEAFQADAEAEAAQAFAAADgEQAEgFgBgOQABgNgEgFQgDgEgFAAQgEAAgDAEg");
	this.shape_11.setTransform(104.8,197.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_12.setTransform(100.1,197.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgHAAIAAg5IAHAAIAAAYIAdAAIAAgYIAIAAIAAA5g");
	this.shape_13.setTransform(93.1,197.8);
	...
	this.shape_14.setTransform(87.6,197.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgSAdIAAg5IAkAAIAAAHIgcAAIAAAyg");
	this.shape_15.setTransform(83,197.8);
	...
	this.shape_16.setTransform(77.4,197.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgNAYQgEgEgBgHIAHgBQABAGADACQADADAEAAQAEAAAEgEQADgEABgGQgBgGgDgDQgEgDgEAAQgDAAgDACQgDABgCACIgGgBIAFgdIAcAAIAAAHIgWAAIgDAPQAFgDAFAAQAIAAAEAFQAGAEAAAIQAAAIgFAGQgFAHgJAAQgIAAgFgFg");
	this.shape_17.setTransform(69.9,197.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_18.setTransform(65.1,197.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgMAXQgFgHgBgQQAAgJACgGQACgHAEgDQAEgDAGAAQAEAAAEACQAEABACAEIADAIIABANQAAAKgCAGQgBAGgFAEQgEADgGAAQgHAAgFgGgAgHgSQgDAFAAANQAAAOADAFQADAEAEAAQAFAAADgEQADgFAAgOQAAgNgDgFQgDgEgFAAQgEAAgDAEg");
	this.shape_19.setTransform(60.9,197.8);
	...
	this.shape_20.setTransform(56.4,197.8);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_21.setTransform(51.7,197.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgMAYQgFgEgBgHIAHgBQABAGADACQADADAEAAQAFAAADgEQAEgEAAgGQAAgGgEgDQgDgDgFAAQgDAAgDACQgDABgCACIgGgBIAFgdIAcAAIAAAHIgWAAIgDAPQAGgDAEAAQAIAAAFAFQAFAEAAAIQAAAIgFAGQgFAHgJAAQgIAAgEgFg");
	this.shape_22.setTransform(47.6,197.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AAFAdIAAgOIgYAAIAAgGIAZglIAGAAIAAAlIAIAAIAAAGIgIAAIAAAOgAgMAJIARAAIAAgZg");
	this.shape_23.setTransform(43,197.8);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#000000").s().p("AgMAXQgFgHAAgQQAAgJABgGQACgHAFgDQAEgDAFAAQAFAAADACQAEABACAEIAEAIIABANQAAAKgCAGQgDAGgEAEQgDADgHAAQgHAAgFgGgAgHgSQgEAFABANQgBAOAEAFQADAEAEAAQAFAAADgEQAEgFgBgOQABgNgEgFQgDgEgFAAQgEAAgDAEg");
	this.shape_24.setTransform(38.7,197.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#000000").s().p("AgJAcQgBgHADgJQADgKAEgIQAEgIAFgHIgbAAIAAgGIAkAAIAAAFQgFAGgFAKQgGAIgCALQgCAHAAAIg");
	this.shape_25.setTransform(34.3,197.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AgKAcQAAgHADgJQACgKAFgIQAEgIAGgHIgbAAIAAgGIAkAAIAAAFQgGAGgGAKQgFAIgCALQgCAHgBAIg");
	this.shape_26.setTransform(29.8,197.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgIAAIAAg5IAIAAIAAAYIAdAAIAAgYIAHAAIAAA5g");
	this.shape_27.setTransform(22.5,197.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgIAAIAAg5IAIAAIAAAYIAdAAIAAgYIAHAAIAAA5g");
	this.shape_28.setTransform(16.7,197.8);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AAPAdIAAgsIgdAsIgIAAIAAg5IAHAAIAAAtIAdgtIAIAAIAAA5g");
	this.shape_29.setTransform(10.9,197.8);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_30.setTransform(265.8,192.4);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("");
	this.shape_31.setTransform(262.4,189.9);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_32.setTransform(256.9,192.4);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#000000").s().p("AARAbIAAgMIggAAIAAAMIgGAAIAAgSIAEAAQAHgJAAgaIAcAAIAAAjIAEAAIAAASgAgKAJIAUAAIAAgdIgPAAQAAAUgFAJg");
	this.shape_33.setTransform(253.3,191.3);
	...
	this.shape_34.setTransform(247.8,192.9);
	...
	this.shape_35.setTransform(244.5,189.9);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgKAEIAAgHIAVAAIAAAHg");
	this.shape_36.setTransform(240.9,190.7);
	...
	this.shape_37.setTransform(237.3,189.9);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AAKAdIAAgfIgTAfIgHAAIAAgpIAHAAIAAAfIASgfIAIAAIAAApgAgGgUQgEgDAAgFIAFAAIACAFIADABIAFgBIACgFIAFAAQAAAFgEADQgCACgGAAQgDAAgDgCg");
	this.shape_38.setTransform(230.8,189.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AAKAVIAAgfIgSAfIgIAAIAAgpIAHAAIAAAfIASgfIAIAAIAAApg");
	this.shape_39.setTransform(226.3,190.7);
	...
	this.shape_40.setTransform(222.6,190.7);
	...
	this.shape_45.setTransform(198.9,190.7);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#000000").s().p("AgVAdIAAg5IAVAAIAIABQAEABAEACQADACABADQACAEAAAEQAAAHgFAEQgFAFgMAAIgNAAIAAAYgAgNAAIANAAQAIAAADgDQADgDAAgFQAAgDgBgDQgDgCgDgBIgHgBIgNAAg");
	this.shape_46.setTransform(194.1,189.9);
	...
	this.shape_47.setTransform(186.7,191.3);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#000000").s().p("");
	this.shape_48.setTransform(182.6,190.7);
	...
	this.shape_49.setTransform(178.6,190.7);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#000000").s().p("AgNAQQgGgFABgLQAAgLAGgFQAFgFAHAAQAJAAAFAGQAFAGAAAJQABAHgDAFQgDAFgEACQgFADgFAAQgIAAgFgGgAgIgLQgDAEAAAHQAAAIADAEQAEAEAEAAQAGAAADgEQAEgEgBgIQABgHgEgEQgDgEgGAAQgEAAgEAEg");
	this.shape_50.setTransform(174.1,190.7);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#000000").s().p("AgRAdIAAg4IAGAAIAAAFQADgDACgCQADgBADAAQAFAAAEADQAFACACAFQACAFAAAGQAAAHgCAEQgDAFgEACQgFADgEAAQgDAAgDgBQgCgCgCgCIAAAUgAgIgSQgDAEAAAIQAAAHADAEQADADAFAAQAEAAAEgEQACgEAAgHQAAgIgCgEQgEgEgEAAQgEAAgEAFg");
	this.shape_51.setTransform(169.8,191.4);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#000000").s().p("AAPAdIAAgyIgdAAIAAAyIgHAAIAAg5IAsAAIAAA5g");
	this.shape_52.setTransform(164.6,189.9);
	...
	this.shape_53.setTransform(158.4,192.9);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("");
	this.shape_54.setTransform(155.1,190.7);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AgQAVIAAgpIAQAAIAIABQADABACADQACADAAADIgBAFIgEAEQADAAACADQACACAAAEQgBAGgEADQgDADgHAAgAgJAPIAJAAIAHgBQADgCAAgDIgBgEQgBAAAAgBQgBAAAAAAQgBgBAAAAQAAAAgBAAIgGAAIgIAAgAgJgCIAHAAIAFgBIADgCQABAAAAgBQAAAAABAAQAAgBAAAAQAAgBAAAAQAAgDgDgCIgHgBIgHAAg");
	this.shape_55.setTransform(150.9,190.7);
	...
	this.shape_56.setTransform(147.1,190.7);
	...
	this.shape_57.setTransform(143.2,190.7);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#000000").s().p("AgNAQQgFgFgBgLQABgLAGgFQAGgFAGAAQAIAAAGAGQAGAGgBAJQAAAHgCAFQgDAFgEACQgEADgGAAQgHAAgGgGgAgIgLQgDAEAAAHQAAAIADAEQAEAEAEAAQAGAAADgEQAEgEAAgIQAAgHgEgEQgDgEgGAAQgEAAgEAEg");
	this.shape_58.setTransform(138.9,190.7);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#000000").s().p("AAUAdIAAgvIgRAvIgFAAIgRgwIAAAwIgHAAIAAg5IALAAIAOAoIABAJIADgKIAOgnIAKAAIAAA5g");
	this.shape_59.setTransform(133.3,189.9);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_60.setTransform(126.8,192.4);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#000000").s().p("AgLAVIAAgpIAXAAIAAAGIgQAAIAAAjg");
	this.shape_61.setTransform(124.4,190.7);
	...
	this.shape_62.setTransform(119.4,192.9);
	...
	this.shape_77.setTransform(51.6,190.6);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgHAAIAAg5IAHAAIAAAYIAdAAIAAgYIAIAAIAAA5g");
	this.shape_78.setTransform(46.2,189.9);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#000000").s().p("AASAdIgHgSIgXAAIgGASIgIAAIAWg5IAHAAIAYA5gAgDgLIgGAQIASAAIgGgPIgDgLIgDAKg");
	this.shape_79.setTransform(40.6,189.9);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#000000").s().p("AALAdIgKgQQgDgGgDgDQgDgCgEAAIAAAbIgHAAIAAg5IAHAAIAAAaQAFAAADgCQACgCACgIIAEgIIAEgEQADgCADAAIAGABIAAAGIgCAAIgCAAQgEAAgBACIgFAHQgCAIgCABIgEADQAEABAGAJIAMATg");
	this.shape_80.setTransform(35.9,189.9);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#000000").s().p("AALASIgLgSIALgRIAGAAIgKARIAKASgAgDASIgNgSIANgRIAFAAIgJARIAJASg");
	this.shape_81.setTransform(31,190.7);
	...
	this.shape_82.setTransform(23.5,189.9);
	...
	this.shape_83.setTransform(17.3,189.9);
	...
	this.shape_84.setTransform(11.1,189.9);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfggg, new cjs.Rectangle(6,183.6,265.2,20.8), null);
...
(lib.ghgf = function(mode,startPosition,loop) {
	...
	this.shape_11.setTransform(-45.6,45.5,0.9,0.9);
	...
	this.shape_12.setTransform(-58.2,45.5,0.9,0.9);
	...
	this.shape_13.setTransform(-70.1,45.5,0.9,0.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("EgSvAnEMAAAhOHMAlfAAAMAAABOHg");
	this.shape_14.setTransform(0,50);
...
}).prototype = getMCSymbolPrototype(lib.ghgf, new cjs.Rectangle(-120,-200,240,500), null);
...
(lib.spr = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(12.2,378.7,1,1,0,0,0,12.2,0);

	this.instance_1 = new lib.pr();
	this.instance_1.parent = this;
	this.instance_1.setTransform(12.2,361.1,1,1,0,0,0,12.2,0);

	this.instance_2 = new lib.pr();
	this.instance_2.parent = this;
	this.instance_2.setTransform(12.2,343.9,1,1,0,0,0,12.2,0);

	this.instance_3 = new lib.pr();
	this.instance_3.parent = this;
	this.instance_3.setTransform(12.2,326.8,1,1,0,0,0,12.2,0);

	this.instance_4 = new lib.pr();
	this.instance_4.parent = this;
	this.instance_4.setTransform(12.2,309.6,1,1,0,0,0,12.2,0);

	this.instance_5 = new lib.pr();
	this.instance_5.parent = this;
	this.instance_5.setTransform(12.2,292.5,1,1,0,0,0,12.2,0);

	this.instance_6 = new lib.pr();
	this.instance_6.parent = this;
	this.instance_6.setTransform(12.2,275.3,1,1,0,0,0,12.2,0);

	this.instance_7 = new lib.pr();
	this.instance_7.parent = this;
	this.instance_7.setTransform(12.2,258.2,1,1,0,0,0,12.2,0);

	this.instance_8 = new lib.pr();
	this.instance_8.parent = this;
	this.instance_8.setTransform(12.2,241,1,1,0,0,0,12.2,0);

	this.instance_9 = new lib.pr();
	this.instance_9.parent = this;
	this.instance_9.setTransform(12.2,223.9,1,1,0,0,0,12.2,0);

	this.instance_10 = new lib.pr();
	this.instance_10.parent = this;
	this.instance_10.setTransform(12.2,206.7,1,1,0,0,0,12.2,0);

	this.instance_11 = new lib.pr();
	this.instance_11.parent = this;
	this.instance_11.setTransform(12.2,189.6,1,1,0,0,0,12.2,0);

	this.instance_12 = new lib.pr();
	this.instance_12.parent = this;
	this.instance_12.setTransform(12.2,172.4,1,1,0,0,0,12.2,0);

	this.instance_13 = new lib.pr();
	this.instance_13.parent = this;
	this.instance_13.setTransform(12.2,155.3,1,1,0,0,0,12.2,0);

	this.instance_14 = new lib.pr();
	this.instance_14.parent = this;
	this.instance_14.setTransform(12.2,138.1,1,1,0,0,0,12.2,0);

	this.instance_15 = new lib.pr();
	this.instance_15.parent = this;
	this.instance_15.setTransform(12.2,121,1,1,0,0,0,12.2,0);

	this.instance_16 = new lib.pr();
	this.instance_16.parent = this;
	this.instance_16.setTransform(12.2,103.8,1,1,0,0,0,12.2,0);

	this.instance_17 = new lib.pr();
	this.instance_17.parent = this;
	this.instance_17.setTransform(12.2,86.7,1,1,0,0,0,12.2,0);

	this.instance_18 = new lib.pr();
	this.instance_18.parent = this;
	this.instance_18.setTransform(12.2,69.5,1,1,0,0,0,12.2,0);

	this.instance_19 = new lib.pr();
	this.instance_19.parent = this;
	this.instance_19.setTransform(12.2,52.4,1,1,0,0,0,12.2,0);

	this.instance_20 = new lib.pr();
	this.instance_20.parent = this;
	this.instance_20.setTransform(12.2,35.2,1,1,0,0,0,12.2,0);

	this.instance_21 = new lib.pr();
	this.instance_21.parent = this;
	this.instance_21.setTransform(12.2,18.1,1,1,0,0,0,12.2,0);

	this.instance_22 = new lib.pr();
	this.instance_22.parent = this;
	this.instance_22.setTransform(12.2,0.9,1,1,0,0,0,12.2,0);
...
}).prototype = getMCSymbolPrototype(lib.spr, new cjs.Rectangle(0,-2.7,24.5,385), null);
...
(lib.logo3 = function(mode,startPosition,loop) {
	...
	this.shape_12.setTransform(-62.5,60.4,1.2,1.2);
	...
	this.shape_13.setTransform(-79.3,60.4,1.2,1.2);
	...
	this.shape_14.setTransform(-95.1,60.4,1.2,1.2);
...
}).prototype = getMCSymbolPrototype(lib.logo3, new cjs.Rectangle(-143.6,-172.9,284.2,284.2), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(149.6,446.9,1.25,1.25);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(149.6,251.4,1.25,1.25);
	...
	this.born2.setTransform(76,589.7);
	this.born2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.born2).to({alpha:1},6,cjs.Ease.get(1)).to({_off:true},297).wait(57));

	// logo
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAAAFIgGAKIgFgEIAIgJIgMgCIACgHIALAFIgBgMIAHAAIgCAMIAMgFIACAHIgMACIAIAJIgFAEIgHgKg");
	this.shape_1.setTransform(203.7,549.8);

	this.instance_2 = new lib.hgj();
	this.instance_2.parent = this;
	this.instance_2.setTransform(154.5,512.3,0.562,0.562,0,0,0,1.9,2.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#706F6F").s().p("AgrBHIAAiNIBWAAIAAAOIhHAAIAAAyIA/AAIAAAMIg/AAIAAAzIBIAAIAAAOg");
	this.shape_2.setTransform(198,554,0.562,0.562);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#706F6F").s().p("AgGBHIgziNIARAAIAoB3IAqh3IAQAAIgzCNg");
	this.shape_3.setTransform(191,554,0.562,0.562);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#706F6F").s().p("AgHBHIAAiNIAPAAIAACNg");
	this.shape_4.setTransform(185.9,554,0.562,0.562);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#706F6F").s().p("AgHBHIAAh/IgnAAIAAgOIBdAAIAAAOIgoAAIAAB/g");
	this.shape_5.setTransform(181.3,554,0.562,0.562);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#706F6F").s().p("AAtBHIgNglIg/AAIgOAlIgQAAIA2iNIAOAAIA3CNgAgaAUIA1AAIgbhHg");
	this.shape_6.setTransform(175.2,553.9,0.562,0.562);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#706F6F").s().p("AgGBHIgziNIARAAIAoB3IAqh3IAQAAIgzCNg");
	this.shape_7.setTransform(168.6,554,0.562,0.562);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#706F6F").s().p("AgrA1QgRgUAAggIAAgBQAAgfARgVQARgUAaAAQAbAAARAUQARAUAAAgIAAABQAAAfgRAVQgRAUgbAAQgaAAgRgUgAgggqQgMAQAAAaIAAABQAAAZAMARQAOAQASAAQAUAAAMgQQANgQAAgaIAAgBQAAgZgNgRQgMgQgUAAQgTAAgNAQg");
	this.shape_8.setTransform(161.3,554,0.562,0.562);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAPAAIBJBvIAAhvIAPAAIAACNg");
	this.shape_9.setTransform(153.3,554,0.562,0.562);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAPAAIBJBvIAAhvIAPAAIAACNg");
	this.shape_10.setTransform(145.6,554,0.562,0.562);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#706F6F").s().p("AgHBHIAAiNIAOAAIAACNg");
	this.shape_11.setTransform(140.3,554,0.562,0.562);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAOAAIBKBvIAAhvIAPAAIAACNg");
	this.shape_12.setTransform(132,554,0.562,0.562);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#706F6F").s().p("AAgBHIgig3IghAAIAAA3IgPAAIAAiNIAxAAQAYAAAMANQALAMAAARIAAABQAAAfgiAJIAnA6gAgjACIAfAAQAQAAAKgHQAJgIAAgOQAAgdghAAIghAAg");
	this.shape_13.setTransform(124.9,554,0.562,0.562);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#706F6F").s().p("AgrA1QgRgUAAggIAAgBQAAgfARgVQARgUAaAAQAbAAARAUQARAUAAAgIAAABQAAAfgRAVQgRAUgbAAQgaAAgRgUgAgggqQgMAQAAAaIAAABQAAAZAMARQAOAQASAAQAUAAAMgQQANgQAAgaIAAgBQAAgZgNgRQgMgQgUAAQgTAAgNAQg");
	this.shape_14.setTransform(117,554,0.562,0.562);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#706F6F").s().p("AgwBHIAAiNIAwAAQAWAAAMAMQAJAKAAAOQAAAYgXAJQAdAIAAAZIAAABQAAASgNAKQgOAKgWAAgAghA5IAhAAQAQAAAJgGQAJgHAAgMIAAgBQAAgZgiAAIghAAgAghgGIAfAAQANAAAIgHQAJgHAAgMQAAgMgIgGQgIgGgNAAIggAAg");
	this.shape_15.setTransform(109.6,554,0.562,0.562);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.instance_2},{t:this.shape_1}]},74).to({state:[]},224).wait(62));

	// Слой 24 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_1 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_2 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_3 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_4 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_5 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_6 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_7 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");
	var mask_graphics_8 = new cjs.Graphics().p("Egk+Am8MAAQhOBMBJtAAQMgbNBN7g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-130.5,y:248}).wait(1).to({graphics:mask_graphics_1,x:-66,y:248}).wait(1).to({graphics:mask_graphics_2,x:-10.2,y:248}).wait(1).to({graphics:mask_graphics_3,x:37.1,y:248}).wait(1).to({graphics:mask_graphics_4,x:75.8,y:248}).wait(1).to({graphics:mask_graphics_5,x:105.8,y:248}).wait(1).to({graphics:mask_graphics_6,x:127.3,y:248}).wait(1).to({graphics:mask_graphics_7,x:140.2,y:248}).wait(1).to({graphics:mask_graphics_8,x:144.5,y:248}).wait(352));

	// ghghj
	this.instance_3 = new lib.ghghj();
	this.instance_3.parent = this;
	this.instance_3.setTransform(154.6,162.4,1.25,1.25);
	...
	mask_1._off = true;
	var mask_1_graphics_62 = new cjs.Graphics().p("Egk1ArFMAAAhU5MBJtAAAMga9BU5g");
	var mask_1_graphics_63 = new cjs.Graphics().p("EgfZArFMAAAhU5MA+zAAAMgW+BU5g");
	var mask_1_graphics_64 = new cjs.Graphics().p("EgadArFMAAAhU5MA07AAAMgTXBU5g");
	var mask_1_graphics_65 = new cjs.Graphics().p("EgWCArFMAAAhU5MAsFAAAMgQIBU5g");
	var mask_1_graphics_66 = new cjs.Graphics().p("EgSJArFMAAAhU5MAkTAAAMgNSBU5g");
	var mask_1_graphics_67 = new cjs.Graphics().p("EgOxArFMAAAhU5IdjAAMgK0BU5g");
	var mask_1_graphics_68 = new cjs.Graphics().p("EgL6ArFMAAAhU5IX1AAMgIuBU5g");
	var mask_1_graphics_69 = new cjs.Graphics().p("EgJkArFMAAAhU5ITJAAMgHABU5g");
	var mask_1_graphics_70 = new cjs.Graphics().p("EgHwArFMAAAhU5IPhAAMgFrBU5g");
	var mask_1_graphics_71 = new cjs.Graphics().p("EgGcArFMAAAhU5IM5AAMgEuBU5g");
	var mask_1_graphics_72 = new cjs.Graphics().p("EgFrArFMAAAhU5ILWAAMgEKBU5g");
	var mask_1_graphics_73 = new cjs.Graphics().p("EgFvArFMAAAhU5IK1AAMgD9BU5g");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(62).to({graphics:mask_1_graphics_62,x:236,y:275.7}).wait(1).to({graphics:mask_1_graphics_63,x:188.4,y:275.7}).wait(1).to({graphics:mask_1_graphics_64,x:145.3,y:275.7}).wait(1).to({graphics:mask_1_graphics_65,x:106.6,y:275.7}).wait(1).to({graphics:mask_1_graphics_66,x:72.5,y:275.7}).wait(1).to({graphics:mask_1_graphics_67,x:43,y:275.7}).wait(1).to({graphics:mask_1_graphics_68,x:18,y:275.7}).wait(1).to({graphics:mask_1_graphics_69,x:-2.4,y:275.7}).wait(1).to({graphics:mask_1_graphics_70,x:-18.3,y:275.7}).wait(1).to({graphics:mask_1_graphics_71,x:-29.7,y:275.7}).wait(1).to({graphics:mask_1_graphics_72,x:-36.4,y:275.7}).wait(1).to({graphics:mask_1_graphics_73,x:-36.7,y:275.7}).wait(287));

	// ghghj
	this.instance_4 = new lib.ghghj();
	this.instance_4.parent = this;
	this.instance_4.setTransform(154.6,162.4,1.25,1.25);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(161,400,0.85,0.85,0,0,0,-0.4,-28.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(7).to({_off:false},0).to({alpha:1},7,cjs.Ease.get(1)).to({_off:true},60).wait(286));

	// mask-in-out (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_62 = new cjs.Graphics().p("EgNfArFMAa8hU5MAuyAAAMAAABU5g");
	var mask_2_graphics_63 = new cjs.Graphics().p("Egj9AqdMAXAhU5MAw7AAAMAAABU5g");
	var mask_2_graphics_64 = new cjs.Graphics().p("EgjJAqdMATbhU5MAy4AAAMAAABU5g");
	var mask_2_graphics_65 = new cjs.Graphics().p("EgiaAqdMAQOhU5MA0nAAAMAAABU5g");
	var mask_2_graphics_66 = new cjs.Graphics().p("EghxAqdMANZhU5MA2KAAAMAAABU5g");
	var mask_2_graphics_67 = new cjs.Graphics().p("EghOAqdMAK9hU5MA3gAAAMAAABU5g");
	var mask_2_graphics_68 = new cjs.Graphics().p("EggwAqdMAI4hU5MA4oAAAMAAABU5g");
	var mask_2_graphics_69 = new cjs.Graphics().p("EggXAqdMAHMhU5MA5jAAAMAAABU5g");
	var mask_2_graphics_70 = new cjs.Graphics().p("EggDAqdMAF3hU5MA6RAAAMAAABU5g");
	var mask_2_graphics_71 = new cjs.Graphics().p("Egf2AqdMAE8hU5MA6xAAAMAAABU5g");
	var mask_2_graphics_72 = new cjs.Graphics().p("EgfuAqdMAEXhU5MA7GAAAMAAABU5g");
	var mask_2_graphics_73 = new cjs.Graphics().p("EgfrArFMAELhU5MA7MAAAMAAABU5g");
	var mask_2_graphics_137 = new cjs.Graphics().p("Egk1ArFMAAAhU5MBJtAAAMga9BU5g");
	var mask_2_graphics_138 = new cjs.Graphics().p("EgfZArFMAAAhU5MA+zAAAMgW+BU5g");
	var mask_2_graphics_139 = new cjs.Graphics().p("EgadArFMAAAhU5MA07AAAMgTXBU5g");
	var mask_2_graphics_140 = new cjs.Graphics().p("EgWCArFMAAAhU5MAsFAAAMgQIBU5g");
	var mask_2_graphics_141 = new cjs.Graphics().p("EgSJArFMAAAhU5MAkTAAAMgNSBU5g");
	var mask_2_graphics_142 = new cjs.Graphics().p("EgOxArFMAAAhU5IdjAAMgK0BU5g");
	var mask_2_graphics_143 = new cjs.Graphics().p("EgL6ArFMAAAhU5IX1AAMgIuBU5g");
	var mask_2_graphics_144 = new cjs.Graphics().p("EgJkArFMAAAhU5ITJAAMgHABU5g");
	var mask_2_graphics_145 = new cjs.Graphics().p("EgHwArFMAAAhU5IPhAAMgFrBU5g");
	var mask_2_graphics_146 = new cjs.Graphics().p("EgGcArFMAAAhU5IM5AAMgEuBU5g");
	var mask_2_graphics_147 = new cjs.Graphics().p("EgFrArFMAAAhU5ILWAAMgEKBU5g");
	var mask_2_graphics_148 = new cjs.Graphics().p("EgFvArFMAAAhU5IK1AAMgD9BU5g");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(62).to({graphics:mask_2_graphics_62,x:385.5,y:275.7}).wait(1).to({graphics:mask_2_graphics_63,x:471.8,y:279.7}).wait(1).to({graphics:mask_2_graphics_64,x:414.5,y:279.7}).wait(1).to({graphics:mask_2_graphics_65,x:363.3,y:279.7}).wait(1).to({graphics:mask_2_graphics_66,x:318.1,y:279.7}).wait(1).to({graphics:mask_2_graphics_67,x:279,y:279.7}).wait(1).to({graphics:mask_2_graphics_68,x:245.9,y:279.7}).wait(1).to({graphics:mask_2_graphics_69,x:218.8,y:279.7}).wait(1).to({graphics:mask_2_graphics_70,x:197.7,y:279.7}).wait(1).to({graphics:mask_2_graphics_71,x:182.6,y:279.7}).wait(1).to({graphics:mask_2_graphics_72,x:173.6,y:279.7}).wait(1).to({graphics:mask_2_graphics_73,x:170.6,y:275.7}).wait(1).to({graphics:null,x:0,y:0}).wait(63).to({graphics:mask_2_graphics_137,x:236,y:275.7}).wait(1).to({graphics:mask_2_graphics_138,x:188.4,y:275.7}).wait(1).to({graphics:mask_2_graphics_139,x:145.3,y:275.7}).wait(1).to({graphics:mask_2_graphics_140,x:106.6,y:275.7}).wait(1).to({graphics:mask_2_graphics_141,x:72.5,y:275.7}).wait(1).to({graphics:mask_2_graphics_142,x:43,y:275.7}).wait(1).to({graphics:mask_2_graphics_143,x:18,y:275.7}).wait(1).to({graphics:mask_2_graphics_144,x:-2.4,y:275.7}).wait(1).to({graphics:mask_2_graphics_145,x:-18.3,y:275.7}).wait(1).to({graphics:mask_2_graphics_146,x:-29.7,y:275.7}).wait(1).to({graphics:mask_2_graphics_147,x:-36.4,y:275.7}).wait(1).to({graphics:mask_2_graphics_148,x:-36.7,y:275.7}).wait(212));

	// logo
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AAAAFIgGAKIgFgEIAIgJIgMgCIACgHIALAFIgBgMIAHAAIgCAMIAMgFIACAHIgMACIAIAJIgFAEIgHgKg");
	this.shape_16.setTransform(203.7,549.8);

	this.instance_6 = new lib.hgj();
	this.instance_6.parent = this;
	this.instance_6.setTransform(154.5,512.3,0.562,0.562,0,0,0,1.9,2.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#706F6F").s().p("AgrBHIAAiNIBWAAIAAAOIhHAAIAAAyIA/AAIAAAMIg/AAIAAAzIBIAAIAAAOg");
	this.shape_17.setTransform(198,554,0.562,0.562);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#706F6F").s().p("AgGBHIgziNIARAAIAoB3IAqh3IAQAAIgzCNg");
	this.shape_18.setTransform(191,554,0.562,0.562);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#706F6F").s().p("AgHBHIAAiNIAPAAIAACNg");
	this.shape_19.setTransform(185.9,554,0.562,0.562);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#706F6F").s().p("AgHBHIAAh/IgnAAIAAgOIBdAAIAAAOIgoAAIAAB/g");
	this.shape_20.setTransform(181.3,554,0.562,0.562);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#706F6F").s().p("AAtBHIgNglIg/AAIgOAlIgQAAIA2iNIAOAAIA3CNgAgaAUIA1AAIgbhHg");
	this.shape_21.setTransform(175.2,553.9,0.562,0.562);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#706F6F").s().p("AgGBHIgziNIARAAIAoB3IAqh3IAQAAIgzCNg");
	this.shape_22.setTransform(168.6,554,0.562,0.562);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#706F6F").s().p("AgrA1QgRgUAAggIAAgBQAAgfARgVQARgUAaAAQAbAAARAUQARAUAAAgIAAABQAAAfgRAVQgRAUgbAAQgaAAgRgUgAgggqQgMAQAAAaIAAABQAAAZAMARQAOAQASAAQAUAAAMgQQANgQAAgaIAAgBQAAgZgNgRQgMgQgUAAQgTAAgNAQg");
	this.shape_23.setTransform(161.3,554,0.562,0.562);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAPAAIBJBvIAAhvIAPAAIAACNg");
	this.shape_24.setTransform(153.3,554,0.562,0.562);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAPAAIBJBvIAAhvIAPAAIAACNg");
	this.shape_25.setTransform(145.6,554,0.562,0.562);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#706F6F").s().p("AgHBHIAAiNIAOAAIAACNg");
	this.shape_26.setTransform(140.3,554,0.562,0.562);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#706F6F").s().p("AAnBHIhLhxIAABxIgPAAIAAiNIAOAAIBKBvIAAhvIAPAAIAACNg");
	this.shape_27.setTransform(132,554,0.562,0.562);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#706F6F").s().p("AAgBHIgig3IghAAIAAA3IgPAAIAAiNIAxAAQAYAAAMANQALAMAAARIAAABQAAAfgiAJIAnA6gAgjACIAfAAQAQAAAKgHQAJgIAAgOQAAgdghAAIghAAg");
	this.shape_28.setTransform(124.9,554,0.562,0.562);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#706F6F").s().p("AgrA1QgRgUAAggIAAgBQAAgfARgVQARgUAaAAQAbAAARAUQARAUAAAgIAAABQAAAfgRAVQgRAUgbAAQgaAAgRgUgAgggqQgMAQAAAaIAAABQAAAZAMARQAOAQASAAQAUAAAMgQQANgQAAgaIAAgBQAAgZgNgRQgMgQgUAAQgTAAgNAQg");
	this.shape_29.setTransform(117,554,0.562,0.562);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#706F6F").s().p("AgwBHIAAiNIAwAAQAWAAAMAMQAJAKAAAOQAAAYgXAJQAdAIAAAZIAAABQAAASgNAKQgOAKgWAAgAghA5IAhAAQAQAAAJgGQAJgHAAgMIAAgBQAAgZgiAAIghAAgAghgGIAfAAQANAAAIgHQAJgHAAgMQAAgMgIgGQgIgGgNAAIggAAg");
	this.shape_30.setTransform(109.6,554,0.562,0.562);

	var maskedShapeInstanceList = [this.shape_16,this.instance_6,this.shape_17,this.shape_18,this.shape_19,this.shape_20,this.shape_21,this.shape_22,this.shape_23,this.shape_24,this.shape_25,this.shape_26,this.shape_27,this.shape_28,this.shape_29,this.shape_30];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask_2;
	}

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.instance_6},{t:this.shape_16}]},62).to({state:[]},12).to({state:[]},75).wait(211));

	// pic1
	this.instance_7 = new lib.pic1_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(155.8,303.9,1.25,1.25);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(160.5,72,1.25,1.25);
	...
	mask_3._off = true;
	var mask_3_graphics_137 = new cjs.Graphics().p("EgNfArFMAa8hU5MAuyAAAMAAABU5g");
	var mask_3_graphics_138 = new cjs.Graphics().p("Egj9AqdMAXAhU5MAw7AAAMAAABU5g");
	var mask_3_graphics_139 = new cjs.Graphics().p("EgjJAqdMATbhU5MAy4AAAMAAABU5g");
	var mask_3_graphics_140 = new cjs.Graphics().p("EgiaAqdMAQOhU5MA0nAAAMAAABU5g");
	var mask_3_graphics_141 = new cjs.Graphics().p("EghxAqdMANZhU5MA2KAAAMAAABU5g");
	var mask_3_graphics_142 = new cjs.Graphics().p("EghOAqdMAK9hU5MA3gAAAMAAABU5g");
	var mask_3_graphics_143 = new cjs.Graphics().p("EggwAqdMAI4hU5MA4oAAAMAAABU5g");
	var mask_3_graphics_144 = new cjs.Graphics().p("EggXAqdMAHMhU5MA5jAAAMAAABU5g");
	var mask_3_graphics_145 = new cjs.Graphics().p("EggDAqdMAF3hU5MA6RAAAMAAABU5g");
	var mask_3_graphics_146 = new cjs.Graphics().p("Egf2AqdMAE8hU5MA6xAAAMAAABU5g");
	var mask_3_graphics_147 = new cjs.Graphics().p("EgfuAqdMAEXhU5MA7GAAAMAAABU5g");
	var mask_3_graphics_148 = new cjs.Graphics().p("EgfrArFMAELhU5MA7MAAAMAAABU5g");
	var mask_3_graphics_211 = new cjs.Graphics().p("Egk1ArFMAAAhU5MBJtAAAMga9BU5g");
	var mask_3_graphics_212 = new cjs.Graphics().p("EgfZArFMAAAhU5MA+zAAAMgW+BU5g");
	var mask_3_graphics_213 = new cjs.Graphics().p("EgadArFMAAAhU5MA07AAAMgTXBU5g");
	var mask_3_graphics_214 = new cjs.Graphics().p("EgWCArFMAAAhU5MAsFAAAMgQIBU5g");
	var mask_3_graphics_215 = new cjs.Graphics().p("EgSJArFMAAAhU5MAkTAAAMgNSBU5g");
	var mask_3_graphics_216 = new cjs.Graphics().p("EgOxArFMAAAhU5IdjAAMgK0BU5g");
	var mask_3_graphics_217 = new cjs.Graphics().p("EgL6ArFMAAAhU5IX1AAMgIuBU5g");
	var mask_3_graphics_218 = new cjs.Graphics().p("EgJkArFMAAAhU5ITJAAMgHABU5g");
	var mask_3_graphics_219 = new cjs.Graphics().p("EgHwArFMAAAhU5IPhAAMgFrBU5g");
	var mask_3_graphics_220 = new cjs.Graphics().p("EgGcArFMAAAhU5IM5AAMgEuBU5g");
	var mask_3_graphics_221 = new cjs.Graphics().p("EgFrArFMAAAhU5ILWAAMgEKBU5g");
	var mask_3_graphics_222 = new cjs.Graphics().p("EgFvArFMAAAhU5IK1AAMgD9BU5g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(137).to({graphics:mask_3_graphics_137,x:385.5,y:275.7}).wait(1).to({graphics:mask_3_graphics_138,x:471.8,y:279.7}).wait(1).to({graphics:mask_3_graphics_139,x:414.5,y:279.7}).wait(1).to({graphics:mask_3_graphics_140,x:363.3,y:279.7}).wait(1).to({graphics:mask_3_graphics_141,x:318.1,y:279.7}).wait(1).to({graphics:mask_3_graphics_142,x:279,y:279.7}).wait(1).to({graphics:mask_3_graphics_143,x:245.9,y:279.7}).wait(1).to({graphics:mask_3_graphics_144,x:218.8,y:279.7}).wait(1).to({graphics:mask_3_graphics_145,x:197.7,y:279.7}).wait(1).to({graphics:mask_3_graphics_146,x:182.6,y:279.7}).wait(1).to({graphics:mask_3_graphics_147,x:173.6,y:279.7}).wait(1).to({graphics:mask_3_graphics_148,x:170.6,y:275.7}).wait(1).to({graphics:null,x:0,y:0}).wait(62).to({graphics:mask_3_graphics_211,x:236,y:275.7}).wait(1).to({graphics:mask_3_graphics_212,x:188.4,y:275.7}).wait(1).to({graphics:mask_3_graphics_213,x:145.3,y:275.7}).wait(1).to({graphics:mask_3_graphics_214,x:106.6,y:275.7}).wait(1).to({graphics:mask_3_graphics_215,x:72.5,y:275.7}).wait(1).to({graphics:mask_3_graphics_216,x:43,y:275.7}).wait(1).to({graphics:mask_3_graphics_217,x:18,y:275.7}).wait(1).to({graphics:mask_3_graphics_218,x:-2.4,y:275.7}).wait(1).to({graphics:mask_3_graphics_219,x:-18.3,y:275.7}).wait(1).to({graphics:mask_3_graphics_220,x:-29.7,y:275.7}).wait(1).to({graphics:mask_3_graphics_221,x:-36.4,y:275.7}).wait(1).to({graphics:mask_3_graphics_222,x:-36.7,y:275.7}).wait(138));
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(161.4,75.6,1.25,1.25);
	...
	mask_4._off = true;
	var mask_4_graphics_211 = new cjs.Graphics().p("EgNfArFMAa8hU5MAuyAAAMAAABU5g");
	var mask_4_graphics_212 = new cjs.Graphics().p("Egj9AqdMAXAhU5MAw7AAAMAAABU5g");
	var mask_4_graphics_213 = new cjs.Graphics().p("EgjJAqdMATbhU5MAy4AAAMAAABU5g");
	var mask_4_graphics_214 = new cjs.Graphics().p("EgiaAqdMAQOhU5MA0nAAAMAAABU5g");
	var mask_4_graphics_215 = new cjs.Graphics().p("EghxAqdMANZhU5MA2KAAAMAAABU5g");
	var mask_4_graphics_216 = new cjs.Graphics().p("EghOAqdMAK9hU5MA3gAAAMAAABU5g");
	var mask_4_graphics_217 = new cjs.Graphics().p("EggwAqdMAI4hU5MA4oAAAMAAABU5g");
	var mask_4_graphics_218 = new cjs.Graphics().p("EggXAqdMAHMhU5MA5jAAAMAAABU5g");
	var mask_4_graphics_219 = new cjs.Graphics().p("EggDAqdMAF3hU5MA6RAAAMAAABU5g");
	var mask_4_graphics_220 = new cjs.Graphics().p("Egf2AqdMAE8hU5MA6xAAAMAAABU5g");
	var mask_4_graphics_221 = new cjs.Graphics().p("EgfuAqdMAEXhU5MA7GAAAMAAABU5g");
	var mask_4_graphics_222 = new cjs.Graphics().p("EgfrArFMAELhU5MA7MAAAMAAABU5g");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:null,x:0,y:0}).wait(211).to({graphics:mask_4_graphics_211,x:385.5,y:275.7}).wait(1).to({graphics:mask_4_graphics_212,x:471.8,y:279.7}).wait(1).to({graphics:mask_4_graphics_213,x:414.5,y:279.7}).wait(1).to({graphics:mask_4_graphics_214,x:363.3,y:279.7}).wait(1).to({graphics:mask_4_graphics_215,x:318.1,y:279.7}).wait(1).to({graphics:mask_4_graphics_216,x:279,y:279.7}).wait(1).to({graphics:mask_4_graphics_217,x:245.9,y:279.7}).wait(1).to({graphics:mask_4_graphics_218,x:218.8,y:279.7}).wait(1).to({graphics:mask_4_graphics_219,x:197.7,y:279.7}).wait(1).to({graphics:mask_4_graphics_220,x:182.6,y:279.7}).wait(1).to({graphics:mask_4_graphics_221,x:173.6,y:279.7}).wait(1).to({graphics:mask_4_graphics_222,x:170.6,y:275.7}).wait(1).to({graphics:null,x:0,y:0}).wait(137));

	// pic3
	this.instance_11 = new lib.pic3();
	this.instance_11.parent = this;
	this.instance_11.setTransform(26,193,1.25,1.25);
	...
	this.instance_12.parent = this;
	this.instance_12.setTransform(152.6,73.1,1.25,1.25);
	...
	this.instance_13.parent = this;
	this.instance_13.setTransform(2.6,305.9,1.5,1.5,0,0,0,12.2,192.5);
	...
	this.instance_14.parent = this;
	this.instance_14.setTransform(165.9,208.3,2.971,2.97,0,0,0,55.1,70);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(360));

	// bg
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("AyvfQMAAAg+fMAlfAAAMAAAA+fg");
	this.shape_31.setTransform(150,300,1.25,1.5);

	this.timeline.addTween(cjs.Tween.get(this.shape_31).wait(360));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(134.3,297.5,317,603.1);
// library properties:
lib.properties = {
	width: 300,
	height: 600,

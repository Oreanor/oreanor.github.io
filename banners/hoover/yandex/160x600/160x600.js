...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.born2).to({alpha:1},5).to({_off:true},297).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-134.1,y:228.7}).wait(1).to({graphics:mask_graphics_1,x:-98.9,y:228.7}).wait(1).to({graphics:mask_graphics_2,x:-68.4,y:228.7}).wait(1).to({graphics:mask_graphics_3,x:-42.6,y:228.7}).wait(1).to({graphics:mask_graphics_4,x:-21.6,y:228.7}).wait(1).to({graphics:mask_graphics_5,x:-5.1,y:228.7}).wait(1).to({graphics:mask_graphics_6,x:6.6,y:228.7}).wait(1).to({graphics:mask_graphics_7,x:13.6,y:228.7}).wait(1).to({graphics:mask_graphics_8,x:15.9,y:228.7}).wait(352));

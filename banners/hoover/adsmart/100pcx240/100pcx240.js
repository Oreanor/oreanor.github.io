...
lib.ssMetadata = [
		{name:"100pcx240_atlas_P_", frames: [[102,414,100,73],[0,414,100,73],[0,185,150,136],[0,0,200,183],[152,185,50,225],[0,323,150,89]]},
...
(lib.main2 = function(mode,startPosition,loop) {
	...
	var mask_graphics_62 = new cjs.Graphics().p("Eg0lAcLMAAAg4VMBpLAAAMgmdA4Vg");
	...
	var mask_1_graphics_137 = new cjs.Graphics().p("Eg0lAcLMAAAg4VMBpLAAAMgmdA4Vg");
	...
	var mask_2_graphics_211 = new cjs.Graphics().p("Eg0lAcLMAAAg4VMBpLAAAMgmdA4Vg");
...
(lib._100pcx240 = function(mode,startPosition,loop) {
	...
	this.main2.setTransform(274.3,124,1,1,0,0,0,374.3,129);
...
p.nominalBounds = new cjs.Rectangle(100,77,1094.5,438);
// library properties:
lib.properties = {
	width: 400,
	height: 240,

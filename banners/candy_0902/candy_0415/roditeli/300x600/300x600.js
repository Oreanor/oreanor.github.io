...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[242,270,180,199],[302,0,150,169],[0,270,240,210],[0,0,300,268]]}
];
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(146.6,565.9,1.25,1.25,0,0,0,105.1,13.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(288).to({_off:false},0).wait(80));

	// legal
	this.instance_1 = new lib.legal();
	this.instance_1.parent = this;
	this.instance_1.setTransform(146.6,565.9,1.25,1.25,0,0,0,105.1,13.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(97,553.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.shape_1}]},288).wait(80));

	// pic5
	this.instance_2 = new lib.sdf();
	this.instance_2.parent = this;
	this.instance_2.setTransform(151,416);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(288).to({_off:false},0).to({y:396,alpha:1},7,cjs.Ease.get(1)).wait(65).to({y:416,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// pic4
	this.instance_3 = new lib.pic4();
	this.instance_3.parent = this;
	this.instance_3.setTransform(171.3,246.9,1.1,1.1,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(216).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));

	// pic3
	this.instance_4 = new lib.pic1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(164.4,261.6,1.25,1.25);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({x:151.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:139.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));

	// pic2
	this.instance_5 = new lib.pic2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(163.8,251.2,1.25,1.25);
	this.instance_5.alpha = 0.289;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(72).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:126.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));

	// pic1
	this.instance_6 = new lib.pic1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(164.4,261.6,1.25,1.25);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:151.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:139.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));

	// text5
	this.instance_7 = new lib.text5();
	this.instance_7.parent = this;
	this.instance_7.setTransform(171.3,188.8,1.25,1.25);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(288).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:131.3,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// text4
	this.instance_8 = new lib.text4();
	this.instance_8.parent = this;
	this.instance_8.setTransform(151.3,462.6,1,1,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(216).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));

	// text3
	this.instance_9 = new lib.text3();
	this.instance_9.parent = this;
	this.instance_9.setTransform(151.3,464.5,1,1,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(144).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:464.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:464.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));

	// text2
	this.instance_10 = new lib.text2();
	this.instance_10.parent = this;
	this.instance_10.setTransform(151.3,464.1,1,1,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(72).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:464.5,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:464.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));

	// text1
	this.instance_11 = new lib.text1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(151.3,465.6,1,1,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:466.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:465.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));
	...
	this.shape_2.setTransform(213.1,45.9,1.25,1.25);
	...
	this.shape_3.setTransform(228.2,68.4,1.25,1.25);
	...
	this.shape_4.setTransform(270.6,46,1.25,1.25);

	this.instance_12 = new lib.ClipGroup_20();
	this.instance_12.parent = this;
	this.instance_12.setTransform(96.9,48.1,1.25,1.25,0,0,0,53,10.7);
	...
	this.shape_5.setTransform(150,300,1.246,1.499);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.instance_12},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2}]}).wait(368));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,299.5,313.6,601);
// library properties:
lib.properties = {
	width: 300,
	height: 600,

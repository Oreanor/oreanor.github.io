...
lib.ssMetadata = [
		{name:"300x240_atlas_", frames: [[0,162,300,160],[0,0,300,160],[0,324,300,160]]}
];
...
(lib._1 = function() {
	this.spriteSheet = ss["300x240_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x240 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("A3WyqMAutAAAMAAAAlVMgutAAAg");
	...
	this.instance.parent = this;
	this.instance.setTransform(149.8,234,0.803,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.1,26.8,0.8,0.8,0,0,0,0.1,0.1);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-63.3,48.3,1.706,1.706,-45,0,0,-0.1,0.1);

	this.instance_3 = new lib.hjk();
	this.instance_3.parent = this;
	this.instance_3.setTransform(358.6,219.9,1.706,1.706,135,0,0,0,-0.1);

	this.instance_4 = new lib.hjk();
	this.instance_4.parent = this;
	this.instance_4.setTransform(62.5,345.7,1.706,1.706,-135,0,0,-0.1,0);

	this.instance_5 = new lib.hjk();
	this.instance_5.parent = this;
	this.instance_5.setTransform(234,-76.3,1.706,1.706,45);

	this.instance_6 = new lib.hjk();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-61.9,222.6,1.706,1.706,-90,0,0,-0.1,0.1);

	this.instance_7 = new lib.hjk();
	this.instance_7.parent = this;
	this.instance_7.setTransform(357.7,45.7,1.706,1.706,90,0,0,0.1,-0.1);

	this.instance_8 = new lib.hjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(237.1,343.9,1.706,1.706,180);

	this.instance_9 = new lib.hjk();
	this.instance_9.parent = this;
	this.instance_9.setTransform(60.2,-75.8,1.706,1.706);
	...
	mask._off = true;
	mask.graphics.p("A3YPyIAA3bMAu3AAAIAAXbg");
	mask.setTransform(150.3,101);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(0,41.5);
	...
	this.instance_12.parent = this;
	this.instance_12.setTransform(0,51.5);
	...
	// Слой 13
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A3bSwMAAAglfMAu3AAAMAAAAlfg");
	this.shape_1.setTransform(150,120);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(187));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,119.5,301,241);
// library properties:
lib.properties = {
	width: 300,
	height: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x240_atlas_.jpg?1518279901081", id:"300x240_atlas_"}
	],
	preloads: []
};

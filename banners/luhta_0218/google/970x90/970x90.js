...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(824.4,45.4,1.156,1.155,0,0,0,0.1,0.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(140.5,44.4,1.1,1.097,0,0,0,0.1,0.1);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(236.4,-54,2.047,2.047,-45);

	this.instance_3 = new lib.hjk();
	this.instance_3.parent = this;
	this.instance_3.setTransform(742.6,152.1,2.047,2.047,135,0,0,0,-0.1);

	this.instance_4 = new lib.hjk();
	this.instance_4.parent = this;
	this.instance_4.setTransform(387.3,303,2.047,2.047,-135,0,0,-0.1,0);

	this.instance_5 = new lib.hjk();
	this.instance_5.parent = this;
	this.instance_5.setTransform(593.1,-203.3,2.047,2.047,45);

	this.instance_6 = new lib.hjk();
	this.instance_6.parent = this;
	this.instance_6.setTransform(238.1,155.3,2.047,2.047,-90,0,0,-0.1,0.1);

	this.instance_7 = new lib.hjk();
	this.instance_7.parent = this;
	this.instance_7.setTransform(741.5,-56.9,2.047,2.047,90,0,0,0.1,-0.1);

	this.instance_8 = new lib.hjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(596.8,300.8,2.047,2.047,180);

	this.instance_9 = new lib.hjk();
	this.instance_9.parent = this;
	this.instance_9.setTransform(384.5,-202.7,2.047,2.047);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]},65).to({state:[]},10).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]},60).to({state:[]},9).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]},61).to({state:[]},10).wait(2));
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(286,-14.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(141).to({_off:false},0).to({y:-38.5},67).to({_off:true},1).wait(8));

	// 2.jpg
	this.instance_11 = new lib.sss();
	this.instance_11.parent = this;
	this.instance_11.setTransform(286,-30.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(71).to({_off:false},0).to({y:-70.5},67).to({_off:true},1).wait(78));

	// 1.jpg
	this.instance_12 = new lib.ss();
	this.instance_12.parent = this;
	this.instance_12.setTransform(286,-1.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({y:-34.5},68).to({_off:true},1).wait(142).to({_off:false,y:2.5},0).to({y:0},5,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/970x90_atlas_.jpg?1518285828248", id:"970x90_atlas_"}
	],
	preloads: []
};

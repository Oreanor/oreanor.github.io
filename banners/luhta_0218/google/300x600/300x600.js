...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[0,0,300,300],[0,302,300,300],[0,604,300,300]]}
];
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(146.8,524.4,1.25,1.25);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150,75,1.25,1.25);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-116.1,191.9,2.133,2.133,-45,0,0,-0.1,0.1);

	this.instance_3 = new lib.hjk();
	this.instance_3.parent = this;
	this.instance_3.setTransform(411.2,406.4,2.133,2.133,135,0,0,0,-0.1);

	this.instance_4 = new lib.hjk();
	this.instance_4.parent = this;
	this.instance_4.setTransform(41,563.6,2.133,2.133,-135,0,0,-0.1,0);

	this.instance_5 = new lib.hjk();
	this.instance_5.parent = this;
	this.instance_5.setTransform(255.5,36.2,2.133,2.133,45);

	this.instance_6 = new lib.hjk();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-114.4,409.8,2.133,2.133,-90,0,0,-0.1,0.1);

	this.instance_7 = new lib.hjk();
	this.instance_7.parent = this;
	this.instance_7.setTransform(410,188.6,2.133,2.133,90,0,0,0.1,-0.1);

	this.instance_8 = new lib.hjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(259.3,561.3,2.133,2.133,180);

	this.instance_9 = new lib.hjk();
	this.instance_9.parent = this;
	this.instance_9.setTransform(38.1,36.8,2.133,2.133);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(121).to({_off:false},0).to({y:150},5,cjs.Ease.get(1)).to({_off:true},53).wait(8));

	// 2.jpg
	this.instance_11 = new lib.sss();
	this.instance_11.parent = this;
	this.instance_11.setTransform(0,140);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(61).to({_off:false},0).to({y:150},5,cjs.Ease.get(1)).to({_off:true},53).wait(68));

	// 1.jpg
	this.instance_12 = new lib.ss();
	this.instance_12.parent = this;
	this.instance_12.setTransform(0,150);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},59).wait(122).to({_off:false,y:140},0).to({y:150},5,cjs.Ease.get(1)).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_atlas_.jpg?1518279480520", id:"300x600_atlas_"}
	],
	preloads: []
};

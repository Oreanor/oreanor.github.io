...
(lib._240x400 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(177).to({_off:false},0).to({y:96.5,alpha:1},9,cjs.Ease.get(1)).wait(1));

	// 3.jpg
	this.instance_3 = new lib.sssss();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,86.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(116).to({_off:false},0).to({y:96.5,alpha:1},10,cjs.Ease.get(1)).to({_off:true},60).wait(1));

	// 2.jpg
	this.instance_4 = new lib.sss();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,86.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(56).to({_off:false},0).to({y:96.5,alpha:1},10,cjs.Ease.get(1)).to({_off:true},60).wait(61));

	// 1.jpg
	this.instance_5 = new lib.ss();
	this.instance_5.parent = this;
	this.instance_5.setTransform(0,96.5);

...
lib.ssMetadata = [
		{name:"160x600_atlas_", frames: [[604,0,300,400],[0,0,300,400],[302,0,300,400]]}
];
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.newcol.setTransform(80,547.3,0.852,0.851);
	...
	this.instance.parent = this;
	this.instance.setTransform(80,46.6,0.7,0.696,0,0,0,0.3,0);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-133.3,213.3,1.706,1.706,-45,0,0,-0.1,0.1);

	this.instance_2 = new lib.hjk();
	this.instance_2.parent = this;
	this.instance_2.setTransform(288.6,384.9,1.706,1.706,135,0,0,0,-0.1);

	this.instance_3 = new lib.hjk();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-7.5,510.7,1.706,1.706,-135,0,0,-0.1,0);

	this.instance_4 = new lib.hjk();
	this.instance_4.parent = this;
	this.instance_4.setTransform(164,88.7,1.706,1.706,45);

	this.instance_5 = new lib.hjk();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-131.9,387.6,1.706,1.706,-90,0,0,-0.1,0.1);

	this.instance_6 = new lib.hjk();
	this.instance_6.parent = this;
	this.instance_6.setTransform(287.7,210.7,1.706,1.706,90,0,0,0.1,-0.1);

	this.instance_7 = new lib.hjk();
	this.instance_7.parent = this;
	this.instance_7.setTransform(167.1,508.9,1.706,1.706,180);

	this.instance_8 = new lib.hjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-9.8,89.2,1.706,1.706);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(-20,100);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(61).to({_off:false},0).to({x:-70},57).to({_off:true},1).wait(68));

	// 1.jpg
	this.instance_11 = new lib.ss();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-70,100);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:-41},58).to({_off:true},1).wait(122).to({_off:false,x:-75},0).to({x:-71},5,cjs.Ease.get(1)).wait(1));

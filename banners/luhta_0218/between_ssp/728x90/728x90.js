...
lib.ssMetadata = [
		{name:"728x90_atlas_", frames: [[0,324,300,160],[0,0,300,160],[0,162,300,160]]}
];
...
(lib.asdsd = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(18).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(17).to({y:10.4},5,cjs.Ease.get(1)).to({y:15.4},5,cjs.Ease.get(-1)).wait(153));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(15).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(14).to({y:8.3},5,cjs.Ease.get(1)).to({y:13.3},5,cjs.Ease.get(-1)).wait(156));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(13).to({y:8.3},5,cjs.Ease.get(1)).to({y:13.3},5,cjs.Ease.get(-1)).wait(157));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(12).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(11).to({y:8.2},5,cjs.Ease.get(1)).to({y:13.2},5,cjs.Ease.get(-1)).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(10).to({y:-22.2},5,cjs.Ease.get(1)).to({y:-17.2},5,cjs.Ease.get(-1)).wait(160));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(9).to({y:-22.2},5,cjs.Ease.get(1)).to({y:-17.2},5,cjs.Ease.get(-1)).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(8).to({y:-22.2},5,cjs.Ease.get(1)).to({y:-17.2},5,cjs.Ease.get(-1)).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(7).to({y:-22.2},5,cjs.Ease.get(1)).to({y:-17.2},5,cjs.Ease.get(-1)).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({y:-22.2},5,cjs.Ease.get(1)).to({y:-17.2},5,cjs.Ease.get(-1)).wait(164));
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	this.newcol.setTransform(619.4,45.3);
	...
	this.instance.parent = this;
	this.instance.setTransform(107.5,44.4,0.9,0.898,0,0,0,0.1,0.1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(156.7,-36.7,1.706,1.706,-45,0,0,-0.1,0.1);

	this.instance_2 = new lib.hjk();
	this.instance_2.parent = this;
	this.instance_2.setTransform(578.6,134.9,1.706,1.706,135,0,0,0,-0.1);

	this.instance_3 = new lib.hjk();
	this.instance_3.parent = this;
	this.instance_3.setTransform(282.5,260.7,1.706,1.706,-135,0,0,-0.1,0);

	this.instance_4 = new lib.hjk();
	this.instance_4.parent = this;
	this.instance_4.setTransform(454,-161.3,1.706,1.706,45);

	this.instance_5 = new lib.hjk();
	this.instance_5.parent = this;
	this.instance_5.setTransform(158.1,137.6,1.706,1.706,-90,0,0,-0.1,0.1);

	this.instance_6 = new lib.hjk();
	this.instance_6.parent = this;
	this.instance_6.setTransform(577.7,-39.3,1.706,1.706,90,0,0,0.1,-0.1);

	this.instance_7 = new lib.hjk();
	this.instance_7.parent = this;
	this.instance_7.setTransform(457.1,258.9,1.706,1.706,180);

	this.instance_8 = new lib.hjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(280.2,-160.8,1.706,1.706);
	...
	mask._off = true;
	mask.graphics.p("AmwHCIAAuDMAu3AAAIAAODg");
	mask.setTransform(256.7,45);

	// 3.jpg
	this.instance_9 = new lib.sssss();
	this.instance_9.parent = this;
	this.instance_9.setTransform(214,-14.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(121).to({_off:false},0).to({y:-4.5},5,cjs.Ease.get(1)).to({_off:true},53).wait(8));

	// 2.jpg
	this.instance_10 = new lib.sss();
	this.instance_10.parent = this;
	this.instance_10.setTransform(214,-7.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(61).to({_off:false},0).to({y:-1.5},5,cjs.Ease.get(1)).to({_off:true},53).wait(68));

	// 1.jpg
	this.instance_11 = new lib.ss();
	this.instance_11.parent = this;
	this.instance_11.setTransform(214,-4.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},59).wait(122).to({_off:false,y:-14.5},0).to({y:-4.5},5,cjs.Ease.get(1)).wait(1));

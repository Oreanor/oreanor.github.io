...
lib.ssMetadata = [
		{name:"300x250_atlas_", frames: [[338,0,336,280],[676,0,336,280],[338,282,336,280],[0,282,336,280],[0,0,336,280]]}
];
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_9.setTransform(105.7,182,0.982,0.982,0,0,0,120.1,200);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(300).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).wait(76));

	// p4
	this.instance_10 = new lib.p4();
	this.instance_10.parent = this;
	this.instance_10.setTransform(105.7,182,0.982,0.982,0,0,0,120.1,200);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(225).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(75));

	// p3
	this.instance_11 = new lib.p3();
	this.instance_11.parent = this;
	this.instance_11.setTransform(105.7,182,0.982,0.982,0,0,0,120.1,200);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(150).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(150));

	// p2
	this.instance_12 = new lib.p2();
	this.instance_12.parent = this;
	this.instance_12.setTransform(105.7,182,0.982,0.982,0,0,0,120.1,200);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(75).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(225));

	// p1
	this.instance_13 = new lib.p1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(105.7,182,0.982,0.982,0,0,0,120.1,200);
	this.instance_13.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8).to({_off:true},76).wait(300));
...
p.nominalBounds = new cjs.Rectangle(137.8,110.5,330.1,279.5);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

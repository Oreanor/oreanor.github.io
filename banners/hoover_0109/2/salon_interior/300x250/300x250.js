...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(104.7,183,0.982,0.982,0,0,0,120.1,200);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(300).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).wait(151));

	// p4
	this.instance_12 = new lib.p4();
	this.instance_12.parent = this;
	this.instance_12.setTransform(103.7,184,0.982,0.982,0,0,0,120.1,200);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(225).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(150));

	// p3
	this.instance_13 = new lib.p3();
	this.instance_13.parent = this;
	this.instance_13.setTransform(103.7,184,0.982,0.982,0,0,0,120.1,200);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(150).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(225));

	// p2
	this.instance_14 = new lib.p2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(104.7,183,0.982,0.982,0,0,0,120.1,200);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(75).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(300));

	// p1
	this.instance_15 = new lib.p1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(104.7,183,0.982,0.982,0,0,0,120.1,200);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regX:120,scaleX:0.89,scaleY:0.89,x:107.2,y:178.6,alpha:1},8).to({_off:true},76).wait(375));
...
p.nominalBounds = new cjs.Rectangle(136.8,111.5,330.1,278.5);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

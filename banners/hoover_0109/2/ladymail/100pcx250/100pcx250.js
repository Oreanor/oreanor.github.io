...
lib.ssMetadata = [
		{name:"100pcx250_atlas_", frames: [[0,0,336,280],[338,0,336,280],[0,282,336,280],[676,0,336,280],[676,282,336,280],[338,282,336,280]]}
];
...
(lib.pic = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(375).to({_off:false},0).to({x:0},6,cjs.Ease.get(1)).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:-42.8},6,cjs.Ease.get(1)).to({_off:true},78).wait(75));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(225).to({_off:false},0).to({x:-42.8},6,cjs.Ease.get(1)).to({_off:true},78).wait(150));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(150).to({_off:false},0).to({x:-42.8},6,cjs.Ease.get(1)).to({_off:true},78).wait(225));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(75).to({_off:false},0).to({x:-42.8},6,cjs.Ease.get(1)).to({_off:true},78).wait(300));

	// p1
	this.instance_5 = new lib.p1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-22.8,53.6,0.893,0.893,0,0,0,120,200);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:-42.8},6,cjs.Ease.get(1)).to({_off:true},78).wait(375));
...
p.nominalBounds = new cjs.Rectangle(200,125,513.2,250.1);
// library properties:
lib.properties = {
	width: 400,
	height: 250,

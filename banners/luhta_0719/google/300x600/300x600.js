...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[0,0,460,423],[0,425,470,384]]}
];
...
(lib.Path_6 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(150,300,1.249,1.101);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Path_6, new cjs.Rectangle(0,90,300,420), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.shape_26.setTransform(146.3,553.4,0.922,0.922);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhLBMIAAiXIA8AAIAABuIBbAAIAAApg");
	this.shape_27.setTransform(119.9,553.2,0.922,0.922);
	...
	this.shape_28.setTransform(80.3,554.9,0.922,0.922);
	...
	this.instance_1.setTransform(149.9,280.8,0.983,0.983,0,0,0,109,67.7);
	...
	this.instance_4.setTransform(7.7,299,1.094,1.094,0,0,0,286.3,191.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(194).to({_off:false},0).to({regX:286.4,x:212.8},83).wait(1));

	// mask2
	this.instance_5 = new lib.aaasas();
	this.instance_5.parent = this;
	this.instance_5.setTransform(148.9,358.4,0.983,0.983,0,0,0,109.2,61.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(138).to({_off:false},0).wait(31).to({regX:109.1,x:149.6,y:359.6},0).to({regX:109.3,x:360,y:358.4},12).to({_off:true},1).wait(96));

	// mask1
	this.instance_6 = new lib.aaasas();
	this.instance_6.parent = this;
	this.instance_6.setTransform(149.6,274,0.983,0.983,0,0,0,109.1,61.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).wait(6).to({x:193.6},0).wait(6).to({regX:109.3,x:235.6,y:272.9},0).wait(6).to({regX:109.2,x:275.4},0).wait(6).to({regX:109.1,x:321.4},0).to({_off:true},7).wait(109));

	// text2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_138 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(138).to({graphics:mask_graphics_138,x:149.9,y:280.4}).wait(140));

	// pic2
	this.instance_7 = new lib.sas("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(125.9,328,0.983,0.983,0,0,0,318.9,192.2);
	...
	this.instance_9.setTransform(150.6,294.8,1.092,1.092,0,0,0,98.5,79.8);
	...
	this.instance_12.setTransform(268.7,304,1,0.993,0,0,0,328.4,219);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(55).to({_off:false},0).to({x:168.1},82).to({_off:true},1).wait(140));

	// mask2
	this.instance_13 = new lib.aaasas();
	this.instance_13.parent = this;
	this.instance_13.setTransform(150.2,362.3,1.092,1.092,0,0,0,109,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(31).to({regX:109.2,x:379.7},12).to({_off:true},1).wait(234));

	// mask1
	this.instance_14 = new lib.aaasas();
	this.instance_14.parent = this;
	this.instance_14.setTransform(150.2,229.1,1.092,1.092,0,0,0,109,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(10).to({regX:109.1,x:226.7},0).wait(11).to({x:281.3},0).to({_off:true},10).wait(247));

	// text1 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("");
	mask_1.setTransform(148.7,263.7);

	// pic1
	this.instance_15 = new lib.eee("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(150,311.6,1.092,1.092,0,0,0,252.9,213.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({rotation:1080},51).to({_off:true},1).wait(226));

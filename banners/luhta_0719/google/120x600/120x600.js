...
lib.ssMetadata = [
		{name:"120x600_atlas_", frames: [[0,0,460,423],[0,425,470,384]]}
];
...
(lib.Path_6 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(80,300,0.666,1.101);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Path_6, new cjs.Rectangle(0,90,160,420), null);
...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	// Слой 18
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("EgJSguyISlAAMAAABdlIylAAg");
	...
	this.shape_26.setTransform(57.9,554.2,0.532,0.532);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhLBMIAAiXIA8AAIAABuIBbAAIAAApg");
	this.shape_27.setTransform(42.7,554,0.532,0.532);
	...
	this.shape_28.setTransform(19.8,555,0.532,0.532);
	...
	this.instance_1.setTransform(61.3,296.7,0.472,0.472,0,0,0,109.1,67.6);
	...
	this.instance_4.setTransform(-117.3,299,1.094,1.094,0,0,0,286.3,191.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(194).to({_off:false},0).to({regX:286.4,x:172.8},83).wait(1));

	// mask2
	this.instance_5 = new lib.aaasas();
	this.instance_5.parent = this;
	this.instance_5.setTransform(60.8,334,0.472,0.472,0,0,0,109.2,61.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(138).to({_off:false},0).wait(31).to({x:61.2,y:334.6},0).to({x:162.3,y:334},12).to({_off:true},1).wait(96));

	// mask1
	this.instance_6 = new lib.aaasas();
	this.instance_6.parent = this;
	this.instance_6.setTransform(61.2,293.4,0.472,0.472,0,0,0,109.2,61.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).wait(6).to({regX:109.1,x:82.3},0).wait(6).to({x:102.4,y:292.9},0).wait(6).to({x:121.6},0).wait(6).to({x:143.7},0).to({_off:true},7).wait(109));

	// text2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_138 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(138).to({graphics:mask_graphics_138,x:61.2,y:296.6}).wait(140));

	// pic2
	this.instance_7 = new lib.sas("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(49.7,319.4,0.472,0.472,0,0,0,318.9,192.1);
	...
	this.instance_9.setTransform(61.6,303.4,0.525,0.525,0,0,0,98.5,79.7);
	...
	this.instance_12.setTransform(208.7,304,1,0.993,0,0,0,328.4,219);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(55).to({_off:false},0).to({x:48.1},82).to({_off:true},1).wait(140));

	// mask2
	this.instance_13 = new lib.aaasas();
	this.instance_13.parent = this;
	this.instance_13.setTransform(61.5,336,0.525,0.525,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(31).to({x:171.8},12).to({_off:true},1).wait(234));

	// mask1
	this.instance_14 = new lib.aaasas();
	this.instance_14.parent = this;
	this.instance_14.setTransform(61.5,271.9,0.525,0.525,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(10).to({x:98.3},0).wait(11).to({x:124.5},0).to({_off:true},10).wait(247));

	// text1 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("");
	mask_1.setTransform(60.6,288.5);

	// pic1
	this.instance_15 = new lib.eee("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(61.3,311.5,0.525,0.525,0,0,0,252.8,213.6);
...
p.nominalBounds = new cjs.Rectangle(59.5,299.5,160.5,601);
// library properties:
lib.properties = {
	width: 120,
	height: 600,

...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).wait(5).to({regX:109.2,x:185.8},0).wait(5).to({x:218.3,y:87.7},0).wait(5).to({x:252.3},0).wait(10).to({x:288.8},0).to({_off:true},6).wait(109));

...
lib.ssMetadata = [
		{name:"200x200_atlas_", frames: [[0,0,460,423],[0,425,470,384]]}
];
...
(lib._200x200 = function(mode,startPosition,loop) {
	...
	// Слой 18
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("AviviIfFAAIAAfFI/FAAg");
	...
	this.shape_26.setTransform(97.4,174.3,0.64,0.64);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhLBMIAAiXIA8AAIAABuIBbAAIAAApg");
	this.shape_27.setTransform(79,174.2,0.64,0.64);
	...
	this.shape_28.setTransform(51.5,175.4,0.64,0.64);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AynG0IAAtnMAlPAAAIAANng");
	this.shape_29.setTransform(99.9,176,0.839,0.551);
	...
	this.instance.parent = this;
	this.instance.setTransform(95.9,160,0.8,0.8,0,0,0,120,200);
	...
	this.instance_1.setTransform(100.1,75.1,0.64,0.64,0,0,0,109.2,67.7);
	...
	this.instance_2.setTransform(96.1,152.7,0.8,0.8,0,0,0,120.2,190.8);
	...
	this.instance_3.setTransform(95.9,160,0.8,0.8,0,0,0,120,200);
	...
	this.instance_4.setTransform(19,152.3,0.8,0.8,0,0,0,286.3,191.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(194).to({_off:false},0).to({x:100.6},83).wait(1));

	// mask2
	this.instance_5 = new lib.aaasas();
	this.instance_5.parent = this;
	this.instance_5.setTransform(99.1,126.2,0.634,0.634,0,0,0,109.2,61.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(138).to({_off:false},0).wait(31).to({regY:61.1,x:99.9,y:126.5},0).to({regX:109.3,regY:61.3,x:240.1,y:125.4},12).to({_off:true},1).wait(96));

	// mask1
	this.instance_6 = new lib.aaasas();
	this.instance_6.parent = this;
	this.instance_6.setTransform(100.7,70.8,0.634,0.634,0,0,0,109.2,61.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).wait(6).to({regX:109.3,x:128.6},0).wait(6).to({x:154.5,y:70.1},0).wait(6).to({x:181.8},0).wait(6).to({x:210.6},0).to({_off:true},6).wait(110));

	// text2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_138 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(138).to({graphics:mask_graphics_138,x:100.5,y:75}).wait(140));

	// pic2
	this.instance_7 = new lib.sas("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(99.9,78.4,0.634,0.634,0,0,0,345.9,149.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(138).to({_off:false},0).to({regY:144.1,rotation:1440,y:75.2},49).to({_off:true},23).wait(68));

	// Слой 12
	this.instance_8 = new lib.bg();
	this.instance_8.parent = this;
	this.instance_8.setTransform(95.9,160,0.8,0.8,0,0,0,120,200);
	...
	this.instance_9.setTransform(100.3,73.4,0.64,0.64,0,0,0,98.6,79.8);
	...
	this.instance_10.setTransform(96.1,152.7,0.8,0.8,0,0,0,120.2,190.8);
	...
	this.instance_11.setTransform(95.9,160,0.8,0.8,0,0,0,120,200);
	...
	this.instance_12.setTransform(206.9,130.5,0.8,0.8,0,0,0,328.4,218.9);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(55).to({_off:false},0).to({x:137.6},82).to({_off:true},1).wait(140));

	// mask2
	this.instance_13 = new lib.aaasas();
	this.instance_13.parent = this;
	this.instance_13.setTransform(100.7,131,0.64,0.64,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(31).to({x:235.1},12).to({_off:true},1).wait(234));

	// mask1
	this.instance_14 = new lib.aaasas();
	this.instance_14.parent = this;
	this.instance_14.setTransform(100.7,52.9,0.64,0.64,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(10).to({x:145.5},0).wait(11).to({x:177.5},0).to({_off:true},10).wait(247));

	// text1 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("");
	mask_1.setTransform(99.6,73.2);

	// pic1
	this.instance_15 = new lib.eee("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(100,82.8,0.64,0.64,0,0,0,252.1,184.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regY:178.3,rotation:1080,y:78.8},51).to({_off:true},87).wait(140));

	// bg
	this.instance_16 = new lib.bg();
	this.instance_16.parent = this;
	this.instance_16.setTransform(96,160,0.8,0.8,0,0,0,120,200);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(278));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(99.5,99.5,201,201);
// library properties:
lib.properties = {
	width: 200,
	height: 200,
	...
	webfonts: {},
	manifest: [
		{src:"images/200x200_atlas_.jpg", id:"200x200_atlas_"}
	],
	preloads: []
};

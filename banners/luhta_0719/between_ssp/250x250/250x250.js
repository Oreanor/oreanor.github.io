...
lib.ssMetadata = [
		{name:"250x250_atlas_", frames: [[0,0,460,423],[0,425,470,384]]}
];
...
(lib._250x250 = function(mode,startPosition,loop) {
	...
	this.shape_26.setTransform(121.7,217.9,0.8,0.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhLBMIAAiXIA8AAIAABuIBbAAIAAApg");
	this.shape_27.setTransform(98.8,217.7,0.8,0.8);
	...
	this.shape_28.setTransform(64.4,219.2,0.8,0.8);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AynG0IAAtnMAlPAAAIAANng");
	this.shape_29.setTransform(125,220,1.048,0.689);
	...
	this.instance_1.setTransform(125.2,93.9,0.8,0.8,0,0,0,109.1,67.7);
	...
	this.instance_4.setTransform(23.9,190.4,1,1,0,0,0,286.4,191.1);
	...
	this.instance_5.setTransform(123.9,157.6,0.792,0.792,0,0,0,109.1,61.2);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(138).to({_off:false},0).wait(31).to({regY:61.1,x:124.9,y:158.2},0).to({regX:109.2,regY:61.2,x:300.3,y:156.6},12).to({_off:true},1).wait(96));

	// mask1
	this.instance_6 = new lib.aaasas();
	this.instance_6.parent = this;
	this.instance_6.setTransform(125.9,88.5,0.792,0.792,0,0,0,109.1,61.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(138).to({_off:false},0).wait(6).to({regX:109.2,x:160.8},0).wait(6).to({x:193.3,y:87.7},0).wait(6).to({x:227.3},0).wait(6).to({x:263.3},0).to({_off:true},6).wait(110));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(138).to({graphics:mask_graphics_138,x:125.8,y:93.8}).wait(140));

	// pic2
	this.instance_7 = new lib.sas("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(125,98,0.792,0.792,0,0,0,346,149.1);
	...
	this.instance_9.setTransform(125.5,91.8,0.8,0.8,0,0,0,98.5,79.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(55).to({_off:false},0).to({x:172.1},82).to({_off:true},1).wait(140));

	// mask2
	this.instance_13 = new lib.aaasas();
	this.instance_13.parent = this;
	this.instance_13.setTransform(126,163.8,0.8,0.8,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(31).to({x:294},12).to({_off:true},1).wait(234));

	// mask1
	this.instance_14 = new lib.aaasas();
	this.instance_14.parent = this;
	this.instance_14.setTransform(126,66.2,0.8,0.8,0,0,0,109.1,61.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(10).to({x:182},0).wait(11).to({x:222},0).to({_off:true},10).wait(247));
	...
	mask_1.setTransform(124.6,91.5);

	// pic1
	this.instance_15 = new lib.eee("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(125,103.5,0.8,0.8,0,0,0,252.1,184.7);

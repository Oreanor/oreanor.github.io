...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[364,252,69,260],[435,252,60,260],[0,0,210,278],[212,0,150,290],[364,0,88,250],[202,292,150,136],[0,280,200,183]]},
		{name:"index_atlas_NP_", frames: [[0,0,554,368],[556,0,220,153]]}
];
...
(lib._100pcx250 = function(mode,startPosition,loop) {
	...
	this.main2.setTransform(1.3,124,1,1,0,0,0,101.3,124);
...
p.nominalBounds = new cjs.Rectangle(16.6,87,1198.8,443);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

...
lib.ssMetadata = [
		{name:"100pcx250_atlas_", frames: [[0,0,300,290],[604,0,300,290],[0,292,300,290],[302,292,300,290],[302,0,300,290]]}
];
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300).to({_off:false},0).to({x:-0.3},4,cjs.Ease.get(1)).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(225).to({_off:false},0).to({x:-0.3},4,cjs.Ease.get(1)).to({_off:true},71).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(152).to({_off:false},0).to({x:-0.3},4,cjs.Ease.get(1)).to({_off:true},69).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(77).to({_off:false},0).to({x:-0.3},4,cjs.Ease.get(1)).to({_off:true},71).wait(228));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:-0.3},4,cjs.Ease.get(1)).to({_off:true},73).wait(303));

	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape.setTransform(-203.5,74,1.21,1.21);
	...
	this.shape_1.setTransform(197.7,-77.3,1.21,1.21);
	...
	this.shape_2.setTransform(205.8,135.6,1.21,1.21);
	...
	this.shape_3.setTransform(220.9,50.9,1.21,1.21);
	...
	this.shape_4.setTransform(244,-137,1.21,1.21);
	...
	this.shape_5.setTransform(234.8,6.4,1.21,1.21);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_6.setTransform(166.7,108.9,1.21,1.21);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_7.setTransform(-179.4,-127.3,1.21,1.21);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_8.setTransform(-72.2,-140.1,1.21,1.21);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgFAkIAAgZIgWANQgGADgDgGQgDgFAFgEIAWgMIgWgLQgFgEADgFQADgGAGADIAWANIAAgaQAAgGAFAAQAGAAAAAGIAAAaIAWgNQAGgDADAGQADAFgFAEIgWALIAWAMQAFAEgDAFQgDAGgGgDIgWgNIAAAZQAAAHgGAAQgFAAAAgHg");
	this.shape_9.setTransform(40.1,-124.2,1.21,1.21);
	...
	this.shape_10.setTransform(156.8,-139.5,0.968,0.968);
	...
	this.shape_11.setTransform(-151.1,135.6,1.21,1.21);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_12.setTransform(111.6,121.9,1.21,1.21);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(-65.6,129.3,1.21,1.21);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_14.setTransform(161.5,104.7,1.21,1.21);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgEAyQgDgCAAgDIAAgfIgbAPQgDACgDgBQgDgBgCgCQgEgIAHgDIAbgQIgbgOQgGgEADgHQAEgHAHAEIAbAPIAAgfQAAgDADgCQACgDACAAQAIAAAAAIIAAAfIAbgPQAHgEAEAHQADAHgGAEIgbAOIAbAQQAHADgEAIQgFAGgGgEIgbgPIAAAfQAAAIgIAAQgCAAgCgDg");
	this.shape_15.setTransform(103.7,78.2,1.21,1.21);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_16.setTransform(170.9,15.6,1.21,1.21);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_17.setTransform(-165.2,-15,1.21,1.21);
	...
	this.shape_18.setTransform(-136,50.9,1.21,1.21);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgFAlIAAgaIgWANQgGADgDgGQgDgFAFgEIAWgMIgWgLQgFgEADgFQADgFAGACIAWANIAAgZQAAgHAFAAQAGAAAAAHIAAAZIAWgNQAGgCADAFQADAFgFAEIgWALIAWAMQAFAEgDAFQgDAGgGgDIgWgNIAAAaQAAAGgGAAQgFAAAAgGg");
	this.shape_19.setTransform(-151.1,-77.4,1.21,1.21);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_20.setTransform(111.6,-91.1,1.21,1.21);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_21.setTransform(4.4,-86.9,1.21,1.21);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("");
	this.shape_22.setTransform(-65.6,-83.7,1.21,1.21);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgFAlIAAgaIgWANQgGADgDgGQgDgFAFgEIAWgMIgWgLQgFgEADgFQADgFAGACIAWANIAAgZQAAgHAFAAQAGAAAAAHIAAAZIAWgNQAGgCADAFQADAFgFAEIgWALIAWAMQAFAEgDAFQgDAGgGgDIgWgNIAAAaQAAAGgGAAQgFAAAAgGg");
	this.shape_23.setTransform(-2.4,120.4,1.21,1.21);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_24.setTransform(-92.2,34.9,1.21,1.21);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("");
	this.shape_25.setTransform(-45.7,50.6,1.21,1.21);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AgFAkIAAgZIgWANQgGADgDgGQgDgFAFgEIAWgMIgWgLQgFgEADgFQADgGAGADIAWANIAAgaQAAgGAFAAQAGAAAAAGIAAAaIAWgNQAGgDADAGQADAFgFAEIgWALIAWAMQAFAEgDAFQgDAGgGgDIgWgNIAAAZQAAAHgGAAQgFAAAAgHg");
	this.shape_26.setTransform(20.1,50.8,1.21,1.21);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgEAyQgDgCAAgDIAAgfIgbAPQgDACgDgBQgDgBgCgCQgEgIAHgDIAbgQIgbgOQgGgEADgHQAEgHAHAEIAbAPIAAgfQAAgDADgCQACgDACAAQAIAAAAAIIAAAfIAbgPQAHgEAEAHQADAHgGAEIgbAOIAbAQQAHADgEAIQgFAGgGgEIgbgPIAAAfQAAAIgIAAQgCAAgCgDg");
	this.shape_27.setTransform(125.1,19.9,1.21,1.21);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_28.setTransform(128.6,-19.2,1.21,1.21);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFFFF").s().p("AgEAdIAAgUIgSALQgFACgCgEQgDgGAFgCIASgKIgSgJQgFgDADgEQACgFAFADIASAKIAAgUQAAgGAEAAQAFAAAAAGIAAAUIASgKQAFgCACAEQADAEgFADIgRAJIARAKQABABAAAAQAAAAABABQAAAAAAABQAAAAABAAIgBAFQgCAEgFgCIgSgLIAAAUQAAAFgFABQgEgBAAgFg");
	this.shape_29.setTransform(78.3,-54.4,1.21,1.21);
	...
	this.shape_30.setTransform(7,-43.2,1.21,1.21);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FFFFFF").s().p("");
	this.shape_31.setTransform(-87.5,-35,0.968,0.968);
...
p.nominalBounds = new cjs.Rectangle(-205.6,-147.1,454.3,288);
...
p.nominalBounds = new cjs.Rectangle(-207,-113.1,1058.5,535.6);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

...
lib.ssMetadata = [
		{name:"600x500_atlas_", frames: [[0,292,600,290],[0,1168,600,290],[0,0,600,290],[0,876,600,290],[0,584,600,290]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	...
	this.shape_1.graphics.f("#00A7E0").s().p("AzRDSIAAjKIIbAAIAAjZIU3AAIAADZIJSAAIAADKg");
	this.shape_1.setTransform(-2.9,-1.3);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.t5, new cjs.Rectangle(-147,-22.6,294,42.3), null);
...
(lib.p5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-300,-145);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.p5, new cjs.Rectangle(-300,-145,600,290), null);
...
}).prototype = getMCSymbolPrototype(lib.p4, new cjs.Rectangle(-300,-145,600,290), null);
...
}).prototype = getMCSymbolPrototype(lib.p3, new cjs.Rectangle(-300,-145,600,290), null);
...
}).prototype = getMCSymbolPrototype(lib.p2, new cjs.Rectangle(-300,-145,600,290), null);
...
}).prototype = getMCSymbolPrototype(lib.p1, new cjs.Rectangle(-300,-145,600,290), null);
...
(lib._600x500 = function(mode,startPosition,loop) {
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EAuzAm/MhdlAAAMAAAhN9MBdlAAAg");
	...
	this.instance.parent = this;
	this.instance.setTransform(233,469.4,2,2,0,0,0,111.1,10.9);
	...
	this.instance_1.setTransform(300.2,355.5,0.9,0.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({scaleX:1,scaleY:1,x:300.3,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:299.8},0).to({scaleX:0.9,scaleY:0.9,x:300.2,alpha:0},6,cjs.Ease.get(1)).wait(1));

	// t5
	this.instance_2 = new lib.t5();
	this.instance_2.parent = this;
	this.instance_2.setTransform(320.5,168.3,2,2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(300).to({_off:false},0).to({x:300.5,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:280.5,alpha:0},6,cjs.Ease.get(1)).wait(1));

	// p4
	this.instance_3 = new lib.p4();
	this.instance_3.parent = this;
	this.instance_3.setTransform(300.2,355.5,0.9,0.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(225).to({_off:false},0).to({scaleX:1,scaleY:1,x:300.3,alpha:1},6,cjs.Ease.get(1)).wait(67).to({scaleX:0.9,scaleY:0.9,x:300.2,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(75));

	// t4
	this.instance_4 = new lib.t4();
	this.instance_4.parent = this;
	this.instance_4.setTransform(320.5,168.3,2,2);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(225).to({_off:false},0).to({x:300.5,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:280.5,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(75));

	// p3
	this.instance_5 = new lib.p3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(300.2,355.5,0.9,0.9);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(150).to({_off:false},0).to({scaleX:1,scaleY:1,x:300.3,alpha:1},6,cjs.Ease.get(1)).wait(67).to({scaleX:0.9,scaleY:0.9,x:300.2,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(150));

	// t3
	this.instance_6 = new lib.t3();
	this.instance_6.parent = this;
	this.instance_6.setTransform(320.5,168.3,2,2);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(150).to({_off:false},0).to({x:300.5,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:280.5,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(150));

	// p2
	this.instance_7 = new lib.p2();
	this.instance_7.parent = this;
	this.instance_7.setTransform(300.2,355.5,0.9,0.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(75).to({_off:false},0).to({scaleX:1,scaleY:1,x:300.3,alpha:1},6,cjs.Ease.get(1)).wait(67).to({scaleX:0.9,scaleY:0.9,x:300.2,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(225));

	// t2
	this.instance_8 = new lib.t2();
	this.instance_8.parent = this;
	this.instance_8.setTransform(320.5,168.3,2,2);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(75).to({_off:false},0).to({x:300.5,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:280.5,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(225));

	// p1
	this.instance_9 = new lib.p1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(300.2,355.5,0.9,0.9);
	this.instance_9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:1,scaleY:1,x:300.3,alpha:1},6,cjs.Ease.get(1)).wait(67).to({scaleX:0.9,scaleY:0.9,x:300.2,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(300));

	// t1
	this.instance_10 = new lib.t1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(320.5,168.3,2,2);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:300.5,alpha:1},6,cjs.Ease.get(1)).wait(67).to({x:280.5,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(300));
	...
	this.shape_3.setTransform(390.3,197.2,1.6,1.6);
	...
	this.shape_4.setTransform(251.3,199.1,2,2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_5.setTransform(569.4,148,2,2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgLAMQgFgFAAgHQAAgGAFgFQAFgFAGAAQAHAAAFAFQAFAFAAAGQAAAHgFAFQgFAFgHAAQgGAAgFgFg");
	this.shape_6.setTransform(112.1,139.7,2,2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(209.7,138.8,1.6,1.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(358.4,138.5,2,2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgEAyQgDgCAAgDIAAgfIgbAPQgDACgDgBQgDgBgCgCQgEgIAHgDIAbgQIgbgOQgGgEADgHQAEgHAHAEIAbAPIAAgfQAAgDADgCQACgDACAAQAIAAAAAIIAAAfIAbgPQAHgEAEAHQADAHgGAEIgbAOIAbAQQAHADgEAIQgFAGgGgEIgbgPIAAAfQAAAIgIAAQgCAAgCgDg");
	this.shape_9.setTransform(513.6,195.7,1.8,1.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgEAdIAAgUIgSALQgFACgCgEQgDgGAFgCIASgKIgSgJQgFgDADgEQACgFAFADIASAKIAAgUQAAgGAEAAQAFAAAAAGIAAAUIASgKQAFgCACAEQADAEgFADIgRAJIARAKQABABAAAAQAAAAABABQAAAAAAABQAAAAABAAIgBAFQgCAEgFgCIgSgLIAAAUQAAAFgFABQgEgBAAgFg");
	this.shape_10.setTransform(468.6,134.5,2,2);
	...
	this.shape_11.setTransform(35,139.3,2,2);
	...
	this.instance_11.setTransform(303.9,63.5,2,2);
	...
	this.instance_12.setTransform(300.5,311,2.5,1.118,0,0,0,120,170);
	...
	this.bg = new lib.bg();
	this.bg.parent = this;
	this.bg.setTransform(300.5,251,2.5,1.25,0,0,0,120,200);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(380));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(299.5,249.5,601,501.5);
// library properties:
lib.properties = {
	width: 600,
	height: 500,

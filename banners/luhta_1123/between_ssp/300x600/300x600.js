...
lib.ssMetadata = [
		{name:"300x600_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
}).prototype = getMCSymbolPrototype(lib.p5_1, new cjs.Rectangle(-120,-122.5,300,300), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(121,202.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.1,470.9,1.307,1.307,0,0,0,0.1,0.1);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(111.9,301.4,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:102,y:301.6,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:111.9,y:301.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_3 = new lib.gh();
	this.instance_3.parent = this;
	this.instance_3.setTransform(190.6,308.4,0.88,0.88);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(224).to({_off:false},0).to({scaleX:1.1,scaleY:1.1,x:200.4,y:310.4,alpha:1},7,cjs.Ease.get(1)).wait(57).to({scaleX:0.88,scaleY:0.88,x:190.6,y:308.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(74));

	// t4a
	this.instance_4 = new lib.t4a();
	this.instance_4.parent = this;
	this.instance_4.setTransform(87.7,155.8,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:71.6,y:119.5,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:87.7,y:155.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_5 = new lib.t4a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(212.1,445.4,0.88,0.88);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(227).to({_off:false},0).to({scaleX:1.1,scaleY:1.1,x:227.3,y:481.7,alpha:1},7,cjs.Ease.get(1)).wait(52).to({scaleX:0.88,scaleY:0.88,x:212.1,y:445.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p3a.png
	this.instance_6 = new lib.sdf();
	this.instance_6.parent = this;
	this.instance_6.setTransform(112.8,279.9,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(148).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:103.1,y:274.6,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:112.8,y:279.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_7 = new lib.dfrg();
	this.instance_7.parent = this;
	this.instance_7.setTransform(193.3,310.9,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(150).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:203.7,y:313.4,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:193.3,y:310.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(148));

	// t3a
	this.instance_8 = new lib.t3a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(87.7,155.8,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:71.6,y:119.5,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:87.7,y:155.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_9 = new lib.t3b();
	this.instance_9.parent = this;
	this.instance_9.setTransform(210.2,445.4,0.88,0.88,0,0,0,0.1,0);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({regX:0,scaleX:1.1,scaleY:1.1,x:224.8,y:481.7,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0.1,scaleX:0.88,scaleY:0.88,x:210.2,y:445.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p2a.png
	this.instance_10 = new lib.qwe();
	this.instance_10.parent = this;
	this.instance_10.setTransform(111.7,293.9,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(74).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:101.7,y:292.2,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:111.7,y:293.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_11 = new lib.qweww();
	this.instance_11.parent = this;
	this.instance_11.setTransform(189.8,312.9,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(76).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:199.3,y:315.9,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:189.8,y:312.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(222));

	// t2a
	this.instance_12 = new lib.t2a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(87.7,155.8,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:71.7,y:119.5,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.88,scaleY:0.88,x:87.7,y:155.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_13 = new lib.t2b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(212.2,445.4,0.88,0.88);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(80).to({_off:false},0).to({scaleX:1.1,scaleY:1.1,x:227.3,y:481.7,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.88,scaleY:0.88,x:212.2,y:445.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// skidka
	this.instance_14 = new lib.skidka();
	this.instance_14.parent = this;
	this.instance_14.setTransform(150.2,396.2,0.88,0.88);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({scaleX:1.1,scaleY:1.1,x:149.7,y:420.4,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// tolko
	this.instance_15 = new lib.tolko();
	this.instance_15.parent = this;
	this.instance_15.setTransform(146.1,288.3,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:144.6,y:290.4,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// logo1
	this.instance_16 = new lib.logo1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(155,163,0.8,0.8);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({scaleX:1,scaleY:1,x:155.9,y:142,alpha:1},7,cjs.Ease.get(1)).wait(56).to({scaleX:0.46,scaleY:0.46,x:242.9,y:40.5},7,cjs.Ease.get(1)).wait(220).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(120.5,597.3,1,1,0,0,0,120,164.4);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:598.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(120.5,431.3,1,1,0,0,0,120,164.4);
	...
	this.shape_1.setTransform(149.5,299.5,0.439,0.528);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(70.5,299.5,559.9,601);
// library properties:
lib.properties = {
	width: 300,
	height: 600,

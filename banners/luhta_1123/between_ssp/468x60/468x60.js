...
lib.ssMetadata = [
		{name:"468x60_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
(lib._468x60 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(232.3,90,0.747,0.747,0,0,0,0.3,0.3);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(386.6,29.9,0.666,0.666);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(253.1,140.9,0.666,0.666);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({regY:0.1,y:-3.8},67).to({regY:0,y:-18.9,alpha:0},7).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_3 = new lib.gh();
	this.instance_3.parent = this;
	this.instance_3.setTransform(317.7,-81.5,0.666,0.666,0,0,0,0,-0.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(222).to({_off:false},0).to({regY:0.1,y:64.4,alpha:0.91},67).to({y:79.7,alpha:0},7).to({_off:true},1).wait(74));

	// t4a
	this.instance_4 = new lib.t4a();
	this.instance_4.parent = this;
	this.instance_4.setTransform(186.1,30.1,0.533,0.533,0,0,0,0,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({scaleX:0.67,scaleY:0.67,x:176.5,y:24.1,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.53,scaleY:0.53,x:186.1,y:30.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_5 = new lib.t4a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(389.7,30,0.533,0.533);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(228).to({_off:false},0).to({scaleX:0.67,scaleY:0.67,x:398.9,y:34.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.53,scaleY:0.53,x:389.7,y:30,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p3a.png
	this.instance_6 = new lib.sdf();
	this.instance_6.parent = this;
	this.instance_6.setTransform(253.8,-68.5,0.666,0.666,0,0,0,0.1,-0.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(148).to({_off:false},0).to({regY:0.1,y:58.1},67).to({regY:0,y:71.3,alpha:0},7).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_7 = new lib.dfrg();
	this.instance_7.parent = this;
	this.instance_7.setTransform(319.7,154.8,0.666,0.666,0,0,0,0,0.1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(148).to({_off:false},0).to({regY:0,y:-2},67).to({y:-18.4,alpha:0},7).to({_off:true},1).wait(148));

	// t3a
	this.instance_8 = new lib.t3a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(186.1,30.1,0.533,0.533,0,0,0,0,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({scaleX:0.67,scaleY:0.67,x:176.5,y:24.1,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.53,scaleY:0.53,x:186.1,y:30.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_9 = new lib.t3b();
	this.instance_9.parent = this;
	this.instance_9.setTransform(388.5,30,0.533,0.533,0,0,0,0.1,0);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({scaleX:0.67,scaleY:0.67,x:397.4,y:34.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.53,scaleY:0.53,x:388.5,y:30,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p2a.png
	this.instance_10 = new lib.qwe();
	this.instance_10.parent = this;
	this.instance_10.setTransform(253,128.6,0.666,0.666,0,0,0,0.1,0);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).to({regY:0.1,y:-2.5},65).to({regY:0,y:-16.6,alpha:0},7).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_11 = new lib.qweww();
	this.instance_11.parent = this;
	this.instance_11.setTransform(317.1,-76.8,0.666,0.666);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(76).to({_off:false},0).to({y:68.6},65).to({regY:0.1,y:84.3,alpha:0},7).to({_off:true},1).wait(222));

	// t2a
	this.instance_12 = new lib.t2a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(186.2,30.1,0.533,0.533,0,0,0,0.1,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({scaleX:0.67,scaleY:0.67,x:176.5,y:24.1,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.53,scaleY:0.53,x:186.2,y:30.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_13 = new lib.t2b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(389.8,30,0.533,0.533);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(80).to({_off:false},0).to({regX:0.1,scaleX:0.67,scaleY:0.67,x:399,y:34.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0,scaleX:0.53,scaleY:0.53,x:389.8,y:30,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// logo1
	this.instance_14 = new lib.logo1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(69.6,30,0.466,0.466,0,0,0,0.1,0);
	...
	this.instance_15.setTransform(359.6,30.7,0.399,0.4,0,0,0,0,0.1);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4).to({_off:false},0).to({regX:0.1,scaleX:0.5,scaleY:0.5,x:391.4,alpha:1},7,cjs.Ease.get(1)).wait(52).to({scaleX:0.4,scaleY:0.4,x:359.5,y:30.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},5).wait(296));

	// tolko
	this.instance_16 = new lib.tolko();
	this.instance_16.parent = this;
	this.instance_16.setTransform(231.3,31.1,0.586,0.586,0,0,0,0.1,0.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:0.73,scaleY:0.73,x:231.5,y:31.3,alpha:1},7,cjs.Ease.get(1)).wait(56).to({scaleX:0.59,scaleY:0.59,x:231.2,y:31,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(328.7,116.1,0.599,0.599,-90,0,0,119.9,164.5);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({regY:164.4,x:329.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(229.2,116.1,0.599,0.599,-90,0,0,119.9,164.5);
	...
	this.shape_1.setTransform(233.9,30,0.688,0.053,0,0,0,-0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(233.5,-69.7,469,335.6);
// library properties:
lib.properties = {
	width: 468,
	height: 60,

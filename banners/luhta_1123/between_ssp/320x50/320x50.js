...
lib.ssMetadata = [
		{name:"320x50_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,219,90);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.ghj, new cjs.Rectangle(-120,-122.5,219,90), null);
...
}).prototype = getMCSymbolPrototype(lib.p5_1, new cjs.Rectangle(-120,-122.5,219,90), null);
...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AhQFEIAAqHIRXAAIAAKHg");
	mask.setTransform(103.1,32.4);

	// p5
	this.instance = new lib.p5_1();
	this.instance.parent = this;
	this.instance.setTransform(152.4,74.2,0.598,0.598,0,0,0,0.4,0.4);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(261.8,26.1,0.533,0.533,0,0,0,0.1,0);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(180,114.9,0.533,0.533,0,0,0,0.1,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({regY:0.1,y:-0.9},67).to({regY:0,y:-13,alpha:0},7).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_3 = new lib.gh();
	this.instance_3.parent = this;
	this.instance_3.setTransform(231.6,-63.1,0.533,0.533,0,0,0,0,-0.2);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(222).to({_off:false},0).to({regY:0.1,y:53.7,alpha:0.91},67).to({y:65.9,alpha:0},7).to({_off:true},1).wait(74));

	// t4a
	this.instance_4 = new lib.t4a();
	this.instance_4.parent = this;
	this.instance_4.setTransform(126.4,26.3,0.426,0.426,0,0,0,0.1,0.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({regX:0,regY:0.2,scaleX:0.53,scaleY:0.53,x:118.6,y:21.4,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.3,scaleX:0.43,scaleY:0.43,x:126.4,y:25.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_5 = new lib.t4a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(285.2,26.2,0.426,0.426,0,0,0,0,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(228).to({_off:false},0).to({scaleX:0.53,scaleY:0.53,x:292.6,y:30,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.43,scaleY:0.43,x:285.2,y:25.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p3a.png
	this.instance_6 = new lib.sdf();
	this.instance_6.parent = this;
	this.instance_6.setTransform(180.8,-48,0.506,0.506,0,0,0,0.2,-0.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(148).to({_off:false},0).to({regY:0.2,y:48.3},67).to({y:58.3,alpha:0},7).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_7 = new lib.dfrg();
	this.instance_7.parent = this;
	this.instance_7.setTransform(230.9,121.7,0.506,0.506,0,0,0,0.1,0.1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(148).to({_off:false},0).to({regY:0,y:2.5},67).to({y:-9.9,alpha:0},7).to({_off:true},1).wait(148));

	// t3a
	this.instance_8 = new lib.t3a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(126.4,26.3,0.426,0.426,0,0,0,0.1,0.3);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({regX:0,regY:0.2,scaleX:0.53,scaleY:0.53,x:118.6,y:21.4,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.3,scaleX:0.43,scaleY:0.43,x:126.4,y:25.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_9 = new lib.t3b();
	this.instance_9.parent = this;
	this.instance_9.setTransform(284.3,26.2,0.426,0.426,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({scaleX:0.53,scaleY:0.53,x:291.4,y:30,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.43,scaleY:0.43,x:284.3,y:25.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p2a.png
	this.instance_10 = new lib.qwe();
	this.instance_10.parent = this;
	this.instance_10.setTransform(179.8,105,0.533,0.533,0,0,0,0.1,0.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).to({y:0.2},65).to({regY:0,y:-11.1,alpha:0},7).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_11 = new lib.qweww();
	this.instance_11.parent = this;
	this.instance_11.setTransform(231.1,-59.3,0.533,0.533,0,0,0,0.1,-0.1);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(76).to({_off:false},0).to({regY:0.1,y:57.1},65).to({regY:0.2,y:69.6,alpha:0},7).to({_off:true},1).wait(222));

	// t2a
	this.instance_12 = new lib.t2a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(126.4,26.3,0.426,0.426,0,0,0,0.1,0.3);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({regY:0.2,scaleX:0.53,scaleY:0.53,x:118.7,y:21.4,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regY:0.3,scaleX:0.43,scaleY:0.43,x:126.4,y:25.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_13 = new lib.t2b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(285.3,26.2,0.426,0.426,0,0,0,0.1,0.1);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(80).to({_off:false},0).to({scaleX:0.53,scaleY:0.53,x:292.6,y:30,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.43,scaleY:0.43,x:285.3,y:25.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// logo1
	this.instance_14 = new lib.logo1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(48.1,26.2,0.373,0.373,0,0,0,0.3,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(371));

	// skidka
	this.instance_15 = new lib.skidka();
	this.instance_15.parent = this;
	this.instance_15.setTransform(245.1,26.7,0.32,0.32,0,0,0,0.1,0.1);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4).to({_off:false},0).to({scaleX:0.4,scaleY:0.4,x:270.6,alpha:1},7,cjs.Ease.get(1)).wait(52).to({regY:0.3,scaleX:0.32,scaleY:0.32,x:255,y:26.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},5).wait(296));

	// tolko
	this.instance_16 = new lib.tolko();
	this.instance_16.parent = this;
	this.instance_16.setTransform(160.5,27.1,0.516,0.516,0,0,0,0.3,0.3);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:160.6,y:27.2,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regX:0.2,regY:0.2,scaleX:0.52,scaleY:0.52,x:160.4,y:27,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(225.9,89.5,0.41,0.41,-90,0,0,119.8,164.7);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({regY:164.4,x:226.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(157.8,89.5,0.41,0.41,-90,0,0,119.8,164.6);
	...
	this.shape_1.setTransform(160,25,0.47,0.044,0,0,0,-0.1,0.2);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(159.5,-33.1,321,229.5);
// library properties:
lib.properties = {
	width: 320,
	height: 50,

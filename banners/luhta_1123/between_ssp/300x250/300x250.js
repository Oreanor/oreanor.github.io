...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(241.9,185.7,0.72,0.72);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(227).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:254.3,y:215.3,alpha:1},7,cjs.Ease.get(1)).wait(52).to({scaleX:0.72,scaleY:0.72,x:241.9,y:185.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));
	...
	this.instance_7.setTransform(240.2,185.7,0.72,0.72);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(154).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:252.2,y:215.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.72,scaleY:0.72,x:240.2,y:185.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));
	...
	this.instance_11.setTransform(241.9,185.7,0.72,0.72);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(80).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:254.4,y:215.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.72,scaleY:0.72,x:241.9,y:185.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

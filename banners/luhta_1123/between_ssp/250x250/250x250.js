...
lib.ssMetadata = [
		{name:"250x250_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
(lib._250x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(122,219.9);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(101,172.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(56.7,58.7,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(226).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:44.9,y:32,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:56.7,y:58.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_3 = new lib.t4a();
	this.instance_3.parent = this;
	this.instance_3.setTransform(197.2,191.4,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(227).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:208.3,y:218.1,alpha:1},7,cjs.Ease.get(1)).wait(52).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:197.2,y:191.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p4a.png
	this.instance_4 = new lib.fghfg();
	this.instance_4.parent = this;
	this.instance_4.setTransform(96.4,137.5,0.559,0.559,0,0,0,0.4,0.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(222).to({_off:false},0).to({regX:0.1,regY:0.2,scaleX:0.7,scaleY:0.7,x:92.7,y:137.6,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.4,regY:0.3,scaleX:0.56,scaleY:0.56,x:96.4,y:137.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_5 = new lib.gh();
	this.instance_5.parent = this;
	this.instance_5.setTransform(146.4,142,0.559,0.559,0,0,0,0.3,0.4);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({regY:0.2,scaleX:0.7,scaleY:0.7,x:152.6,y:143.2,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regY:0.4,scaleX:0.56,scaleY:0.56,x:146.4,y:142,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(74));

	// t3a
	this.instance_6 = new lib.t3a();
	this.instance_6.parent = this;
	this.instance_6.setTransform(56.7,58.7,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(152).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:44.9,y:32,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:56.7,y:58.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_7 = new lib.t3b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(195.7,191.4,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(154).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:206.4,y:218.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:195.7,y:191.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p3a.png
	this.instance_8 = new lib.sdf();
	this.instance_8.parent = this;
	this.instance_8.setTransform(96.6,135.5,0.634,0.634,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(148).to({_off:false},0).to({scaleX:0.79,scaleY:0.79,x:89.7,y:132.8,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regY:0.2,y:131.9},0).to({regY:0.1,scaleX:0.63,scaleY:0.63,x:96.6,y:135.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_9 = new lib.dfrg();
	this.instance_9.parent = this;
	this.instance_9.setTransform(154.6,141.8,0.634,0.634,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(150).to({_off:false},0).to({regX:0,regY:0,scaleX:0.79,scaleY:0.79,x:162.1,y:143.7,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.63,scaleY:0.63,x:154.6,y:141.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(148));

	// t2a
	this.instance_10 = new lib.t2a();
	this.instance_10.parent = this;
	this.instance_10.setTransform(56.7,58.7,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(78).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:44.9,y:32,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:56.7,y:58.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_11 = new lib.t2b();
	this.instance_11.parent = this;
	this.instance_11.setTransform(197.2,191.4,0.648,0.648,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(80).to({_off:false},0).to({regX:0,regY:0,scaleX:0.81,scaleY:0.81,x:208.4,y:218.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0.1,regY:0.1,scaleX:0.65,scaleY:0.65,x:197.2,y:191.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// p2a.png
	this.instance_12 = new lib.qwe();
	this.instance_12.parent = this;
	this.instance_12.setTransform(95.9,132.6,0.634,0.634,0,0,0,0.3,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(74).to({_off:false},0).to({regX:0.1,scaleX:0.79,scaleY:0.79,x:83.7,y:131.5,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:88.7},0).to({regX:0.3,scaleX:0.63,scaleY:0.63,x:95.9,y:132.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_13 = new lib.qweww();
	this.instance_13.parent = this;
	this.instance_13.setTransform(152.1,143.3,0.634,0.634,0,0,0,0.3,0.1);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(76).to({_off:false},0).to({regX:0.1,regY:0.2,scaleX:0.79,scaleY:0.79,x:159,y:145.6,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.3,regY:0.1,scaleX:0.63,scaleY:0.63,x:152.1,y:143.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(222));

	// skidka
	this.instance_14 = new lib.skidka();
	this.instance_14.parent = this;
	this.instance_14.setTransform(125.1,181.1,0.64,0.64,0,0,0,0.1,0);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:0,scaleX:0.8,scaleY:0.8,x:124.7,y:198.7,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// tolko
	this.instance_15 = new lib.tolko();
	this.instance_15.parent = this;
	this.instance_15.setTransform(121.3,127.1,0.72,0.72,0,0,0,0.2,0.3);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({regX:0.3,regY:0.1,scaleX:0.9,scaleY:0.9,x:120.1,y:128.9,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// logo1
	this.instance_16 = new lib.logo1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(130.9,74.6,0.64,0.64,0,0,0,0.1,0);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({regX:0,scaleX:0.8,scaleY:0.8,x:131.6,y:57.8,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regX:0.1,regY:0.1,scaleX:0.37,scaleY:0.37,x:206.2,y:30.6},7,cjs.Ease.get(1)).wait(220).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(108.5,405.8,0.9,0.9,0,0,0,120,164.4);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:406.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(108.5,256.4,0.9,0.9,0,0,0,120,164.4);
	...
	this.shape_1.setTransform(124.9,125,0.368,0.22,0,0,0,-0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(53.5,124.5,503.8,405.7);
// library properties:
lib.properties = {
	width: 250,
	height: 250,
	...
	manifest: [
		...
		{src:"images/250x250_atlas_P_.png", id:"250x250_atlas_P_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"120x600_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,160,360);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.p5_1, new cjs.Rectangle(-120,-122.5,160,360), null);
...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(91,172.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(59.6,452.1,0.577,0.577,0,0,0,0.1,0.1);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(72.7,359,0.554,0.554,0,0,0,0.2,0.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(224).to({_off:false},0).to({regX:0,regY:0,scaleX:0.69,scaleY:0.69,x:78.8,y:360.2,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.2,scaleX:0.55,scaleY:0.55,x:72.7,y:359,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(74));

	// p4a.png
	this.instance_3 = new lib.fghfg();
	this.instance_3.parent = this;
	this.instance_3.setTransform(49,254.5,0.554,0.554,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(222).to({_off:false},0).to({regX:0,regY:0,scaleX:0.69,scaleY:0.69,x:42.7,y:254.6,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.55,scaleY:0.55,x:49,y:254.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(74));

	// t4a
	this.instance_4 = new lib.t4a();
	this.instance_4.parent = this;
	this.instance_4.setTransform(45.8,162.8,0.554,0.554,0,0,0,0.1,0.2);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({regY:0.1,scaleX:0.69,scaleY:0.69,x:35.8,y:140,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regY:0.2,scaleX:0.55,scaleY:0.55,x:45.8,y:162.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_5 = new lib.t4a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(76.1,453,0.554,0.554,0,0,0,0.1,0);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(227).to({_off:false},0).to({regY:0.1,scaleX:0.69,scaleY:0.69,x:85.6,y:475.8,alpha:1},7,cjs.Ease.get(1)).wait(52).to({regY:0,scaleX:0.55,scaleY:0.55,x:76.1,y:453,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p3b.png
	this.instance_6 = new lib.dfrg();
	this.instance_6.parent = this;
	this.instance_6.setTransform(66.3,360.5,0.554,0.554,0,0,0,0.2,0.2);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(150).to({_off:false},0).to({regX:0,regY:0,scaleX:0.69,scaleY:0.69,x:72.8,y:362.1,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.2,scaleX:0.55,scaleY:0.55,x:66.3,y:360.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(148));

	// p3a.png
	this.instance_7 = new lib.sdf();
	this.instance_7.parent = this;
	this.instance_7.setTransform(55.6,241,0.554,0.554,0,0,0,0.1,0.2);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(148).to({_off:false},0).to({regX:0,regY:0,scaleX:0.69,scaleY:0.69,x:49.4,y:237.7,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.2,scaleX:0.55,scaleY:0.55,x:55.6,y:241,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(148));

	// t3a
	this.instance_8 = new lib.t3a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(45.8,162.8,0.554,0.554,0,0,0,0.1,0.2);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({regY:0.1,scaleX:0.69,scaleY:0.69,x:35.8,y:140,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regY:0.2,scaleX:0.55,scaleY:0.55,x:45.8,y:162.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_9 = new lib.t3b();
	this.instance_9.parent = this;
	this.instance_9.setTransform(74.8,453,0.554,0.554,0,0,0,0.2,0);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.69,scaleY:0.69,x:84,y:475.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0.2,regY:0,scaleX:0.55,scaleY:0.55,x:74.8,y:453,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p2b.png
	this.instance_10 = new lib.qweww();
	this.instance_10.parent = this;
	this.instance_10.setTransform(70.1,361.8,0.554,0.554,0,0,0,0.1,0.2);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).to({regY:0.1,scaleX:0.69,scaleY:0.69,x:76.1,y:363.7,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regY:0.2,scaleX:0.55,scaleY:0.55,x:70.1,y:361.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(222));

	// p2a.png
	this.instance_11 = new lib.qwe();
	this.instance_11.parent = this;
	this.instance_11.setTransform(54.9,249.8,0.554,0.554,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(74).to({_off:false},0).to({regX:0,regY:0,scaleX:0.69,scaleY:0.69,x:48.6,y:248.7,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.55,scaleY:0.55,x:54.9,y:249.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// t2a
	this.instance_12 = new lib.t2a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(45.8,162.8,0.554,0.554,0,0,0,0,0.2);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({regY:0.1,scaleX:0.69,scaleY:0.69,x:35.8,y:140,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regY:0.2,scaleX:0.55,scaleY:0.55,x:45.8,y:162.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_13 = new lib.t2b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(76.1,453,0.554,0.554,0,0,0,0.2,0);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(80).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.69,scaleY:0.69,x:85.7,y:475.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:0.2,regY:0,scaleX:0.55,scaleY:0.55,x:76.1,y:453,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));
	...
	this.instance_15.setTransform(58.8,372.1,0.478,0.478,0,0,0,0.2,0.2);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.6,scaleY:0.6,y:385.3,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// tolko
	this.instance_16 = new lib.tolko();
	this.instance_16.parent = this;
	this.instance_16.setTransform(58.9,302.4,0.478,0.478,0,0,0,0.3,0);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({regX:0.1,regY:0.3,scaleX:0.6,scaleY:0.6,x:58.8,y:303.7,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(54.6,596.7,0.924,0.924,0,0,0,120,164.5);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:597.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(54.6,443.4,0.924,0.924,0,0,0,120,164.5);
	...
	this.shape_1.setTransform(59.5,300,0.175,0.529,0,0,0,-0.3,0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-70.2,299.5,517.3,601);
// library properties:
lib.properties = {
	width: 120,
	height: 600,

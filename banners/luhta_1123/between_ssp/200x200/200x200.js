...
lib.ssMetadata = [
		{name:"200x200_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
(lib._200x200 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(99.1,176.5,0.8,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(76.3,138.6,0.8,0.8);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(45.9,47.6,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(226).to({_off:false},0).to({regX:0,scaleX:0.65,scaleY:0.65,x:36.5,y:26.2,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,scaleX:0.52,scaleY:0.52,x:45.9,y:47.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_3 = new lib.t4a();
	this.instance_3.parent = this;
	this.instance_3.setTransform(158.3,153.7,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(227).to({_off:false},0).to({scaleX:0.65,scaleY:0.65,x:167.2,y:175.1,alpha:1},7,cjs.Ease.get(1)).wait(52).to({scaleX:0.52,scaleY:0.52,x:158.3,y:153.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p4a.png
	this.instance_4 = new lib.fghfg();
	this.instance_4.parent = this;
	this.instance_4.setTransform(77.7,110.7,0.447,0.447,0,0,0,0.4,0.4);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(222).to({_off:false},0).to({regX:0.1,regY:0.3,scaleX:0.56,scaleY:0.56,x:74.7,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.4,regY:0.4,scaleX:0.45,scaleY:0.45,x:77.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_5 = new lib.gh();
	this.instance_5.parent = this;
	this.instance_5.setTransform(117.7,114.2,0.447,0.447,0,0,0,0.4,0.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({regY:0.3,scaleX:0.56,scaleY:0.56,x:122.7,y:115.2,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regY:0.5,scaleX:0.45,scaleY:0.45,x:117.7,y:114.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(74));

	// t3a
	this.instance_6 = new lib.t3a();
	this.instance_6.parent = this;
	this.instance_6.setTransform(45.9,47.6,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(152).to({_off:false},0).to({regX:0,scaleX:0.65,scaleY:0.65,x:36.5,y:26.2,alpha:1},7,cjs.Ease.get(1)).wait(54).to({regX:0.1,scaleX:0.52,scaleY:0.52,x:45.9,y:47.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_7 = new lib.t3b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(157.1,153.7,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(154).to({_off:false},0).to({scaleX:0.65,scaleY:0.65,x:165.7,y:175.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.52,scaleY:0.52,x:157.1,y:153.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p3a.png
	this.instance_8 = new lib.sdf();
	this.instance_8.parent = this;
	this.instance_8.setTransform(77.9,109,0.507,0.507,0,0,0,0.3,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(148).to({_off:false},0).to({regX:0.1,scaleX:0.63,scaleY:0.63,x:72.2,y:106.8,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regY:0.3,y:106.2},0).to({regX:0.3,regY:0.1,scaleX:0.51,scaleY:0.51,x:77.9,y:109,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_9 = new lib.dfrg();
	this.instance_9.parent = this;
	this.instance_9.setTransform(124.3,114.1,0.507,0.507,0,0,0,0.3,0.3);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(150).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.63,scaleY:0.63,x:130.2,y:115.6,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.3,regY:0.3,scaleX:0.51,scaleY:0.51,x:124.3,y:114.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(148));

	// t2a
	this.instance_10 = new lib.t2a();
	this.instance_10.parent = this;
	this.instance_10.setTransform(45.9,47.6,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(78).to({_off:false},0).to({scaleX:0.65,scaleY:0.65,x:36.5,y:26.2,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.52,scaleY:0.52,x:45.9,y:47.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_11 = new lib.t2b();
	this.instance_11.parent = this;
	this.instance_11.setTransform(158.3,153.7,0.518,0.518,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(80).to({_off:false},0).to({scaleX:0.65,scaleY:0.65,x:167.3,y:175.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.52,scaleY:0.52,x:158.3,y:153.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// p2a.png
	this.instance_12 = new lib.qwe();
	this.instance_12.parent = this;
	this.instance_12.setTransform(77.3,106.7,0.507,0.507,0,0,0,0.3,0.2);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(74).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.63,scaleY:0.63,x:67.5,y:105.8,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:71.4},0).to({regX:0.3,regY:0.2,scaleX:0.51,scaleY:0.51,x:77.3,y:106.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_13 = new lib.qweww();
	this.instance_13.parent = this;
	this.instance_13.setTransform(122.2,115.3,0.507,0.507,0,0,0,0.3,0.2);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(76).to({_off:false},0).to({regX:0.1,regY:0.3,scaleX:0.63,scaleY:0.63,x:127.7,y:117.1,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.3,regY:0.2,scaleX:0.51,scaleY:0.51,x:122.2,y:115.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(222));

	// skidka
	this.instance_14 = new lib.skidka();
	this.instance_14.parent = this;
	this.instance_14.setTransform(100.6,145.5,0.512,0.512,0,0,0,0.2,0.1);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:0,regY:0,scaleX:0.64,scaleY:0.64,x:100.3,y:159.5,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// tolko
	this.instance_15 = new lib.tolko();
	this.instance_15.parent = this;
	this.instance_15.setTransform(97.6,102.4,0.576,0.576,0,0,0,0.3,0.4);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({regX:0.4,regY:0.1,scaleX:0.72,scaleY:0.72,x:96.7,y:103.7,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// logo1
	this.instance_16 = new lib.logo1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(105.3,60.3,0.512,0.512,0,0,0,0.2,0.1);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({regX:0.1,scaleX:0.64,scaleY:0.64,x:105.8,y:46.8,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regY:0.4,scaleX:0.29,scaleY:0.29,x:165.5,y:25.1},7,cjs.Ease.get(1)).wait(220).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(87.3,325.3,0.72,0.72,0,0,0,120,164.5);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:326,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(87.3,205.7,0.72,0.72,0,0,0,120,164.4);
	...
	this.shape_1.setTransform(100.5,100.6,0.294,0.176);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(43.4,99.5,403,325.2);
// library properties:
lib.properties = {
	width: 200,
	height: 200,

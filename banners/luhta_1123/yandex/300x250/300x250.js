...
lib.ssMetadata = [
		{name:"300x250_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(147,219.9);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(60,62.4,0.72,0.72);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(226).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:47,y:32.8,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.72,scaleY:0.72,x:60,y:62.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_3 = new lib.t4a();
	this.instance_3.parent = this;
	this.instance_3.setTransform(239.9,184.7,0.72,0.72);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(227).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:252.3,y:214.3,alpha:1},7,cjs.Ease.get(1)).wait(52).to({scaleX:0.72,scaleY:0.72,x:239.9,y:184.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p4a.png
	this.instance_4 = new lib.fghfg();
	this.instance_4.parent = this;
	this.instance_4.setTransform(122.7,132,0.64,0.64,0,0,0,0.1,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(222).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:115.5,y:132.2,alpha:1},7,cjs.Ease.get(1)).wait(60).to({regX:0.1,regY:0.1,scaleX:0.64,scaleY:0.64,x:122.7,y:132,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_5 = new lib.gh();
	this.instance_5.parent = this;
	this.instance_5.setTransform(180,137.2,0.64,0.64,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:187.1,y:138.6,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.64,scaleY:0.64,x:180,y:137.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(74));

	// t3a
	this.instance_6 = new lib.t3a();
	this.instance_6.parent = this;
	this.instance_6.setTransform(60,62.4,0.72,0.72);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(152).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:47,y:32.8,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.72,scaleY:0.72,x:60,y:62.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_7 = new lib.t3b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(238.2,184.7,0.72,0.72);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(154).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:250.2,y:214.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.72,scaleY:0.72,x:238.2,y:184.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p3a.png
	this.instance_8 = new lib.sdf();
	this.instance_8.parent = this;
	this.instance_8.setTransform(123.3,116.4,0.64,0.64,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(148).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:116.3,y:113.6,alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:112.6},0).to({regX:0.1,regY:0.1,scaleX:0.64,scaleY:0.64,x:123.3,y:116.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_9 = new lib.dfrg();
	this.instance_9.parent = this;
	this.instance_9.setTransform(181.9,138.9,0.64,0.64,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(150).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:189.5,y:140.8,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.64,scaleY:0.64,x:181.9,y:138.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(148));

	// t2a
	this.instance_10 = new lib.t2a();
	this.instance_10.parent = this;
	this.instance_10.setTransform(60.1,62.4,0.72,0.72);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(78).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:47,y:32.8,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.72,scaleY:0.72,x:60.1,y:62.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_11 = new lib.t2b();
	this.instance_11.parent = this;
	this.instance_11.setTransform(239.9,184.7,0.72,0.72);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(80).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,x:252.4,y:214.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.72,scaleY:0.72,x:239.9,y:184.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// p2a.png
	this.instance_12 = new lib.qwe();
	this.instance_12.parent = this;
	this.instance_12.setTransform(122.5,126.6,0.64,0.64,0,0,0,0.1,0);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(74).to({_off:false},0).to({regX:0,scaleX:0.8,scaleY:0.8,x:110.3,y:125.4,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:115.3},0).to({regX:0.1,scaleX:0.64,scaleY:0.64,x:122.5,y:126.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_13 = new lib.qweww();
	this.instance_13.parent = this;
	this.instance_13.setTransform(179.3,140.4,0.64,0.64,0,0,0,0.1,0.1);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(76).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:186.3,y:142.6,alpha:1},7,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.64,scaleY:0.64,x:179.3,y:140.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},2).wait(222));

	// skidka
	this.instance_14 = new lib.skidka();
	this.instance_14.parent = this;
	this.instance_14.setTransform(150.1,181.1,0.64,0.64,0,0,0,0.1,0);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:0,scaleX:0.8,scaleY:0.8,x:149.7,y:198.7,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// tolko
	this.instance_15 = new lib.tolko();
	this.instance_15.parent = this;
	this.instance_15.setTransform(146.3,127.1,0.72,0.72,0,0,0,0.2,0.3);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(2).to({_off:false},0).to({regX:0.3,regY:0.1,scaleX:0.9,scaleY:0.9,x:145.1,y:128.9,alpha:1},7,cjs.Ease.get(1)).wait(56).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// logo1
	this.instance_16 = new lib.logo1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(155.9,74.6,0.64,0.64,0,0,0,0.1,0);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({regX:0,scaleX:0.8,scaleY:0.8,x:156.6,y:57.8,alpha:1},7,cjs.Ease.get(1)).wait(56).to({regX:0.1,regY:0.1,scaleX:0.37,scaleY:0.37,x:256.2,y:30.6},7,cjs.Ease.get(1)).wait(220).to({alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(73));
	...
	this.shape_1.setTransform(150,125,0.441,0.22);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(78.5,124.5,503.8,405.7);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

...
lib.ssMetadata = [
		{name:"728x90_atlas_P_", frames: [[272,251,128,231],[142,0,129,243],[0,245,147,206],[0,0,140,241],[149,245,121,247],[273,0,122,249]]}
];
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(364,122.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(597,44.9);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(396.5,211.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({y:-5.8},67).to({y:-28.5,alpha:0},7).to({_off:true},1).wait(74));

	// p4b.png
	this.instance_3 = new lib.gh();
	this.instance_3.parent = this;
	this.instance_3.setTransform(486,-122.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(222).to({_off:false},0).to({y:96.6,alpha:0.91},67).to({y:119.5,alpha:0},7).to({_off:true},1).wait(74));

	// t4a
	this.instance_4 = new lib.t4a();
	this.instance_4.parent = this;
	this.instance_4.setTransform(303.4,45,0.8,0.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({scaleX:1,scaleY:1,x:288.9,y:36,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.8,scaleY:0.8,x:303.4,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(74));

	// t4b
	this.instance_5 = new lib.t4a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(586.6,45,0.8,0.8);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(228).to({_off:false},0).to({scaleX:1,scaleY:1,x:600.4,y:52.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.8,scaleY:0.8,x:586.6,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(74));

	// p3a.png
	this.instance_6 = new lib.sdf();
	this.instance_6.parent = this;
	this.instance_6.setTransform(397.5,-103);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(148).to({_off:false},0).to({y:87.2},67).to({y:107,alpha:0},7).to({_off:true},1).wait(148));

	// p3b.png
	this.instance_7 = new lib.dfrg();
	this.instance_7.parent = this;
	this.instance_7.setTransform(489,232.3);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(148).to({_off:false},0).to({y:-3.1},67).to({y:-27.7,alpha:0},7).to({_off:true},1).wait(148));

	// t3a
	this.instance_8 = new lib.t3a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(303.4,45,0.8,0.8);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({scaleX:1,scaleY:1,x:288.9,y:36,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.8,scaleY:0.8,x:303.4,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(148));

	// t3b
	this.instance_9 = new lib.t3b();
	this.instance_9.parent = this;
	this.instance_9.setTransform(584.8,45,0.8,0.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({scaleX:1,scaleY:1,x:598.1,y:52.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.8,scaleY:0.8,x:584.8,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(148));

	// p2a.png
	this.instance_10 = new lib.qwe();
	this.instance_10.parent = this;
	this.instance_10.setTransform(396.3,193);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(76).to({_off:false},0).to({y:-3.8},65).to({y:-25,alpha:0},7).to({_off:true},1).wait(222));

	// p2b.png
	this.instance_11 = new lib.qweww();
	this.instance_11.parent = this;
	this.instance_11.setTransform(485,-115.5);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(76).to({_off:false},0).to({y:103},65).to({y:126.5,alpha:0},7).to({_off:true},1).wait(222));

	// t2a
	this.instance_12 = new lib.t2a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(303.5,45,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({scaleX:1,scaleY:1,x:289,y:36,alpha:1},7,cjs.Ease.get(1)).wait(54).to({scaleX:0.8,scaleY:0.8,x:303.5,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(222));

	// t2b
	this.instance_13 = new lib.t2b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(586.7,45,0.8,0.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(80).to({_off:false},0).to({scaleX:1,scaleY:1,x:600.5,y:52.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.8,scaleY:0.8,x:586.7,y:45,alpha:0},7,cjs.Ease.get(1)).to({_off:true},4).wait(222));

	// logo1
	this.instance_14 = new lib.logo1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(105.8,45,0.7,0.7);
	...
	this.instance_15.setTransform(563.9,46,0.6,0.6,0,0,0,0,0.1);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4).to({_off:false},0).to({regY:0,scaleX:0.75,scaleY:0.75,x:611.7,alpha:1},7,cjs.Ease.get(1)).wait(52).to({regY:0.1,scaleX:0.6,scaleY:0.6,x:563.7,y:45.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},5).wait(296));

	// tolko
	this.instance_16 = new lib.tolko();
	this.instance_16.parent = this;
	this.instance_16.setTransform(363.8,46.7,0.88,0.88,0,0,0,0.1,0.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:1.1,scaleY:1.1,x:364.1,y:46.9,alpha:1},7,cjs.Ease.get(1)).wait(56).to({scaleX:0.88,scaleY:0.88,x:363.6,y:46.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},3).wait(296));

	// mania - копия
	this.instance_17 = new lib.mania();
	this.instance_17.parent = this;
	this.instance_17.setTransform(526.5,182.2,1,1,-90,0,0,120,164.4);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:527.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(296));

	// mania
	this.instance_18 = new lib.mania();
	this.instance_18.parent = this;
	this.instance_18.setTransform(360.5,182.2,1,1,-90,0,0,120,164.4);
	...
	this.shape_1.setTransform(364,45,1.07,0.079,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(371));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(363.5,-132.7,729,559.8);
// library properties:
lib.properties = {
	width: 728,
	height: 90,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/p5.jpg?1543015326214", id:"p5"},
		{src:"images/728x90_atlas_P_.png?1543015326161", id:"728x90_atlas_P_"}
	],
	preloads: []
};

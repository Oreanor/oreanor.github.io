...
lib.ssMetadata = [
		{name:"375x290_atlas_", frames: [[0,0,375,160],[0,162,375,160],[0,324,375,160],[0,486,375,160],[0,648,375,160]]}
];
...
(lib._375x290 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(240).to({_off:false},0).to({regX:69.5,regY:14.8,scaleX:1.19,scaleY:1.19,x:125.9,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:69.4,regY:14.7,scaleX:1.07,scaleY:1.07,x:125.7,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.shape_96.graphics.f("#FFFFFF").s().p("A9SWqMAAAgtTMA6lAAAMAAAAtTg");
	this.shape_96.setTransform(187.5,145);

...
lib.ssMetadata = [
		{name:"300x500_atlas_P_", frames: [[0,266,301,168],[0,436,317,121],[0,0,300,264]]},
		{name:"300x500_atlas_NP_", frames: [[0,502,300,248],[0,251,300,249],[0,0,300,249]]}
];
...
(lib.p1 = function() {
	this.spriteSheet = ss["300x500_atlas_NP_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._300x500 = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(149.4,38.1,1.25,1.25);
...
p.nominalBounds = new cjs.Rectangle(149.5,249.5,320.5,600.5);
// library properties:
lib.properties = {
	width: 300,
	height: 500,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x500_atlas_P_.png?1607185682552", id:"300x500_atlas_P_"},
		{src:"images/300x500_atlas_NP_.jpg?1607185682552", id:"300x500_atlas_NP_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[302,276,300,274],[0,276,300,274],[0,0,300,274],[302,0,300,274],[604,0,300,274]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00A7E0").s().p("");
	this.shape.setTransform(119.5,27.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t5, new cjs.Rectangle(2,-12,235.2,78.9), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_10.setTransform(200.7,10.3,1,1,0,0,0,25.1,16.5);

	this.instance_11 = new lib.ClipGroup_1_5();
	this.instance_11.parent = this;
	this.instance_11.setTransform(88.5,3.5,1,1,0,0,0,15.1,15.1);

	this.instance_12 = new lib.ClipGroup_2_5();
	this.instance_12.parent = this;
	this.instance_12.setTransform(270.6,6.8,1,1,0,0,0,38.9,21.4);

	this.instance_13 = new lib.ClipGroup_3_5();
	this.instance_13.parent = this;
	this.instance_13.setTransform(18.2,7.8,1,1,0,0,0,21.8,22.4);
	...
	this.shape_96.setTransform(39.1,42.1);
	...
	this.shape_103.setTransform(161.2,9.8);
	...
	this.shape_106.setTransform(124.7,9.9);
	...
	this.shape_107.setTransform(220.4,22.5);
	...
	this.shape_108.graphics.f("#FFFFFF").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	this.shape_108.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.shape_108).wait(306));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(146.4,285.4,313.6,615.1);
// library properties:
lib.properties = {
	width: 300,
	height: 600,

...
lib.ssMetadata = [
		{name:"600x500_atlas_", frames: [[0,1088,600,270],[0,816,600,270],[0,544,600,270],[0,0,600,270],[0,272,600,270]]}
];
...
}).prototype = getMCSymbolPrototype(lib.p4, new cjs.Rectangle(0,0,600,270), null);
...
(lib._600x500 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(211,417.3,1.8,1.8,0,0,0,69.4,14.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(240).to({_off:false},0).to({scaleX:2,scaleY:2,x:211.1,y:417.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.8,scaleY:1.8,x:211,y:417.3,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t4
	this.instance_1 = new lib.t4();
	this.instance_1.parent = this;
	this.instance_1.setTransform(211.1,417.3,1.8,1.8,0,0,0,70,14.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(180).to({_off:false},0).to({regX:69.9,scaleX:2,scaleY:2,x:211,y:417.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:70,scaleX:1.8,scaleY:1.8,x:211.1,y:417.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// t3
	this.instance_2 = new lib.t3();
	this.instance_2.parent = this;
	this.instance_2.setTransform(210.9,417.3,1.8,1.8,0,0,0,91.5,14.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(120).to({_off:false},0).to({scaleX:2,scaleY:2,x:211,y:417.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.8,scaleY:1.8,x:210.9,y:417.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// t2
	this.instance_3 = new lib.t2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(211.1,417.2,1.8,1.8,0,0,0,59.6,14);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60).to({_off:false},0).to({scaleX:2,scaleY:2,y:417.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.8,scaleY:1.8,y:417.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// t1
	this.instance_4 = new lib.t1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(211,417.3,1.8,1.8,0,0,0,64.4,12.8);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:64.3,scaleX:2,scaleY:2,x:210.9,y:417.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:64.4,scaleX:1.8,scaleY:1.8,x:211,y:417.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));
	...
	this.instance_10.setTransform(436.3,14.8,2,2,0,0,0,16.4,10.8);

	this.instance_11 = new lib.ClipGroup_1_15();
	this.instance_11.parent = this;
	this.instance_11.setTransform(116.8,5.8,2,2,0,0,0,9.9,9.8);

	this.instance_12 = new lib.ClipGroup_2_15();
	this.instance_12.parent = this;
	this.instance_12.setTransform(559.8,8.3,2,2,0,0,0,25.5,14);

	this.instance_13 = new lib.ClipGroup_3_14();
	this.instance_13.parent = this;
	this.instance_13.setTransform(24.8,11.6,2,2,0,0,0,14.3,14.7);
	...
	this.shape_96.setTransform(52.1,56.6,2,2);
	...
	this.shape_103.setTransform(107.2,45,2,2);
	...
	this.shape_106.setTransform(158.3,14,2,2);
	...
	this.shape_107.setTransform(487.4,15.8,2,2);
	...
	this.shape_108.graphics.f("#FFFFFF").s().p("Egu3AnEMAAAhOHMBdvAAAMAAABOHg");
	this.shape_108.setTransform(300,250);

	this.timeline.addTween(cjs.Tween.get(this.shape_108).wait(306));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(296.2,230.3,614.6,520.2);
// library properties:
lib.properties = {
	width: 600,
	height: 500,

...
lib.ssMetadata = [
		{name:"480x320_atlas_P_", frames: [[319,277,167,169],[0,277,317,121],[0,0,480,275]]},
...
(lib._480x320 = function(mode,startPosition,loop) {
	...
	this.instance_9.setTransform(0,-61);
...
p.nominalBounds = new cjs.Rectangle(230,99,490.5,381.5);
// library properties:
lib.properties = {
	width: 480,
	height: 320,

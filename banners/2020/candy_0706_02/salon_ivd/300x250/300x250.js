...
lib.ssMetadata = [
		{name:"300x250_atlas_", frames: [[0,0,300,135],[0,137,300,135],[0,274,300,135],[0,411,300,135],[0,548,300,135],[0,685,60,10]]}
];
...
(lib.p4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(9,139);
...
}).prototype = getMCSymbolPrototype(lib.p4, new cjs.Rectangle(0,0,300,149), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(104.4,208.7,0.9,0.9,0,0,0,69.4,14.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(240).to({_off:false},0).to({scaleX:1,scaleY:1,x:104.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.9,scaleY:0.9,x:104.4,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t4
	this.instance_1 = new lib.t4();
	this.instance_1.parent = this;
	this.instance_1.setTransform(119.4,209.8,0.9,0.9,0,0,0,70,14.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(180).to({_off:false},0).to({regX:69.9,scaleX:1,scaleY:1,x:120.9,y:209.9,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:70,scaleX:0.9,scaleY:0.9,x:119.4,y:209.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// t3
	this.instance_2 = new lib.t3();
	this.instance_2.parent = this;
	this.instance_2.setTransform(119,208.3,0.9,0.9,0,0,0,91.5,14.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(120).to({_off:false},0).to({scaleX:1,scaleY:1,x:120.6,y:208.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.9,scaleY:0.9,x:119,y:208.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// t2
	this.instance_3 = new lib.t2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(110.3,207.3,0.9,0.9,0,0,0,59.6,14);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60).to({_off:false},0).to({scaleX:1,scaleY:1,x:110.9,y:207.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.9,scaleY:0.9,x:110.3,y:207.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// t1
	this.instance_4 = new lib.t1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(87,208,0.9,0.9,0,0,0,64.4,12.8);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:64.3,scaleX:1,scaleY:1,x:84.9,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:64.4,scaleX:0.9,scaleY:0.9,x:87,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));
	...
	this.shape_96.graphics.f("#FFFFFF").s().p("AmZFXIAAqtIMzAAIAAKtg");
	this.shape_96.setTransform(150,125,3.659,3.65);

	this.timeline.addTween(cjs.Tween.get(this.shape_96).wait(306));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,124.5,310.5,251);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

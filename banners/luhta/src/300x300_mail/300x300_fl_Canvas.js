...
lib.ssMetadata = [
		{name:"300x300_fl_Canvas_atlas_NP_", frames: [[0,604,300,300],[0,302,300,300],[0,0,300,300]]}
];
...
(lib._0 = function() {
	this.spriteSheet = ss["300x300_fl_Canvas_atlas_NP_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x300_fl_Canvas = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// library properties:
lib.properties = {
	id: '1BB86FADF64CF14EA71EE0F7BF24B368',
	width: 300,
	height: 300,
	fps: 24,
	color: "#FFFFFF",
	...
	manifest: [
		...
		{src:"300x300_fl_Canvas_atlas_NP_.jpg", id:"300x300_fl_Canvas_atlas_NP_"}
	],
	preloads: []
};
...
an.compositions['1BB86FADF64CF14EA71EE0F7BF24B368'] = {

...
lib.ssMetadata = [
		{name:"300x300_atlas_P_", frames: [[288,399,7,6],[0,399,240,97],[242,399,44,12],[0,0,319,397]]}
];
...
(lib._300x300 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(150,202.2,1,0.05,0,0,0,0,1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(148).to({_off:false},0).to({regY:0,scaleY:1,y:201.2},6,cjs.Ease.get(1)).wait(46).to({scaleY:0.1},5,cjs.Ease.get(1)).to({_off:true},1).wait(4));

	// new
	this.instance_3 = new lib.Символ5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(150,202.2,1,0.094);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(54).to({_off:false},0).to({regY:0.3,scaleY:1.1,y:202.8},6,cjs.Ease.get(1)).to({regY:0,scaleY:1,y:202.4},3,cjs.Ease.get(1)).wait(35).to({scaleY:0.05,y:202.2},4,cjs.Ease.get(0.99)).to({_off:true},1).wait(107));

	// Слой 6
	this.instance_4 = new lib.Символ4();
	this.instance_4.parent = this;
	this.instance_4.setTransform(420,202.1,1,1.2,0,0,0,120,50.1);
	...
	this.instance_5.setTransform(51,281);
	...
	this.instance_6.setTransform(420,202.5,1,1,0,0,0,120,48.5);
	...
	this.instance_7.setTransform(142.9,147.1,0.95,0.95,0,0,0,119.5,148.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:119.2,regY:148.7,scaleX:1.05,scaleY:1.05,x:102,y:166.8},209).wait(1));

	// Слой 4
	this.instance_8 = new lib.Символ8();
	this.instance_8.parent = this;
	this.instance_8.setTransform(160,182.5,1.143,1.143,0,0,0,139.9,159.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({scaleX:1.18,scaleY:1.18,x:136.4,y:190.2},209).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149,149,333.5,384.1);
// library properties:
lib.properties = {
	width: 300,
	height: 300,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1503616985250", id:"bg"},
		{src:"images/300x300_atlas_P_.png?1503616985226", id:"300x300_atlas_P_"}
	],
	preloads: []
};

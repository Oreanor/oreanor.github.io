...
(lib._240x400_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({_off:false},0).to({alpha:1},5,cjs.Ease.get(1)).wait(24).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(55).to({_off:false},0).to({alpha:1},5,cjs.Ease.get(1)).wait(27).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(52));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(8).to({_off:false},0).wait(1).to({regX:124.5,regY:48.6,x:361.8,y:222.6},0).wait(1).to({x:353.1},0).wait(1).to({x:337.3},0).wait(1).to({x:313},0).wait(1).to({x:279.7},0).wait(1).to({x:238.4},0).wait(1).to({x:194.2},0).wait(1).to({x:156.1},0).wait(1).to({x:132.2},0).wait(1).to({regX:120,regY:48.5,x:120,y:222.5},0).wait(29).to({x:-120},7,cjs.Ease.get(1)).wait(49).to({x:120},6,cjs.Ease.get(1)).wait(33).to({x:-120},6,cjs.Ease.get(1)).wait(52));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:119.2,regY:148.7,scaleX:1.05,scaleY:1.05,x:72,y:166.8},199).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:139.9,x:105.5,y:197.8},199).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1503521337240", id:"bg"},
		{src:"images/240x400_2_atlas_P_.png?1503521337210", id:"240x400_2_atlas_P_"}
	],
	preloads: []
};

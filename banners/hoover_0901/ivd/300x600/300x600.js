...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[604,0,300,170],[302,0,300,170],[0,0,300,170],[0,172,300,170],[302,172,300,170],[604,172,300,170]]}
];
...
(lib.txt6 = function(mode,startPosition,loop) {
	...
	this.shape_34.setTransform(52.6,4.6,0.9,0.9);
	...
	this.shape_35.setTransform(44.9,4.6,0.9,0.9);
	...
	this.shape_36.setTransform(37.5,4.6,0.9,0.9);
	...
	this.shape_39.setTransform(13.4,4.6,0.9,0.9);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#FFFFFF").s().p("AAWA4IAAheIgqAAIAABeIgTAAIAAhvIBPAAIAABvg");
	this.shape_40.setTransform(3.6,3.4,0.9,0.9);
	...
	this.shape_49.setTransform(95.4,4.7,0.45,0.45);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#FFFFFF").s().p("AgPBTIg6ilIAlAAIAkB3IAmh3IAkAAIg6Clg");
	this.shape_50.setTransform(88.4,4.7,0.45,0.45);
	...
	this.shape_51.setTransform(81.1,4.7,0.45,0.45);
...
}).prototype = getMCSymbolPrototype(lib.txt6, new cjs.Rectangle(0,-1.6,159.4,48.3), null);
...
(lib.txt1 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(52.6,6.5,0.9,0.9);
	...
	this.shape_1.setTransform(44.9,6.5,0.9,0.9);
	...
	this.shape_2.setTransform(37.5,6.5,0.9,0.9);
	...
	this.shape_5.setTransform(13.4,6.5,0.9,0.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAWA4IAAheIgqAAIAABeIgTAAIAAhvIBPAAIAABvg");
	this.shape_6.setTransform(3.6,5.2,0.9,0.9);
	...
	this.shape_15.setTransform(95.4,6.5,0.45,0.45);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgPBTIg6ilIAlAAIAkB3IAmh3IAkAAIg6Clg");
	this.shape_16.setTransform(88.4,6.5,0.45,0.45);
	...
	this.shape_17.setTransform(81.1,6.5,0.45,0.45);
...
}).prototype = getMCSymbolPrototype(lib.txt1, new cjs.Rectangle(0,0.2,166.3,43.7), null);
...
}).prototype = getMCSymbolPrototype(lib.p6, new cjs.Rectangle(-120,-67.5,300,170), null);
...
}).prototype = getMCSymbolPrototype(lib.p5, new cjs.Rectangle(-120,-67.5,300,170), null);
...
}).prototype = getMCSymbolPrototype(lib.p4, new cjs.Rectangle(-120,-67.5,300,170), null);
...
}).prototype = getMCSymbolPrototype(lib.p3, new cjs.Rectangle(-120,-67.5,300,170), null);
...
}).prototype = getMCSymbolPrototype(lib.p2, new cjs.Rectangle(-120,-67.5,300,170), null);
...
}).prototype = getMCSymbolPrototype(lib.p1, new cjs.Rectangle(-120,-67.5,300,170), null);
...
(lib.hfree = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(36.2,2.5,1.2,1.2);
	...
	this.shape_1.setTransform(30.8,3.2,1.2,1.2);
	...
	this.shape_4.setTransform(10.2,1.5,1.2,1.2);
	...
	this.shape_5.setTransform(5.2,2.5,1.2,1.2);
	...
	this.shape_6.setTransform(1.1,-0.2,1.2,1.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.hfree, new cjs.Rectangle(-0.3,-1.9,38.7,8.5), null);
...
(lib.dfgdfggg = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(164.5,9.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgOAbQgGgEgBgJIAJAAQABAGAEADQACADAFAAQAFAAAEgEQAEgFAAgHQAAgHgDgDQgFgDgFAAQgEAAgCABQgEACgCACIgHgBIAGggIAgAAIAAAHIgZAAIgEASQAGgEAGAAQAIAAAFAFQAHAFgBAJQAAAJgEAHQgHAHgKAAQgJAAgFgFg");
	this.shape_1.setTransform(159.5,9.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAGAgIAAgPIgbAAIAAgHIAcgpIAHAAIAAApIAIAAIAAAHIgIAAIAAAPgAgNAKIATAAIAAgcg");
	this.shape_2.setTransform(154.3,9.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgOAaQgGgIAAgSQAAgKACgHQADgHAFgEQAEgEAGAAQAGAAADACQAEACADAEQADAEABAGIABAOQAAALgCAHQgDAHgEAEQgEAEgIAAQgIAAgGgHgAgIgVQgDAGAAAPQgBAQAEAFQAEAFAEAAQAGAAADgFQAEgFAAgQQAAgPgEgFQgDgFgGAAQgFAAgDAEg");
	this.shape_3.setTransform(149.5,9.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgLAgQAAgIADgLQADgKAFgJQAFgKAGgHIgfAAIAAgIIApAAIAAAGQgGAHgGALQgHAKgCALQgCAIgBAKg");
	this.shape_4.setTransform(144.5,9.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgOAaQgGgIAAgSQAAgKADgHQACgHAFgEQAEgEAGAAQAGAAADACQAEACADAEQACAEACAGIABAOQAAALgCAHQgDAHgEAEQgFAEgHAAQgIAAgGgHgAgIgVQgDAGAAAPQAAAQADAFQAEAFAEAAQAGAAADgFQAEgFAAgQQAAgPgEgFQgDgFgGAAQgFAAgDAEg");
	this.shape_5.setTransform(139.5,9.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("");
	this.shape_6.setTransform(134.5,9.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("");
	this.shape_7.setTransform(129.5,9.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgLAgQAAgIADgLQADgKAFgJQAFgKAGgHIgfAAIAAgIIApAAIAAAGQgGAHgGALQgHAKgCALQgCAIgBAKg");
	this.shape_8.setTransform(124.5,9.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgLAgQAAgIADgLQADgKAFgJQAFgKAGgHIgfAAIAAgIIApAAIAAAGQgGAHgGALQgHAKgCALQgCAIgBAKg");
	this.shape_9.setTransform(119.5,9.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AAGAgIAAgPIgbAAIAAgHIAcgpIAHAAIAAApIAIAAIAAAHIgIAAIAAAPgAgNAKIATAAIAAgcg");
	this.shape_10.setTransform(114.3,9.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgNAaQgHgIAAgSQAAgKADgHQACgHAEgEQAFgEAGAAQAGAAAEACQADACADAEQACAEACAGIABAOQAAALgCAHQgCAHgFAEQgEAEgIAAQgIAAgFgHgAgHgVQgFAGAAAPQABAQADAFQAEAFAEAAQAGAAAEgFQADgFAAgQQAAgPgDgFQgEgFgGAAQgEAAgDAEg");
	this.shape_11.setTransform(109.5,9.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_12.setTransform(104.2,9.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AARAgIAAgeIghAAIAAAeIgIAAIAAg/IAIAAIAAAaIAhAAIAAgaIAIAAIAAA/g");
	this.shape_13.setTransform(96.2,9.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AgYAgIAAg/IAYAAIAJAAQAGABACACQAEADACAEQACAEAAAEQAAAJgGAEQgFAGgOAAIgPAAIAAAagAgPgBIAPAAQAJAAAEgDQADgDAAgFQAAgEgCgDQgDgDgDgBIgIgBIgPAAg");
	this.shape_14.setTransform(90.2,9.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgUAgIAAg/IApAAIAAAHIggAAIAAA4g");
	this.shape_15.setTransform(84.9,9.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AgPAdQgIgEgDgIQgEgIAAgIQAAgPAJgJQAIgJANAAQAJAAAHAEQAHAEAEAIQAEAHAAAJQAAAKgEAIQgEAHgHAEQgIAEgIAAQgIAAgHgEgAgPgTQgGAGAAAOQAAAMAGAGQAGAHAJAAQAJAAAHgHQAGgGAAgNQAAgHgDgGQgCgGgFgDQgGgDgGAAQgIAAgHAGg");
	this.shape_16.setTransform(78.7,9.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgOAbQgGgEAAgJIAIAAQABAGADADQAEADAEAAQAFAAAEgEQAEgFAAgHQAAgHgEgDQgEgDgFAAQgDAAgEABQgCACgCACIgIgBIAGggIAfAAIAAAHIgZAAIgDASQAGgEAFAAQAJAAAGAFQAFAFAAAJQAAAJgEAHQgHAHgKAAQgJAAgFgFg");
	this.shape_17.setTransform(70.2,9.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_18.setTransform(64.8,9.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgNAaQgHgIAAgSQAAgKACgHQADgHAFgEQAEgEAGAAQAFAAAEACQAEACADAEQADAEABAGIABAOQAAALgCAHQgDAHgEAEQgFAEgHAAQgIAAgFgHgAgIgVQgDAGAAAPQAAAQADAFQAEAFAEAAQAFAAAEgFQAEgFAAgQQAAgPgEgFQgEgFgFAAQgEAAgEAEg");
	this.shape_19.setTransform(60.1,9.8);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgUAgIABgFQACgFADgEIAKgKQAKgIADgEQAEgFAAgFQAAgEgDgEQgDgDgGAAQgFAAgDAEQgDADAAAGIgJgBQABgJAGgFQAFgEAIAAQAJAAAGAFQAFAFAAAHIgCAIIgEAHIgNALIgIAIIgDAFIAfAAIAAAHg");
	this.shape_20.setTransform(55.1,9.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_21.setTransform(49.8,9.7);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgOAbQgFgEgBgJIAIAAQABAGADADQADADAFAAQAFAAAEgEQAEgFAAgHQAAgHgEgDQgDgDgGAAQgDAAgEABQgDACgBACIgIgBIAHggIAeAAIAAAHIgZAAIgDASQAGgEAFAAQAJAAAGAFQAFAFABAJQgBAJgFAHQgGAHgKAAQgJAAgFgFg");
	this.shape_22.setTransform(45.2,9.8);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AAGAgIAAgPIgbAAIAAgHIAcgpIAHAAIAAApIAIAAIAAAHIgIAAIAAAPgAgNAKIATAAIAAgcg");
	this.shape_23.setTransform(40,9.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#000000").s().p("AgNAaQgHgIAAgSQAAgKACgHQADgHAEgEQAFgEAGAAQAFAAAFACQADACADAEQACAEACAGIABAOQAAALgCAHQgCAHgFAEQgEAEgIAAQgIAAgFgHgAgHgVQgFAGAAAPQABAQADAFQAEAFAEAAQAFAAAFgFQADgFAAgQQAAgPgDgFQgFgFgFAAQgEAAgDAEg");
	this.shape_24.setTransform(35.1,9.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#000000").s().p("AgLAgQAAgIADgLQADgKAFgJQAFgKAGgHIgfAAIAAgIIApAAIAAAGQgGAHgGALQgHAKgCALQgCAIgBAKg");
	this.shape_25.setTransform(30.2,9.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AgLAgQAAgIADgLQADgKAFgJQAFgKAGgHIgfAAIAAgIIApAAIAAAGQgGAHgGALQgHAKgCALQgCAIgBAKg");
	this.shape_26.setTransform(25.2,9.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AARAgIAAgeIghAAIAAAeIgIAAIAAg/IAIAAIAAAaIAhAAIAAgaIAIAAIAAA/g");
	this.shape_27.setTransform(16.9,9.7);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AARAgIAAgeIghAAIAAAeIgIAAIAAg/IAIAAIAAAaIAhAAIAAgaIAIAAIAAA/g");
	this.shape_28.setTransform(10.4,9.7);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AASAgIAAgyIgiAyIgIAAIAAg/IAIAAIAAAyIAhgyIAIAAIAAA/g");
	this.shape_29.setTransform(3.9,9.7);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#000000").s().p("AgEAEIAAgIIAIAAIAAAIg");
	this.shape_30.setTransform(291.3,3.5);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("");
	this.shape_31.setTransform(287.5,0.7);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#000000").s().p("AgEAEIAAgIIAIAAIAAAIg");
	this.shape_32.setTransform(281.3,3.5);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#000000").s().p("AASAeIAAgNIgjAAIAAANIgHAAIAAgUIAEAAQAJgKgBgdIAgAAIAAAnIAFAAIAAAUgAgMAKIAYAAIAAggIgRAAQgBAWgGAKg");
	this.shape_33.setTransform(277.2,2.2);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#000000").s().p("AgEAIQABAAAAgBQABAAAAgBQABAAAAgBQAAAAABgBQAAgCAAgDIgDAAIAAgJIAIAAIAAAJQAAAEgCADQgCADgDACg");
	this.shape_34.setTransform(271,4.1);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AALAgIAAgiIgVAiIgIAAIAAgtIAIAAIAAAiIAVgiIAIAAIAAAtgAgHgXQgEgDAAgFIAFAAIACAEQACACACAAQAEAAACgCQACgBAAgDIAGAAQgBAFgDADQgEADgFAAQgFAAgDgDg");
	this.shape_35.setTransform(267.2,0.7);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgLAEIAAgHIAXAAIAAAHg");
	this.shape_36.setTransform(263.2,1.6);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("AgVAgIABgFQACgFAEgEIAKgKQAKgIADgEQAEgFAAgFQAAgEgDgEQgEgDgFAAQgFAAgDAEQgDADgBAGIgIgBQABgJAGgFQAFgEAIAAQAJAAAGAFQAFAFAAAHIgBAIIgGAHIgMALIgIAIIgEAFIAgAAIAAAHg");
	this.shape_37.setTransform(259.1,0.7);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AALAgIAAgiIgVAiIgIAAIAAgtIAIAAIAAAiIAVgiIAIAAIAAAtgAgHgXQgEgDAAgFIAFAAIACAEQACACACAAQAEAAACgCQACgBAAgDIAGAAQgBAFgDADQgEADgFAAQgFAAgDgDg");
	this.shape_38.setTransform(251.7,0.7);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AALAXIAAgiIgVAiIgIAAIAAgtIAIAAIAAAiIAVgiIAIAAIAAAtg");
	this.shape_39.setTransform(246.6,1.6);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#000000").s().p("AAIAXIgIgOQgBgFgCgBQgBAAgBAAQAAgBgBAAQAAAAgBAAQAAAAgBAAIAAAVIgIAAIAAgtIAIAAIAAAUQADAAACgCIADgIIAFgHIACgDIAHAAIABAAIAAAGIgCAAIgEABIgDAGIgDAGIgEADQAFABAEAIIAJAOg");
	this.shape_40.setTransform(242.5,1.6);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#000000").s().p("AgNASQgGgGAAgMQAAgGACgGQADgGAFgDQAFgCAFAAQAIAAAEADQAFAEACAHIgIABQgBgEgDgDQgDgCgEAAQgFAAgDAEQgEAFAAAIQAAAJADAFQAEAEAFAAQAFAAADgDQADgDABgGIAHABQgBAIgFAFQgFAEgIAAQgJAAgFgGg");
	this.shape_41.setTransform(238,1.6);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#000000").s().p("AALAXIAAgUIgVAAIAAAUIgIAAIAAgtIAIAAIAAATIAVAAIAAgTIAIAAIAAAtg");
	this.shape_42.setTransform(233.2,1.6);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#000000").s().p("AALAXIAAgiIgVAiIgIAAIAAgtIAIAAIAAAiIAVgiIAIAAIAAAtg");
	this.shape_43.setTransform(228.2,1.6);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AAaAeIAAgNIg5AAIAAguIAIAAIAAAnIASAAIAAgnIAGAAIAAAnIASAAIAAgnIAIAAIAAAnIAGAAIAAAUg");
	this.shape_44.setTransform(222.1,2.2);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#000000").s().p("AgPASQgGgGAAgMQAAgMAHgGQAGgFAIAAQAKAAAGAGQAGAGAAALQAAAIgDAFQgCAGgGACQgFADgGAAQgJAAgGgGgAgJgMQgEAEAAAIQAAAJAEAEQAEAFAFAAQAGAAAEgFQAEgEAAgJQAAgIgEgEQgEgFgGAAQgFAAgEAFg");
	this.shape_45.setTransform(215.7,1.6);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#000000").s().p("AgXAgIAAg/IAXAAIAJAAQAGABACACQADADADAEQABAEAAAEQABAJgGAEQgFAGgOAAIgPAAIAAAagAgPgBIAPAAQAJAAAEgDQADgDAAgFQAAgEgCgDQgDgDgDgBIgIgBIgPAAg");
	this.shape_46.setTransform(210.4,0.7);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#000000").s().p("AASAeIAAgNIgjAAIAAANIgHAAIAAgUIAEAAQAJgKgBgdIAgAAIAAAnIAFAAIAAAUgAgMAKIAYAAIAAggIgRAAQgBAWgGAKg");
	this.shape_47.setTransform(202,2.2);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#000000").s().p("");
	this.shape_48.setTransform(197.4,1.6);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#000000").s().p("AgOASQgHgGABgMQgBgKAHgHQAFgGAJAAQAJAAAGAGQAGAGABALIAAACIgiAAQAAAIAEAEQAEAEAEAAQAFAAADgCQADgDACgFIAIABQgCAHgFAEQgFAEgJAAQgIAAgGgGgAgIgNQgDADgBAGIAZAAQgBgFgCgDQgEgFgGAAQgFAAgDAEg");
	this.shape_49.setTransform(192.9,1.6);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#000000").s().p("AgPASQgGgGAAgMQAAgMAHgGQAGgFAIAAQAKAAAGAGQAGAGAAALQAAAIgDAFQgCAGgGACQgFADgGAAQgJAAgGgGgAgJgMQgEAEAAAIQAAAJAEAEQAEAFAFAAQAGAAAEgFQAEgEAAgJQAAgIgEgEQgEgFgGAAQgFAAgEAFg");
	this.shape_50.setTransform(187.8,1.6);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#000000").s().p("AgTAhIAAhAIAHAAIAAAGQACgDAEgCQADgCADAAQAGAAAFADQAFADACAGQACAFAAAHQAAAHgCAFQgDAGgFADQgFADgFAAQgDAAgDgCIgFgEIAAAXgAgIgVQgEAFAAAJQAAAIADAEQAEAEAFAAQAFAAADgEQAEgFAAgIQAAgJgEgEQgDgFgFAAQgEAAgEAFg");
	this.shape_51.setTransform(183,2.4);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#000000").s().p("AARAgIAAg4IghAAIAAA4IgIAAIAAg/IAxAAIAAA/g");
	this.shape_52.setTransform(177.1,0.7);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#000000").s().p("AgEAIQABAAAAgBQABAAAAgBQABAAAAgBQABAAAAgBQAAgCAAgDIgDAAIAAgJIAIAAIAAAJQAAAEgCADQgCADgDACg");
	this.shape_53.setTransform(170.1,4.1);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("");
	this.shape_54.setTransform(166.4,1.6);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AgSAXIAAgtIASAAIAJABQADABADADQACADAAAEIgBAGQgCACgDACQAEAAACADQACADAAAEQAAAHgFADQgEADgIAAgAgKARIAKAAQAGAAACgCQADgBAAgEIgCgEQAAgBAAAAQgBgBAAAAQgBAAAAAAQgBgBAAAAIgHAAIgJAAgAgKgDIAIAAIAGAAIADgCIACgEQAAgEgDgBQgCgCgGAAIgIAAg");
	this.shape_55.setTransform(161.6,1.6);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#000000").s().p("AAJAXIgJgOQgBgFgDgBQAAAAgBAAQAAgBgBAAQAAAAgBAAQAAAAgBAAIAAAVIgIAAIAAgtIAIAAIAAAUQAEAAABgCIAEgIIADgHIAEgDIAFAAIADAAIAAAGIgDAAIgEABIgCAGIgEAGIgDADQAEABAFAIIAIAOg");
	this.shape_56.setTransform(157.5,1.6);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#000000").s().p("AgNASQgGgGAAgMQAAgGACgGQADgGAFgDQAFgCAFAAQAIAAAEADQAFAEACAHIgIABQgBgEgDgDQgDgCgEAAQgFAAgDAEQgEAFAAAIQAAAJADAFQAEAEAFAAQAFAAADgDQADgDABgGIAHABQgBAIgFAFQgFAEgIAAQgJAAgFgGg");
	this.shape_57.setTransform(153,1.6);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#000000").s().p("AgPASQgGgGAAgMQAAgMAHgGQAGgFAIAAQAKAAAGAGQAGAGAAALQAAAIgDAFQgCAGgGACQgFADgGAAQgJAAgGgGgAgJgMQgEAEAAAIQAAAJAEAEQAEAFAFAAQAGAAAEgFQAEgEAAgJQAAgIgEgEQgEgFgGAAQgFAAgEAFg");
	this.shape_58.setTransform(148.1,1.6);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#000000").s().p("AAXAgIAAg1IgTA1IgHAAIgSg2IAAA2IgJAAIAAg/IANAAIAQAsIACAKIADgKIAPgsIAMAAIAAA/g");
	this.shape_59.setTransform(141.9,0.7);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#000000").s().p("AgEAEIAAgIIAIAAIAAAIg");
	this.shape_60.setTransform(134.4,3.5);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#000000").s().p("AgNAXIAAgtIAaAAIAAAGIgSAAIAAAng");
	this.shape_61.setTransform(131.8,1.6);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#000000").s().p("AgEAIQABAAAAgBQABAAAAgBQABAAAAgBQAAAAABgBQAAgCAAgDIgDAAIAAgJIAIAAIAAAJQAAAEgCADQgCADgDACg");
	this.shape_62.setTransform(126.1,4.1);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#000000").s().p("");
	this.shape_63.setTransform(122.3,0.7);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_64.setTransform(117,0.7);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#000000").s().p("AAGAgIAAgPIgbAAIAAgHIAcgpIAHAAIAAApIAIAAIAAAHIgIAAIAAAPgAgNAKIATAAIAAgcg");
	this.shape_65.setTransform(112.2,0.7);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#000000").s().p("AgOAbQgFgEgBgJIAIAAQABAGADADQAEADAEAAQAFAAAEgEQAEgFAAgHQAAgHgEgDQgDgDgGAAQgDAAgEABQgDACgBACIgIgBIAHggIAeAAIAAAHIgZAAIgDASQAGgEAFAAQAJAAAGAFQAFAFABAJQgBAJgFAHQgGAHgKAAQgIAAgGgFg");
	this.shape_66.setTransform(107.4,0.8);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_67.setTransform(102,0.7);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#000000").s().p("AAEAgIAAgxQgDADgEACIgIAEIAAgHQAHgDAEgFQAFgEACgEIAFAAIAAA/g");
	this.shape_68.setTransform(97,0.7);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#000000").s().p("AAAAUIAKgUIgKgTIAFAAIAOATIgOAUgAgSAUIAMgUIgMgTIAHAAIANATIgNAUg");
	this.shape_69.setTransform(89.9,1.6);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#000000").s().p("AgDAEIAAgIIAIAAIAAAIg");
	this.shape_70.setTransform(86.1,3.5);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#000000").s().p("AgUAgIAAg/IApAAIAAAHIggAAIAAA4g");
	this.shape_71.setTransform(82.8,0.7);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#000000").s().p("AgEAEIAAgIIAIAAIAAAIg");
	this.shape_72.setTransform(78.8,3.5);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#000000").s().p("AARAgIAAgeIghAAIAAAeIgIAAIAAg/IAIAAIAAAaIAhAAIAAgaIAIAAIAAA/g");
	this.shape_73.setTransform(74.2,0.7);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#000000").s().p("AgEAEIAAgIIAIAAIAAAIg");
	this.shape_74.setTransform(69.8,3.5);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#000000").s().p("AgOAdQgHgEgDgIQgDgIAAgJQAAgKADgHQAEgHAIgEQAGgEAIAAQAJAAAHAFQAGAFADAIIgIACQgDgHgEgDQgEgDgHAAQgFAAgFAEQgFADgDAGQgBAGAAAGQAAAIABAGQADAGAFADQAFADAFAAQAHAAAFgEQAFgEACgIIAIACQgCAKgHAGQgHAFgKAAQgKAAgGgEg");
	this.shape_75.setTransform(65.3,0.7);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#000000").s().p("AASAgIAAgyIgiAyIgIAAIAAg/IAIAAIAAAyIAhgyIAIAAIAAA/g");
	this.shape_76.setTransform(56.3,0.7);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#000000").s().p("AAVAoIAAgPIgpAAIAAAPIgIAAIAAgXIAFAAQAIgMAAgiIAAgKIAmAAIAAA4IAGAAIAAAXgAgHgcIgCAXQgBANgEAJIAcAAIAAgwIgVAAg");
	this.shape_77.setTransform(49.9,1.4);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#000000").s().p("AARAgIAAgeIghAAIAAAeIgIAAIAAg/IAIAAIAAAaIAhAAIAAgaIAIAAIAAA/g");
	this.shape_78.setTransform(43.7,0.7);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#000000").s().p("AAVAgIgIgTIgaAAIgHATIgJAAIAYg/IAJAAIAaA/gAgEgMIgHASIAWAAIgIgRIgDgNIgEAMg");
	this.shape_79.setTransform(37.5,0.7);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#000000").s().p("AAMAgIgKgRIgHgKQgDgDgFAAIAAAeIgJAAIAAg/IAJAAIAAAcQAGAAACgCQACgCAEgJIAEgJQACgDADgBQADgCAEAAIAFAAIAAAHIgBAAIgCAAQgFAAgCACQgCACgCAHQgDAIgDACQgCACgCABQAFABAHAKIAMAVg");
	this.shape_80.setTransform(32.2,0.7);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#000000").s().p("AAMAUIgNgUIANgTIAHAAIgMATIAMAUgAgEAUIgOgUIAOgTIAGAAIgLATIALAUg");
	this.shape_81.setTransform(26.7,1.6);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#000000").s().p("AgPAdQgIgEgDgIQgEgIAAgIQAAgPAJgJQAIgJANAAQAJAAAHAEQAHAEAEAIQAEAHAAAJQAAAKgEAIQgEAHgHAEQgIAEgIAAQgIAAgHgEgAgPgTQgGAGAAAOQAAAMAGAGQAGAHAJAAQAJAAAHgHQAGgGAAgNQAAgHgDgGQgCgGgFgDQgGgDgGAAQgIAAgHAGg");
	this.shape_82.setTransform(18.2,0.7);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#000000").s().p("AgPAdQgIgEgDgIQgEgIAAgIQAAgPAJgJQAIgJANAAQAJAAAHAEQAHAEAEAIQAEAHAAAJQAAAKgEAIQgEAHgHAEQgIAEgIAAQgIAAgHgEgAgPgTQgGAGAAAOQAAAMAGAGQAGAHAJAAQAJAAAHgHQAGgGAAgNQAAgHgDgGQgCgGgFgDQgGgDgGAAQgIAAgHAGg");
	this.shape_83.setTransform(11.2,0.7);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#000000").s().p("AgPAdQgIgEgDgIQgEgIAAgIQAAgPAJgJQAIgJANAAQAJAAAHAEQAHAEAEAIQAEAHAAAJQAAAKgEAIQgEAHgHAEQgIAEgIAAQgIAAgHgEgAgPgTQgGAGAAAOQAAAMAGAGQAGAHAJAAQAJAAAHgHQAGgGAAgNQAAgHgDgGQgCgGgFgDQgGgDgGAAQgIAAgHAGg");
	this.shape_84.setTransform(4.2,0.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_84},{t:this.shape_83},{t:this.shape_82},{t:this.shape_81},{t:this.shape_80},{t:this.shape_79},{t:this.shape_78},{t:this.shape_77},{t:this.shape_76},{t:this.shape_75},{t:this.shape_74},{t:this.shape_73},{t:this.shape_72},{t:this.shape_71},{t:this.shape_70},{t:this.shape_69},{t:this.shape_68},{t:this.shape_67},{t:this.shape_66},{t:this.shape_65},{t:this.shape_64},{t:this.shape_63},{t:this.shape_62},{t:this.shape_61},{t:this.shape_60},{t:this.shape_59},{t:this.shape_58},{t:this.shape_57},{t:this.shape_56},{t:this.shape_55},{t:this.shape_54},{t:this.shape_53},{t:this.shape_52},{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.dfgdfggg, new cjs.Rectangle(-1.3,-6.2,297.7,23.1), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(25.2,571.4,0.972,0.972,0,0,0,16,3.6);
	...
	this.addr2.setTransform(6.8,581.3,0.972,0.972);
	...
	this.shape_1.setTransform(195.5,131.9,0.562,0.562);

	this.instance_1 = new lib.ClipGroup_0();
	this.instance_1.parent = this;
	this.instance_1.setTransform(153.3,89.5,0.562,0.562,0,0,0,139.6,139.1);

	this.instance_2 = new lib.ClipGroup_1_0();
	this.instance_2.parent = this;
	this.instance_2.setTransform(167.5,91.2,0.562,0.562,0,0,0,55.3,52.4);

	this.instance_3 = new lib.ClipGroup_2_0();
	this.instance_3.parent = this;
	this.instance_3.setTransform(151.7,102.4,0.562,0.562,0,0,0,16.6,15.8);
	...
	this.shape_2.setTransform(152.5,89.6,0.562,0.562);
	...
	this.shape_3.setTransform(166.6,91.2,0.562,0.562);
	...
	this.shape_4.setTransform(151,102.1,0.562,0.562);
	...
	this.shape_5.setTransform(153.6,90.4,0.562,0.562);
	...
	this.shape_6.setTransform(167.7,92,0.562,0.562);
	...
	this.shape_7.setTransform(152.1,102.9,0.562,0.562);

	this.instance_4 = new lib.ClipGroup_3_0();
	this.instance_4.parent = this;
	this.instance_4.setTransform(152.5,89.1,0.562,0.562,0,0,0,158.9,158.6);

	this.instance_5 = new lib.ClipGroup_4_0();
	this.instance_5.parent = this;
	this.instance_5.setTransform(152.4,89.2,0.562,0.562,0,0,0,161.8,161.6);

	this.instance_6 = new lib.ClipGroup_5_0();
	this.instance_6.parent = this;
	this.instance_6.setTransform(152.5,89.1,0.562,0.562,0,0,0,169.4,169.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_330 = new cjs.Graphics().p("AmvUhIDutTMA0vAAAIjtNTg");
	var mask_graphics_331 = new cjs.Graphics().p("As9UhIDutTMA0vAAAIjtNTg");
	var mask_graphics_332 = new cjs.Graphics().p("AyNUhIDttTMA0vAAAIjtNTg");
	var mask_graphics_333 = new cjs.Graphics().p("A2hUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_334 = new cjs.Graphics().p("A53UhIDttTMA0wAAAIjuNTg");
	var mask_graphics_335 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_336 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_337 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_396 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_397 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_398 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_399 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_400 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_graphics_401 = new cjs.Graphics().p("A8YUhIDttTMA0wAAAIjuNTg");
	var mask_graphics_402 = new cjs.Graphics().p("A+AUhIDutTMA0vAAAIjtNTg");
	var mask_graphics_403 = new cjs.Graphics().p("A+iUhIDttTMA0wAAAIjuNTg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(330).to({graphics:mask_graphics_330,x:318.2,y:131.3}).wait(1).to({graphics:mask_graphics_331,x:278.4,y:131.3}).wait(1).to({graphics:mask_graphics_332,x:244.7,y:131.3}).wait(1).to({graphics:mask_graphics_333,x:217.2,y:131.3}).wait(1).to({graphics:mask_graphics_334,x:195.8,y:131.3}).wait(1).to({graphics:mask_graphics_335,x:180.2,y:131.3}).wait(1).to({graphics:mask_graphics_336,x:161.8,y:131.3}).wait(1).to({graphics:mask_graphics_337,x:155.8,y:131.3}).wait(59).to({graphics:mask_graphics_396,x:127.2,y:131.3}).wait(1).to({graphics:mask_graphics_397,x:37.6,y:131.3}).wait(1).to({graphics:mask_graphics_398,x:-38.1,y:131.3}).wait(1).to({graphics:mask_graphics_399,x:-100.1,y:131.3}).wait(1).to({graphics:mask_graphics_400,x:-148.3,y:131.3}).wait(1).to({graphics:mask_graphics_401,x:-181.7,y:131.3}).wait(1).to({graphics:mask_graphics_402,x:-192.1,y:131.3}).wait(1).to({graphics:mask_graphics_403,x:-195.5,y:131.3}).wait(1));

	// txt6
	this.instance_7 = new lib.txt6();
	this.instance_7.parent = this;
	this.instance_7.setTransform(119.6,222.4,1.375,1.375,0,0,0,71.4,21.8);
	...
	mask_1._off = true;
	var mask_1_graphics_198 = new cjs.Graphics().p("AmvUhIDutTMA0vAAAIjtNTg");
	var mask_1_graphics_199 = new cjs.Graphics().p("As9UhIDutTMA0vAAAIjtNTg");
	var mask_1_graphics_200 = new cjs.Graphics().p("AyNUhIDttTMA0vAAAIjtNTg");
	var mask_1_graphics_201 = new cjs.Graphics().p("A2hUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_202 = new cjs.Graphics().p("A53UhIDttTMA0wAAAIjuNTg");
	var mask_1_graphics_203 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_204 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_205 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_330 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_331 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_332 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_333 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_334 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_335 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_336 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_1_graphics_337 = new cjs.Graphics().p("A8TUhIDttTMA0wAAAIjuNTg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(198).to({graphics:mask_1_graphics_198,x:318.2,y:131.3}).wait(1).to({graphics:mask_1_graphics_199,x:278.4,y:131.3}).wait(1).to({graphics:mask_1_graphics_200,x:244.7,y:131.3}).wait(1).to({graphics:mask_1_graphics_201,x:217.2,y:131.3}).wait(1).to({graphics:mask_1_graphics_202,x:195.8,y:131.3}).wait(1).to({graphics:mask_1_graphics_203,x:180.2,y:131.3}).wait(1).to({graphics:mask_1_graphics_204,x:161.8,y:131.3}).wait(1).to({graphics:mask_1_graphics_205,x:155.8,y:131.3}).wait(125).to({graphics:mask_1_graphics_330,x:155.8,y:131.3}).wait(1).to({graphics:mask_1_graphics_331,x:66.2,y:131.3}).wait(1).to({graphics:mask_1_graphics_332,x:-9.5,y:131.3}).wait(1).to({graphics:mask_1_graphics_333,x:-71.5,y:131.3}).wait(1).to({graphics:mask_1_graphics_334,x:-119.7,y:131.3}).wait(1).to({graphics:mask_1_graphics_335,x:-154.2,y:131.3}).wait(1).to({graphics:mask_1_graphics_336,x:-174.8,y:131.3}).wait(1).to({graphics:mask_1_graphics_337,x:-181.2,y:131.3}).wait(67));

	// txt4
	this.instance_8 = new lib.txt4();
	this.instance_8.parent = this;
	this.instance_8.setTransform(127.5,222.4,1.375,1.375,0,0,0,68.1,6.3);
	...
	mask_2._off = true;
	var mask_2_graphics_132 = new cjs.Graphics().p("AmvUhIDutTMA0vAAAIjtNTg");
	var mask_2_graphics_133 = new cjs.Graphics().p("As9UhIDutTMA0vAAAIjtNTg");
	var mask_2_graphics_134 = new cjs.Graphics().p("AyNUhIDttTMA0vAAAIjtNTg");
	var mask_2_graphics_135 = new cjs.Graphics().p("A2hUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_136 = new cjs.Graphics().p("A53UhIDttTMA0wAAAIjuNTg");
	var mask_2_graphics_137 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_138 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_139 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_198 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_199 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_200 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_201 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_202 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_203 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_204 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_2_graphics_205 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(132).to({graphics:mask_2_graphics_132,x:318.2,y:131.3}).wait(1).to({graphics:mask_2_graphics_133,x:278.4,y:131.3}).wait(1).to({graphics:mask_2_graphics_134,x:244.7,y:131.3}).wait(1).to({graphics:mask_2_graphics_135,x:217.2,y:131.3}).wait(1).to({graphics:mask_2_graphics_136,x:195.8,y:131.3}).wait(1).to({graphics:mask_2_graphics_137,x:180.2,y:131.3}).wait(1).to({graphics:mask_2_graphics_138,x:161.8,y:131.3}).wait(1).to({graphics:mask_2_graphics_139,x:155.8,y:131.3}).wait(59).to({graphics:mask_2_graphics_198,x:155.8,y:131.3}).wait(1).to({graphics:mask_2_graphics_199,x:71.2,y:131.3}).wait(1).to({graphics:mask_2_graphics_200,x:-0.3,y:131.3}).wait(1).to({graphics:mask_2_graphics_201,x:-58.9,y:131.3}).wait(1).to({graphics:mask_2_graphics_202,x:-104.4,y:131.3}).wait(1).to({graphics:mask_2_graphics_203,x:-136.9,y:131.3}).wait(1).to({graphics:mask_2_graphics_204,x:-156.5,y:131.3}).wait(1).to({graphics:mask_2_graphics_205,x:-163,y:131.3}).wait(199));

	// txt3
	this.instance_9 = new lib.txt3();
	this.instance_9.parent = this;
	this.instance_9.setTransform(106.9,222.4,1.375,1.375,0,0,0,53.1,14.6);
	...
	mask_3._off = true;
	var mask_3_graphics_66 = new cjs.Graphics().p("AmvUhIDutTMA0vAAAIjtNTg");
	var mask_3_graphics_67 = new cjs.Graphics().p("As9UhIDutTMA0vAAAIjtNTg");
	var mask_3_graphics_68 = new cjs.Graphics().p("AyNUhIDttTMA0vAAAIjtNTg");
	var mask_3_graphics_69 = new cjs.Graphics().p("A2hUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_70 = new cjs.Graphics().p("A53UhIDttTMA0wAAAIjuNTg");
	var mask_3_graphics_71 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_72 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_73 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_132 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_133 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_134 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_135 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_136 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_137 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_138 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_3_graphics_139 = new cjs.Graphics().p("A8TUhIDttTMA0wAAAIjuNTg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(66).to({graphics:mask_3_graphics_66,x:318.2,y:131.3}).wait(1).to({graphics:mask_3_graphics_67,x:278.4,y:131.3}).wait(1).to({graphics:mask_3_graphics_68,x:244.7,y:131.3}).wait(1).to({graphics:mask_3_graphics_69,x:217.2,y:131.3}).wait(1).to({graphics:mask_3_graphics_70,x:195.8,y:131.3}).wait(1).to({graphics:mask_3_graphics_71,x:180.2,y:131.3}).wait(1).to({graphics:mask_3_graphics_72,x:161.8,y:131.3}).wait(1).to({graphics:mask_3_graphics_73,x:155.8,y:131.3}).wait(59).to({graphics:mask_3_graphics_132,x:155.8,y:131.3}).wait(1).to({graphics:mask_3_graphics_133,x:66.2,y:131.3}).wait(1).to({graphics:mask_3_graphics_134,x:-9.5,y:131.3}).wait(1).to({graphics:mask_3_graphics_135,x:-71.5,y:131.3}).wait(1).to({graphics:mask_3_graphics_136,x:-119.7,y:131.3}).wait(1).to({graphics:mask_3_graphics_137,x:-154.2,y:131.3}).wait(1).to({graphics:mask_3_graphics_138,x:-174.8,y:131.3}).wait(1).to({graphics:mask_3_graphics_139,x:-181.2,y:131.3}).wait(265));

	// txt2
	this.instance_10 = new lib.txt2();
	this.instance_10.parent = this;
	this.instance_10.setTransform(100.6,222.4,1.375,1.375,0,0,0,48.5,14.6);
	...
	mask_4._off = true;
	var mask_4_graphics_0 = new cjs.Graphics().p("AmvUhIDutTMA0vAAAIjtNTg");
	var mask_4_graphics_1 = new cjs.Graphics().p("As9UhIDutTMA0vAAAIjtNTg");
	var mask_4_graphics_2 = new cjs.Graphics().p("AyNUhIDttTMA0vAAAIjtNTg");
	var mask_4_graphics_3 = new cjs.Graphics().p("A2hUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_4 = new cjs.Graphics().p("A53UhIDttTMA0wAAAIjuNTg");
	var mask_4_graphics_5 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_6 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_7 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_66 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_67 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_68 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_69 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_70 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_71 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_72 = new cjs.Graphics().p("A8OUhIDutTMA0vAAAIjuNTg");
	var mask_4_graphics_73 = new cjs.Graphics().p("A8TUhIDttTMA0wAAAIjuNTg");

	this.timeline.addTween(cjs.Tween.get(mask_4).to({graphics:mask_4_graphics_0,x:318.2,y:131.3}).wait(1).to({graphics:mask_4_graphics_1,x:278.4,y:131.3}).wait(1).to({graphics:mask_4_graphics_2,x:244.7,y:131.3}).wait(1).to({graphics:mask_4_graphics_3,x:217.2,y:131.3}).wait(1).to({graphics:mask_4_graphics_4,x:195.8,y:131.3}).wait(1).to({graphics:mask_4_graphics_5,x:180.2,y:131.3}).wait(1).to({graphics:mask_4_graphics_6,x:161.8,y:131.3}).wait(1).to({graphics:mask_4_graphics_7,x:155.8,y:131.3}).wait(59).to({graphics:mask_4_graphics_66,x:155.8,y:131.3}).wait(1).to({graphics:mask_4_graphics_67,x:66.2,y:131.3}).wait(1).to({graphics:mask_4_graphics_68,x:-9.5,y:131.3}).wait(1).to({graphics:mask_4_graphics_69,x:-71.5,y:131.3}).wait(1).to({graphics:mask_4_graphics_70,x:-119.7,y:131.3}).wait(1).to({graphics:mask_4_graphics_71,x:-154.2,y:131.3}).wait(1).to({graphics:mask_4_graphics_72,x:-174.8,y:131.3}).wait(1).to({graphics:mask_4_graphics_73,x:-181.2,y:131.3}).wait(331));

	// txt1
	this.instance_11 = new lib.txt1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(129.6,222.3,1.375,1.375,0,0,0,83.2,21.9);
	...
	this.shape_8.setTransform(268.1,186.8,0.562,0.562);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#CB0927").s().p("AkbIYIElwvIERAAIkkQvg");
	this.shape_9.setTransform(262,237.4,0.562,0.562);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#DBDBDA").s().p("Al+LYICSoiIERAAID0uOIBmAAImFWwg");
	this.shape_10.setTransform(262.2,248.3,0.562,0.562);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#DC052B").s().p("AxjFuIAArbMAjHAAAIi+Lbg");
	this.shape_11.setTransform(141.7,222.3,1.25,1.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8}]}).wait(404));

	// rect
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("A6XEBIAAoAMA0vAAAIAAIAg");
	this.shape_12.setTransform(170.3,241.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("A6XEBIAAoAMA0vAAAIAAIAg");
	this.shape_13.setTransform(170.3,461.6);
	...
	this.instance_12.setTransform(120,333.5,1.1,1.1);
	...
	this.instance_13.setTransform(120,333.5,1.1,1.1);
	...
	this.instance_14.setTransform(120,333.5,1.1,1.1);
	...
	this.instance_15.setTransform(120,333.5,1.1,1.1);
	...
	this.instance_16.setTransform(120,333.5,1.1,1.1);
	...
	this.instance_17.setTransform(120,333.5,1.1,1.1);
	...
	// bg
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	this.shape_14.setTransform(150,300);

	this.timeline.addTween(cjs.Tween.get(this.shape_14).wait(404));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138,294.1,351.2,606.5);
// library properties:
lib.properties = {
	width: 300,
	height: 600,

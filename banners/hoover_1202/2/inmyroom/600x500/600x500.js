...
lib.ssMetadata = [
		{name:"600x500_atlas_", frames: [[0,502,600,500],[602,502,600,500],[1204,0,600,500],[602,0,600,500],[0,0,600,500],[1204,502,600,500]]}
];
...
(lib.t6 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(78.9,23.9);
...
(lib.t1 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(72.9,21.4);
...
(lib._600x500 = function(mode,startPosition,loop) {
	...
	this.instance_9.setTransform(251.8,198.7,1.98,1.98,0,0,0,11.7,19.2);
	this.instance_9.alpha = 0.398;

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhUDFIBomJIBCAAIhpGJg");
	this.shape_1.setTransform(293.1,122.6,1.98,1.98);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DD052B").s().p("Au3EEICKoHIblAAIAAIHg");
	this.shape_2.setTransform(438.5,161.5,1.98,1.98);

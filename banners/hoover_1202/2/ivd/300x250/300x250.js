...
lib.ssMetadata = [
		{name:"300x250_atlas_", frames: [[676,282,336,280],[0,0,336,280],[338,0,336,280],[676,0,336,280],[338,282,336,280],[0,282,336,280]]}
];
...
(lib.t6 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(78.9,24.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t6, new cjs.Rectangle(0,-7.5,158.4,61.3), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_9.setTransform(126.9,99.3,0.99,0.99,0,0,0,11.8,19.3);
	this.instance_9.alpha = 0.398;

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhUDFIBomJIBCAAIhpGJg");
	this.shape_1.setTransform(147.6,61.3,0.99,0.99);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DD052B").s().p("Au3EEICKoHIblAAIAAIHg");
	this.shape_2.setTransform(220.3,80.7,0.99,0.99);

...
lib.ssMetadata = [
		{name:"100pcx240_atlas_", frames: [[338,0,336,280],[0,0,336,280],[676,0,336,280],[0,282,336,280],[338,282,336,280]]}
];
...
(lib.p5 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#DD052B").s().p("AiUCVQg+g+AAhXQAAhWA+g+QA+g+BWAAQBYAAA9A+QA+A+AABWQAABXg+A+Qg9A+hYAAQhWAAg+g+gAhfhfQgnAoAAA3QAAA4AnAoQAoAoA3AAQA4AAAogoQAogoAAg4QAAg3gogoQgogog4AAQg3AAgoAog");
	this.shape.setTransform(301.5,211.9,0.27,0.27,0,0,0,0.8,-1.2);
	...
	this.shape_1.setTransform(273.5,57,0.27,0.27);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DD052B").s().p("");
	this.shape_2.setTransform(15.8,208.7,0.27,0.27,0,0,0,-1.1,1.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#DD052B").s().p("");
	this.shape_3.setTransform(21.5,102.3,0.27,0.27);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#DD052B").s().p("AgBAiQgwAAgSAIIAAhLQAXgIAsAAQAugBAWAJIAABLQgUgJgxABg");
	this.shape_4.setTransform(200.4,216,0.27,0.27);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#DD052B").s().p("AjjDkQhehfAAiFQAAiEBehfQBfheCEAAQCFAABfBeQBeBfAACEQAACFheBfQhfBeiFAAQiEAAhfhegAititQhIBIAABlQAABlBIBJQBIBIBlAAQBlAABIhIQBIhJAAhlQAAhlhIhIQhIhHhlgBQhlABhIBHg");
	this.shape_5.setTransform(200.4,226.2,0.27,0.27);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#DD052B").s().p("");
	this.shape_6.setTransform(200.4,226.3,0.27,0.27);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#DD052B").s().p("");
	this.shape_7.setTransform(178.9,33.7,0.27,0.27,0,0,0,1.4,-0.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#DD052B").s().p("");
	this.shape_8.setTransform(39.5,35.5,0.27,0.27,0,0,0,0.9,-1.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#DD052B").s().p("");
	this.shape_9.setTransform(251.4,131.9,0.27,0.27,0,0,0,1.9,-0.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#DD052B").s().p("");
	this.shape_10.setTransform(92.8,66.7,0.27,0.27,0,0,0,-1.7,-1.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#DD052B").s().p("AiUCVQg+g+AAhXQAAhWA+g+QA+g+BWAAQBYAAA9A+QA+A+AABWQAABXg+A+Qg9A+hYAAQhWAAg+g+gAhfhfQgnAoAAA3QAAA4AnAoQAoAoA3AAQA4AAAogoQAogoAAg4QAAg3gogoQgogog4AAQg3AAgoAog");
	this.shape_11.setTransform(168.7,90.1,0.27,0.27,0,0,0,0.8,-1.2);
...
(lib.pic = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-47,59,0.982,0.982,0,0,0,120.1,200);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:-42.8,y:53.6,alpha:1},8,cjs.Ease.get(1)).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(225).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:-42.8,y:53.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(75));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(150).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:-42.8,y:53.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(150));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(75).to({_off:false},0).to({regX:120,scaleX:0.89,scaleY:0.89,x:-42.8,y:53.6,alpha:1},8,cjs.Ease.get(1)).to({_off:true},76).wait(225));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:120,scaleX:0.89,scaleY:0.89,x:-42.8,y:53.6,alpha:1},8).to({_off:true},76).wait(300));

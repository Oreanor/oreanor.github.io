...
lib.ssMetadata = [
		{name:"1170x120_atlas_", frames: [[0,0,298,274],[600,0,298,274],[300,0,298,274],[0,276,298,274],[300,276,298,274]]}
];
...
(lib._1 = function() {
	this.spriteSheet = ss["1170x120_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._1170x120 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EhLsgTcMCXZAAAMAAAAm5MiXZAAAg");
	this.shape.setTransform(585,60,1.206,0.478);
	...
	this.uznat.setTransform(1061.6,60,0.8,0.8);
	...
	this.legal.setTransform(495.3,110.2,1,1,0,0,0,0.3,17.6);
	...
	this.logo.setTransform(141.6,61.4,1.3,1.3,0,0,0,0.1,-0.1);
	...
	this.pics.setTransform(371.6,84.1,0.6,0.6,0,0,0,0.3,0.3);
	...
	this.text.setTransform(720.3,59.1);
	...
	this.bg = new lib.bg();
	this.bg.parent = this;
	this.bg.setTransform(0,60,2.925,0.48,0,0,0,0,125);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(380));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(584.5,56.9,1171,174);
// library properties:
lib.properties = {
	width: 1170,
	height: 120,
	...
	webfonts: {},
	manifest: [
		{src:"images/1170x120_atlas_.jpg", id:"1170x120_atlas_"}
	],
	preloads: []
};

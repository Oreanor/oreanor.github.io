...
lib.ssMetadata = [
		{name:"100pcx400_atlas_NP_", frames: [[0,402,400,400],[402,0,400,400],[0,0,400,400]]}
];
...
}).prototype = getMCSymbolPrototype(lib.bgwhite, new cjs.Rectangle(0,0,300,400), null);
...
(lib.pics2copy2 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(150,156,1,1,0,0,0,150,136);
	this.instance_2.alpha = 0;
...
(lib.pics4 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A/KMgIAA4/MA+VAAAIAAY/g");
...
}).prototype = getMCSymbolPrototype(lib.pics4, new cjs.Rectangle(-200,-80,399.1,160), null);
...
p.nominalBounds = new cjs.Rectangle(19.1,200,731,408.1);
// library properties:
lib.properties = {
	width: 300,
	height: 400,

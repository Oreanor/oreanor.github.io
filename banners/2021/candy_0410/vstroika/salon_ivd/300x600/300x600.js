...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[0,0,300,274],[604,252,300,250],[604,0,300,250],[302,0,300,274]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	this.shape_6.setTransform(151.35,39.25);
	...
	this.shape_7.setTransform(135.45,39.175);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#00A7E0").s().p("AAxBZIgxiDIgvCDIglAAIBHixIAcAAIBGCxg");
	this.shape_8.setTransform(119.275,39.175);
	...
	this.shape_9.setTransform(100.575,39.25);
	...
	this.shape_10.setTransform(83.95,39.175);
	...
	this.shape_21.setTransform(105.25,9.175);
	...
	this.shape_22.setTransform(91.175,9.175);
	...
	this.shape_25.setTransform(44.675,9.25);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#00A7E0").s().p("AgrBZIAAixIBXAAIAAAgIg2AAIAACRg");
	this.shape_26.setTransform(30.125,9.175);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(178).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(60).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(118));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// t5
	this.instance_4 = new lib.t5();
	this.instance_4.parent = this;
	this.instance_4.setTransform(150.05,429,0.9,0.9,0,0,0,121,25.7);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(178).to({_off:false},0).to({regX:120.9,scaleX:1,scaleY:1,x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:121,scaleX:0.9,scaleY:0.9,x:150.05,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t3
	this.instance_5 = new lib.t3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(150,429.05,0.9,0.9,0,0,0,98.1,39.9);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({regY:39.8,scaleX:1,scaleY:1,y:429,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:39.9,scaleX:0.9,scaleY:0.9,y:429.05,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(58));

	// t2
	this.instance_6 = new lib.t2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(149.95,429.05,0.9,0.9,0,0,0,109.5,26.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.9,scaleY:0.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(118));

	// t1
	this.instance_7 = new lib.t1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150,429,0.9,0.9,0,0,0,121.2,24.3);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regY:24.2,scaleX:1,scaleY:1,y:428.95,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:24.3,scaleX:0.9,scaleY:0.9,y:429,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// Слой 4
	this.instance_8 = new lib.butt();
	this.instance_8.parent = this;
	this.instance_8.setTransform(149.75,507.25);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(178).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(54).to({alpha:0},5,cjs.Ease.get(1)).wait(1));
	...
	this.shape_1.setTransform(156.2544,55.4998);
	...
	this.shape_2.setTransform(239.425,570.8);
	...
	this.shape_3.setTransform(234.4,570.85);
	...
	this.shape_4.setTransform(229.325,570.8);
	...
	this.shape_7.setTransform(214.275,570.8);
	...
	this.shape_8.setTransform(209.3,570.85);
	...
	this.shape_16.setTransform(165.275,570.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#737373").s().p("AgSAfIAAg9IAlAAIAAAHIgcAAIAAA2g");
	this.shape_17.setTransform(160.375,570.8);
	...
	this.shape_18.setTransform(154.225,570.8);
	...
	this.shape_21.setTransform(135.925,570.8);
	...
	this.shape_24.setTransform(120.775,570.85);
	...
	this.shape_30.setTransform(85.95,570.8);
	...
	this.shape_34.setTransform(61.775,572.45);
	...
	this.shape_35.setTransform(280.275,564.025);
	...
	this.shape_36.setTransform(276.775,560.875);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#737373").s().p("AgKADIAAgFIAVAAIAAAFg");
	this.shape_37.setTransform(272.65,561.375);
	...
	this.shape_38.setTransform(268.475,560.85);
	...
	this.shape_39.setTransform(261.275,560.875);
	...
	this.shape_40.setTransform(256.25,561.775);
	...
	this.shape_41.setTransform(251.75,561.775);
	...
	this.shape_44.setTransform(237.65,561.775);
	...
	this.shape_45.setTransform(231.625,562.525);
	...
	this.shape_46.setTransform(225.175,561.775);
	...
	this.shape_47.setTransform(220.55,560.875);
	...
	this.shape_48.setTransform(212.75,562.525);
	...
	this.shape_49.setTransform(208.05,561.775);
	...
	this.shape_50.setTransform(203.9,561.775);
	...
	this.shape_51.setTransform(199.125,561.775);
	...
	this.shape_52.setTransform(194.325,562.475);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#737373").s().p("AAPAfIAAg2IgdAAIAAA2IgJAAIAAg9IAvAAIAAA9g");
	this.shape_53.setTransform(188.625,560.875);
	...
	this.shape_54.setTransform(182.25,564.025);
	...
	this.shape_55.setTransform(178.95,561.775);
	...
	this.shape_56.setTransform(174.875,561.775);
	...
	this.shape_57.setTransform(170.575,561.775);
	...
	this.shape_58.setTransform(166.05,561.775);
	...
	this.shape_59.setTransform(161.425,561.775);
	...
	this.shape_63.setTransform(140.45,564.025);
	...
	this.shape_66.setTransform(126.775,560.875);
	...
	this.shape_75.setTransform(87.65,563.475);
	...
	this.shape_76.setTransform(83.825,560.875);
	...
	this.shape_77.setTransform(75.3,560.875);
	...
	this.shape_80.setTransform(55.525,560.875);
	...
	this.shape_81.setTransform(50,560.875);
	...
	this.shape_82.setTransform(44.795,561.675);
	...
	this.shape_83.setTransform(37.275,560.875);
	...
	this.shape_84.setTransform(30.3,560.875);
	...
	this.shape_85.setTransform(23.325,560.875);
	...
	this.shape_87.setTransform(73.775,534.475);
	...
	this.shape_88.setTransform(73.775,534.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_88},{t:this.shape_87},{t:this.shape_86}]}).wait(244));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(140,299.5,170,301);
// library properties:
lib.properties = {
	id: '9802C3B962962C478555C47E512D00A7',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['9802C3B962962C478555C47E512D00A7'] = {

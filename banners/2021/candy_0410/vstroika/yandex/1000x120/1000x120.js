...
lib.ssMetadata = [
		{name:"1000x120_atlas_", frames: [[0,0,298,274],[300,252,300,250],[300,0,300,250],[0,276,298,274]]}
];
...
(lib._1 = function() {
	this.initialize(ss["1000x120_atlas_"]);
	this.gotoAndStop(0);
...
(lib.pics = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(10,-17.65);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(150).to({_off:false},0).to({x:0,y:-18.35,alpha:1},6,cjs.Ease.get(1)).to({_off:true},74).wait(75));
...
p.nominalBounds = new cjs.Rectangle(-159,-163.4,320,308.4);
...
(lib._1000x120 = function(mode,startPosition,loop) {
	...
	this.uznat.setTransform(891.55,54.95,0.7,0.7);
	this.uznat._off = true;

	this.timeline.addTween(cjs.Tween.get(this.uznat).wait(226).to({_off:false},0).wait(81));

	// legal
	this.legal = new lib.legal();
	this.legal.name = "legal";
	this.legal.parent = this;
	this.legal.setTransform(469.25,110.2,1,1,0,0,0,0.3,17.6);

	this.timeline.addTween(cjs.Tween.get(this.legal).wait(307));

	// logo
	this.logo = new lib.logo();
	this.logo.name = "logo";
	this.logo.parent = this;
	this.logo.setTransform(111.55,59.35,1,1,0,0,0,0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.logo).wait(307));
	...
	this.timeline.addTween(cjs.Tween.get(this.pics).wait(307));

	// text
	this.text = new lib.main();
	this.text.name = "text";
	this.text.parent = this;
	this.text.setTransform(590.3,56.55,0.9,0.9,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(307));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg).wait(307));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(499.5,56.9,501,114);
// library properties:
lib.properties = {
	id: 'CA3877575E1D8F40AAFBB9B171743AD6',
	width: 1000,
	height: 120,
	fps: 25,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/1000x120_atlas_.jpg", id:"1000x120_atlas_"}
	],
	preloads: []
};
...
an.compositions['CA3877575E1D8F40AAFBB9B171743AD6'] = {

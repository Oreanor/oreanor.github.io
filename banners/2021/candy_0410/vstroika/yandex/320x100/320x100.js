...
lib.ssMetadata = [
		{name:"320x100_atlas_", frames: [[242,0,240,200],[0,202,240,200],[0,0,240,200],[242,202,240,200]]}
];
...
(lib._1 = function() {
	this.initialize(ss["320x100_atlas_"]);
	this.gotoAndStop(0);
...
(lib.fff = function(mode,startPosition,loop) {
	...
	this.shape_3.setTransform(7.8311,0.4092,0.6,0.6);
	...
	this.shape_4.setTransform(2.2062,0.4242,0.6,0.6);
	...
	this.shape_7.setTransform(-14.7135,0.4242,0.6,0.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AARAvIAAhMIghAAIAABMIgSAAIAAhdIBEAAIAABdg");
	this.shape_8.setTransform(-20.5034,0.4092,0.6,0.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#00A7E0").s().p("An6CDIAAkFIP1AAIAAEFg");
	this.shape_9.setTransform(0.0163,0.0192,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-30.3,-7.8,60.7,15.7);
...
(lib._320x100 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(160,49.925);
	...
	this.instance.parent = this;
	this.instance.setTransform(264.15,26.7,0.4487,0.4487,0,0,0,0.2,0.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(159).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.5609,scaleY:0.5609,x:264.1,y:26.6,alpha:1},6,cjs.Ease.get(1)).wait(47).to({regX:0.2,regY:0.2,scaleX:0.4487,scaleY:0.4487,x:264.15,y:26.7,alpha:0},6,cjs.Ease.get(1)).wait(1));

	// t3
	this.instance_1 = new lib.t3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(263.85,37.55,0.4487,0.4487,0,0,0,0.4,0.4);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(106).to({_off:false},0).to({regX:0.1,regY:0.2,scaleX:0.5609,scaleY:0.5609,x:263.6,y:37.4,alpha:1},6,cjs.Ease.get(1)).wait(47).to({regX:0.4,regY:0.4,scaleX:0.4487,scaleY:0.4487,x:263.85,y:37.55,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(53));

	// t2
	this.instance_2 = new lib.t2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(264.1,36.6,0.4487,0.4487,0,0,0,0.2,0.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(53).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.5609,scaleY:0.5609,x:264.05,y:36.55,alpha:1},6,cjs.Ease.get(1)).wait(47).to({regX:0.2,regY:0.2,scaleX:0.4487,scaleY:0.4487,x:264.1,y:36.6,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(106));

	// t1
	this.instance_3 = new lib.t1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(264.15,36.6,0.4487,0.4487,0,0,0,0.2,0.2);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:0.1,regY:0.1,scaleX:0.5609,scaleY:0.5609,x:264.05,y:36.55,alpha:1},6,cjs.Ease.get(1)).wait(47).to({regX:0.2,regY:0.2,scaleX:0.4487,scaleY:0.4487,x:264.15,y:36.6,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(159));

	// 5.jpg
	this.instance_4 = new lib.pic5();
	this.instance_4.parent = this;
	this.instance_4.setTransform(147.5,51,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(106).to({_off:false},0).to({x:148.5,alpha:1},6,cjs.Ease.get(1)).wait(47).to({x:147.5},0).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(53));
	...
	// Слой 2
	this.instance_8 = new lib.fff("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(263,55.6);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.instance_9 = new lib.fdddd("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(263,56.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(159).to({_off:false},0).to({_off:true,y:56.1,alpha:1},6,cjs.Ease.get(1)).wait(54));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(159).to({_off:false},6,cjs.Ease.get(1)).wait(47).to({y:56},0).to({y:55.6,alpha:0},6,cjs.Ease.get(0.99)).wait(1));

	// fon
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("");
	this.shape_1.setTransform(264.4,84.55,1,1,0,0,0,-0.1,0.5);
	...
	this.shape_2.setTransform(45,47.1,0.5,0.5,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(219));

	// bg
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("A4/H0IAAvnMAx/AAAIAAPng");
	this.shape_3.setTransform(160,50);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(219));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(159.5,49.5,161,51.5);
// library properties:
lib.properties = {
	id: 'D8BC4E2D28A6E54F8CBF66589DD0AE50',
	width: 320,
	height: 100,
	fps: 25,
	color: "#FFFFFF",
...
an.compositions['D8BC4E2D28A6E54F8CBF66589DD0AE50'] = {

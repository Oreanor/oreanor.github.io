...
lib.ssMetadata = [
		{name:"300x250_atlas_NP_", frames: [[0,137,300,135],[0,411,300,135],[0,0,300,135],[0,274,300,135]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	this.shape_6.setTransform(86.775,22.3);
	...
	this.shape_9.setTransform(57.675,22.3);
	...
	this.shape_10.setTransform(48.15,22.25);
	...
	this.shape_21.setTransform(60.35,5.25);
	...
	this.shape_22.setTransform(52.3,5.25);
	...
	this.shape_26.setTransform(17.25,5.25);
...
(lib.t3 = function(mode,startPosition,loop) {
	...
	// Слой_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00A7E0").s().p("");
	this.shape.setTransform(96.55,5.425);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t3, new cjs.Rectangle(-16.1,-4.5,226.9,19.5), null);
...
(lib.t2 = function(mode,startPosition,loop) {
	...
	// Слой_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00A7E0").s().p("");
	this.shape.setTransform(57.7,11.85);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t2, new cjs.Rectangle(-41,1.1,194,19.599999999999998), null);
...
(lib.t1 = function(mode,startPosition,loop) {
	...
	this.shape_20.setTransform(-6.425,9.875);
...
(lib.butt = function(mode,startPosition,loop) {
	...
	this.shape_3.setTransform(11.025,0.575);
	...
	this.shape_4.setTransform(3.125,0.6);
...
}).prototype = getMCSymbolPrototype(lib.butt, new cjs.Rectangle(-42.6,-11,85.30000000000001,22.1), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(119.15,233.7,1.008,1.008,0,0,0,69.4,14.8);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(178).to({_off:false},0).to({regY:14.7,scaleX:1.12,scaleY:1.12,x:119.2,y:233.55,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:14.8,scaleX:1.008,scaleY:1.008,x:119.15,y:233.7,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t3
	this.instance_1 = new lib.t3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(163.9,233.65,1.008,1.008,0,0,0,91.5,14.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).to({scaleX:1.12,scaleY:1.12,x:163.95,y:233.55,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.008,scaleY:1.008,x:163.9,y:233.65,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(58));

	// t2
	this.instance_2 = new lib.t2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(169.6,228.1,1.008,1.008,0,0,0,59.6,14.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(60).to({_off:false},0).to({regY:14,scaleX:1.12,scaleY:1.12,y:227.95,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:14.1,scaleX:1.008,scaleY:1.008,y:228.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(118));

	// t1
	this.instance_3 = new lib.t1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(169.55,228.05,1.008,1.008,0,0,0,64.4,12.8);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:1.12,scaleY:1.12,x:169.6,y:227.95,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.008,scaleY:1.008,x:169.55,y:228.05,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// 5.jpg
	this.instance_4 = new lib.p5();
	this.instance_4.parent = this;
	this.instance_4.setTransform(180.2,120.35,1.12,1.12,0,0,0,150,67.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(178).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.85,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// 3.jpg
	this.instance_5 = new lib.p3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(180.2,120.35,1.12,1.12,0,0,0,150,67.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.85,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(58));

	// 2.jpg
	this.instance_6 = new lib.p2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(180.2,120.35,1.12,1.12,0,0,0,150,67.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.85,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(118));

	// 1.jpg
	this.instance_7 = new lib.p1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(180.2,120.35,1.12,1.12,0,0,0,150,67.5);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.85,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// Слой 3
	this.instance_8 = new lib.butt();
	this.instance_8.parent = this;
	this.instance_8.setTransform(279.45,233.55,1.12,1.12);
	...
	this.shape_1.setTransform(174.2601,21.3869,1.12,1.12);
	...
	this.shape_2.setTransform(321.135,269.5504,1.12,1.12);
	...
	this.shape_3.setTransform(317.691,269.5504,1.12,1.12);
	...
	this.shape_4.setTransform(314.219,269.5224,1.12,1.12);
	...
	this.shape_5.setTransform(310.803,269.5504,1.12,1.12);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#737373").s().p("AgIATIAQggIgSAAIgCgBIAAgBIAAgDIAZAAIAAAEIgPAfIgBACIgCAAg");
	this.shape_6.setTransform(307.359,269.5224,1.12,1.12);
	...
	this.shape_7.setTransform(303.8871,269.5504,1.12,1.12);
	...
	this.shape_8.setTransform(300.4431,269.5504,1.12,1.12);
	...
	this.shape_12.setTransform(286.5271,269.5224,1.12,1.12);
	...
	this.shape_16.setTransform(270.2032,269.5224,1.12,1.12);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#737373").s().p("AgLATIAAglIAXAAIAAAEIgRAAIAAAhg");
	this.shape_17.setTransform(266.8152,269.5224,1.12,1.12);
	...
	this.shape_18.setTransform(262.6152,269.5504,1.12,1.12);
	...
	this.shape_19.setTransform(256.9313,269.5504,1.12,1.12);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#737373").s().p("AgIATIAAgEIAIAAIAAgaIgHAFIAAABIgBAAIgBgBIgBgCIAKgKIAEAAIAAAhIAHAAIAAAEg");
	this.shape_20.setTransform(253.5433,269.5224,1.12,1.12);
	...
	this.shape_21.setTransform(250.0433,269.5504,1.12,1.12);
	...
	this.shape_24.setTransform(239.6273,269.5504,1.12,1.12);
	...
	this.shape_25.setTransform(236.1274,269.5224,1.12,1.12);
	...
	this.shape_31.setTransform(211.1515,269.5224,1.12,1.12);
	...
	this.shape_32.setTransform(205.6075,269.5504,1.12,1.12);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#737373").s().p("AgBADIgBAAIgBgBIAAgDIACgCIACAAIACABIAAABIABABIgBACIAAABIgCAAIgBAAg");
	this.shape_33.setTransform(201.6875,271.3424,1.12,1.12);
	...
	this.shape_34.setTransform(199.0835,270.6704,1.12,1.12);
	...
	this.shape_35.setTransform(195.0515,271.7064,1.12,1.12);
	...
	this.shape_36.setTransform(192.6435,269.5224,1.12,1.12);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#737373").s().p("AgFACIAAgDIALAAIAAADg");
	this.shape_37.setTransform(189.8156,269.8864,1.12,1.12);
	...
	this.shape_38.setTransform(186.9596,269.5224,1.12,1.12);
	...
	this.shape_39.setTransform(182.0036,269.5224,1.12,1.12);
	...
	this.shape_40.setTransform(178.5876,270.1664,1.12,1.12);
	...
	this.shape_41.setTransform(175.4516,270.1664,1.12,1.12);
	...
	this.shape_42.setTransform(172.3436,270.1664,1.12,1.12);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#737373").s().p("AAGANIAAgMIgLAAIAAAMIgFAAIAAgaIAFAAIAAALIALAAIAAgLIAGAAIAAAag");
	this.shape_43.setTransform(169.2076,270.1664,1.12,1.12);
	...
	this.shape_44.setTransform(165.7917,270.1664,1.12,1.12);
	...
	this.shape_45.setTransform(161.6197,270.6704,1.12,1.12);
	...
	this.shape_46.setTransform(157.1957,270.1664,1.12,1.12);
	...
	this.shape_47.setTransform(154.0317,269.5224,1.12,1.12);
	...
	this.shape_48.setTransform(148.6837,270.6704,1.12,1.12);
	...
	this.shape_49.setTransform(145.4358,270.1664,1.12,1.12);
	...
	this.shape_50.setTransform(142.6078,270.1664,1.12,1.12);
	...
	this.shape_51.setTransform(139.3038,270.1664,1.12,1.12);
	...
	this.shape_52.setTransform(135.9998,270.6424,1.12,1.12);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#737373").s().p("AAJATIAAghIgRAAIAAAhIgGAAIAAglIAdAAIAAAlg");
	this.shape_53.setTransform(132.1078,269.5224,1.12,1.12);
	...
	this.shape_54.setTransform(127.7118,271.7064,1.12,1.12);
	...
	this.shape_55.setTransform(125.4438,270.1664,1.12,1.12);
	...
	this.shape_56.setTransform(122.6439,270.1664,1.12,1.12);
	...
	this.shape_57.setTransform(119.6759,270.1664,1.12,1.12);
	...
	this.shape_58.setTransform(116.5679,270.1664,1.12,1.12);
	...
	this.shape_59.setTransform(113.4319,270.1664,1.12,1.12);
	...
	this.shape_63.setTransform(98.984,271.7064,1.12,1.12);
	...
	this.shape_66.setTransform(89.576,269.5224,1.12,1.12);
	...
	this.shape_76.setTransform(60.0921,269.5504,1.12,1.12);
	...
	this.shape_77.setTransform(54.2121,269.5224,1.12,1.12);
	...
	this.shape_78.setTransform(49.5082,270.0264,1.12,1.12);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#737373").s().p("AAKATIAAgRIgTAAIAAARIgFAAIAAglIAFAAIAAARIATAAIAAgRIAFAAIAAAlg");
	this.shape_79.setTransform(44.9442,269.5224,1.12,1.12);
	...
	this.shape_80.setTransform(40.6322,269.5224,1.12,1.12);
	...
	this.shape_81.setTransform(36.8522,269.5224,1.12,1.12);
	...
	this.shape_82.setTransform(33.2402,270.0824,1.12,1.12);
	...
	this.shape_83.setTransform(28.0883,269.5504,1.12,1.12);
	...
	this.shape_84.setTransform(23.3283,269.5504,1.12,1.12);
	...
	this.shape_85.setTransform(18.5123,269.5504,1.12,1.12);
...
p.nominalBounds = new cjs.Rectangle(157.9,139.5,190.29999999999998,141);
// library properties:
lib.properties = {
	id: 'A3442A427B5A114C9AE9BBE4A2962BC9',
	width: 336,
	height: 280,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['A3442A427B5A114C9AE9BBE4A2962BC9'] = {

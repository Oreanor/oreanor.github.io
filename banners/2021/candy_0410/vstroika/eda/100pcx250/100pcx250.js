...
lib.ssMetadata = [
		{name:"100pcx250_atlas_NP_", frames: [[402,402,400,400],[402,0,400,400],[0,402,400,400],[0,0,400,400]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	this.shape_3.setTransform(136.3,83.5,0.72,0.72);
	...
	this.shape_4.setTransform(123.3,83.5,0.72,0.72);
	...
	this.shape_14.setTransform(175.5,42.3,0.975,0.975);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#00A7E0").s().p("AgPBZIAAiRIghAAIAAggIBhAAIAAAgIggAAIAACRg");
	this.shape_15.setTransform(163.4,42.3,0.975,0.975);
	...
	this.shape_16.setTransform(149.5,42.4,0.975,0.975);
	...
	this.shape_17.setTransform(134,42.3,0.975,0.975);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#00A7E0").s().p("AAxBZIgxiDIgvCDIglAAIBHixIAcAAIBGCxg");
	this.shape_18.setTransform(118.2,42.3,0.975,0.975);
	...
	this.shape_19.setTransform(100,42.4,0.975,0.975);
	...
	this.shape_20.setTransform(83.8,42.3,0.975,0.975);
	...
	this.shape_31.setTransform(104.6,13,0.975,0.975);
	...
	this.shape_32.setTransform(90.8,13,0.975,0.975);
	...
	this.shape_33.setTransform(73.8,13.1,0.975,0.975);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#00A7E0").s().p("AgQBZIAAiRIggAAIAAggIBhAAIAAAgIghAAIAACRg");
	this.shape_34.setTransform(59.6,13,0.975,0.975);
	...
	this.shape_35.setTransform(45.5,13.1,0.975,0.975);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#00A7E0").s().p("AgrBZIAAixIBXAAIAAAgIg2AAIAACRg");
	this.shape_36.setTransform(31.3,13,0.975,0.975);
...
}).prototype = getMCSymbolPrototype(lib.t5, new cjs.Rectangle(2,4.1,235.8,96.7), null);
...
(lib.bg = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Egu3AfQMAAAg+fMBdvAAAMAAAA+fg");
	this.shape.setTransform(150,150,0.5,0.75);
...
(lib.pics2copy2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(231).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(61).to({alpha:0},6,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(162).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(61).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(69));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(82).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).to({_off:true},81).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:1},6,cjs.Ease.get(1)).to({_off:true},83).wait(216));
...
(lib.pics2copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(233).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(59).to({alpha:0},6,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(165).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(60).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(82).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).to({_off:true},84).wait(133));
...
(lib.pics4 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A/PJYIAAyvMA+fAAAIAASvg");
...
}).prototype = getMCSymbolPrototype(lib.pics4, new cjs.Rectangle(-200,-60,400,120), null);
...
(lib._100pcx250 = function(mode,startPosition,loop) {
	...
	this.pics4.setTransform(150.5,150);
	...
	this.pics3.setTransform(108.9,130.2,0.75,0.75);
	...
	this.pics2.setTransform(205.6,130.2,0.75,0.75);
	...
	this.pics.setTransform(162.1,130.2,0.75,0.75);
...
p.nominalBounds = new cjs.Rectangle(78.9,-17,641.7,532.1);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_4.setTransform(150.1,429,0.9,0.9,0,0,0,121,25.7);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(178).to({_off:false},0).to({regX:120.9,scaleX:1,scaleY:1,x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:121,scaleX:0.9,scaleY:0.9,x:150.1,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t3
	this.instance_5 = new lib.t3();
	this.instance_5.parent = this;
	this.instance_5.setTransform(150,429.1,0.9,0.9,0,0,0,98.1,39.9);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({regY:39.8,scaleX:1,scaleY:1,y:429,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:39.9,scaleX:0.9,scaleY:0.9,y:429.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(58));

	// t2
	this.instance_6 = new lib.t2();
	this.instance_6.parent = this;
	this.instance_6.setTransform(150.1,429.1,0.9,0.9,0,0,0,109.6,26.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({scaleX:1,scaleY:1,y:429.1,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:0.9,scaleY:0.9,y:429,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// Слой 4
	this.instance_8 = new lib.butt();
	this.instance_8.parent = this;
	this.instance_8.setTransform(149.8,507.3);

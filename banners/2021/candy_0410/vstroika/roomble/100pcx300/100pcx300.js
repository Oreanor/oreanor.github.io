...
lib.ssMetadata = [
		{name:"100pcx300_atlas_NP_", frames: [[402,402,400,400],[0,0,400,400],[0,402,400,400],[402,0,400,400]]}
];
...
(lib.t5 = function(mode,startPosition,loop) {
	...
	this.shape_3.setTransform(138.3,84.4,0.8,0.8);
	...
	this.shape_4.setTransform(123.9,84.4,0.8,0.8);
...
}).prototype = getMCSymbolPrototype(lib.t5, new cjs.Rectangle(2,0.9,235.8,102.7), null);
...
(lib.pics4 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A/KK8IAA13MA+VAAAIAAV3g");
...
}).prototype = getMCSymbolPrototype(lib.pics4, new cjs.Rectangle(-200,-70,399.1,140), null);
...
(lib._100pcx300 = function(mode,startPosition,loop) {
	...
	this.pics3.setTransform(108.9,150.2,0.75,0.75);
	...
	this.pics2.setTransform(205.6,150.2,0.75,0.75);
	...
	this.pics.setTransform(162.1,150.2,0.75,0.75);
...
p.nominalBounds = new cjs.Rectangle(78.9,8,641.7,532.1);
// library properties:
lib.properties = {
	width: 300,
	height: 300,

...
lib.ssMetadata = [
		{name:"100pcx300_atlas_P_", frames: [[0,0,317,121],[0,123,254,32]]},
		{name:"100pcx300_atlas_NP_", frames: [[0,0,400,400],[0,402,400,400],[402,0,400,400],[402,402,400,400]]}
];
...
(lib.p4 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(170.9,158.6);

	// Слой_1
	this.instance = new lib._4();
	this.instance.parent = this;
	this.instance.setTransform(45,35,0.775,0.775);
...
(lib.pics2copy2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-14.4,-14.2,0.378,0.378,0,0,0,156.1,140.8);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-50,6,1,1,0,0,0,150,136);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-50,16,1,1,0,0,0,150,136);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;
...
(lib.pics2copy = function(mode,startPosition,loop) {
	...
	this.instance = new lib.p4();
	this.instance.parent = this;
	this.instance.setTransform(-33.1,-19,0.7,0.7,0,0,0,156.3,140.8);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.instance_2 = new lib.p2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-32,-64,1,1,0,0,0,150,136);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;
	...
	this.instance_3 = new lib.p1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-146,-64,1,1,0,0,0,150,136);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:1},6,cjs.Ease.get(1)).to({_off:true},92).wait(271));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-296,-200,400,400);
...
}).prototype = getMCSymbolPrototype(lib.pics4, new cjs.Rectangle(-199.9,-60,399.9,120), null);
...
(lib._100pcx300 = function(mode,startPosition,loop) {
	...
	this.pics3.setTransform(87.6,150,0.75,0.75);
	...
	this.pics2.setTransform(184.4,150,0.75,0.75);
	...
	this.pics.setTransform(130,150,0.75,0.75);
...
p.nominalBounds = new cjs.Rectangle(15.6,150,734.4,418.1);
// library properties:
lib.properties = {
	width: 300,
	height: 300,

...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[0,0,300,274],[302,276,300,250],[302,0,300,274],[604,0,300,274],[0,276,300,274]]}
];
...
(lib.text2 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#737373").s().p("");
...
(lib.t3 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00A7E0").s().p("");
	this.shape.setTransform(97.7,40.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.t3, new cjs.Rectangle(0.5,14.3,194.4,53.2), null);
...
}).prototype = getMCSymbolPrototype(lib.butt, new cjs.Rectangle(-97.6,-25.2,195.2,50.5), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_10.setTransform(149.8,507.3);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(240).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(54).to({alpha:0},5,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_11 = new lib.text2();
	this.instance_11.parent = this;
	this.instance_11.setTransform(149.2,548.3);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(120).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(107).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(66));
	...
	this.shape_86.graphics.f("#FFFFFF").s().p("EgXbAu4MAAAhdvMAu3AAAMAAABdvg");
	this.shape_86.setTransform(150,300);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f().s("#000000").ss(1,1,1).p("Ag3g7IAAgZICBAAIAABIIhXAAIAAAMIgqAAIAAg7IAqAAIAAAvAnWBDIAAASIhXAAIAAhWIBXAAIAAAOAnWBDIg+AAIAAg2IA+AAIQEAAIAAA2g");
	this.shape_87.setTransform(73.8,534.5);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("#00FF00").s().p("AotBVIAAhWIBXAAIAAAOIQEAAIAAA2IwEAAIg+AAIAAg2IA+AAIg+AAIAAA2IA+AAIAAASgAg3AAIAAg7IAqAAIAAAvIAAgvIgqAAIAAgZICBAAIAABIIhXAAIAAAMg");
	this.shape_88.setTransform(73.8,534.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_88},{t:this.shape_87},{t:this.shape_86}]}).wait(306));

...
lib.ssMetadata = [
		{name:"375x290_atlas_", frames: [[0,162,375,160],[0,648,375,160],[0,0,375,160],[0,324,375,160],[0,486,375,160]]}
];
...
(lib._375x290 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(187.5,270.7,1.288,1.288,0,0,0,0.1,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.instance_1 = new lib.butt();
	this.instance_1.parent = this;
	this.instance_1.setTransform(302.4,249.6,1.226,1.226,0,0,0,0.1,0.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(120).to({_off:false},0).to({alpha:1},7,cjs.Ease.get(1)).wait(106).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(66));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(240).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(53).to({alpha:0},6,cjs.Ease.get(1)).wait(1));

	// t5
	this.instance_2 = new lib.t5();
	this.instance_2.parent = this;
	this.instance_2.setTransform(125.7,249.2,1.069,1.069,0,0,0,69.4,14.7);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(240).to({_off:false},0).to({regX:69.5,regY:14.8,scaleX:1.19,scaleY:1.19,x:125.9,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:69.4,regY:14.7,scaleX:1.07,scaleY:1.07,x:125.7,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// t4
	this.instance_3 = new lib.t4();
	this.instance_3.parent = this;
	this.instance_3.setTransform(185.7,261.6,1.069,1.069,0,0,0,70,14.7);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(180).to({_off:false},0).to({regY:14.8,scaleX:1.19,scaleY:1.19,y:262.8,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:14.7,scaleX:1.07,scaleY:1.07,y:261.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// t3
	this.instance_4 = new lib.t3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(178,260.2,1.069,1.069,0,0,0,91.5,14.2);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(120).to({_off:false},0).to({regY:14.3,scaleX:1.19,scaleY:1.19,x:177.1,y:261.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:14.2,scaleX:1.07,scaleY:1.07,x:178,y:260.2,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// t2
	this.instance_5 = new lib.t2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(189,253.5,1.069,1.069,0,0,0,59.6,14.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(60).to({_off:false},0).to({regY:14,scaleX:1.19,scaleY:1.19,x:189.3,y:253.6,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regY:14.1,scaleX:1.07,scaleY:1.07,x:189,y:253.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// t1
	this.instance_6 = new lib.t1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(187.7,254.7,1.069,1.069,0,0,0,64.5,12.8);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:64.4,regY:12.9,scaleX:1.19,scaleY:1.19,y:255.2,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:64.5,regY:12.8,scaleX:1.07,scaleY:1.07,y:254.7,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));

	// 5.jpg
	this.instance_7 = new lib.p5();
	this.instance_7.parent = this;
	this.instance_7.setTransform(160,127.5,1,1,0,0,0,150,67.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(240).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// 4.jpg
	this.instance_8 = new lib.p4();
	this.instance_8.parent = this;
	this.instance_8.setTransform(160,127.5,1,1,0,0,0,150,67.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(180).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(120).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// 2.jpg
	this.instance_10 = new lib.p2();
	this.instance_10.parent = this;
	this.instance_10.setTransform(160,127.5,1,1,0,0,0,150,67.5);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(60).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// 1.jpg
	this.instance_11 = new lib.p1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(160,127.5,1,1,0,0,0,150,67.5);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:140,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));
	...
	this.shape_1.setTransform(185.2,29.2,1.25,1.25);
	...
	this.shape_2.setTransform(349.1,281.2,1.25,1.25);
	...
	this.shape_3.setTransform(345.3,281.2,1.25,1.25);
	...
	this.shape_4.setTransform(341.4,281.2,1.25,1.25);
	...
	this.shape_5.setTransform(337.6,281.2,1.25,1.25);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#737373").s().p("AgIATIAQggIgSAAIgCgBIAAgBIAAgDIAZAAIAAAEIgPAfIgBACIgCAAg");
	this.shape_6.setTransform(333.7,281.2,1.25,1.25);
	...
	this.shape_7.setTransform(329.9,281.2,1.25,1.25);
	...
	this.shape_8.setTransform(326,281.2,1.25,1.25);
	...
	this.shape_12.setTransform(310.5,281.2,1.25,1.25);
	...
	this.shape_16.setTransform(292.3,281.2,1.25,1.25);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#737373").s().p("AgLATIAAglIAXAAIAAAEIgRAAIAAAhg");
	this.shape_17.setTransform(288.5,281.2,1.25,1.25);
	...
	this.shape_18.setTransform(283.8,281.2,1.25,1.25);
	...
	this.shape_21.setTransform(269.8,281.2,1.25,1.25);
	...
	this.shape_24.setTransform(258.1,281.2,1.25,1.25);
	...
	this.shape_25.setTransform(254.2,281.2,1.25,1.25);
	...
	this.shape_31.setTransform(226.4,281.2,1.25,1.25);
	...
	this.shape_34.setTransform(212.9,282.5,1.25,1.25);
	...
	this.shape_35.setTransform(208.4,283.6,1.25,1.25);
	...
	this.shape_36.setTransform(205.7,281.2,1.25,1.25);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#737373").s().p("AgFACIAAgDIALAAIAAADg");
	this.shape_37.setTransform(202.5,281.6,1.25,1.25);
	...
	this.shape_38.setTransform(199.4,281.2,1.25,1.25);
	...
	this.shape_39.setTransform(193.8,281.2,1.25,1.25);
	...
	this.shape_40.setTransform(190,281.9,1.25,1.25);
	...
	this.shape_41.setTransform(186.5,281.9,1.25,1.25);
	...
	this.shape_44.setTransform(175.7,281.9,1.25,1.25);
	...
	this.shape_45.setTransform(171.1,282.5,1.25,1.25);
	...
	this.shape_46.setTransform(166.1,281.9,1.25,1.25);
	...
	this.shape_47.setTransform(162.6,281.2,1.25,1.25);
	...
	this.shape_48.setTransform(156.6,282.5,1.25,1.25);
	...
	this.shape_49.setTransform(153,281.9,1.25,1.25);
	...
	this.shape_50.setTransform(149.9,281.9,1.25,1.25);
	...
	this.shape_51.setTransform(146.2,281.9,1.25,1.25);
	...
	this.shape_52.setTransform(142.5,282.4,1.25,1.25);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#737373").s().p("AAJATIAAghIgRAAIAAAhIgGAAIAAglIAdAAIAAAlg");
	this.shape_53.setTransform(138.1,281.2,1.25,1.25);
	...
	this.shape_54.setTransform(133.2,283.6,1.25,1.25);
	...
	this.shape_55.setTransform(130.7,281.9,1.25,1.25);
	...
	this.shape_56.setTransform(127.6,281.9,1.25,1.25);
	...
	this.shape_57.setTransform(124.3,281.9,1.25,1.25);
	...
	this.shape_58.setTransform(120.8,281.9,1.25,1.25);
	...
	this.shape_59.setTransform(117.3,281.9,1.25,1.25);
	...
	this.shape_63.setTransform(101.2,283.6,1.25,1.25);
	...
	this.shape_66.setTransform(90.7,281.2,1.25,1.25);
	...
	this.shape_76.setTransform(57.8,281.2,1.25,1.25);
	...
	this.shape_77.setTransform(51.2,281.2,1.25,1.25);
	...
	this.shape_80.setTransform(36,281.2,1.25,1.25);
	...
	this.shape_81.setTransform(31.8,281.2,1.25,1.25);
	...
	this.shape_82.setTransform(27.8,281.8,1.25,1.25);
	...
	this.shape_83.setTransform(22,281.2,1.25,1.25);
	...
	this.shape_84.setTransform(16.7,281.2,1.25,1.25);
	...
	this.shape_85.setTransform(11.4,281.2,1.25,1.25);
	...
	this.shape_86.setTransform(187.5,145);

	this.timeline.addTween(cjs.Tween.get(this.shape_86).wait(306));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(187,144.5,385.5,291);
// library properties:
lib.properties = {
	width: 375,
	height: 290,

...
lib.ssMetadata = [
		{name:"600x500_atlas_", frames: [[0,0,600,270],[0,272,600,270],[0,544,600,270],[0,816,600,270],[0,1088,600,270]]}
];
...
(lib._600x500 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(297.6,431.4,1.8,1.8,0,0,0,70,14.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(180).to({_off:false},0).to({regX:69.9,scaleX:2,scaleY:2,x:297.4,y:433.3,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:70,scaleX:1.8,scaleY:1.8,x:297.6,y:431.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// t3
	this.instance_2 = new lib.t3();
	this.instance_2.parent = this;
	this.instance_2.setTransform(284.6,429,1.8,1.8,0,0,0,91.5,14.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(120).to({_off:false},0).to({scaleX:2,scaleY:2,x:283.1,y:430.7,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.8,scaleY:1.8,x:284.6,y:429,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// t2
	this.instance_3 = new lib.t2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(303.2,417.6,1.8,1.8,0,0,0,59.6,14);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60).to({_off:false},0).to({scaleX:2,scaleY:2,x:303.8,y:418,alpha:1},7,cjs.Ease.get(1)).wait(51).to({scaleX:1.8,scaleY:1.8,x:303.2,y:417.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// t1
	this.instance_4 = new lib.t1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(300.8,419.8,1.8,1.8,0,0,0,64.4,12.8);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:64.3,scaleX:2,scaleY:2,x:300.9,y:420.4,alpha:1},7,cjs.Ease.get(1)).wait(51).to({regX:64.4,scaleX:1.8,scaleY:1.8,x:300.8,y:419.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));

	// Слой 3
	this.instance_5 = new lib.text2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(300.1,467.3,1.96,1.96,0,0,0,0.1,0);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.instance_6 = new lib.butt();
	this.instance_6.parent = this;
	this.instance_6.setTransform(496.6,417.5,1.96,1.96,0,0,0,0.1,0);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({alpha:1},7,cjs.Ease.get(1)).wait(106).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(66));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(240).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(53).to({alpha:0},6,cjs.Ease.get(1)).wait(1));
	...
	this.instance_10.setTransform(160,147.5,1,1,0,0,0,150,67.5);
	...
	this.instance_11.setTransform(160,147.5,1,1,0,0,0,150,67.5);
	...
	this.shape_86.setTransform(300,250);

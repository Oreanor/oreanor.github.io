...
lib.ssMetadata = [
		{name:"300x250_atlas_NP_", frames: [[0,0,300,135],[0,137,300,135],[0,274,300,135],[0,411,300,135],[0,548,300,135]]}
];
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(180.2,120.4,1.12,1.12,0,0,0,150,67.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(240).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.9,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// 4.jpg
	this.instance_6 = new lib.p4();
	this.instance_6.parent = this;
	this.instance_6.setTransform(180.2,120.4,1.12,1.12,0,0,0,150,67.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(180).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// 3.jpg
	this.instance_7 = new lib.p3();
	this.instance_7.parent = this;
	this.instance_7.setTransform(180.2,120.4,1.12,1.12,0,0,0,150,67.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(120).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(120));

	// 2.jpg
	this.instance_8 = new lib.p2();
	this.instance_8.parent = this;
	this.instance_8.setTransform(180.2,120.4,1.12,1.12,0,0,0,150,67.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(60).to({_off:false},0).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(180));

	// 1.jpg
	this.instance_9 = new lib.p1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(180.2,120.4,1.12,1.12,0,0,0,150,67.5);
	this.instance_9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:169,alpha:1},7,cjs.Ease.get(1)).wait(51).to({x:157.9,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(240));
...
p.nominalBounds = new cjs.Rectangle(167.5,139.5,348.7,281);
// library properties:
lib.properties = {
	width: 336,
	height: 280,

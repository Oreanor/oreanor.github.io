...
lib.ssMetadata = [
		{name:"240x600_atlas_", frames: [[0,404,240,200],[0,808,240,200],[0,606,240,200],[0,0,240,200],[0,202,240,200]]}
];
...
(lib._240x600 = function(mode,startPosition,loop) {
	...
	this.shape_96.graphics.f("#FFFFFF").s().p("EgSvAu4MAAAhdvMAlfAAAMAAABdvg");
	this.shape_96.setTransform(120,300);

	this.timeline.addTween(cjs.Tween.get(this.shape_96).wait(272));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(119.5,299.5,241,601);
// library properties:
lib.properties = {
	width: 240,
	height: 600,

...
lib.ssMetadata = [
		{name:"1000x120_atlas_", frames: [[0,0,298,274],[300,276,300,250],[300,0,298,274],[600,0,298,274],[0,276,298,274]]}
];
...
(lib._1000x120 = function(mode,startPosition,loop) {
	...
	this.uznat.setTransform(891.6,55,0.7,0.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(689.2,101.3);
	this.instance.alpha = 0;
	this.instance._off = true;
	...
	this.legal.setTransform(469.3,110.2,1,1,0,0,0,0.3,17.6);
	...
	this.logo.setTransform(111.6,59.4,1,1,0,0,0,0.1,-0.1);
	...
	this.text.setTransform(590.3,56.6,0.9,0.9,0,0,0,0.1,0.1);
...
p.nominalBounds = new cjs.Rectangle(499.5,56.9,1001,174);
// library properties:
lib.properties = {
	width: 1000,
	height: 120,

...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(280).to({_off:false},0).to({x:52.3,alpha:1},5).to({x:207.5},67).to({x:221,alpha:0},6).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(221).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(47).to({regX:-0.1,regY:-0.1,scaleX:0.99,scaleY:0.99,x:68.1,y:453.7,alpha:0.989},0).wait(1).to({scaleX:0.97,scaleY:0.97,alpha:0.947},0).wait(1).to({scaleX:0.93,scaleY:0.93,alpha:0.852},0).wait(1).to({scaleX:0.83,scaleY:0.83,alpha:0.651},0).wait(1).to({scaleX:0.67,scaleY:0.67,x:68.2,y:453.8,alpha:0.345},0).wait(1).to({scaleX:0.57,scaleY:0.57,alpha:0.146},0).wait(1).to({scaleX:0.53,scaleY:0.53,alpha:0.052},0).wait(1).to({scaleX:0.51,scaleY:0.51,alpha:0.011},0).wait(1).to({regX:0,regY:0,scaleX:0.5,scaleY:0.5,alpha:0},0).to({_off:true},1).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(213).to({_off:false},0).to({x:92},6,cjs.Ease.get(0.64)).to({x:67},55).to({x:-74},6,cjs.Ease.get(1)).to({_off:true},1).wait(81));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(213).to({_off:false},0).to({x:38},6,cjs.Ease.get(0.64)).to({x:78},55).to({x:198},6,cjs.Ease.get(1)).to({_off:true},1).wait(81));

...
lib.ssMetadata = [
		{name:"970x90_atlas_P_", frames: [[292,0,148,180],[144,0,146,190],[0,0,142,204],[442,0,142,187],[292,189,574,9],[586,0,164,75]]},
		{name:"970x90_atlas_NP_", frames: [[0,0,600,350],[0,352,600,350]]}
];
...
}).prototype = getMCSymbolPrototype(lib.v, new cjs.Rectangle(-120,-167,600,350), null);
...
}).prototype = getMCSymbolPrototype(lib.bbvv, new cjs.Rectangle(-120,-167,600,350), null);
...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").p("EhLsgG8MCXZAAAIAAN5MiXZAAAg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(284).to({_off:false},0).wait(1).to({regX:180,regY:8,x:300.5,y:263.3,alpha:0.014},0).wait(1).to({y:258.9,alpha:0.063},0).wait(1).to({y:249.6,alpha:0.168},0).wait(1).to({y:233.2,alpha:0.353},0).wait(1).to({y:211,alpha:0.604},0).wait(1).to({y:192.6,alpha:0.81},0).wait(1).to({y:182.1,alpha:0.929},0).wait(1).to({y:177.1,alpha:0.985},0).wait(1).to({regX:0,regY:0,x:120.5,y:167.8,alpha:1},0).to({x:120.1,y:-91.7},55).wait(1).to({regX:180,regY:8,x:300,y:-84.7,alpha:0.989},0).wait(1).to({y:-88.3,alpha:0.95},0).wait(1).to({y:-95.6,alpha:0.869},0).wait(1).to({y:-108.6,alpha:0.726},0).wait(1).to({y:-127.9,alpha:0.512},0).wait(1).to({y:-147.9,alpha:0.292},0).wait(1).to({y:-161.8,alpha:0.14},0).wait(1).to({y:-169.6,alpha:0.053},0).wait(1).to({y:-173.4,alpha:0.012},0).wait(1).to({regX:0,regY:0,x:120,y:-182.5,alpha:0},0).wait(4));
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(204.5,34,0.4,0.4,0,0,0,0.1,0.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(354.5,197);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(205).to({_off:false},0).wait(1).to({regX:1,regY:6.5,x:355.5,y:201.2},0).wait(1).to({y:196.1},0).wait(1).to({y:187.3},0).wait(1).to({y:174.4},0).wait(1).to({y:157.9},0).wait(1).to({y:141.3},0).wait(1).to({y:129.9},0).wait(1).to({regX:0,regY:0,x:354.5,y:119.8},0).to({y:5.7},68).wait(1).to({regX:1,regY:6.5,x:355.5,y:10.8},0).wait(1).to({y:6.1},0).wait(1).to({y:-3.9},0).wait(1).to({y:-22.2},0).wait(1).to({y:-49},0).wait(1).to({y:-73.1},0).wait(1).to({y:-87.3},0).wait(1).to({y:-94.2},0).wait(1).to({regX:0,regY:0,x:354.5,y:-103},0).to({_off:true},1).wait(71));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(133).to({_off:false},0).wait(1).to({regX:180,regY:8,x:300,y:263.5,alpha:0.016},0).wait(1).to({y:258.5,alpha:0.071},0).wait(1).to({y:249.1,alpha:0.175},0).wait(1).to({y:234.4,alpha:0.337},0).wait(1).to({y:214.7,alpha:0.555},0).wait(1).to({y:193.8,alpha:0.784},0).wait(1).to({y:179.2,alpha:0.946},0).wait(1).to({regX:0,regY:0,x:120,y:166.3,alpha:1},0).to({y:-90.2},60).wait(1).to({regX:180,regY:8,x:300,y:-85.5,alpha:0.967},0).wait(1).to({y:-91.7,alpha:0.905},0).wait(1).to({y:-101.3,alpha:0.81},0).wait(1).to({y:-114.8,alpha:0.676},0).wait(1).to({y:-132,alpha:0.506},0).wait(1).to({y:-151.1,alpha:0.316},0).wait(1).to({y:-168.3,alpha:0.146},0).wait(1).to({y:-179.4,alpha:0.036},0).wait(1).to({regX:0,regY:0,x:120,y:-191,alpha:0},0).to({_off:true},1).wait(151));
	...
	this.instance_7.setTransform(202.8,34.9,0.4,0.4,0,0,0,0.1,0.3);
	this.instance_7.alpha = 0.301;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(80).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8,scaleY:0.8,x:202.7,y:34.8,alpha:1},6,cjs.Ease.get(1)).wait(42).to({regX:0.1,regY:0.1,scaleX:0.4,scaleY:0.4,x:202.8,y:34.9,alpha:0.301},5,cjs.Ease.get(1)).to({_off:true},1).wait(228));

	// 1
	this.instance_8 = new lib.ghgh();
	this.instance_8.parent = this;
	this.instance_8.setTransform(348,216);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(68).to({_off:false},0).wait(1).to({regX:14.4,regY:-12.1,x:362.4,y:202.9},0).wait(1).to({y:199.8},0).wait(1).to({y:194.1},0).wait(1).to({y:185.5},0).wait(1).to({y:173.7},0).wait(1).to({y:159.1},0).wait(1).to({y:143.5},0).wait(1).to({y:129.9},0).wait(1).to({y:120.9},0).wait(1).to({regX:0,regY:0,x:348,y:129.5},0).to({y:-0.6},52).wait(1).to({regX:14.4,regY:-12.1,x:362.4,y:-14.8},0).wait(1).to({y:-22.7},0).wait(1).to({y:-38.8},0).wait(1).to({y:-62.6},0).wait(1).to({y:-84.4},0).wait(1).to({y:-97.8},0).wait(1).to({y:-104.3},0).wait(1).to({regX:0,regY:0,x:348,y:-94},0).to({_off:true},1).wait(223));

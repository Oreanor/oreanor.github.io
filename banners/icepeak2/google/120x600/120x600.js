...
lib.ssMetadata = [
		{name:"120x600_atlas_NP_", frames: [[0,0,260,600],[524,0,250,600],[262,0,260,600]]}
];
...
(lib.hhjjhj = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-118,-263);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.hhjjhj, new cjs.Rectangle(-118,-263,114,52), null);
...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(60.4,530.2,0.494,0.049,0,0,0,0.3,3.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(100).to({_off:false},0).to({regY:0.3,scaleY:0.49},8,cjs.Ease.get(1)).wait(67).to({regY:2.9,scaleY:0.05},6,cjs.Ease.get(1)).to({_off:true},1).wait(96));

	// Символ 15
	this.instance_1 = new lib.vbnvbn();
	this.instance_1.parent = this;
	this.instance_1.setTransform(180.9,55.8,0.525,0.525,0,0,0,0.1,0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(92).to({_off:false},0).to({scaleY:0.54,skewX:-13.7,x:56.9},5,cjs.Ease.get(1)).to({scaleY:0.53,skewX:0,x:60.1},2).wait(76).to({scaleY:0.53,skewX:-10.4,x:57.5},0).to({regX:-0.1,x:-63.2},6,cjs.Ease.get(1)).to({_off:true},1).wait(96));

	// Символ 14
	this.instance_2 = new lib.nnbnn();
	this.instance_2.parent = this;
	this.instance_2.setTransform(181.6,75.3,0.525,0.525,0,0,0,0,0.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(93).to({_off:false},0).to({regX:0.1,scaleY:0.54,skewX:-14.4,x:57.7},5,cjs.Ease.get(1)).to({regX:0,scaleY:0.53,skewX:0,x:60.9},2).wait(74).to({regX:0.1,scaleY:0.54,skewX:-12.6},0).to({regX:-0.1,x:-59.9},6,cjs.Ease.get(1)).to({_off:true},2).wait(96));

	// Символ 13
	this.instance_3 = new lib.bnn();
	this.instance_3.parent = this;
	this.instance_3.setTransform(188.1,65.9,0.64,0.64,0,0,0,0.6,0.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).to({regX:0.7,scaleY:0.65,skewX:-7.6,x:53.7},5,cjs.Ease.get(1)).to({regX:0.1,regY:0.1,scaleY:0.64,skewX:0,x:60,y:65.8},2,cjs.Ease.get(1)).wait(79).to({scaleY:0.64,skewX:-5.3,x:56.8},0).to({regX:-0.1,x:-74.4},7,cjs.Ease.get(1)).to({_off:true},1).wait(183));

	// Символ 12
	this.instance_4 = new lib.bvvbn();
	this.instance_4.parent = this;
	this.instance_4.setTransform(184.9,28.6,0.64,0.64,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleY:0.66,skewX:-13.6,x:53.7},5,cjs.Ease.get(1)).to({scaleY:0.64,skewX:0,x:60.1},2).wait(79).to({scaleY:0.66,skewX:-13.6,x:56.9},0).to({regX:-0.1,x:-74.3},7,cjs.Ease.get(1)).to({_off:true},1).wait(184));
	...
	this.instance_6.setTransform(181.7,90.5,0.64,0.64,0,0,0,0.3,0.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(184).to({_off:false},0).to({scaleY:0.68,skewX:-18.7,x:57.3},7,cjs.Ease.get(1)).to({regX:0.4,scaleY:0.64,skewX:0,x:60.1},3,cjs.Ease.get(1)).wait(78).to({regX:0.3,scaleY:0.65,skewX:-9.6,x:57},0).to({regX:-0.5,scaleY:0.7,skewX:-23,x:-61.5},5).wait(1));

	// Символ 9
	this.instance_7 = new lib.jhjhj();
	this.instance_7.parent = this;
	this.instance_7.setTransform(182,66.5,0.64,0.64,0,0,0,0.3,1.3);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(183).to({_off:false},0).to({regX:-0.1,scaleY:0.69,skewX:-21.6,x:57.4},7,cjs.Ease.get(1)).to({regX:0.3,regY:0.3,scaleY:0.64,skewX:0,x:60.5},3,cjs.Ease.get(1)).wait(78).to({regX:0.1,scaleY:0.66,skewX:-14.6,x:57.2},0).to({regX:-0.4,scaleY:0.68,skewX:-19.1,x:-61.2},5).to({_off:true},1).wait(1));

	// Символ 8
	this.instance_8 = new lib.jjjhhh();
	this.instance_8.parent = this;
	this.instance_8.setTransform(181.6,42.2,0.64,0.64,0,0,0,0.4,1.3);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(182).to({_off:false},0).to({regX:0.3,scaleY:0.65,skewX:-8.9,x:57.2},7,cjs.Ease.get(1)).to({regY:0.1,scaleY:0.64,skewX:0,x:60,y:42.1},3,cjs.Ease.get(1)).wait(78).to({regX:0.4,scaleY:0.65,skewX:-12.1,x:56.8},0).to({regX:-0.5,scaleY:0.68,skewX:-18.9,x:-61.7},5).to({_off:true},1).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:50,alpha:1},94).to({x:0,alpha:0},87).to({_off:true},1).wait(96));

	// Символ 2
	this.instance_10 = new lib.hhhh();
	this.instance_10.parent = this;
	this.instance_10.setTransform(55,200);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:30,alpha:0},94).to({_off:true},1).wait(87).to({_off:false,x:120},0).to({x:55,alpha:1},95).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(95).to({_off:false},0).to({x:60},87).to({x:100,alpha:0},95).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-5,299.5,325,601);
// library properties:
lib.properties = {
	width: 120,
	height: 600,

...
p.nominalBounds = new cjs.Rectangle(0,0,313,23);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.jhh, new cjs.Rectangle(-91.7,-15.6,183.5,31.3), null);
...
}).prototype = getMCSymbolPrototype(lib.etgrt, new cjs.Rectangle(-120,-170,336,280), null);
...
}).prototype = getMCSymbolPrototype(lib.errrr, new cjs.Rectangle(-120,-190,336,280), null);
...
}).prototype = getMCSymbolPrototype(lib.err, new cjs.Rectangle(-120,-200,336,280), null);
...
}).prototype = getMCSymbolPrototype(lib.asdas, new cjs.Rectangle(0,0,313,23), null);
...
(lib.hh = function(mode,startPosition,loop) {
	...
	this.instance = new lib.legal();
	this.instance.parent = this;
	this.instance.setTransform(-140,21);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2
	this.instance_1 = new lib.asdas();
	this.instance_1.parent = this;
	this.instance_1.setTransform(17.5,33.5,1,1,0,0,0,156.5,11.5);
	this.instance_1.filters = [new cjs.ColorFilter(0.13, 0.13, 0.13, 1, 0, 0, 0, 0)];
	this.instance_1.cache(-2,-2,317,27);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.hh, new cjs.Rectangle(-140,21,314,24), null);
...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).to({regX:0.8,scaleY:0.91,skewX:-7.6,x:71,y:76.2,alpha:1},5,cjs.Ease.get(1)).to({regX:0.1,regY:0.1,scaleY:0.9,skewX:0,x:79.8,y:76.1},2,cjs.Ease.get(1)).wait(69).to({scaleY:0.9,skewX:-5.3,x:75.3},0).to({regX:-0.2,x:-109.2},7,cjs.Ease.get(1)).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleY:1.03,skewX:-13.6,x:70.6,alpha:1},5,cjs.Ease.get(1)).to({scaleY:1,skewX:0,x:80.6},2).wait(69).to({scaleY:1.03,skewX:-13.6,x:75.6},0).to({x:-129.4},7,cjs.Ease.get(1)).to({_off:true},1).wait(164));

	// Layer 1
	this.instance_5 = new lib.hh();
	this.instance_5.parent = this;
	this.instance_5.setTransform(152.3,223.5);
...
p.nominalBounds = new cjs.Rectangle(167.5,139.4,340.1,281);
// library properties:
lib.properties = {
	width: 336,
	height: 280,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/legal.png?1508851644410", id:"legal"},
		{src:"images/336x280_atlas_NP_.jpg?1508851644387", id:"336x280_atlas_NP_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"240x400_atlas_", frames: [[238,0,180,199],[242,201,150,169],[0,231,240,210],[0,0,236,229]]}
];
...
(lib.legal2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(105.1,13.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.legal2, new cjs.Rectangle(0,0,210.2,27.2), null);
...
(lib._240x400 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(116.2,380.8,1,1,0,0,0,105.1,13.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},288).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(288).to({_off:false},0).to({regX:0,regY:0,y:285.5,alpha:1},7,cjs.Ease.get(1)).wait(65).to({y:305.5,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(216).to({_off:false},0).to({x:120,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:100,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({x:120.5,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:110.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(72).to({_off:false},0).to({x:120,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:100,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:120.5,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:110.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(288).to({_off:false},0).to({x:120,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:110,alpha:0},7,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(216).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(65).to({scaleX:0.8,scaleY:0.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(144).to({_off:false},0).to({scaleX:1,scaleY:1,y:328,alpha:1},7,cjs.Ease.get(1)).wait(65).to({scaleX:0.8,scaleY:0.8,y:327.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(72).to({_off:false},0).to({scaleX:1,scaleY:1,y:327.6,alpha:1},7,cjs.Ease.get(1)).wait(65).to({scaleX:0.8,scaleY:0.8,y:327.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({scaleX:1,scaleY:1,y:329.1,alpha:1},7,cjs.Ease.get(1)).wait(65).to({scaleX:0.8,scaleY:0.8,y:328.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.instance_12},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(368));

...
(lib.legal2 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#444444").s().p("");
	...
	// Слой 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#444444").s().p("");
	this.shape_1.setTransform(7.7,23.5,1,1,0,0,0,-0.1,-0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#444444").s().p("");
	this.shape_2.setTransform(25.8,3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#444444").s().p("");
	this.shape_3.setTransform(104.7,19);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.legal2, new cjs.Rectangle(0.9,-0.4,207.2,27.4), null);
...
(lib._240x400 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(121.2,381.8,1.1,1.1,0,0,0,105.1,13.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},328).wait(90));

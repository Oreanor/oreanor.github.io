...
(lib._300x300 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(83.4,263.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(164).to({_off:false},0).to({scaleX:1,scaleY:1,y:236,alpha:1},7,cjs.Ease.get(1)).wait(75).to({scaleX:0.8,scaleY:0.8,y:235.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(82).to({_off:false},0).to({scaleX:1,scaleY:1,y:235.1,alpha:1},7,cjs.Ease.get(1)).wait(75).to({scaleX:0.8,scaleY:0.8,y:234.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(246));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({scaleX:1,scaleY:1,y:237.1,alpha:1},7,cjs.Ease.get(1)).wait(75).to({scaleX:0.8,scaleY:0.8,y:236.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(328));
	...
	this.shape_2.setTransform(229.6,29.8,0.88,0.88);
	...
	this.shape_3.setTransform(240.2,45.6,0.88,0.88);
	...
	this.shape_4.setTransform(270.1,29.9,0.88,0.88);
	...
	this.shape_5.setTransform(150,150,1.246,0.75);

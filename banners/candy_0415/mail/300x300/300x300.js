...
lib.ssMetadata = [
		{name:"300x300_atlas_", frames: [[238,0,180,199],[302,201,150,169],[0,231,300,120],[0,0,236,229]]}
];
...
(lib.text5 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(132.7,-51.4);
	...
	this.shape_1.setTransform(124.5,-51.4);
	...
	this.shape_2.setTransform(114,-51.4);
	...
	this.shape_3.setTransform(101.9,-51.4);
	...
	this.shape_4.setTransform(90.8,-51.4);
	...
	this.shape_8.setTransform(56.1,-51.4);
	...
	this.shape_13.setTransform(4.5,-51.4);
	...
	this.shape_14.setTransform(-4.7,-51.4);
	...
	this.shape_15.setTransform(-15.6,-51.4);
	...
	this.shape_16.setTransform(-32.6,-51.4);
	...
	this.shape_17.setTransform(-46.8,-51.4);
	...
	this.shape_18.setTransform(-57.4,-51.4);
	...
	this.shape_19.setTransform(-67.4,-51.4);
	...
	this.shape_20.setTransform(-82.1,-51.4);
	...
	this.shape_23.setTransform(-109.8,-51.4);
	...
	this.shape_24.setTransform(-121.7,-51.4);
	...
	this.shape_25.setTransform(-133,-51.4);
	...
	this.shape_26.setTransform(23,-20.2,0.8,0.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgHA2IAAheIgiAAIAAgNIBTAAIAAANIgiAAIAABeg");
	this.shape_27.setTransform(15.4,-20.2,0.8,0.8);
	...
	this.shape_28.setTransform(8.6,-20.2,0.8,0.8);
	...
	this.shape_29.setTransform(1.9,-20.2,0.8,0.8);
	...
	this.shape_30.setTransform(-5.5,-20.2,0.8,0.8);
	...
	this.shape_31.setTransform(-15,-20.2,0.8,0.8);
	...
	this.shape_32.setTransform(-24.1,-20.2,0.8,0.8);
	...
	this.shape_33.setTransform(-0.9,-20,0.8,0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text5, new cjs.Rectangle(-136.8,-57.5,273.7,51.9), null);
...
(lib.pic5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-106,-76,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.pic5, new cjs.Rectangle(-106,-76,212.4,206.1), null);
...
(lib.legal2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib._300x300 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(116.2,274.8,1,1,0,0,0,105.1,13.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(268).to({_off:false},0).to({regX:0,regY:0,y:199.5,alpha:1},7,cjs.Ease.get(1)).wait(60).to({y:219.5,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// pic4
	this.instance_2 = new lib.pic4();
	this.instance_2.parent = this;
	this.instance_2.setTransform(157,126.5,0.63,0.63,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(201).to({_off:false},0).to({x:150.7,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:138.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(67));

	// pic3
	this.instance_3 = new lib.pic1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(158.4,145,0.8,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(134).to({_off:false},0).to({x:150.4,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:142.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(134));

	// pic2
	this.instance_4 = new lib.pic2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(130,180);
	this.instance_4.alpha = 0.289;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(67).to({_off:false},0).to({x:120,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:100,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(201));

	// pic1
	this.instance_5 = new lib.pic1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(158.4,145,0.8,0.8);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:150.4,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:142.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(268));

	// text5
	this.instance_6 = new lib.text5();
	this.instance_6.parent = this;
	this.instance_6.setTransform(160,123.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(268).to({_off:false},0).to({x:150,alpha:1},7,cjs.Ease.get(1)).wait(60).to({x:140,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// text4
	this.instance_7 = new lib.text4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(150,246.1,0.8,0.8);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(201).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},7,cjs.Ease.get(1)).wait(60).to({scaleX:0.8,scaleY:0.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(67));

	// text3
	this.instance_8 = new lib.text3();
	this.instance_8.parent = this;
	this.instance_8.setTransform(150,235.6,0.8,0.8);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(134).to({_off:false},0).to({scaleX:1,scaleY:1,y:236,alpha:1},7,cjs.Ease.get(1)).wait(60).to({scaleX:0.8,scaleY:0.8,y:235.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(134));

	// text2
	this.instance_9 = new lib.text2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(150,234.8,0.8,0.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(67).to({_off:false},0).to({scaleX:1,scaleY:1,y:235.1,alpha:1},7,cjs.Ease.get(1)).wait(60).to({scaleX:0.8,scaleY:0.8,y:234.8,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(201));

	// text1
	this.instance_10 = new lib.text1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(150,236.5,0.8,0.8);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({scaleX:1,scaleY:1,y:237.1,alpha:1},7,cjs.Ease.get(1)).wait(60).to({scaleX:0.8,scaleY:0.8,y:236.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(268));
	...
	this.shape_1.setTransform(229.6,29.8,0.88,0.88);
	...
	this.shape_2.setTransform(240.2,45.6,0.88,0.88);
	...
	this.shape_3.setTransform(270.1,29.9,0.88,0.88);

	this.instance_11 = new lib.ClipGroup_20();
	this.instance_11.parent = this;
	this.instance_11.setTransform(69.2,30.1,0.99,0.99,0,0,0,53,10.7);
	...
	this.shape_4.setTransform(150,150,1.246,0.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.instance_11},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(343));

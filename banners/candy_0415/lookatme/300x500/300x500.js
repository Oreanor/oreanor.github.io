...
lib.ssMetadata = [
		{name:"300x500_atlas_", frames: [[242,330,180,199],[292,0,150,169],[0,330,240,210],[0,0,290,328]]}
];
...
}).prototype = getMCSymbolPrototype(lib.pic5, new cjs.Rectangle(-118,-114.5,290,328), null);
...
(lib._300x500 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(368));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(368));

	// legal
	this.instance = new lib.legal();
	this.instance.parent = this;
	this.instance.setTransform(146.6,470.9,1.25,1.25,0,0,0,105.1,13.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A4A49").s().p("");
	this.shape_1.setTransform(150.5,473.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#4A4A49").s().p("");
	this.shape_2.setTransform(62.1,454.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A49").s().p("");
	this.shape_3.setTransform(135.5,484.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4A4A49").s().p("");
	this.shape_4.setTransform(16.9,484.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},288).wait(80));

	// pic5
	this.instance_1 = new lib.pic5();
	this.instance_1.parent = this;
	this.instance_1.setTransform(124.3,360.9,1,1,0,0,0,0,0.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(288).to({_off:false},0).to({y:330.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({y:355.9,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// pic4
	this.instance_2 = new lib.pic4();
	this.instance_2.parent = this;
	this.instance_2.setTransform(171.3,216.9,1.1,1.1,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(216).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:131.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));

	// pic3
	this.instance_3 = new lib.pic1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(164.4,231.6,1.25,1.25);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(144).to({_off:false},0).to({x:151.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:139.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));

	// pic2
	this.instance_4 = new lib.pic2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(163.8,221.2,1.25,1.25);
	this.instance_4.alpha = 0.289;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(72).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:126.3,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));

	// pic1
	this.instance_5 = new lib.pic1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(164.4,231.6,1.25,1.25);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:151.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({x:139.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));

	// text5
	this.instance_6 = new lib.text5();
	this.instance_6.parent = this;
	this.instance_6.setTransform(171.3,148.8,1.25,1.25);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(288).to({_off:false},0).to({x:151.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({y:168.8},0).to({x:138.8,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// text4
	this.instance_7 = new lib.text4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(151.3,397.6,1,1,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(216).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(72));

	// text3
	this.instance_8 = new lib.text3();
	this.instance_8.parent = this;
	this.instance_8.setTransform(151.3,399.5,1,1,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(144).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:399.9,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:399.5,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(144));

	// text2
	this.instance_9 = new lib.text2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(151.3,399.1,1,1,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(72).to({_off:false},0).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:399.5,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:399.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(216));

	// text1
	this.instance_10 = new lib.text1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(151.3,400.6,1,1,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,y:401.3,alpha:1},7,cjs.Ease.get(1)).wait(65).to({regX:0.1,regY:0.1,scaleX:1,scaleY:1,y:400.6,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(288));

	// bg
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#3B454C").s().p("");
	this.shape_5.setTransform(215.2,37.7,1.125,1.125);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#3B454C").s().p("");
	this.shape_6.setTransform(228.7,57.9,1.125,1.125);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#3B454C").s().p("");
	this.shape_7.setTransform(266.9,37.8,1.125,1.125);

	this.instance_11 = new lib.ClipGroup_20();
	this.instance_11.parent = this;
	this.instance_11.setTransform(96.9,40.1,1.25,1.042,0,0,0,53,10.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#E6F4FC","#E3F3FB","#D9EEFA","#C7E6F7","#B0DCF3","#A3D6F1","#90CEEB","#8BCCEA","#31AED8"],[0,0.192,0.349,0.49,0.627,0.686,0.82,0.843,1],8.6,-168.6,-3.5,70.5).s().p("AyzfRMAAAg+hMAlnAAAMAAAA+hg");
	this.shape_8.setTransform(150,250,1.246,1.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.instance_11},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5}]}).wait(368));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,249.5,313.6,501);
// library properties:
lib.properties = {
	width: 300,
	height: 500,
	...
	webfonts: {},
	manifest: [
		{src:"images/300x500_atlas_.png", id:"300x500_atlas_"}
	],
	preloads: []
};

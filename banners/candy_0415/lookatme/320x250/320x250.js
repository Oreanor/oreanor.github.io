...
lib.ssMetadata = [
		{name:"320x250_atlas_", frames: [[238,0,180,199],[302,201,150,169],[0,231,300,120],[0,0,236,229]]}
];
...
(lib._1 = function() {
	this.spriteSheet = ss["320x250_atlas_"];
	this.gotoAndStop(0);
...
(lib.pic2 = function(mode,startPosition,loop) {
	...
	mask.setTransform(30,-46);

	// Слой 1
	this.instance = new lib._3();
	this.instance.parent = this;
	this.instance.setTransform(-130,-110,1.067,1.067);
...
}).prototype = getMCSymbolPrototype(lib.pic2, new cjs.Rectangle(-130,-106,320,120), null);
...
(lib._320x250 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(418));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(160,219.5,1,1,0,0,0,0.1,0.1);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(167,101.5,0.63,0.63,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(246).to({_off:false},0).to({x:160.7,alpha:1},7,cjs.Ease.get(1)).wait(75).to({x:148.1,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(82));

	// pic3
	this.instance_3 = new lib.pic1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(168.4,120,0.8,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(164).to({_off:false},0).to({x:160.4,alpha:1},7,cjs.Ease.get(1)).wait(75).to({x:152.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(164));

	// pic2
	this.instance_4 = new lib.pic2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(140,155);
	this.instance_4.alpha = 0.289;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(82).to({_off:false},0).to({x:130,alpha:1},7,cjs.Ease.get(1)).wait(75).to({x:110,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(246));

	// pic1
	this.instance_5 = new lib.pic1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(168.4,120,0.8,0.8);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:160.4,alpha:1},7,cjs.Ease.get(1)).wait(75).to({x:152.4,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(328));

	// text5
	this.instance_6 = new lib.text5();
	this.instance_6.parent = this;
	this.instance_6.setTransform(170,93.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(328).to({_off:false},0).to({x:160,alpha:1},7,cjs.Ease.get(1)).wait(75).to({x:150,alpha:0},7,cjs.Ease.get(1)).wait(1));

	// text4
	this.instance_7 = new lib.text4();
	this.instance_7.parent = this;
	this.instance_7.setTransform(160,211.1,0.8,0.8);
	...
	this.instance_8.setTransform(160,200.6,0.8,0.8);
	...
	this.instance_9.setTransform(160,199.8,0.8,0.8);
	...
	this.instance_10.setTransform(160,201.5,0.8,0.8);
	...
	this.shape_2.setTransform(260.7,20.2,0.8,0.8);
	...
	this.shape_3.setTransform(270.3,34.6,0.8,0.8);
	...
	this.shape_4.setTransform(297.5,20.2,0.8,0.8);
	...
	this.shape_5.setTransform(160,120,1.329,0.75);
...
p.nominalBounds = new cjs.Rectangle(159.5,95,321,300);
// library properties:
lib.properties = {
	width: 320,
	height: 250,
	...
	webfonts: {},
	manifest: [
		{src:"images/320x250_atlas_.png", id:"320x250_atlas_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"100pcx240_3_atlas_", frames: [[0,0,256,255],[258,252,118,116],[258,0,143,250]]}
];
...
(lib.pic0 = function() {
	this.spriteSheet = ss["100pcx240_3_atlas_"];
	this.gotoAndStop(0);
...
(lib.ghgh = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0.8,1,0.9,0.9);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},294).wait(79).to({_off:false,x:18.8},0).to({x:0.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:-17.2,alpha:0},8,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-79,-26.7,159.6,55.4);
...
// stage content:
(lib._100pcx240_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/100pcx240_3_atlas_.png", id:"100pcx240_3_atlas_"}
	],
	preloads: []
};

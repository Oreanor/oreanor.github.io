...
lib.ssMetadata = [
		{name:"970x90_atlas_", frames: [[0,0,130,129],[132,92,60,59],[132,0,79,90]]}
];
...
(lib.text5 = function(mode,startPosition,loop) {
	...
	this.shape_20.setTransform(74.8,-11.3,0.412,0.412);
	...
	this.shape_21.setTransform(61.3,-11.3,0.412,0.412);
	...
	this.shape_22.setTransform(49.8,-11.3,0.412,0.412);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#4A4A49").s().p("ABhCtIAAkJIjcEJIgIAAIAAlZIAiAAIAAENIDdkNIAHAAIAAFZg");
	this.shape_23.setTransform(37.2,-11.3,0.412,0.412);
	...
	this.shape_24.setTransform(21.7,-11.3,0.412,0.412);
	...
	this.shape_25.setTransform(8,-11.3,0.412,0.412);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#4A4A49").s().p("ABVCtIAAk4IipAAIAAE4IgiAAIAAlZIDtAAIAAFZg");
	this.shape_26.setTransform(-4.6,-11.3,0.412,0.412);
	...
	this.shape_32.setTransform(-89.3,-11.3,0.412,0.412);
...
}).prototype = getMCSymbolPrototype(lib.text5, new cjs.Rectangle(-154.4,-21.8,308.8,43.8), null);
...
(lib.text4b = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAAAEIgFAKIgFgEIAHgIIgLgCIACgGIAKAEIgBgLIAGAAIgBALIALgEIABAGIgLACIAIAIIgGAEIgFgKg");
	this.shape.setTransform(41.5,-4.7);
...
}).prototype = getMCSymbolPrototype(lib.text4b, new cjs.Rectangle(-38.4,-9.6,86.4,16.6), null);
...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(630,45,0.99,0.99);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(382).to({_off:false},0).to({x:610.2,alpha:1},8,cjs.Ease.get(1)).wait(50).to({regX:0.1,regY:0.1,x:590.5,y:45.1,alpha:0},8,cjs.Ease.get(1)).wait(8));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(608.9,57.5,0.99,0.99);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:589.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:569.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(82));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(611.3,37.7,0.99,0.99);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({x:591.5,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:571.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(84));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(285.5,48.5,0.8,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({scaleX:1,scaleY:1,x:285.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.8,scaleY:0.8,x:285.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(88));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(609.3,57.5,0.99,0.99);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({x:589.5,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:569.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(156));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(609.7,37.8,0.99,0.99,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:589.9,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:570.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(158));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(285.5,48.5,0.8,0.8);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(162));

	// text2b
	this.instance_7 = new lib.text2b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(610.8,60,0.99,0.99);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({x:591,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:571.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(230));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(611.5,40.1,0.99,0.99);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({x:591.7,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:571.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(232));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(287.4,45.9,0.4,0.4,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({regX:0,regY:0,scaleX:0.5,scaleY:0.5,x:287,y:44.3,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.4,scaleY:0.4,x:287.4,y:45.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(236));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(611.7,60,0.99,0.99);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({x:591.9,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:572.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(304));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(612,37,0.99,0.99);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({x:592.2,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:572.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(306));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(283,45,0.475,0.475,0,0,0,0.2,0.2);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(73).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.59,scaleY:0.59,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0.2,regY:0.2,scaleX:0.48,scaleY:0.48,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(310));

	// text0b
	this.instance_13 = new lib.text0b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(606.3,57.5,0.99,0.99);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({x:586.5,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:566.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(377));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(611.4,37.7,0.99,0.99);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({x:591.6,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:571.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(379));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(285.5,48.5,0.8,0.8);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(383));

	// tr2
	this.instance_16 = new lib.dfg();
	this.instance_16.parent = this;
	this.instance_16.setTransform(850.6,80.2);
	...
	this.instance_17.setTransform(859.5,80.2);
	...
	this.instance_18.setTransform(119.2,39.6,1.4,1.4,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(381).to({scaleX:1.6,scaleY:1.6,x:219.2,y:39.5},8,cjs.Ease.get(1)).wait(54).to({scaleX:1.4,scaleY:1.4,x:119.2,y:39.6},9,cjs.Ease.get(1)).wait(4));

	// Слой 1
	this.instance_19 = new lib.pic_static();
	this.instance_19.parent = this;
	this.instance_19.setTransform(891,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(456));

	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#EEF1F4","#D6DCE3","#C8CFD9","#C3CBD6","#CED4DD","#E9ECF0","#F9FAFB","#FFFFFF"],[0,0.086,0.235,0.376,0.494,0.553,0.725,0.882,1],0,121.8,0,-47.9).s().p("EhLxAHCIAAuDMCXjAAAIAAODg");
	this.shape_1.setTransform(486,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(456));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(484.5,41.5,971.5,103.2);
// library properties:
lib.properties = {
	width: 970,
	height: 90,

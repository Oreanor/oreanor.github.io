...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	this.instance_16.setTransform(119.2,39.6,1.4,1.4,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(381).to({scaleX:1.6,scaleY:1.6,x:219.2,y:39.5},8,cjs.Ease.get(1)).wait(54).to({scaleX:1.4,scaleY:1.4,x:119.2,y:39.6},9,cjs.Ease.get(1)).wait(4));

	// Слой 1
	this.instance_17 = new lib.pic_static();
	this.instance_17.parent = this;
	this.instance_17.setTransform(891,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(456));

...
lib.ssMetadata = [
		{name:"336x280_atlas_", frames: [[0,0,214,212],[0,214,99,97]]}
];
...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(189,185.3,0.99,0.99,0,0,0,0.1,0.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(373).to({_off:false},0).to({x:169.2,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:149.4,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(187.4,242.2,0.99,0.99);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:167.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:147.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(189.8,223.8,0.99,0.99);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({x:170,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:150.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(75));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(168.5,138.5,0.8,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({scaleX:1,scaleY:1,x:168.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.8,scaleY:0.8,x:168.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(79));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(187.8,241.9,0.99,0.99,0,0,0,0.1,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({x:168,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:148.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(147));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(188.2,224.8,0.99,0.99,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:168.4,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:148.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(149));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(168.5,138.5,0.8,0.8);
	...
	this.instance_7.setTransform(189.3,253.1,0.99,0.99);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({x:168,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:149.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(221));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(190,210,0.99,0.99);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({x:168.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:150.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(223));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(165.6,130.8,0.713,0.713,0,0,0,0.3,0.2);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.89,scaleY:0.89,x:164.9,y:128,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.3,regY:0.2,scaleX:0.71,scaleY:0.71,x:165.6,y:130.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(227));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(190.3,252.9,0.99,0.99,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({x:168.1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:150.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(295));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(190.5,206.1,0.99,0.99);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({x:168,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:150.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(297));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(160.5,129.2,0.792,0.792,0,0,0,0.1,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(73).to({_off:false},0).to({scaleX:0.99,scaleY:0.99,alpha:1},8,cjs.Ease.get(1)).wait(56).to({scaleX:0.79,scaleY:0.79,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(301));

	// text0b
	this.instance_13 = new lib.text0b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(184.3,254.1,0.99,0.99);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({x:164.5,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:144.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(368));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(190,233.6,0.99,0.99);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({x:170.2,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:150.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(370));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(168.5,138.5,0.8,0.8);
	...
	this.instance_16.setTransform(17.6,270.2);
	...
	this.instance_17.setTransform(26.5,270.2);
	...
	this.instance_18.setTransform(168.2,30.7,1.1,1.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(372).to({regX:0.1,regY:0.1,scaleX:1.43,scaleY:1.43,x:168.3,y:96.8},11,cjs.Ease.get(1)).wait(54).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:168.2,y:30.7},9,cjs.Ease.get(1)).wait(1));
	...
	this.shape_1.setTransform(168.1,140,0.525,0.292);

...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.instance_16.setTransform(168.2,30.7,1.1,1.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(372).to({regX:0.1,regY:0.1,scaleX:1.43,scaleY:1.43,x:168.3,y:96.8},11,cjs.Ease.get(1)).wait(54).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:168.2,y:30.7},9,cjs.Ease.get(1)).wait(1));

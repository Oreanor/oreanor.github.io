...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_16.setTransform(149.9,95.2,1.1,1.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(372).to({regX:0.1,regY:0.1,scaleX:1.43,scaleY:1.43,x:150,y:210.7},11,cjs.Ease.get(1)).wait(54).to({regX:0,regY:0,scaleX:1.1,scaleY:1.1,x:149.9,y:95.2},9,cjs.Ease.get(1)).wait(1));

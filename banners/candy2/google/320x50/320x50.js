...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	this.instance_16.setTransform(182.3,11.5,0.553,0.553,0,0,0,0,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(371).to({regX:0.1,scaleX:0.69,scaleY:0.69,x:62.5,y:21.9},11,cjs.Ease.get(1)).wait(64).to({x:62.6},0).to({regX:0,regY:0,scaleX:0.55,scaleY:0.55,x:183.2,y:12.3},9,cjs.Ease.get(1)).wait(1));

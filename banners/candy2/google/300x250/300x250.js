...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_16.setTransform(150,25.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(372).to({regX:0.1,regY:0.1,scaleX:1.3,scaleY:1.3,x:150.2,y:85.6},11,cjs.Ease.get(1)).wait(54).to({regX:0,regY:0,scaleX:1,scaleY:1,x:150,y:25.5},9,cjs.Ease.get(1)).wait(1));

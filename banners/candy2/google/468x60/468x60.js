...
lib.ssMetadata = [
		{name:"468x60_atlas_", frames: [[0,0,130,129],[132,92,60,59],[132,0,79,90]]}
];
...
(lib.text4b = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(42.1,-4.7);
...
}).prototype = getMCSymbolPrototype(lib.text4b, new cjs.Rectangle(-38.4,-9.6,87,16.6), null);
...
(lib._468x60 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(283.8,30,0.666,0.666,0,0,0,0.1,0);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(382).to({_off:false},0).to({regX:0,x:271.4,y:31,alpha:1},8,cjs.Ease.get(1)).wait(50).to({x:258.1,alpha:0},8,cjs.Ease.get(1)).wait(8));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(256.1,48.6,0.666,0.666);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({regX:0.1,x:242.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0,x:229.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(82));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(257.8,35.3,0.666,0.666,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({regX:0,x:244.4,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,x:231.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(84));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(49.8,32.3,0.533,0.533,0,0,0,0.1,0);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({regX:0,scaleX:0.67,scaleY:0.67,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,scaleX:0.53,scaleY:0.53,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(88));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(256.4,48.6,0.666,0.666,0,0,0,0.1,0);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({regX:0,x:243,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,x:229.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(156));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(256.6,35.3,0.666,0.666,0,0,0,0,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:243.3,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,x:230,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(158));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(49.8,32.3,0.533,0.533,0,0,0,0.2,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({regX:0.1,regY:0,scaleX:0.67,scaleY:0.67,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.1,scaleX:0.53,scaleY:0.53,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(162));

	// text2b
	this.instance_7 = new lib.text2b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(257.4,50.3,0.666,0.666,0,0,0,0,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({regX:0.1,x:244.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:230.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(230));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(257.9,36.9,0.666,0.666,0,0,0,0,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({regX:0.1,x:244.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:231.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(232));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(51,30.6,0.266,0.266,0,0,0,0.2,0.2);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({regX:0.1,regY:0,scaleX:0.33,scaleY:0.33,x:50.8,y:29.5,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.2,scaleX:0.27,scaleY:0.27,x:51,y:30.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(236));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(258,50.3,0.666,0.666,0,0,0,0,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({regX:0.1,x:244.7,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0,x:231.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(304));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(258.2,34.8,0.666,0.666,0,0,0,0,0.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({regX:0.1,x:244.9,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:231.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(306));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(48.1,30,0.316,0.316,0,0,0,0.1,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(73).to({_off:false},0).to({scaleX:0.4,scaleY:0.4,alpha:1},8,cjs.Ease.get(1)).wait(56).to({scaleX:0.32,scaleY:0.32,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(310));

	// text0b
	this.instance_13 = new lib.text0b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(254.4,48.6,0.666,0.666,0,0,0,0.1,0);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({regX:0,x:241,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0.1,x:227.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(377));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(257.8,35.3,0.666,0.666,0,0,0,0,0.1);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({regX:0.1,x:244.5,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0,x:231.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(379));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(49.8,32.3,0.533,0.533,0,0,0,0.2,0.1);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regX:0.1,regY:0,scaleX:0.67,scaleY:0.67,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0.2,regY:0.1,scaleX:0.53,scaleY:0.53,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(383));

	// logo
	this.instance_16 = new lib.logo();
	this.instance_16.parent = this;
	this.instance_16.setTransform(241.9,14.8,0.666,0.666);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(371).to({regX:0.1,regY:0.1,scaleX:0.83,scaleY:0.83,x:73.5,y:27.4},11,cjs.Ease.get(1)).wait(64).to({x:74.5,y:28.4},0).to({regX:0,regY:0,scaleX:0.67,scaleY:0.67,x:242.9,y:15.8},9,cjs.Ease.get(1)).wait(1));

	// tr2
	this.instance_17 = new lib.dfg();
	this.instance_17.parent = this;
	this.instance_17.setTransform(374.6,50.2);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(297).to({alpha:1},6,cjs.Ease.get(1)).wait(63).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},75).wait(9));

	// tr1
	this.instance_18 = new lib.fgdfg();
	this.instance_18.parent = this;
	this.instance_18.setTransform(383.5,50.2);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(232).to({alpha:1},6,cjs.Ease.get(1)).wait(53).to({alpha:0},6,cjs.Ease.get(1)).to({_off:true},150).wait(9));

	// Слой 1
	this.instance_19 = new lib.pic_static();
	this.instance_19.parent = this;
	this.instance_19.setTransform(415,0,0.666,0.666);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(456));

	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#EEF1F4","#D6DCE3","#C8CFD9","#C3CBD6","#CED4DD","#E9ECF0","#F9FAFB","#FFFFFF"],[0,0.086,0.235,0.376,0.494,0.553,0.725,0.882,1],0,81.1,0,-32).s().p("EgkjAEsIAApXMBJHAAAIAAJXg");
	this.shape_1.setTransform(234,30);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(456));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(233.5,27.6,469,68.8);
// library properties:
lib.properties = {
	width: 468,
	height: 60,
	...
	webfonts: {},
	manifest: [
		{src:"images/468x60_atlas_.png", id:"468x60_atlas_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"120x600_atlas_", frames: [[0,0,285,283],[0,285,131,128]]}
];
...
(lib.text5 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(39.9,51.7,0.353,0.353,0,0,0,0.1,-0.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A4A49").s().p("ACcCtIghj3Ih2D3IgIAAIh4j4IghD4IggAAIAwlZIAFAAICHEbICHkbIAGAAIAwFZg");
	this.shape_1.setTransform(26.3,51.7,0.353,0.353,0,0,0,0.1,-0.2);
	...
	this.shape_2.setTransform(11.6,51.7,0.353,0.353,0,0,0,0.2,-0.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A49").s().p("ACGDHIAAgzIkLAAIAAAzIghAAIAAhUIAbAAICDk5IALAAICKE5IAaAAIAABUgAhlBzIDLAAIhojyg");
	this.shape_3.setTransform(-1.6,52.6,0.353,0.353,0,0,0,0.1,-0.2);
	...
	this.shape_20.setTransform(2,10.9,0.353,0.353);
	...
	this.shape_21.setTransform(-9.5,10.9,0.353,0.353);
	...
	this.shape_22.setTransform(-19.2,10.9,0.353,0.353,0,0,0,0.1,-0.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#4A4A49").s().p("ABhCtIAAkJIjcEJIgIAAIAAlZIAiAAIAAENIDdkNIAHAAIAAFZg");
	this.shape_23.setTransform(-30.2,10.9,0.353,0.353);
	...
	this.shape_24.setTransform(-43.4,10.9,0.353,0.353);
	...
	this.shape_25.setTransform(-55.1,10.9,0.353,0.353);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#4A4A49").s().p("ABVCtIAAk4IipAAIAAE4IgiAAIAAlZIDtAAIAAFZg");
	this.shape_26.setTransform(-65.9,10.9,0.353,0.353);
	...
	this.shape_32.setTransform(-3.4,-9.5,0.353,0.353);
...
}).prototype = getMCSymbolPrototype(lib.text5, new cjs.Rectangle(-70,-18.6,140.1,78.3), null);
...
(lib.text4a = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(34,0,0.375,0.375,0,0,0,-0.1,-0.1);
	...
	this.shape_4.setTransform(1.3,0,0.375,0.375,0,0,0,-0.1,-0.1);
...
(lib.text3b = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAAAEIgEAIIgFgDIAGgHIgJgCIACgFIAJADIgBgJIAFAAIgBAJIAJgDIACAFIgKACIAHAHIgFADIgFgIg");
	this.shape.setTransform(49.4,-5);
	...
	this.shape_1.setTransform(45.1,0.2,0.337,0.337);
	...
	this.shape_2.setTransform(40.1,0.2,0.337,0.337);
	...
	this.shape_3.setTransform(33.4,0.2,0.337,0.337);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgMCPIAAkcIAZAAIAAEcg");
	this.shape_4.setTransform(27.9,-1.2,0.337,0.337);
	...
	this.shape_5.setTransform(22.3,0.2,0.337,0.337);
	...
	this.shape_6.setTransform(12,0.1,0.337,0.337);
	...
	this.shape_7.setTransform(4.5,-1.3,0.337,0.337);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgNCLIAAj6Ig+AAIAAgbICXAAIAAAbIg+AAIAAD6g");
	this.shape_8.setTransform(0.4,-1.1,0.337,0.337,0,0,0,0,-0.1);
	...
	this.shape_9.setTransform(-9.1,0.2,0.337,0.337,0,0,0,0.1,0);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AA/BnIAAiWIiVCWIgDAAIAAjNIAbAAIAACXICWiXIACAAIAADNg");
	this.shape_10.setTransform(-15.8,0.2,0.337,0.337);
	...
	this.shape_11.setTransform(-24.1,1.3,0.337,0.337);
	...
	this.shape_12.setTransform(-33,0.2,0.337,0.337);
	...
	this.shape_13.setTransform(-42.5,-1.1,0.337,0.337,0,0,0,0.2,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text3b, new cjs.Rectangle(-47.2,-9.6,103.3,15.8), null);
...
(lib.text3a = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AhCCLIAAkVIAbAAIAAD6IBqAAIAAAbg");
	this.shape.setTransform(34.2,-19.7,0.371,0.371,0,0,0,0.2,0.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("ABICLIhIh1IhHB1IghAAIBZiOIhTiHIAhAAIBBBsIBDhsIAgAAIhTCHIBZCOg");
	this.shape_1.setTransform(26,-19.8,0.371,0.371);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgrCHQgUgMgLgTQgLgUABgXQgBgRAHgTQAIgVARgXIBUh+IAWAPIhKByQAQgFALgBQAhAAAXAYQAYAXAAAjQgBAZgKATQgLATgVALQgUAMgYAAQgWAAgUgLgAgoATQgSARABAYQgBAZASARQAQARAYAAQAZAAAQgRQASgRAAgZQAAgYgSgRQgRgRgYAAQgXAAgRARg");
	this.shape_2.setTransform(17.9,-19.7,0.371,0.371,0,0,0,0.1,0.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AhdCOIBphyQAhgiAJgQQAJgQAAgUQAAgYgRgQQgRgRgZAAQgZAAgTASQgSASgCAfIgaAAQAAgpAbgaQAbgbAlABQAmAAAYAZQAXAXAAAjQAAAYgLAUQgLAUghAjIhDBLIB/AAIAAAag");
	this.shape_3.setTransform(9.7,-19.8,0.371,0.371,0,0,0,0.2,0.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgrCHQgTgMgLgTQgMgVAAgWQAAgQAHgUQAHgSASgaIBUh+IAWAPIhKByQAQgFAMgBQAhAAAXAYQAXAXAAAjQAAAZgLATQgLATgVALQgUAMgXAAQgYAAgTgLgAgoATQgRARAAAYQAAAZARARQARARAXAAQAYAAARgRQASgRAAgZQAAgYgSgRQgSgRgXAAQgWAAgSARg");
	this.shape_4.setTransform(1.9,-19.8,0.371,0.371);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AA4CLIh4iBIAACBIgcAAIAAkVIAcAAIAABpIBuhpIAlAAIiFB9ICPCYg");
	this.shape_5.setTransform(-5.9,-19.7,0.371,0.371,0,0,0,0.2,0.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AhWCLIAAkVIA4AAQAtAAASAEQAYAGAPASQAPATAAAbQAAAdgPARQgOASgaAFQgUAFgyAAIgUAAIAACBgAg6gQIAvAAQAdAAAMgFQANgGAIgLQAHgLAAgPQAAgOgHgMQgIgKgMgGQgNgEgbgBIgxAAg");
	this.shape_6.setTransform(-14.7,-19.7,0.371,0.371,0,0,0,0.2,0.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AhkBhQgjgpAAg5QAAg8ArgqQArgqA/AAQAnAAAgAPQAeAPAVAdIgWARQgRgXgbgNQgZgNgfAAQgfAAgdAQQgcAQgQAcQgPAaAAAhQAAAzAiAiQAjAiA0AAQA7AAAnguIAWARQgVAbgfANQgdAPgpAAQhIAAgqgxg");
	this.shape_7.setTransform(-25.1,-19.8,0.371,0.371);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AhECLIAAkVICJAAIAAAbIhuAAIAABYIBuAAIAAAaIhuAAIAACIg");
	this.shape_8.setTransform(-34,-19.7,0.371,0.371,0,0,0,0.2,0.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("ABICLIhIh1IhHB1IghAAIBZiOIhTiHIAhAAIBBBsIBDhsIAgAAIhTCHIBZCOg");
	this.shape_9.setTransform(29.3,-0.8,0.371,0.371);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AgrCHQgUgMgLgTQgLgUAAgXQAAgSAHgSQAHgUASgYIBTh+IAXAPIhKByQAQgFALgBQAiAAAXAYQAXAYAAAiQAAAYgMAUQgKATgVALQgUAMgXAAQgYAAgTgLgAgpATQgRARAAAYQAAAZARARQARARAYAAQAYAAARgRQARgRAAgZQAAgYgRgRQgSgRgXAAQgXAAgSARg");
	this.shape_10.setTransform(21.3,-0.7,0.371,0.371,0,0,0,0.3,0.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgwCDQgWgQgMgeQgMgeAAg3QAAg2AMgeQAMgeAWgQQAUgPAbAAQAaAAAXAPQAVAQANAfQANAgAAAzQAAAzgNAhQgMAfgWAQQgWAPgbAAQgbAAgUgPgAgjhqQgQANgIAXQgIAYAAAvQAAAwAIAXQAIAYAQANQARAMASAAQASAAAQgMQAQgNAJgYQAKgdAAgqQAAgogKgcQgJgbgQgMQgRgNgRAAQgSAAgRANg");
	this.shape_11.setTransform(13,-0.8,0.371,0.371);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AgrCHQgUgLgLgUQgLgUAAgXQAAgSAHgSQAHgUASgYIBTh+IAXAPIhKByQAPgFAMgBQAiAAAWAYQAYAYAAAiQAAAYgMAUQgLATgUALQgUAMgXAAQgYAAgTgLgAgpATQgRARAAAYQAAAZARARQARARAYAAQAYAAARgRQARgSAAgYQAAgXgRgSQgSgRgXAAQgXAAgSARg");
	this.shape_12.setTransform(5.3,-0.7,0.371,0.371,0,0,0,0.2,0.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AA5CLIh5iBIAACBIgdAAIAAkVIAdAAIAABpIBuhpIAmAAIiFB9ICPCYg");
	this.shape_13.setTransform(-2.6,-0.7,0.371,0.371,0,0,0,0.1,0.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#000000").s().p("AhWCLIAAkVIA4AAQAtAAASAEQAYAGAOASQAQASAAAcQAAAcgPASQgOASgaAFQgTAFgzAAIgUAAIAACBgAg6gQIAvAAQAcAAANgFQANgGAIgLQAHgLAAgPQAAgOgHgMQgIgLgNgFQgMgEgbgBIgxAAg");
	this.shape_14.setTransform(-11.3,-0.7,0.371,0.371,0,0,0,0.1,0.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AhkBhQgjgoAAg6QAAg8ArgqQArgqA/AAQAoAAAeAPQAfAPAVAdIgWARQgRgXgbgNQgZgNgeAAQggAAgdAQQgcAQgQAcQgQAcAAAfQAAAzAjAiQAjAiA0AAQA7AAAnguIAWARQgVAbgfANQgeAPgnAAQhJAAgqgxg");
	this.shape_15.setTransform(-21.8,-0.8,0.371,0.371);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AhFCLIAAkVICLAAIAAAbIhvAAIAABYIBvAAIAAAaIhvAAIAACIg");
	this.shape_16.setTransform(-30.7,-0.8,0.371,0.371);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text3a, new cjs.Rectangle(-36.6,-25.2,73.3,29.9), null);
...
(lib.text2b = function(mode,startPosition,loop) {
	...
	this.shape_5.setTransform(-3.4,64.8,0.375,0.375);
	...
	this.shape_6.setTransform(-14,64.8,0.375,0.375);
	...
	this.shape_10.setTransform(-55.1,64.8,0.375,0.375);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#4A4A49").s().p("ABXCtIhXiSIhWCSIgnAAIBriyIhkinIAnAAIBPCHIBRiHIAnAAIhkCnIBqCyg");
	this.shape_11.setTransform(37.7,43.1,0.375,0.375);
	...
	this.shape_14.setTransform(1.6,43.1,0.375,0.375);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#4A4A49").s().p("ABwCtIhvkLIhwELIgkAAICRlZIAHAAICPFZg");
	this.shape_15.setTransform(-10.1,43.1,0.375,0.375);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#4A4A49").s().p("ABgCtIAAkIIjbEIIgIAAIAAlZIAiAAIAAENIDdkNIAHAAIAAFZg");
	this.shape_16.setTransform(-22.7,43.1,0.375,0.375);
	...
	this.shape_21.setTransform(3.1,21.1,0.375,0.375);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#4A4A49").s().p("ABhCtIAAkIIjcEIIgHAAIAAlZIAhAAIAAENIDdkNIAIAAIAAFZg");
	this.shape_22.setTransform(-10.4,21.1,0.375,0.375);
	...
	this.shape_23.setTransform(-22.2,21.1,0.375,0.375);
	...
	this.shape_24.setTransform(-33.9,21.1,0.375,0.375);
	...
	this.shape_28.setTransform(31.5,-0.7,0.375,0.375);
	...
	this.shape_32.setTransform(-10.5,-0.7,0.375,0.375);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#4A4A49").s().p("AhfCtIAAlZIC/AAIAAAiIieAAIAABsICcAAIAAAhIicAAIAACJICcAAIAAAhg");
	this.shape_33.setTransform(-20.2,-0.7,0.375,0.375);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#4A4A49").s().p("ABVCtIAAk5IipAAIAAE5IgiAAIAAlZIDtAAIAAFZg");
	this.shape_34.setTransform(-31.3,-0.7,0.375,0.375);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#4A4A49").s().p("ACcCtIghj3Ih2D3IgIAAIh4j4IghD4IggAAIAwlZIAFAAICHEbICHkbIAGAAIAwFZg");
	this.shape_35.setTransform(-45.3,-0.7,0.375,0.375);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#4A4A49").s().p("AhfCtIAAlZIC/AAIAAAiIieAAIAABsICdAAIAAAhIidAAIAACJICdAAIAAAhg");
	this.shape_36.setTransform(-57.5,-0.7,0.375,0.375);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#4A4A49").s().p("AgQCtIAAk3IhLAAIAAgiIC3AAIAAAiIhLAAIAAE3g");
	this.shape_37.setTransform(-66.4,-0.7,0.375,0.375);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#4A4A49").s().p("Ah2APIAAgdIDtAAIAAAdg");
	this.shape_38.setTransform(39.6,-21.7,0.252,0.4,0,0,0,0.1,-0.3);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#4A4A49").s().p("Ah8CBQg0g1AAhKQAAgxAYgrQAYgrAngYQApgYAvAAQBLAAAzA1QA0A1gBBLQABBMg0A1QgyA1hLAAQhJAAgzg1gAhGh/QghAUgTAiQgSAhgBAqQAAA+ApAqQAqArA6AAQAmAAAhgUQAjgVARghQASghAAgqQAAgpgSghQgSghgigUQgigUglAAQgmAAggAUg");
	this.shape_39.setTransform(27.1,-21.7,0.375,0.375);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#4A4A49").s().p("ABECtIiRihIAAChIgjAAIAAlZIAjAAIAACBICEiBIAtAAIifCbICsC+g");
	this.shape_40.setTransform(14.9,-21.7,0.375,0.375);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#4A4A49").s().p("Ah8CBQgzg0AAhLQAAgxAXgrQAYgrAogYQAogYAvAAQBMAAAyA1QAzA0AABMQAABMgzA1QgyA1hKAAQhKAAgzg1gAhGh/QghAUgTAiQgTAiAAApQAAA+AqAqQApArA6AAQAmAAAigUQAhgUASgiQATghAAgqQAAgpgTghQgSghgigUQgigUglAAQglAAghAUg");
	this.shape_41.setTransform(1.6,-21.7,0.375,0.375);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#4A4A49").s().p("Ah4B6Qgqg0AAhHQAAhLAzg1QA0g0BMAAQAvAAAmATQAlATAYAjIgaAVQgVgegfgPQgegPglAAQgoAAghAUQgjAUgSAiQgTAhAAApQAABAAqAqQAqArA+AAQBHAAAvg6IAaAVQgYAhgmASQglASguAAQhXAAgzg8g");
	this.shape_42.setTransform(-13.1,-21.7,0.375,0.375);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#4A4A49").s().p("ABuCtIAAlZIAiAAIAAFZgAiPCtIAAlZIAiAAIAACUIAXAAQBBAAAdAHQAbAFATAYQASAYAAAlQgBAkgRAaQgQAXgbAIQgZAIg/gBgAhtCMIAjAAQA3AAATgFQAPgGALgPQAKgQAAgXQAAgagNgQQgMgQgTgEQgWgEgzAAIgcAAg");
	this.shape_43.setTransform(-27.1,-21.7,0.375,0.375);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#4A4A49").s().p("AhjCtIAAlZIBCAAQAnAAAVAJQAVAKANAUQAMAVAAAYQAAAYgLATQgKASgWAMQAbAKAOALQAOANAHAQQAIASAAAVQAAApgdAdQgeAdgwAAgAhCCMIApAAQAkAAARgIQARgHAKgRQALgPAAgTQAAgWgPgSQgOgQgagIQgRgDgqAAIgSAAgAhCgbIATAAQAiAAAQgIQAQgFAKgPQAKgPAAgSQAAgYgRgNQgPgNgjAAIgmAAg");
	this.shape_44.setTransform(-38.8,-21.7,0.375,0.375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_44},{t:this.shape_43},{t:this.shape_42},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39},{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text2b, new cjs.Rectangle(-69.8,-28.5,139.8,100.2), null);
...
(lib.text1b = function(mode,startPosition,loop) {
	...
	this.shape_4.setTransform(-26,64.1,0.375,0.375);
	...
	this.shape_5.setTransform(57.1,42,0.375,0.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4A4A49").s().p("AhTCtIAAlZICnAAIAAAhIiGAAIAAE4g");
	this.shape_6.setTransform(46.1,42,0.375,0.375);
	...
	this.shape_20.setTransform(9.2,-0.8,0.375,0.375);
	...
	this.shape_27.setTransform(13.6,-22.6,0.375,0.375);
	...
	this.shape_28.setTransform(1.3,-22.6,0.375,0.375);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#4A4A49").s().p("AB9CuIg0hzIiQAAIg0BzIglAAICelaIAHAAICcFagAg3AaIBxAAIg5h9g");
	this.shape_29.setTransform(-10.5,-22.6,0.375,0.375);
	...
	this.shape_30.setTransform(-21.8,-22.6,0.375,0.375);
	...
	this.shape_31.setTransform(-32,-22.6,0.375,0.375);
	...
	this.shape_32.setTransform(-44.9,-22.6,0.375,0.375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text1b, new cjs.Rectangle(-63.6,-29.4,127.3,101.8), null);
...
(lib.text1a = function(mode,startPosition,loop) {
	...
	this.shape_4.setTransform(23.1,0.8,0.445,0.445,0,0,0,-0.2,0.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#25387A").s().p("ABhCuIAAkKIjcEKIgIAAIAAlbIAiAAIAAEOIDdkOIAIAAIAAFbg");
	this.shape_5.setTransform(7.1,0.7,0.445,0.445);
	...
	this.shape_6.setTransform(-6.9,0.7,0.445,0.445,0,0,0,-0.2,0);
	...
	this.shape_7.setTransform(-20.8,0.8,0.445,0.445,0,0,0,-0.2,0.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#25387A").s().p("AB9CtIg0hxIiQAAIg0BxIglAAICelaIAHAAICcFagAg3AaIBxAAIg5h9g");
	this.shape_8.setTransform(-37.4,0.7,0.445,0.445);
	...
	this.shape_9.setTransform(-50.7,0.7,0.445,0.445,0,0,0,-0.1,0);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#25387A").s().p("ABECtIiSihIAAChIgiAAIAAlZIAiAAIAACCICFiCIAtAAIigCcICtC9g");
	this.shape_10.setTransform(-62.4,0.7,0.445,0.445,0,0,0,-0.1,0);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#25387A").s().p("AB9CuIg0hyIiQAAIg0ByIglAAICelaIAHAAICcFagAg4AaIByAAIg5h9g");
	this.shape_11.setTransform(-77,0.7,0.445,0.445,0,0,0,-0.2,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text1a, new cjs.Rectangle(-84.1,-7.4,168.5,16.3), null);
...
(lib.text0a = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4A4A49").s().p("AgPCuIAAhkIgkAAQgnAAgZgHQgZgJgSgZQgSgYAAgiQAAgqAegeQAdgfBMAAIAaAAIAAgsIAgAAIAAAsIAaAAQBKAAAfAeQAdAeAAArQAAAmgaAfQgaAehIAAIgkAAIAABkgAARApIA1AAQAjgBATgSQASgTAAgcQAAgggWgTQgWgTgsAAIglAAgAh2hNQgXATAAAhQAAAbASATQATATAlABIA0AAIAAiIIgmAAQgpAAgYASg");
	this.shape.setTransform(65.3,-19.4,0.364,0.364);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A4A49").s().p("AB9CtIg0hyIiQAAIg0ByIglAAICelZIAHAAICcFZgAg3AaIBxAAIg5h9g");
	this.shape_1.setTransform(51.7,-19.4,0.364,0.364);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#4A4A49").s().p("ABECuIiSijIAACjIgiAAIAAlaIAiAAIAACBICFiBIAtAAIigCbICtC/g");
	this.shape_2.setTransform(41,-19.4,0.364,0.364);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A49").s().p("AjCCuIAAlaIAiAAIAAE5ICPAAIAAk5IAhAAIAAE5ICRAAIAAk5IAiAAIAAFag");
	this.shape_3.setTransform(26.8,-19.4,0.364,0.364);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4A4A49").s().p("ABhDXIAAkJIjcEJIgIAAIAAlaIAiAAIAAEOIDdkOIAIAAIAAFagAg0izQgWgOgGgVIAfAAQAIAMANAGQAMAGARAAQARAAANgFQALgFAJgOIAeAAQgGAVgUAOQgUAPgiAAQghAAgUgPg");
	this.shape_4.setTransform(7.4,-20.9,0.364,0.364);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4A4A49").s().p("Ah8CBQgzg1gBhKQABgxAXgrQAXgqAogZQAogYAwAAQBLAAAzA0QAzA2AABLQAABMgzA1QgzA1hKAAQhJAAgzg1gAhGh/QghAUgTAiQgTAhAAApQAAA/AqAqQApArA6AAQAnAAAggUQAigUASgiQASghAAgqQAAgpgSghQgSghgigUQgigUglAAQgmAAggAUg");
	this.shape_5.setTransform(-6.3,-19.4,0.364,0.364);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4A4A49").s().p("AhjCtIAAlZIBCAAQAnAAAVAJQAVAJANAVQAMAVAAAYQAAAXgLATQgMAUgUALQAaAJAOALQAPAOAHAQQAIAUAAATQAAApgdAeQgfAcgvAAgAhDCMIAqAAQAkAAARgIQAQgHALgQQAKgQAAgTQAAgYgOgQQgOgQgagIQgPgDgsAAIgTAAgAhDgcIAUAAQAiAAAQgGQAQgHAKgOQAJgPAAgSQAAgYgQgNQgPgNgjgBIgnAAg");
	this.shape_6.setTransform(-18.2,-19.4,0.364,0.364);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4A4A49").s().p("Ah8CBQgzg0AAhLQAAgyAXgqQAXgqAogZQAogYAwAAQBLAAAzA0QAzA1AABMQAABMgzA1QgzA1hKAAQhJAAgzg1gAhGh/QgiAUgSAiQgTAhAAApQAAA/ApAqQArArA5AAQAnAAAggUQAigUASgiQATgiAAgpQAAgogTgiQgSghgigUQgigUglAAQgmAAggAUg");
	this.shape_7.setTransform(-30.7,-19.4,0.364,0.364);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#4A4A49").s().p("ABXCuIhXiTIhWCTIgnAAIBrizIhkioIAnAAIBPCIIBRiIIAmAAIhjCoIBqCzg");
	this.shape_8.setTransform(-43.2,-19.4,0.364,0.364);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4A4A49").s().p("AhZCqQgQgHgZgdIAYgVQAZAaAJADQAHAEAKAAQANAAAKgHQAKgJALgcIh6kWIAlAAIBlDrIBcjsIAlAAIh/E3QgQAsguAAQgSAAgQgIg");
	this.shape_9.setTransform(-53.9,-19.2,0.364,0.364);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#4A4A49").s().p("ACGDHIAAgzIkMAAIAAAzIggAAIAAhUIAaAAICEk5IALAAICKE5IAaAAIAABUgAhlBzIDLAAIhojyg");
	this.shape_10.setTransform(-65.7,-18.5,0.364,0.364);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#4A4A49").s().p("ABgCuIAAkJIjbEJIgHAAIAAlaIAhAAIAAENIDdkNIAHAAIAAFag");
	this.shape_11.setTransform(34,43.6,0.364,0.364);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#4A4A49").s().p("ABECuIiSiiIAACiIgiAAIAAlaIAiAAIAACCICFiCIAtAAIigCbICtC/g");
	this.shape_12.setTransform(23.3,43.6,0.364,0.364);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#4A4A49").s().p("AgQCuIAAk5IhLAAIAAgiIC3AAIAAAiIhLAAIAAE5g");
	this.shape_13.setTransform(14.1,43.6,0.364,0.364);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#4A4A49").s().p("Ah4B5QgrgyAAhIQAAhNA0gzQAzg0BNAAQAuAAAmATQAmATAZAjIgbAVQgWgegegPQgegPglAAQgoAAghAUQgjAUgTAhQgTAiAAApQAAA/ArArQApAqBAAAQBGAAAvg5IAbAVQgZAhgmASQgnASgsAAQhXAAgzg9g");
	this.shape_14.setTransform(3.6,43.6,0.364,0.364);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#4A4A49").s().p("ABgCuIAAkKIjbEKIgIAAIAAlbIAiAAIAAEOIDdkOIAHAAIAAFbg");
	this.shape_15.setTransform(-9.6,43.6,0.364,0.364);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#4A4A49").s().p("ABECuIAAikIgYAAQgwAAgYgEQgYgFgRgMQgSgPgHgUQgHgUAAgmIAAhEIAhAAIAABGQAAAsARASQARARAmAAIBAAAIAAiVIAiAAIAAFag");
	this.shape_16.setTransform(-21,43.6,0.364,0.364);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#4A4A49").s().p("Ah8CBQgzg1AAhLQAAgxAXgqQAYgsAogXQAogYAvAAQBLAAAzA0QAzA1AABMQAABMgzA1QgzA1hJAAQhJAAg0g1gAhGiAQgiAVgSAhQgTAkAAAnQAAA+AqArQApAqA6AAQAmAAAhgTQAhgTATgjQATgiAAgpQAAgpgTghQgTgighgUQgjgUgkAAQgkAAgiAUg");
	this.shape_17.setTransform(-32.3,43.6,0.364,0.364);
	...
	this.shape_18.setTransform(43.6,21,0.364,0.364);
	...
	this.shape_23.setTransform(-16.1,22.5,0.364,0.364);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#4A4A49").s().p("ABhCtIAAkJIjcEJIgHAAIAAlZIAhAAIAAENIDdkNIAHAAIAAFZg");
	this.shape_24.setTransform(-29.3,22.5,0.364,0.364);
	...
	this.shape_25.setTransform(-42.4,22.5,0.364,0.364);
	...
	this.shape_26.setTransform(47.5,0.2,0.364,0.364);
	...
	this.shape_29.setTransform(8.7,0.2,0.364,0.364);
	...
	this.shape_30.setTransform(-4.9,1.7,0.364,0.364);
	...
	this.shape_33.setTransform(-46.3,1.7,0.364,0.364);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_33},{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text0a, new cjs.Rectangle(-71.8,-28.7,143.6,79), null);
...
(lib.pic0_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-142.5,-141.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.pic0_1, new cjs.Rectangle(-142.5,-141.5,285,283), null);
...
(lib.pic4_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-65.5,-68.4);
...
}).prototype = getMCSymbolPrototype(lib.pic4_1, new cjs.Rectangle(-142.5,-141.5,285,283), null);
...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(75.7,355.8,0.75,0.75);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(373).to({_off:false},0).to({x:60.7,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:45.7,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(74.6,386.4,0.75,0.75);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:59.6},0).to({x:44.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(76.4,372.5,0.75,0.75);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({x:61.4,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:46.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(75));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(60.5,257.9,0.54,0.54,0,0,0,0.2,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({regX:0,regY:0,scaleX:0.68,scaleY:0.68,y:257.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.1,scaleX:0.54,scaleY:0.54,y:257.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(79));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(74.8,386.2,0.75,0.75);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:59.8},0).to({x:44.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(147));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(75.1,373.2,0.75,0.75);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:45.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(149));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(60.5,257.9,0.54,0.54,0,0,0,0.2,0.2);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({regX:0.1,regY:0.1,scaleX:0.68,scaleY:0.68,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.2,regY:0.2,scaleX:0.54,scaleY:0.54,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(153));

	// text2b
	this.instance_7 = new lib.text2b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(76,386.4,0.75,0.75);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:46,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(221));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(76.6,350,0.75,0.75);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({x:61.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:46.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(223));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(58.4,257.9,0.6,0.6,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({regX:0,regY:0,scaleX:0.75,scaleY:0.75,x:57.9,y:255.5,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.6,scaleY:0.6,x:58.4,y:257.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(227));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(76.7,382,0.75,0.75);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:46.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(295));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(75.3,343.1,0.661,0.661,0,0,0,0.4,0.3);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({regX:0.1,x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:48.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(297));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(54.9,251.5,0.6,0.6,0,0,0,0.1,0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(73).to({_off:false},0).to({regX:0,regY:0,scaleX:0.75,scaleY:0.75,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0.1,regY:0.1,scaleX:0.6,scaleY:0.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(301));

	// text0b
	this.instance_13 = new lib.text0b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(72.6,422.2,0.75,0.75);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({x:57.6,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:42.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(368));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(76.5,371.4,0.75,0.75);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({x:60.1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:46.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(370));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(60.5,257.9,0.54,0.54,0,0,0,0.2,0.2);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regX:0.1,regY:0.1,scaleX:0.68,scaleY:0.68,alpha:1},8,cjs.Ease.get(1)).wait(56).to({regX:0.2,regY:0.2,scaleX:0.54,scaleY:0.54,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(374));

	// logo
	this.instance_16 = new lib.logo();
	this.instance_16.parent = this;
	this.instance_16.setTransform(60.1,82.4,0.75,0.75);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(372).to({y:237.4},11,cjs.Ease.get(1)).wait(54).to({y:82.4},9,cjs.Ease.get(1)).wait(1));

	// tr2
	this.instance_17 = new lib.dfg();
	this.instance_17.parent = this;
	this.instance_17.setTransform(17.6,590.2);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(297).to({alpha:1},6,cjs.Ease.get(1)).wait(63).to({alpha:0},6,cjs.Ease.get(1)).wait(75));

	// tr1
	this.instance_18 = new lib.fgdfg();
	this.instance_18.parent = this;
	this.instance_18.setTransform(26.5,590.2);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(232).to({alpha:1},6,cjs.Ease.get(1)).wait(53).to({alpha:0},6,cjs.Ease.get(1)).wait(150));
	...
	this.shape_1.setTransform(60,300,0.188,0.521);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(447));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(43.5,299.5,153.9,601);
// library properties:
lib.properties = {
	width: 120,
	height: 600,

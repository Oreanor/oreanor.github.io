...
(lib.gfhjfghj = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","#EEF1F4","#D6DCE3","#C8CFD9","#C3CBD6","#CED4DD","#E9ECF0","#F9FAFB","#FFFFFF"],[0,0.086,0.235,0.376,0.494,0.553,0.725,0.882,1],0,338.2,0,-133.2).s().p("A3bTiMAAAgnDMAu3AAAMAAAAnDg");
	this.shape.setTransform(150,125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.gfhjfghj, new cjs.Rectangle(0,0,300,250), null);
...
p.nominalBounds = new cjs.Rectangle(17.2,125,751.8,250);
// library properties:
lib.properties = {
	width: 300,
	height: 250,

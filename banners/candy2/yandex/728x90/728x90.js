...
lib.ssMetadata = [
		{name:"728x90_atlas_", frames: [[0,0,130,129],[132,92,60,59],[132,0,79,90]]}
];
...
}).prototype = getMCSymbolPrototype(lib.text4b, new cjs.Rectangle(-38.4,-9.6,86.7,16.6), null);
...
(lib.text3b = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAAAEIgEAIIgFgDIAHgHIgKgCIACgFIAJADIgBgJIAFAAIgBAJIAJgDIACAFIgKACIAHAHIgFADIgFgIg");
	this.shape.setTransform(56.6,-5);
...
}).prototype = getMCSymbolPrototype(lib.text3b, new cjs.Rectangle(-52.4,-9.6,115.7,16.5), null);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	// Слой 21
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#999999").ss(1,1,1).p("Eg43gG8MBxvAAAIAAN5MhxvAAAg");
	...
	this.instance.parent = this;
	this.instance.setTransform(426.8,45);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(382).to({_off:false},0).to({x:406.8,alpha:1},8,cjs.Ease.get(1)).wait(50).to({x:386.8,alpha:0},8,cjs.Ease.get(1)).wait(8));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(385.3,73);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:365.3,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:345.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(82));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(387.8,53);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({x:367.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:347.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(84));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(75.5,48.5,0.8,0.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({scaleX:1,scaleY:1,x:75.6,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.8,scaleY:0.8,x:75.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(88));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(385.7,73);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({x:365.7,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:345.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(156));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(386,53);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:366,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:346,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(158));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(75.5,48.5,0.8,0.8);
	...
	this.instance_7.setTransform(387.2,75.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({x:367.2,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:347.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(230));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(388,55.4);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({x:368,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:348,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(232));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(77.4,45.9,0.4,0.4,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({regX:0,regY:0,scaleX:0.5,scaleY:0.5,x:77,y:44.3,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,regY:0.1,scaleX:0.4,scaleY:0.4,x:77.4,y:45.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(236));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(388.2,75.5);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({x:368.2,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:348.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(304));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(388.4,52.3);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({x:368.4,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:348.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(306));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(73,45,0.475,0.475,0,0,0,0.2,0.2);
	...
	this.instance_13.setTransform(382.7,73);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({x:362.7,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:342.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(377));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(387.9,53);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({x:367.9,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:347.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(379));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(75.5,48.5,0.8,0.8);
	...
	this.instance_16.setTransform(364,22.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(371).to({regX:0.1,regY:0.1,scaleX:1.25,scaleY:1.25,x:111.1,y:41.1},11,cjs.Ease.get(1)).wait(64).to({regX:0,regY:0,scaleX:1,scaleY:1,x:364,y:22.3},9,cjs.Ease.get(1)).wait(1));

	// tr2
	this.instance_17 = new lib.dfg();
	this.instance_17.parent = this;
	this.instance_17.setTransform(608.6,80.2);
	this.instance_17.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(297).to({alpha:1},6,cjs.Ease.get(1)).wait(63).to({alpha:0},6,cjs.Ease.get(1)).wait(84));

	// tr1
	this.instance_18 = new lib.fgdfg();
	this.instance_18.parent = this;
	this.instance_18.setTransform(617.5,80.2);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(232).to({alpha:1},6,cjs.Ease.get(1)).wait(53).to({alpha:0},6,cjs.Ease.get(1)).wait(159));

	// Слой 1
	this.instance_19 = new lib.pic_static();
	this.instance_19.parent = this;
	this.instance_19.setTransform(649,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(456));

	// bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#EEF1F4","#D6DCE3","#C8CFD9","#C3CBD6","#CED4DD","#E9ECF0","#F9FAFB","#FFFFFF"],[0,0.086,0.235,0.376,0.494,0.553,0.725,0.882,1],0,121.8,0,-47.9).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape_1.setTransform(365,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(456));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(363.5,41.5,730,103.2);
// library properties:
lib.properties = {
	width: 728,
	height: 90,

...
lib.ssMetadata = [
		{name:"160x600_atlas_", frames: [[0,0,285,283],[0,285,131,128]]}
];
...
(lib.text4b = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAAAEIgFAIIgEgDIAGgHIgJgCIACgFIAJADIgBgJIAFAAIgBAJIAJgDIACAFIgKACIAHAHIgFADIgFgIg");
	this.shape.setTransform(40.6,-5);
...
}).prototype = getMCSymbolPrototype(lib.text4b, new cjs.Rectangle(-38.4,-9.6,85.7,16.6), null);
...
(lib.text3b = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAAAEIgFAIIgEgDIAGgHIgJgCIACgFIAJADIgBgJIAEAAIAAAJIAJgDIACAFIgKACIAHAHIgFADIgFgIg");
	this.shape.setTransform(51.6,-5);
...
}).prototype = getMCSymbolPrototype(lib.text3b, new cjs.Rectangle(-47.2,-9.6,105.5,15.8), null);
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(100.8,384.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(373).to({_off:false},0).to({x:80.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:60.8,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// text4b
	this.instance_1 = new lib.text4b();
	this.instance_1.parent = this;
	this.instance_1.setTransform(99.3,424.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(300).to({_off:false},0).to({x:80,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:79.3},0).to({x:59.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(73));

	// text4a
	this.instance_2 = new lib.text4a();
	this.instance_2.parent = this;
	this.instance_2.setTransform(101.8,406.3);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({x:81.8,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:61.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(75));

	// pic4
	this.instance_3 = new lib.pic4_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(80.5,253.5,0.72,0.72,0,0,0,0.1,0);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(294).to({_off:false},0).to({regX:0,scaleX:0.9,scaleY:0.9,alpha:1},8,cjs.Ease.get(1)).wait(57).to({regX:0.1,scaleX:0.72,scaleY:0.72,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(79));

	// text3b
	this.instance_4 = new lib.text3b();
	this.instance_4.parent = this;
	this.instance_4.setTransform(99.7,424.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(226).to({_off:false},0).to({x:80,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:79.7},0).to({x:59.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(147));

	// text3a
	this.instance_5 = new lib.text3a();
	this.instance_5.parent = this;
	this.instance_5.setTransform(100,407.2);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(224).to({_off:false},0).to({x:80,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:60,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(149));

	// pic3
	this.instance_6 = new lib.pic0_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(80.5,253.5,0.72,0.72);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({scaleX:0.9,scaleY:0.9,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.72,scaleY:0.72,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(153));

	// text2b
	this.instance_7 = new lib.text2b();
	this.instance_7.parent = this;
	this.instance_7.setTransform(101.2,424.8);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(152).to({_off:false},0).to({x:80,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:61.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(221));

	// text2a
	this.instance_8 = new lib.text2a();
	this.instance_8.parent = this;
	this.instance_8.setTransform(102,376.3);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(150).to({_off:false},0).to({x:82,alpha:1},8,cjs.Ease.get(1)).wait(57).to({x:62,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(223));

	// pic2
	this.instance_9 = new lib.pic2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(77.7,253.4,0.8,0.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(146).to({_off:false},0).to({scaleX:1,scaleY:1,x:77,y:250.3,alpha:1},8,cjs.Ease.get(1)).wait(57).to({scaleX:0.8,scaleY:0.8,x:77.7,y:253.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(227));

	// text1b
	this.instance_10 = new lib.text1b();
	this.instance_10.parent = this;
	this.instance_10.setTransform(102.2,419);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(79).to({_off:false},0).to({x:80,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:62.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(295));

	// text1a
	this.instance_11 = new lib.text1a();
	this.instance_11.parent = this;
	this.instance_11.setTransform(100.3,367.1,0.882,0.882,0,0,0,0.4,0.3);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(77).to({_off:false},0).to({regX:0.1,x:80,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:64.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(297));

	// pic1
	this.instance_12 = new lib.pic1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(73,245,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(73).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(301));

	// text0b
	this.instance_13 = new lib.text0b();
	this.instance_13.parent = this;
	this.instance_13.setTransform(96.7,472.6);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(6).to({_off:false},0).to({x:76.7,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:56.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(368));

	// text0a
	this.instance_14 = new lib.text0a();
	this.instance_14.parent = this;
	this.instance_14.setTransform(101.9,404.9);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(4).to({_off:false},0).to({x:80.1,alpha:1},8,cjs.Ease.get(1)).wait(56).to({x:61.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(370));

	// pic0
	this.instance_15 = new lib.pic0_1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(80.5,253.5,0.72,0.72);
	this.instance_15.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({scaleX:0.9,scaleY:0.9,alpha:1},8,cjs.Ease.get(1)).wait(56).to({scaleX:0.72,scaleY:0.72,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(374));

	// logo
	this.instance_16 = new lib.logo();
	this.instance_16.parent = this;
	this.instance_16.setTransform(80,59.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(372).to({y:159.5},11,cjs.Ease.get(1)).wait(54).to({y:59.5},9,cjs.Ease.get(1)).wait(1));
	...
	this.shape_1.setTransform(80,300,0.25,0.521);
...
p.nominalBounds = new cjs.Rectangle(57.9,299.5,205.2,601);
// library properties:
lib.properties = {
	width: 160,
	height: 600,

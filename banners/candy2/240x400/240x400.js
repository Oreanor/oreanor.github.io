...
lib.ssMetadata = [
		{name:"240x400_atlas_", frames: [[0,0,285,283],[0,285,131,128]]}
];
...
(lib.text2a = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4A4A49").s().p("Ah2APIAAgdIDtAAIAAAdg");
	this.shape.setTransform(44.5,1.5,0.375,0.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A4A49").s().p("Ag9CnQgagQgYgmIAagQQAZAkATAJQAUAKAVAAQAfAAAXgTQAWgTAAglQAAgUgIgOQgIgPgNgJQgNgIgNgDQgOgCgaAAIgGAAIAAgeIALAAQBJAAAAg+QABgdgSgRQgSgRgYAAQgiAAgcAgIgYgWQAkgqAzAAQAoAAAbAYQAbAZAAAnQAAA3gyAZQBCAUAABGQAAAwgdAcQgeAdgzAAQgjAAgbgPg");
	this.shape_1.setTransform(30.2,0,0.375,0.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#4A4A49").s().p("ABhCtIAAkJIjcEJIgHAAIAAlZIAhAAIAAENIDdkNIAIAAIAAFZg");
	this.shape_2.setTransform(18.7,0,0.375,0.375);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A49").s().p("ABwCtIhvkLIhwELIgkAAICRlZIAHAAICPFZg");
	this.shape_3.setTransform(6.1,0,0.375,0.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4A4A49").s().p("Ah8CBQg0g0AAhLQAAgxAYgrQAWgqApgZQApgYAvAAQBLAAAzA0QAzA1ABBMQgBBLgzA2QgyA1hLAAQhJAAgzg1gAhGh/QghASgTAkQgTAiAAAoQAAA+ApArQAqAqA6AAQAnAAAggTQAhgTATgjQATghgBgqQABgpgTghQgTgighgTQgigUglAAQgmAAggAUg");
	this.shape_4.setTransform(-7.6,0,0.375,0.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4A4A49").s().p("AhnCtIAAlZIBCAAQA5AAATAFQAcAHAUAXQARAWABAjQAAAigSAXQgSAXgfAGQgXAGg9AAIgYAAIAAChgAhGgVIA5ABQAiAAAPgHQAQgGAJgPQAJgOAAgSQAAgRgJgPQgJgOgPgGQgPgGghAAIg7AAg");
	this.shape_5.setTransform(-20.1,0,0.375,0.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4A4A49").s().p("ABhCtIAAkJIjcEJIgIAAIAAlZIAiAAIAAENIDdkNIAHAAIAAFZg");
	this.shape_6.setTransform(-32,0,0.375,0.375);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4A4A49").s().p("ABVCtIAAk4IipAAIAAE4IghAAIAAlZIDrAAIAAFZg");
	this.shape_7.setTransform(-44.5,0,0.375,0.375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text2a, new cjs.Rectangle(-48.9,-6.8,97.9,13.7), null);
...
(lib.text1a = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4A4A49").s().p("Ah2APIAAgdIDtAAIAAAdg");
	this.shape.setTransform(66.5,1.4,0.375,0.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4A4A49").s().p("AB9CuIg1hzIiPAAIg0BzIglAAICelbIAHAAICcFbgAg3AaIBxAAIg5h8g");
	this.shape_1.setTransform(50.8,0,0.375,0.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#4A4A49").s().p("ABECuIiRiiIAACiIgjAAIAAlbIAjAAIAACDICEiDIAtAAIifCdICsC+g");
	this.shape_2.setTransform(39.8,0,0.375,0.375);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#4A4A49").s().p("AgQCuIAAk5IhLAAIAAgiIC3AAIAAAiIhLAAIAAE5g");
	this.shape_3.setTransform(30.3,0,0.375,0.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4A4A49").s().p("Ah4B6Qgrg1AAhGQAAhMA0g0QA0g0BMAAQAuAAAnATQAmATAXAjIgaAVQgWgegegPQgggPgkAAQglAAgjAUQgjAUgTAhQgSAiAAApQAABAAqAqQAqAqA+AAQBIAAAug5IAaAVQgYAhgmASQglASgvAAQhVAAg0g8g");
	this.shape_4.setTransform(19.5,0,0.375,0.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4A4A49").s().p("ABhCuIAAkKIjcEKIgIAAIAAlbIAiAAIAAEOIDdkOIAIAAIAAFbg");
	this.shape_5.setTransform(5.9,0,0.375,0.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#4A4A49").s().p("ABECtIAAijIgYAAQgzAAgVgEQgXgEgSgOQgSgNgHgWQgHgUAAglIAAhFIAhAAIAABIQAAAsARAQQARATAmAAIBAAAIAAiXIAiAAIAAFag");
	this.shape_6.setTransform(-5.9,0,0.375,0.375);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#4A4A49").s().p("Ah8CBQgzg0AAhMQAAgwAXgrQAXgqApgZQAogYAvAAQBLAAAzA0QAzA1AABMQAABMgzA1QgzA1hJAAQhKAAgzg1gAhGh/QghATgTAjQgTAiAAAoQAAA+AqArQApAqA6AAQAmAAAigTQAggTATgjQATghAAgqQAAgpgTghQgTgighgTQgigVglAAQgkAAgiAVg");
	this.shape_7.setTransform(-17.6,0,0.375,0.375);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#4A4A49").s().p("AB9CtIg0hxIiQAAIg0BxIglAAICelaIAHAAICcFagAg3AaIBxAAIg5h9g");
	this.shape_8.setTransform(-31.6,0,0.375,0.375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#4A4A49").s().p("AhjCuIAAlbIBCAAQAmAAAWAKQAWALAMAUQAMAUAAAZQAAAXgLASQgKATgWAMQAaAJAPAMQAOAOAHAQQAIARAAAVQAAAqgdAdQgdAdgxAAgAhCCLIApAAQAkAAARgGQAQgIALgQQALgQAAgSQAAgXgPgSQgPgRgZgGQgQgFgqAAIgTAAgAhCgbIATAAQAiAAAQgHQAQgGAKgPQAKgQAAgQQAAgYgQgNQgQgOgjgBIgmAAg");
	this.shape_9.setTransform(-42.8,0,0.375,0.375);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#4A4A49").s().p("ABECtIiSihIAAChIgiAAIAAlZIAiAAIAACCICFiCIAtAAIigCcICtC9g");
	this.shape_10.setTransform(-52.7,0,0.375,0.375);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#4A4A49").s().p("AB9CuIg0hyIiQAAIg0ByIglAAICelaIAHAAICcFagAg4AaIByAAIg5h9g");
	this.shape_11.setTransform(-64.9,0,0.375,0.375);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.text1a, new cjs.Rectangle(-70.9,-6.8,141.9,13.7), null);
...
(lib.pic1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:40.3,y:44.5},11,cjs.Ease.get(0.71)).to({x:28.3,y:41.5},12,cjs.Ease.get(0.71)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:44.6,y:34.8},11,cjs.Ease.get(0.71)).to({x:41.6,y:30.8},12,cjs.Ease.get(0.71)).wait(1));
...
(lib._240x400 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(140.8,309.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(298).to({_off:false},0).to({x:120.8,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:100.8,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// pic5
	this.instance_1 = new lib.pic0_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(120.5,193.5,0.8,0.8);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(293).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(42).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(5));

	// text4b
	this.instance_2 = new lib.text4b();
	this.instance_2.parent = this;
	this.instance_2.setTransform(139.3,324.9);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(240).to({_off:false},0).to({x:119.3,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:99.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(58));

	// text4a
	this.instance_3 = new lib.text4a();
	this.instance_3.parent = this;
	this.instance_3.setTransform(141.8,306.3);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({x:121.8,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:101.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(60));

	// pic4
	this.instance_4 = new lib.pic4_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(120.5,193.5,0.8,0.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(234).to({_off:false},0).to({scaleX:1,scaleY:1,x:120.6,alpha:1},8,cjs.Ease.get(1)).wait(42).to({scaleX:0.8,scaleY:0.8,x:120.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(64));

	// text3b
	this.instance_5 = new lib.text3b();
	this.instance_5.parent = this;
	this.instance_5.setTransform(139.7,324.6);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(181).to({_off:false},0).to({x:119.7,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:99.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(117));

	// text3a
	this.instance_6 = new lib.text3a();
	this.instance_6.parent = this;
	this.instance_6.setTransform(140,307.2);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(179).to({_off:false},0).to({x:120,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:100,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(119));

	// pic3
	this.instance_7 = new lib.pic0_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(120.5,193.5,0.8,0.8);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(175).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(42).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(123));

	// text2b
	this.instance_8 = new lib.text2b();
	this.instance_8.parent = this;
	this.instance_8.setTransform(141.2,324.8);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(122).to({_off:false},0).to({x:121.2,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:101.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(176));

	// text2a
	this.instance_9 = new lib.text2a();
	this.instance_9.parent = this;
	this.instance_9.setTransform(142,281.3);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(120).to({_off:false},0).to({x:122,alpha:1},8,cjs.Ease.get(1)).wait(42).to({x:102,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(178));

	// pic2
	this.instance_10 = new lib.pic2();
	this.instance_10.parent = this;
	this.instance_10.setTransform(117.7,200.9,0.8,0.8);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(116).to({_off:false},0).to({scaleX:1,scaleY:1,x:117,y:197.8,alpha:1},8,cjs.Ease.get(1)).wait(42).to({scaleX:0.8,scaleY:0.8,x:117.7,y:200.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(182));

	// text1b
	this.instance_11 = new lib.text1b();
	this.instance_11.parent = this;
	this.instance_11.setTransform(142.2,319);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(64).to({_off:false},0).to({x:122.2,alpha:1},8,cjs.Ease.get(1)).wait(41).to({x:102.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(235));

	// text1a
	this.instance_12 = new lib.text1a();
	this.instance_12.parent = this;
	this.instance_12.setTransform(142.4,274.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(62).to({_off:false},0).to({x:122.4,alpha:1},8,cjs.Ease.get(1)).wait(41).to({x:102.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(237));

	// pic1
	this.instance_13 = new lib.pic1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(113,185,0.8,0.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(58).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(41).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(241));

	// text0b
	this.instance_14 = new lib.text0b();
	this.instance_14.parent = this;
	this.instance_14.setTransform(136.7,352.6);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(6).to({_off:false},0).to({x:116.7,alpha:1},8,cjs.Ease.get(1)).wait(41).to({x:96.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(293));

	// text0a
	this.instance_15 = new lib.text0a();
	this.instance_15.parent = this;
	this.instance_15.setTransform(141.9,304.9);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(4).to({_off:false},0).to({x:121.9,alpha:1},8,cjs.Ease.get(1)).wait(41).to({x:101.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(295));

	// pic0
	this.instance_16 = new lib.pic0_1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(120.5,193.5,0.8,0.8);
	this.instance_16.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({scaleX:1,scaleY:1,alpha:1},8,cjs.Ease.get(1)).wait(41).to({scaleX:0.8,scaleY:0.8,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(299));

	// logo
	this.instance_17 = new lib.logo();
	this.instance_17.parent = this;
	this.instance_17.setTransform(117.4,59.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(357));
	...
	this.shape_1.setTransform(120,200,0.375,0.417);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(357));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/240x400_atlas_.png?1528232744018", id:"240x400_atlas_"}
	],
	preloads: []
};

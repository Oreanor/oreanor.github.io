...
lib.ssMetadata = [
		{name:"728x90_atlas_", frames: [[0,0,198,164],[0,166,135,90]]}
];
...
(lib.pic2_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-68,-45);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.pic2_1, new cjs.Rectangle(-68,-45,135,90), null);
...
(lib.dfgdfggg = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(168.1,10.8);
	...
	this.shape_1.setTransform(163.7,10.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAFAdIAAgOIgYAAIAAgGIAZglIAGAAIAAAlIAIAAIAAAGIgIAAIAAAOgAgMAJIARAAIAAgZg");
	this.shape_2.setTransform(159,10.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgMAXQgGgHAAgQQAAgJADgGQACgHADgDQAFgDAFAAQAFAAADACQADABADAEIADAIIABANQAAAKgCAGQgBAGgEAEQgFADgGAAQgHAAgFgGgAgHgSQgDAFgBANQABAOADAFQADAEAEAAQAFAAADgEQAEgFAAgOQAAgNgEgFQgDgEgFAAQgEAAgDAEg");
	this.shape_3.setTransform(154.7,10.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgKAcQAAgHADgJQACgKAFgIQAEgIAGgHIgcAAIAAgGIAlAAIAAAFQgGAGgGAKQgFAIgCALQgCAHgBAIg");
	this.shape_4.setTransform(150.3,10.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgMAXQgGgHAAgQQABgJACgGQACgHADgDQAFgDAFAAQAEAAAEACQADABADAEIADAIIACANQgBAKgCAGQgCAGgDAEQgFADgGAAQgIAAgEgGgAgHgSQgDAFgBANQABAOADAFQADAEAEAAQAFAAADgEQADgFABgOQgBgNgDgFQgDgEgFAAQgEAAgDAEg");
	this.shape_5.setTransform(145.8,10.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgMAXQgGgHAAgPQAAgPAGgIQAGgGAHAAQAIAAADAEQAFADABAHIgHABQgBgFgCgBQgDgDgEAAIgFABQgDADgCAEQgCAFAAAJQADgEADgCIAHgCQAHAAAFAFQAFAEAAAJQAAAFgCAFQgDAEgEADQgEACgFAAQgIAAgFgGgAgHABQgDADAAAGIABAHQACADADACQACABADAAQAEAAADgDQADgEAAgGQAAgGgDgDQgDgDgFAAQgEAAgDADg");
	this.shape_6.setTransform(141.4,10.8);
	...
	this.shape_14.setTransform(101.9,10.8);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#000000").s().p("AgRAdIAAg5IAjAAIAAAHIgcAAIAAAyg");
	this.shape_15.setTransform(97.3,10.8);
	...
	this.shape_16.setTransform(91.7,10.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#000000").s().p("AgNAYQgEgEgBgHIAHgBQABAGADACQADADAEAAQAEAAAEgEQADgEABgGQgBgGgDgDQgEgDgEAAQgEAAgCACQgDABgCACIgGgBIAFgdIAcAAIAAAHIgWAAIgDAPQAFgDAFAAQAIAAAEAFQAGAEAAAIQAAAIgFAGQgFAHgJAAQgIAAgFgFg");
	this.shape_17.setTransform(84.2,10.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_18.setTransform(79.4,10.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#000000").s().p("AgMAXQgFgHgBgQQAAgJACgGQADgHAEgDQADgDAGAAQAEAAAEACQAEABACAEIADAIIABANQAAAKgBAGQgCAGgFAEQgEADgGAAQgIAAgEgGgAgHgSQgEAFABANQgBAOAEAFQADAEAEAAQAFAAADgEQAEgFgBgOQABgNgEgFQgDgEgFAAQgEAAgDAEg");
	this.shape_19.setTransform(75.2,10.8);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#000000").s().p("AgSAdIAAgFIAGgIIAJgIQAIgIADgEQAEgEgBgEQAAgEgDgDQgDgDgFAAQgEAAgDADQgCADAAAGIgIgBQABgIAFgEQAFgFAHAAQAIAAAFAFQAEAEAAAHIgBAHQgBADgEADQgDAEgHAGIgIAHIgCAEIAbAAIAAAHg");
	this.shape_20.setTransform(70.7,10.8);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_21.setTransform(66,10.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#000000").s().p("AgMAYQgGgEAAgHIAHgBQABAGADACQADADAEAAQAEAAAEgEQAEgEAAgGQAAgGgEgDQgEgDgEAAQgEAAgCACQgDABgBACIgHgBIAGgdIAbAAIAAAHIgWAAIgDAPQAFgDAFAAQAHAAAGAFQAFAEAAAIQAAAIgEAGQgGAHgJAAQgIAAgEgFg");
	this.shape_22.setTransform(61.9,10.9);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#000000").s().p("AAFAdIAAgOIgYAAIAAgGIAZglIAGAAIAAAlIAIAAIAAAGIgIAAIAAAOgAgMAJIARAAIAAgZg");
	this.shape_23.setTransform(57.3,10.8);
	...
	this.shape_24.setTransform(53,10.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#000000").s().p("AgJAcQgBgHADgJQADgKAEgIQAEgIAGgHIgbAAIAAgGIAjAAIAAAFQgFAGgFAKQgGAIgCALQgCAHAAAIg");
	this.shape_25.setTransform(48.6,10.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#000000").s().p("AgKAcQAAgHADgJQACgKAFgIQAEgIAGgHIgcAAIAAgGIAlAAIAAAFQgGAGgGAKQgFAIgCALQgCAHgBAIg");
	this.shape_26.setTransform(44.1,10.8);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgIAAIAAg5IAIAAIAAAYIAdAAIAAgYIAHAAIAAA5g");
	this.shape_27.setTransform(36.8,10.8);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgHAAIAAg5IAHAAIAAAYIAdAAIAAgYIAIAAIAAA5g");
	this.shape_28.setTransform(31,10.8);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#000000").s().p("AAPAdIAAgsIgdAsIgIAAIAAg5IAHAAIAAAtIAdgtIAIAAIAAA5g");
	this.shape_29.setTransform(25.2,10.8);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_30.setTransform(19.1,13.3);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("");
	this.shape_31.setTransform(15.7,10.8);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_32.setTransform(10.2,13.3);
	...
	this.shape_33.setTransform(6.6,12.2);
	...
	this.shape_34.setTransform(244.2,4.9);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AAKAdIAAgfIgTAfIgHAAIAAgpIAHAAIAAAfIASgfIAIAAIAAApgAgHgUQgDgDAAgFIAEAAIADAFIADAAIAFAAIACgFIAFAAQgBAFgDADQgCADgGAAQgDAAgEgDg");
	this.shape_35.setTransform(240.9,1.9);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AgKAEIAAgHIAVAAIAAAHg");
	this.shape_36.setTransform(237.3,2.7);
	...
	this.shape_37.setTransform(233.7,1.9);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AAKAdIAAgfIgTAfIgHAAIAAgpIAHAAIAAAfIASgfIAIAAIAAApgAgGgUQgEgDAAgFIAFAAIACAFIADAAIAFAAIACgFIAFAAQAAAFgEADQgCADgGAAQgDAAgDgDg");
	this.shape_38.setTransform(227.2,1.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AAKAVIAAgfIgSAfIgIAAIAAgpIAHAAIAAAfIASgfIAIAAIAAApg");
	this.shape_39.setTransform(222.7,2.7);
	...
	this.shape_40.setTransform(219,2.7);
	...
	this.shape_44.setTransform(201,3.3);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#000000").s().p("AgNAQQgGgFABgLQAAgLAGgFQAFgFAHAAQAJAAAFAGQAFAGAAAJQABAHgDAFQgDAFgEACQgFADgFAAQgHAAgGgGgAgIgLQgDAEAAAHQAAAIADAEQAEAEAEAAQAGAAADgEQAEgEgBgIQABgHgEgEQgDgEgGAAQgEAAgEAEg");
	this.shape_45.setTransform(195.3,2.7);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("#000000").s().p("AgVAdIAAg5IAVAAIAIABQAEABAEACQADACABADQACAEAAAEQAAAHgFAEQgFAFgMAAIgNAAIAAAYgAgNAAIANAAQAIAAADgDQADgDAAgFQAAgDgBgDQgDgCgCgBIgIgBIgNAAg");
	this.shape_46.setTransform(190.5,1.9);
	...
	this.shape_47.setTransform(183.1,3.3);
	...
	this.shape_48.setTransform(179,2.7);
	...
	this.shape_49.setTransform(175,2.7);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#000000").s().p("AgNAQQgGgFABgLQAAgLAGgFQAFgFAHAAQAJAAAFAGQAFAGAAAJQABAHgDAFQgDAFgEACQgFADgFAAQgHAAgGgGgAgIgLQgDAEAAAHQAAAIADAEQAEAEAEAAQAGAAADgEQAEgEgBgIQABgHgEgEQgDgEgGAAQgEAAgEAEg");
	this.shape_50.setTransform(170.5,2.7);
	...
	this.shape_51.setTransform(166.2,3.4);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#000000").s().p("AAOAdIAAgyIgcAAIAAAyIgHAAIAAg5IAsAAIAAA5g");
	this.shape_52.setTransform(161,1.9);
	...
	this.shape_53.setTransform(154.8,4.9);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("");
	this.shape_54.setTransform(151.5,2.7);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AgQAVIAAgpIAQAAIAIABQADABACADQACADAAADIgBAFIgEAEQADAAACADQACACAAAEQgBAGgDADQgEADgHAAgAgJAPIAJAAIAHgBQADgCAAgDIgBgEQgBAAAAgBQgBAAAAAAQgBgBAAAAQAAAAgBAAIgGAAIgIAAgAgJgCIAHAAIAFgBIADgCQABAAAAgBQAAAAABAAQAAgBAAAAQAAgBAAAAQAAgDgDgCIgHgBIgHAAg");
	this.shape_55.setTransform(147.3,2.7);
	...
	this.shape_56.setTransform(143.5,2.7);
	...
	this.shape_57.setTransform(139.6,2.7);
	...
	this.shape_62.setTransform(115.8,4.9);
	...
	this.shape_66.setTransform(99.2,2);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_67.setTransform(94.4,1.9);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#000000").s().p("AAEAdIAAgsIgGAFIgIADIAAgGQAGgDAEgEQAEgEACgEIAFAAIAAA5g");
	this.shape_68.setTransform(89.9,1.9);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#000000").s().p("AgBASIAKgSIgKgRIAFAAIANARIgNASgAgQASIALgSIgLgRIAGAAIALARIgLASg");
	this.shape_69.setTransform(83.6,2.7);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_70.setTransform(80.3,4.4);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#000000").s().p("AgSAdIAAg5IAkAAIAAAHIgcAAIAAAyg");
	this.shape_71.setTransform(77.3,1.9);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_72.setTransform(73.8,4.4);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgIAAIAAg5IAIAAIAAAYIAdAAIAAgYIAHAAIAAA5g");
	this.shape_73.setTransform(69.7,1.9);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#000000").s().p("AgDAEIAAgHIAHAAIAAAHg");
	this.shape_74.setTransform(65.8,4.4);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#000000").s().p("AgMAZQgGgDgDgHQgDgIAAgHQAAgIADgHQAEgHAGgDQAGgEAHAAQAIAAAGAFQAGAEACAIIgHABQgCgFgEgEQgEgDgFAAQgGABgEADQgFADgCAFQgBAGAAAFQAAAGACAGQACAGAEADQAFACAEAAQAGAAAFgDQAEgFACgGIAHACQgCAIgGAFQgGAGgJAAQgJAAgFgFg");
	this.shape_75.setTransform(61.7,1.9);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#000000").s().p("AAPAdIAAgsIgdAsIgIAAIAAg5IAHAAIAAAtIAdgtIAIAAIAAA5g");
	this.shape_76.setTransform(53.8,1.9);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#000000").s().p("AATAkIAAgOIglAAIAAAOIgHAAIAAgVIAFAAQAHgKAAgfIAAgIIAhAAIAAAxIAGAAIAAAVgAgGgZIgBAUQgCAMgEAIIAaAAIAAgqIgTAAg");
	this.shape_77.setTransform(48,2.6);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#000000").s().p("AAPAdIAAgbIgdAAIAAAbIgHAAIAAg5IAHAAIAAAYIAdAAIAAgYIAIAAIAAA5g");
	this.shape_78.setTransform(42.6,1.9);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#000000").s().p("AASAdIgHgSIgXAAIgGASIgIAAIAWg5IAHAAIAYA5gAgDgLIgGAQIASAAIgGgPIgDgLIgDAKg");
	this.shape_79.setTransform(37,1.9);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#000000").s().p("AALAdIgKgQQgDgGgDgDQgDgCgEAAIAAAbIgHAAIAAg5IAHAAIAAAaQAFAAADgCQACgCACgIIAEgIIAEgEQADgCAEAAIAFABIAAAGIgCAAIgCAAQgEAAgBACIgFAHQgCAIgCABIgEADQAEABAGAJIAMATg");
	this.shape_80.setTransform(32.3,1.9);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#000000").s().p("AALASIgLgSIALgRIAGAAIgKARIAKASgAgDASIgNgSIANgRIAFAAIgJARIAJASg");
	this.shape_81.setTransform(27.4,2.7);
	...
	this.shape_82.setTransform(19.9,1.9);
	...
	this.shape_83.setTransform(13.7,1.9);
	...
	this.shape_84.setTransform(7.5,1.9);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfggg, new cjs.Rectangle(2.4,-4.4,250.6,21.8), null);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	this.addr2.setTransform(1.6,71.8);
	...
	this.instance.parent = this;
	this.instance.setTransform(549.1,60.3,0.99,0.049,0,0,0,0.1,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(108).to({_off:false},0).to({scaleY:0.99},6,cjs.Ease.get(1)).wait(76).to({scaleY:0.05,y:58.1},6,cjs.Ease.get(1)).to({_off:true},1).wait(3));

	// text2a
	this.instance_1 = new lib.text2a();
	this.instance_1.parent = this;
	this.instance_1.setTransform(566.7,30.9,0.968,0.968,0,0,0,0.1,0.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(104).to({_off:false},0).to({x:546.7,alpha:1},6,cjs.Ease.get(1)).wait(77).to({x:526.7,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(6));

	// pic2
	this.instance_2 = new lib.pic2_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(350,45.8,0.8,0.8);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(101).to({_off:false},0).to({scaleX:1,scaleY:1,x:320,alpha:1},6,cjs.Ease.get(1)).wait(77).to({scaleX:0.8,scaleY:0.8,x:290,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(9));

	// text1a
	this.instance_3 = new lib.text1a();
	this.instance_3.parent = this;
	this.instance_3.setTransform(569.1,30.7,1.089,1.089,0,0,0,0.2,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(3).to({_off:false},0).to({x:549.1,alpha:1},6,cjs.Ease.get(1)).wait(78).to({x:529.1,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(106));

	// pic1
	this.instance_4 = new lib.pic1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(333.7,46,0.448,0.448,0,0,0,0.1,0);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:0.56,scaleY:0.56,x:316.9,alpha:1},6,cjs.Ease.get(1)).wait(78).to({scaleX:0.45,scaleY:0.45,x:305.7,alpha:0},6,cjs.Ease.get(1)).to({_off:true},1).wait(109));

	// text1b
	this.instance_5 = new lib.text1b();
	this.instance_5.parent = this;
	this.instance_5.setTransform(550.1,58,0.99,0.049,0,0,0,0.1,3.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(12).to({_off:false},0).to({regX:0,regY:0,scaleY:0.99,x:550,y:57.8},6,cjs.Ease.get(1)).wait(73).to({regX:0.1,regY:2,scaleY:0.05,x:550.1,y:57.9},6,cjs.Ease.get(1)).to({_off:true},1).wait(102));

	// rect
	this.instance_6 = new lib.rect();
	this.instance_6.parent = this;
	this.instance_6.setTransform(550.1,58,0.942,0.049,0,0,0,0.1,3.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(8).to({_off:false},0).to({regY:1.1,scaleY:1.09},4,cjs.Ease.get(1)).to({regY:0.1,scaleY:0.99},2).wait(80).to({regY:3.1,scaleY:0.05},6,cjs.Ease.get(1)).to({_off:true},1).wait(1).to({_off:false,scaleX:1.02},0).to({regY:1.1,scaleY:1.09},4,cjs.Ease.get(1)).to({regY:0.1,scaleY:0.99},2).wait(85).to({regY:3.1,scaleY:0.05},6,cjs.Ease.get(1)).wait(1));

	// logo
	this.instance_7 = new lib.logo();
	this.instance_7.parent = this;
	this.instance_7.setTransform(127,40.1,0.9,0.9,0,0,0,0.1,0.1);
	...
	this.instance_8.setTransform(364,45,3.033,0.225,0,0,0,120,200);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_atlas_.png?1539294529204", id:"728x90_atlas_"}
	],
	preloads: []
};

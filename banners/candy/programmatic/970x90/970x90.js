...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("Eg4UAHCIAAuDMBwpAAAIAAODg");
	this.shape_10.setTransform(610.5,45);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],125,0,-124.9,0).s().p("AzhHCIAAuDMAnDAAAIAAODg");
	this.shape_11.setTransform(125,45);

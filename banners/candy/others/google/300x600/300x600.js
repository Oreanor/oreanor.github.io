...
lib.ssMetadata = [
		...
		{name:"300x600_atlas_NP_", frames: [[0,202,300,200],[0,0,300,200],[0,404,300,200]]}
];
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(296).call(this.frame_296).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(257).to({_off:false},0).to({scaleX:1,scaleY:1,x:192,y:339,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:162,y:337,alpha:0},8,cjs.Ease.get(1)).wait(1));

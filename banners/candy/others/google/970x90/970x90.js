...
lib.ssMetadata = [
		{name:"970x90_atlas_P_", frames: [[0,0,130,160],[132,0,122,160]]},
		{name:"970x90_atlas_NP_", frames: [[0,184,240,90],[0,92,240,90],[0,0,240,90]]}
];
...
(lib.ghjghjhjj = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(26.9,-1);
	...
	this.shape_2.setTransform(18.4,-1);
	...
	this.shape_4.setTransform(-3.4,-1);
	...
	this.shape_5.setTransform(-11.7,-1);
	...
	this.shape_6.setTransform(-22.2,-1.1);
	...
	this.shape_9.setTransform(25.1,-0.9);
...
p.nominalBounds = new cjs.Rectangle(-48.2,-24.1,103.2,46.6);
...
(lib.jlkjl = function(mode,startPosition,loop) {
	...
	this.instance = new lib.hhggh();
	this.instance.parent = this;
	this.instance.setTransform(-34,12.4,1.06,1.061,0,0,0,65.2,7.8);

	this.instance_1 = new lib.hhhj();
	this.instance_1.parent = this;
	this.instance_1.setTransform(93.1,12.7,1.205,1.205,0,0,0,27.8,6.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1D1D1B").s().p("AAlBAIAAhhIhUBhIgDAAIAAh/IANAAIAABjIBUhjIADAAIAAB/g");
	this.shape.setTransform(135,12.5,1.21,1.21);
	...
	this.shape_1.setTransform(44.4,10.7,1.21,1.21);
	...
	this.shape_10.setTransform(-28.7,-13.5,1.21,1.21);
...
}).prototype = getMCSymbolPrototype(lib.jlkjl, new cjs.Rectangle(-103.1,-21.6,244.3,42.5), null);
...
(lib._970x90 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(959,70.2,1,1,-90,0,0,13.5,6.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(959.3,12.8,1,1,-90,0,0,70.7,6.5);
	...
	this.instance_2.setTransform(959.4,56.2,1,1,-90,0,0,27.9,6.5);
	...
	// Слой 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(949.9,49.9);
	...
	this.shape_2.setTransform(949.9,53.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgUARIAAgHIASAAIAAgTIgSAAIAAgHIApAAIAAAHIgTAAIAAATIATAAIAAAHg");
	this.shape_3.setTransform(949.9,57.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAKAKQgGgDAAgDQgBAGgDADQgDACgFABQgFgBgDgDQgEgEAAgHIAAgTIApAAIAAAIIgQAAIAAADIABAGQAAABAGAEIAJAFIAAAJgAgOgBQAAAGACABQABABAAAAQABABAAAAQABAAAAAAQABAAABAAQADABACgDQACgDAAgFIAAgIIgOAAg");
	this.shape_4.setTransform(949.9,62.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgUARIAAgHIAQAAIAAgJQAAgIAEgFQACgEAGAAQAFAAAEADQAEAEAAAJIAAARgAADgHQgCACAAAHIAAAIIAOAAIAAgHQAAgGgCgDQgBgDgEAAQgCAAgDACg");
	this.shape_5.setTransform(949.9,66.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgcAWIAAgkIAHAAIAAAcIASAAIAAgOQAAgGABgFQACgEADgDQAEgDAFABIAIABQAEACACAEQADAEAAAJIAAAWgAAGgLQgCACgBADIgBAKIAAAKIAUAAIAAgPQAAgFgCgEQgDgCgFAAQgDgBgDACg");
	this.shape_6.setTransform(949.1,70.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgGALIAFgJIgKABIAAgEIAKAAIgFgJIAGgCIABAKIAIgHIADAFIgIAEIAIAGIgDAEIgIgHIgBAKg");
	this.shape_7.setTransform(947.4,77.5);
	...
	this.instance_3.setTransform(285.9,45.6,0.9,0.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(193).to({_off:false},0).to({x:267.9,y:46.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:45.6},0).to({x:249.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(65));

	// i2.png
	this.instance_4 = new lib.ghjgh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(318.5,46,0.9,0.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(129).to({_off:false},0).to({x:300.5,alpha:1},8,cjs.Ease.get(0.96)).wait(52).to({startPosition:0},0).to({x:282.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(129));

	// i1.png
	this.instance_5 = new lib.ghjghj("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(281.5,51,0.9,0.9);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(65).to({_off:false},0).to({x:263.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:245.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(193));

	// i0.png
	this.instance_6 = new lib.ghjghjhjj("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(268.5,45,0.9,0.9);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({x:250.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:232.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(257));

	// t4.png
	this.instance_7 = new lib.jlkjl();
	this.instance_7.parent = this;
	this.instance_7.setTransform(178.1,45.5,0.9,0.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(256).to({_off:false},0).to({x:160.1,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:142.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(2));

	// t3.png
	this.instance_8 = new lib.hkhjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(179,45.7,0.99,0.99);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(192).to({_off:false},0).to({x:159.2,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:139.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(66));

	// t2.png
	this.instance_9 = new lib.uuiui();
	this.instance_9.parent = this;
	this.instance_9.setTransform(150.3,45.4,0.99,0.99,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(128).to({_off:false},0).to({x:130.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:110.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(130));

	// t1.png
	this.instance_10 = new lib.hhh();
	this.instance_10.parent = this;
	this.instance_10.setTransform(128.1,46.1,0.9,0.9);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(64).to({_off:false},0).to({x:110.1,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:92.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(194));

	// t0.png
	this.instance_11 = new lib.uu8();
	this.instance_11.parent = this;
	this.instance_11.setTransform(143.5,45.6,0.9,0.9);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:125.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:107.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(258));

	// Слой 5
	this.instance_12 = new lib.jkljkj();
	this.instance_12.parent = this;
	this.instance_12.setTransform(516,45);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(130).to({_off:false},0).to({x:486,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:456,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(128));

	// p0.png - копия
	this.instance_13 = new lib.eeee();
	this.instance_13.parent = this;
	this.instance_13.setTransform(527,54,0.8,0.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(258).to({_off:false},0).to({scaleX:1,scaleY:1,x:497,y:56,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:467,y:54,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// p3.png
	this.instance_14 = new lib.ghj();
	this.instance_14.parent = this;
	this.instance_14.setTransform(537,46,0.8,0.8);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(194).to({_off:false},0).to({scaleX:1,scaleY:1,x:507,y:44,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:46},0).to({scaleX:0.8,scaleY:0.8,x:477,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(64));

	// p2.png
	this.instance_15 = new lib.dfgdfg();
	this.instance_15.parent = this;
	this.instance_15.setTransform(516,51,0.8,0.8);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(66).to({_off:false},0).to({scaleX:1,scaleY:1,x:486,y:53,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:456,y:51,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(192));

	// p1.png
	this.instance_16 = new lib.ggggg();
	this.instance_16.parent = this;
	this.instance_16.setTransform(516,51,0.8,0.8);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:1,scaleY:1,x:486,y:53,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:456,y:51,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(256));
	...
	this.shape_8.setTransform(803,34.4,0.796,0.795);
	...
	this.shape_9.setTransform(851.8,62.9,0.7,0.7);

	this.instance_17 = new lib.ClipGroup();
	this.instance_17.parent = this;
	this.instance_17.setTransform(799.6,67.8,0.255,0.255,0,0,0,199.3,43.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.shape_9},{t:this.shape_8}]}).wait(327));

	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],125,0,-124.9,0).s().p("AzhHCIAAuDMAnDAAAIAAODg");
	this.shape_10.setTransform(125,45);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("Eg4UAHCIAAuDMBwpAAAIAAODg");
	this.shape_11.setTransform(610.5,45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10}]}).wait(327));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(484.5,44.5,971.5,91);
// library properties:
lib.properties = {
	width: 970,
	height: 90,
	...
	webfonts: {},
	manifest: [
		{src:"970x90_atlas_P_.png", id:"970x90_atlas_P_"},
		{src:"970x90_atlas_NP_.jpg", id:"970x90_atlas_NP_"}
	],
	preloads: []
};

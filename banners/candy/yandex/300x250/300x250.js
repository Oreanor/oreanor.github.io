...
lib.ssMetadata = [
		{name:"300x250_atlas_P_", frames: [[0,136,150,121],[0,0,150,134]]},
		{name:"300x250_atlas_NP_", frames: [[0,0,300,125],[0,254,300,125],[0,127,300,125]]}
];
...
(lib.njm = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.instance = new lib.p4();
	this.instance.parent = this;
	this.instance.setTransform(-150,-62.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.njm, new cjs.Rectangle(-150,-62.5,300,125), null);
...
}).prototype = getMCSymbolPrototype(lib.ghj, new cjs.Rectangle(-120,-107,150,134), null);
...
}).prototype = getMCSymbolPrototype(lib.ggggg, new cjs.Rectangle(-120,-97,300,125), null);
...
}).prototype = getMCSymbolPrototype(lib.eeee, new cjs.Rectangle(-120,-97,150,121), null);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfg, new cjs.Rectangle(-120,-97,300,125), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(242.1,238.4,1.188,1.188,0,0,0,13.5,6.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(310.2,238.8,1.188,1.188,0,0,0,70.6,6.5);
	...
	this.instance_2.setTransform(258.7,239,1.188,1.188,0,0,0,27.9,6.5);
	...
	// Слой 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(266.3,227.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAJAZIgJgQIgEgGQgCgBgDAAIAAAXIgIAAIAAgxIAIAAIAAAWQAEAAACgCQACgBACgIIAEgHQAAgBABAAQAAgBAAAAQABAAAAAAQABgBAAAAIAHgBIABAAIAAAHIgCAAIgEABIgDAGIgEAHIgEADQAFABAFAIIAJAQg");
	this.shape_2.setTransform(261.9,227.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AAMAZIAAgWIgXAAIAAAWIgIAAIAAgxIAIAAIAAAVIAXAAIAAgVIAIAAIAAAxg");
	this.shape_3.setTransform(256.9,227.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAOAZIAAgTIgFAAIgHABQgCABgDAGIgHALIgLAAIAJgOQAEgGAEAAQgHgBgDgEQgEgEAAgFQAAgHAFgEQAEgEAJAAIAWAAIAAAxgAgHgOQgCACAAADQAAAFADACQADACAHAAIAKAAIAAgRIgMAAQgHAAgCADg");
	this.shape_4.setTransform(251.4,227.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgTAZIAAgxIAIAAIAAAUIALAAQAJAAAGAEQAFADAAAHQAAAGgEAEQgFAFgKAAgAgLASIAJAAQAHAAADgCQAEgCAAgEQAAgDgDgDQgCgCgIAAIgKAAg");
	this.shape_5.setTransform(246.8,227.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AgZAiIAAhDIAsAAIAAAIIgiAAIAAAVIAPAAQAJAAAFACQAFABAEAEQADAFAAAGQAAAFgDAFQgCAEgEADQgFADgLAAgAgPAbIARAAQAHAAADgDQAEgEAAgFQAAgFgCgCQgCgDgEgCIgLgBIgMAAg");
	this.shape_6.setTransform(241.3,226.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AAAAFIgFAKIgGgFIAIgJIgLgBIACgHIALAFIgBgLIAFAAIgBALIALgFIACAHIgLABIAIAJIgGAFIgGgKg");
	this.shape_7.setTransform(233.5,224.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(194).to({_off:false},0).to({x:219.9,y:36.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:35.6},0).to({x:201.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(63));
	...
	// Слой 5
	this.instance_12 = new lib.njm();
	this.instance_12.parent = this;
	this.instance_12.setTransform(191,128.5,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(129).to({_off:false},0).to({scaleX:1,scaleY:1,x:151,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:111,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(128));

	// p0.png - копия
	this.instance_13 = new lib.eeee();
	this.instance_13.parent = this;
	this.instance_13.setTransform(222,161,0.8,0.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(257).to({_off:false},0).to({scaleX:1,scaleY:1,x:192,y:163,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:162,y:161,alpha:0},8,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(193).to({_off:false},0).to({scaleX:1,scaleY:1,x:190,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:160,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(65));

	// p2.png
	this.instance_15 = new lib.dfgdfg();
	this.instance_15.parent = this;
	this.instance_15.setTransform(160,161,0.8,0.8);
	...
	this.instance_16.setTransform(160,161,0.8,0.8);
	...
	this.shape_8.setTransform(150,207.5,0.578,0.578);
	...
	this.shape_9.setTransform(185.5,228.3,0.508,0.509);

	this.instance_17 = new lib.ClipGroup();
	this.instance_17.parent = this;
	this.instance_17.setTransform(147.4,232,0.185,0.185,0,0,0,200.2,44.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.shape_9},{t:this.shape_8}]}).wait(326));

	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("A3bJxIAAzhMAu3AAAIAAThg");
	this.shape_10.setTransform(150,187.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],-0.1,62.5,-0.1,-62.5).s().p("A3bJxIAAzhMAu3AAAIAAThg");
	this.shape_11.setTransform(150,62.5);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"300x250_atlas_NP_.jpg", id:"300x250_atlas_NP_"}
	],
	preloads: []
};

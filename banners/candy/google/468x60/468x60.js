...
lib.ssMetadata = [
		{name:"468x60_atlas_P_", frames: [[0,87,62,80],[0,0,69,85]]},
		{name:"468x60_atlas_NP_", frames: [[0,92,240,90],[0,184,240,90],[0,0,240,90]]}
];
...
(lib.vgbh = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.instance = new lib.p4();
	this.instance.parent = this;
	this.instance.setTransform(-79.2,-29.7,0.66,0.66);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.vgbh, new cjs.Rectangle(-79.2,-29.7,158.4,59.4), null);
...
(lib.hkhjk = function(mode,startPosition,loop) {
	...
	this.shape_4.setTransform(-6.4,10.6);
	...
	this.shape_9.setTransform(53.7,-12.5);
	...
	this.shape_12.setTransform(15.5,-11);
...
(lib.ghjghjhjj = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(31.6,-1,0.9,0.9);
	...
	this.shape_1.setTransform(21.3,-0.9,0.9,0.9);
	...
	this.shape_2.setTransform(13.7,-1,0.9,0.9);
	...
	this.shape_3.setTransform(7.1,-1,0.9,0.9);
	...
	this.shape_4.setTransform(-5.9,-1,0.9,0.9);
	...
	this.shape_5.setTransform(-13.4,-1,0.9,0.9);
	...
	this.shape_6.setTransform(-22.9,-1.1,0.9,0.9);
	...
	this.shape_7.setTransform(-33.5,-0.9,0.9,0.9);
	...
	this.shape_8.setTransform(-43.3,-0.9,0.9,0.9);
	...
	this.shape_9.setTransform(19.7,-0.8,0.9,0.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("AAAAEIgFAIIgEgDIAGgIIgJgBIACgFIAJADIgBgJIAEAAIAAAJIAJgDIACAFIgKABIAHAIIgFADIgFgIg");
	this.shape_10.setTransform(48.4,-19.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AAAAEIgEAIIgFgDIAHgIIgKgBIACgFIAJADIgBgJIAFAAIgBAJIAJgDIACAFIgKABIAHAIIgFADIgFgIg");
	this.shape_11.setTransform(45.3,-19.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-46.3,-24.1,98.4,44.3);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfg, new cjs.Rectangle(-120,-52,240,90), null);
...
(lib.uuiui = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(72.2,-8.3,1.1,1.1,0,0,0,27.8,6.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1D1D1B").s().p("AgFBBIAAh0IgeAAIAAgNIBGAAIAAANIgdAAIAAB0g");
	this.shape.setTransform(96.7,15.3,1.1,1.1);
	...
	this.shape_5.setTransform(22.3,15.3,1.1,1.1);
	...
	this.shape_8.setTransform(-19.9,15.3,1.1,1.1);
	...
	this.shape_12.setTransform(-76.1,15.3,1.1,1.1);
	...
	this.shape_20.setTransform(-34.1,-8.4,1.1,1.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#1D1D1B").s().p("AgFBBIAAh0IgeAAIAAgNIBGAAIAAANIgcAAIAAB0g");
	this.shape_21.setTransform(-44.3,-8.4,1.1,1.1);
...
(lib.uu8 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-8,-12.2,1,1,0,0,0,65.3,7.7);

	this.instance_1 = new lib.gghghg();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-3,12.5,1,1,0,0,0,65,7.5);
...
}).prototype = getMCSymbolPrototype(lib.uu8, new cjs.Rectangle(-73.3,-19.9,141.9,40), null);
...
(lib.jlkjl = function(mode,startPosition,loop) {
	...
	this.instance = new lib.hhggh();
	this.instance.parent = this;
	this.instance.setTransform(-47.6,11.2,0.964,0.964,0,0,0,65.2,7.8);

	this.instance_1 = new lib.hhhj();
	this.instance_1.parent = this;
	this.instance_1.setTransform(67.8,11.5,1.095,1.096,0,0,0,27.7,6.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#1D1D1B").s().p("AAlBAIAAhhIhUBhIgDAAIAAh/IANAAIAABjIBUhjIADAAIAAB/g");
	this.shape.setTransform(106,11.3,1.1,1.1);
	...
	this.shape_1.setTransform(23.7,9.7,1.1,1.1);
	...
	this.shape_10.setTransform(-42.8,-12.3,1.1,1.1);
...
}).prototype = getMCSymbolPrototype(lib.jlkjl, new cjs.Rectangle(-110.5,-19.7,222.1,38.6), null);
...
(lib._468x60 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(234,30,0.642,0.663);
	...
	this.instance.parent = this;
	this.instance.setTransform(459.5,45.6,0.9,0.9,-90,0,0,13.5,6.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(459.8,-6,0.9,0.9,-90,0,0,70.6,6.5);
	...
	this.instance_2.setTransform(459.9,33,0.9,0.9,-90,0,0,27.9,6.5);
	...
	this.shape_1.setTransform(451.4,27.2);
	...
	this.shape_2.setTransform(451.3,30.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgSAPIAAgGIAQAAIAAgQIgQAAIAAgHIAlAAIAAAHIgRAAIAAAQIARAAIAAAGg");
	this.shape_3.setTransform(451.3,34.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAJAKQgFgDgBgEQAAAGgDACQgDADgEAAQgFAAgDgDQgDgEAAgGIAAgQIAlAAIAAAGIgPAAIAAADIABAGQABAAAFADIAIAGIAAAIgAgMAAQAAAFABABQABAAAAABQABAAAAAAQABAAABAAQAAABABAAQADAAABgDQACgCAAgGIAAgGIgMAAg");
	this.shape_4.setTransform(451.3,38.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgSAPIAAgGIAPAAIAAgIQAAgHADgEQACgEAFAAQAFAAADADQAEAEAAAHIAAAPgAADgGQgCACAAAGIAAAHIANAAIAAgGQAAgFgCgDQgBgDgEAAQAAAAgBAAQAAAAgBAAQAAABgBAAQAAAAgBABg");
	this.shape_5.setTransform(451.3,42);
	...
	this.instance_3.setTransform(149.1,30.1,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(193).to({_off:false},0).to({x:137.2,y:30.7,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:30.1},0).to({x:125.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(65));

	// i2.png
	this.instance_4 = new lib.ghjgh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(91.5,43.6,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(129).to({_off:false},0).to({x:78.6,alpha:1},8,cjs.Ease.get(0.96)).wait(52).to({x:79.6},0).to({x:67.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(129));

	// i1.png
	this.instance_5 = new lib.ghjghj("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(91.5,46.9,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(65).to({_off:false},0).to({x:79.6,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:67.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(193));

	// i0.png
	this.instance_6 = new lib.ghjghjhjj("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(137.5,29.7,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({x:125.6,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:113.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(257));

	// t4.png
	this.instance_7 = new lib.jlkjl();
	this.instance_7.parent = this;
	this.instance_7.setTransform(101.2,30,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(256).to({_off:false},0).to({x:89.3,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:77.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(2));

	// t3.png
	this.instance_8 = new lib.hkhjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(91.8,30.2,0.653,0.653,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(192).to({_off:false},0).to({x:78.7,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:65.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(66));

	// t2.png
	this.instance_9 = new lib.uuiui();
	this.instance_9.parent = this;
	this.instance_9.setTransform(91.5,17.5,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(128).to({_off:false},0).to({x:78.6,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:79.6},0).to({x:67.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(130));

	// t1.png
	this.instance_10 = new lib.hhh();
	this.instance_10.parent = this;
	this.instance_10.setTransform(91.2,19.3,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(64).to({_off:false},0).to({x:79.3,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:67.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(194));

	// t0.png
	this.instance_11 = new lib.uu8();
	this.instance_11.parent = this;
	this.instance_11.setTransform(65,30.1,0.594,0.594,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:53.1,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:41.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(258));

	// Слой 5
	this.instance_12 = new lib.vgbh();
	this.instance_12.parent = this;
	this.instance_12.setTransform(253.2,30.7,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(130).to({_off:false},0).to({scaleX:1,scaleY:1,x:236.2,alpha:1},8,cjs.Ease.get(0.98)).wait(52).to({scaleX:0.8,scaleY:0.8,x:212.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(128));

	// p0.png - копия
	this.instance_13 = new lib.eeee();
	this.instance_13.parent = this;
	this.instance_13.setTransform(262.8,44.6,0.686,0.686,0,0,0,0.1,0.1);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(258).to({_off:false},0).to({scaleX:0.86,scaleY:0.86,x:237.2,y:46.4,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.69,scaleY:0.69,x:211.4,y:44.6,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// p3.png
	this.instance_14 = new lib.ghj();
	this.instance_14.parent = this;
	this.instance_14.setTransform(260.9,35,0.634,0.634,0,0,0,0.1,0.3);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(194).to({_off:false},0).to({regY:0.1,scaleX:0.79,scaleY:0.79,x:237.2,alpha:1},8,cjs.Ease.get(1)).wait(52).to({regY:0.3,scaleX:0.63,scaleY:0.63,x:213.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(64));

	// p2.png
	this.instance_15 = new lib.dfgdfg();
	this.instance_15.parent = this;
	this.instance_15.setTransform(257.1,33.7,0.528,0.528,0,0,0,0.1,0.1);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(66).to({_off:false},0).to({scaleX:0.66,scaleY:0.66,x:236.3,y:35,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:237.3},0).to({scaleX:0.53,scaleY:0.53,x:217.5,y:33.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(192));

	// p1.png
	this.instance_16 = new lib.ggggg();
	this.instance_16.parent = this;
	this.instance_16.setTransform(257.1,33.7,0.528,0.528,0,0,0,0.1,0.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:0.66,scaleY:0.66,x:237.3,y:35,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.53,scaleY:0.53,x:217.5,y:33.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(256));
	...
	this.shape_8.setTransform(385.9,22.9,0.517,0.517);
	...
	this.shape_9.setTransform(417.5,41.5,0.455,0.455);

	this.instance_17 = new lib.ClipGroup();
	this.instance_17.parent = this;
	this.instance_17.setTransform(383.7,44.6,0.165,0.166,0,0,0,199.7,44.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.shape_9},{t:this.shape_8}]}).wait(327));

	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],64.3,0,-64.2,0).s().p("AqCEsIAApXIUFAAIAAJXg");
	this.shape_10.setTransform(64.3,30);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("A6gEsIAApXMA1BAAAIAAJXg");
	this.shape_11.setTransform(298.3,30);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"468x60_atlas_P_.png", id:"468x60_atlas_P_"},
		{src:"468x60_atlas_NP_.jpg", id:"468x60_atlas_NP_"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		...
		{name:"300x250_atlas_NP_", frames: [[0,0,300,125],[0,127,300,125]]}
];
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_12.setTransform(222,161,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(194).to({_off:false},0).to({scaleX:1,scaleY:1,x:192,y:163,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:162,y:161,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(63));
	...
	this.instance_16.setTransform(209.2,161.7,0.8,0.8,0,0,0,0.1,0.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:1,scaleY:1,x:190,y:163,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:170.8,y:161.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(255));

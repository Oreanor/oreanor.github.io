...
lib.ssMetadata = [
		{name:"300x600_atlas_P_", frames: [[0,0,186,150],[0,152,168,150]]},
		{name:"300x600_atlas_NP_", frames: [[0,202,300,200],[0,0,300,200]]}
];
...
(lib.ghj = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-137,-114,1.2,1.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ghj, new cjs.Rectangle(-137,-114,201.6,180), null);
...
}).prototype = getMCSymbolPrototype(lib.ggggg, new cjs.Rectangle(-120,-97,300,200), null);
...
(lib.eeee = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-156,-127,1.2,1.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eeee, new cjs.Rectangle(-156,-127,223.2,180), null);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfg, new cjs.Rectangle(-120,-97,300,200), null);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(24).call(this.frame_24).wait(301).call(this.frame_325).wait(1));
	...
	this.instance.parent = this;
	this.instance.setTransform(288.5,580.6,0.9,0.9,-90,0,0,13.5,6.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(288.8,529,0.9,0.9,-90,0,0,70.6,6.5);
	...
	this.instance_2.setTransform(288.9,568,0.9,0.9,-90,0,0,27.9,6.5);
	...
	// Слой 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(280.4,562.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgSAOIAAgHIARAAQAAAAAAgBQAAgBgBAAQAAgBAAAAQAAgBgBAAIgGgDIgGgDIgCgCIgBgFIAAgBIAGAAIAAABIAAAEIAFACIAFACIACADQABgDAGgEIAMgHIAAAHIgMAGQgDACgBACQgBAAAAABQAAAAAAAAQgBABAAAAQAAABAAAAIASAAIAAAHg");
	this.shape_2.setTransform(280.3,565.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgSAPIAAgGIAQAAIAAgRIgQAAIAAgGIAlAAIAAAGIgRAAIAAARIARAAIAAAGg");
	this.shape_3.setTransform(280.3,569.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAJAJQgFgCgBgDQAAAFgDACQgDADgEAAQgFAAgDgEQgDgDAAgHIAAgQIAlAAIAAAGIgPAAIAAAEIABAFQABABAFADIAIAFIAAAIgAgMgBQAAAFABACQABAAAAABQABAAAAAAQABAAABAAQAAABABAAQADgBABgCQACgCAAgFIAAgIIgMAAg");
	this.shape_4.setTransform(280.3,573.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgSAQIAAgHIAPAAIAAgIQAAgHADgEQACgFAFAAQAFAAADAEQAEAEAAAHIAAAQgAADgGQgCACAAAFIAAAIIANAAIAAgHQAAgEgCgDQgBgDgEAAQAAAAgBAAQAAAAgBABQAAAAgBAAQAAABgBAAg");
	this.shape_5.setTransform(280.3,577);
	...
	this.instance_3.setTransform(265.8,97.9,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(193).to({_off:false},0).to({x:240.6,y:99.2,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:97.9},0).to({x:215.4,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(64));

	// i2.png
	this.instance_4 = new lib.ghjgh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(175.5,136.2,1.26,1.26);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(129).to({_off:false},0).to({x:150.3,alpha:1},8,cjs.Ease.get(0.96)).wait(52).to({startPosition:0},0).to({x:125.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(128));

	// i1.png
	this.instance_5 = new lib.ghjghj("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(175.7,143.3,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(65).to({_off:false},0).to({x:150.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:125.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(192));

	// i0.png
	this.instance_6 = new lib.ghjghjhjj("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(175.5,148.8,1.26,1.26);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1).to({_off:false},0).to({x:150.3,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:125.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(256));

	// t4.png
	this.instance_7 = new lib.jlkjl();
	this.instance_7.parent = this;
	this.instance_7.setTransform(175,99.2,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(256).to({_off:false},0).to({x:149.8,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:124.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(1));

	// t3.png
	this.instance_8 = new lib.hkhjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(141.6,97.9,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(192).to({_off:false},0).to({x:116.4,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:91.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(65));

	// t2.png
	this.instance_9 = new lib.uuiui();
	this.instance_9.parent = this;
	this.instance_9.setTransform(175.7,80.9,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(128).to({_off:false},0).to({x:150.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:125.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(129));

	// t1.png
	this.instance_10 = new lib.hhh();
	this.instance_10.parent = this;
	this.instance_10.setTransform(175,84.7,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(64).to({_off:false},0).to({x:149.8,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:124.6,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(193));

	// t0.png
	this.instance_11 = new lib.uu8();
	this.instance_11.parent = this;
	this.instance_11.setTransform(175.7,85.3,1.26,1.26,0,0,0,0.1,0.1);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:150.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:125.3,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(257));

	// p0.png - копия
	this.instance_12 = new lib.eeee();
	this.instance_12.parent = this;
	this.instance_12.setTransform(222,337,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(194).to({_off:false},0).to({scaleX:1,scaleY:1,x:192,y:339,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:162,y:337,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(63));

	// p3.png
	this.instance_13 = new lib.ghj();
	this.instance_13.parent = this;
	this.instance_13.setTransform(220,326,0.8,0.8);
	...
	this.instance_14.setTransform(150,302,0.8,0.8);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(130).to({_off:false},0).to({scaleX:1,scaleY:1,x:120,y:304,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:90,y:302,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(127));

	// p1.png
	this.instance_15 = new lib.ggggg();
	this.instance_15.parent = this;
	this.instance_15.setTransform(150,318,0.8,0.8);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(66).to({_off:false},0).to({scaleX:1,scaleY:1,x:120,y:304,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:90,y:302,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(191));

	// p0.png
	this.instance_16 = new lib.eeee();
	this.instance_16.parent = this;
	this.instance_16.setTransform(209.2,338.7,0.8,0.8,0,0,0,0.1,0.1);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(2).to({_off:false},0).to({scaleX:1,scaleY:1,x:190,y:340,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:170.8,y:338.7,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(255));
	...
	this.shape_8.setTransform(150.3,486.8,0.953,0.954);
	...
	this.shape_9.setTransform(208.8,521.1,0.838,0.84);

	this.instance_17 = new lib.ClipGroup();
	this.instance_17.parent = this;
	this.instance_17.setTransform(145.8,527.6,0.305,0.306,0,0,0,201.3,45.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.shape_9},{t:this.shape_8}]}).wait(326));

	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],-0.1,99.9,-0.1,-100).s().p("A3bPoIAA/PMAu3AAAIAAfPg");
	this.shape_10.setTransform(150,100);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("A3bfQMAAAg+fMAu3AAAMAAAA+fg");
	this.shape_11.setTransform(150,400);

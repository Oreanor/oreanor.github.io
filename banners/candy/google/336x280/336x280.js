...
lib.ssMetadata = [
		{name:"336x280_atlas_P_", frames: [[0,136,150,121],[0,0,150,134]]},
		{name:"336x280_atlas_NP_", frames: [[0,142,338,140],[0,0,338,140],[0,284,338,140]]}
];
...
(lib.ghj = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-115,-107);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ghj, new cjs.Rectangle(-115,-107,150,134), null);
...
}).prototype = getMCSymbolPrototype(lib.ggggg, new cjs.Rectangle(-120,-97,338,140), null);
...
(lib.fgh = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-169,-70);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fgh, new cjs.Rectangle(-169,-70,338,140), null);
...
(lib.eeee = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-116,-97);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eeee, new cjs.Rectangle(-116,-97,150,121), null);
...
}).prototype = getMCSymbolPrototype(lib.dfgdfg, new cjs.Rectangle(-120,-97,338,140), null);
...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(323.5,260.6,0.9,0.9,-90,0,0,13.5,6.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(323.8,209,0.9,0.9,-90,0,0,70.6,6.5);
	...
	this.instance_2.setTransform(323.9,248,0.9,0.9,-90,0,0,27.9,6.5);
	...
	// Слой 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(315.4,242.2);
	...
	this.shape_2.setTransform(315.3,245.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgSAPIAAgGIAQAAIAAgQIgQAAIAAgHIAlAAIAAAHIgRAAIAAAQIARAAIAAAGg");
	this.shape_3.setTransform(315.3,249.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AAJAKQgFgEgBgCQAAAFgDADQgDACgEAAQgFAAgDgDQgDgEAAgGIAAgQIAlAAIAAAFIgPAAIAAAFIABAEQABABAFADIAIAGIAAAHgAgMgBQAAAGABABQABAAAAABQABAAAAAAQABAAABAAQAAAAABAAQADAAABgCQACgCAAgGIAAgHIgMAAg");
	this.shape_4.setTransform(315.3,253.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AgSAPIAAgGIAPAAIAAgIQAAgHADgEQACgFAFABQAFgBADAEQAEAEAAAHIAAAPgAADgGQgCACAAAGIAAAHIANAAIAAgGQAAgFgCgDQgBgDgEAAQAAAAgBAAQAAAAgBAAQAAABgBAAQAAAAgBABg");
	this.shape_5.setTransform(315.3,257);
	...
	this.instance_3.setTransform(255.9,37.6,0.9,0.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(194).to({_off:false},0).to({x:237.9,y:38.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({y:37.6},0).to({x:219.9,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(63));

	// i2.png
	this.instance_4 = new lib.ghjgh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(277.4,34.9,0.81,0.81,0,0,0,0.1,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(130).to({_off:false},0).to({x:261.2,alpha:1},8,cjs.Ease.get(0.96)).wait(52).to({startPosition:0},0).to({x:245,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(127));

	// i1.png
	this.instance_5 = new lib.ghjghj("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(269.2,41.9,0.729,0.729,0,0,0,0.1,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(66).to({_off:false},0).to({regX:0.2,x:254.7,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({regX:0.1,x:240.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(191));

	// i0.png
	this.instance_6 = new lib.ghjghjhjj("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(258.5,37,0.9,0.9);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({_off:false},0).to({x:240.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({startPosition:0},0).to({x:222.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(255));

	// t4.png
	this.instance_7 = new lib.jlkjl();
	this.instance_7.parent = this;
	this.instance_7.setTransform(186.1,34.5,0.9,0.9);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(256).to({_off:false},0).to({x:168.1,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:150.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(1));

	// t3.png
	this.instance_8 = new lib.hkhjk();
	this.instance_8.parent = this;
	this.instance_8.setTransform(158.2,37.6,0.9,0.9);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(192).to({_off:false},0).to({x:140.2,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:122.2,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(65));

	// t2.png
	this.instance_9 = new lib.uuiui();
	this.instance_9.parent = this;
	this.instance_9.setTransform(142.5,33.4,0.9,0.9);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(128).to({_off:false},0).to({x:124.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:106.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(129));

	// t1.png
	this.instance_10 = new lib.hhh();
	this.instance_10.parent = this;
	this.instance_10.setTransform(136.1,37.1,0.9,0.9);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(64).to({_off:false},0).to({x:118.1,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:100.1,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(193));

	// t0.png
	this.instance_11 = new lib.uu8();
	this.instance_11.parent = this;
	this.instance_11.setTransform(141.5,36.6,0.9,0.9);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:123.5,alpha:1},8,cjs.Ease.get(1)).wait(52).to({x:105.5,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(257));

	// Слой 5
	this.instance_12 = new lib.fgh();
	this.instance_12.parent = this;
	this.instance_12.setTransform(199,136,0.8,0.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(257).to({_off:false},0).to({scaleX:1,scaleY:1,x:169,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:139,alpha:0},8,cjs.Ease.get(1)).wait(1));

	// p0.png - копия
	this.instance_13 = new lib.eeee();
	this.instance_13.parent = this;
	this.instance_13.setTransform(240,172,0.8,0.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(194).to({_off:false},0).to({scaleX:1,scaleY:1,x:210,y:174,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:180,y:172,alpha:0},8,cjs.Ease.get(1)).to({_off:true},1).wait(63));

	// p3.png
	this.instance_14 = new lib.ghj();
	this.instance_14.parent = this;
	this.instance_14.setTransform(238,176,0.8,0.8);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(131).to({_off:false},0).to({scaleX:1,scaleY:1,x:208,alpha:1},8,cjs.Ease.get(1)).wait(52).to({scaleX:0.8,scaleY:0.8,x:178,alpha:0},7,cjs.Ease.get(1)).to({_off:true},1).wait(127));
	...
	this.instance_16.setTransform(150,161,0.8,0.8);
	...
	this.shape_8.setTransform(168,229.5,0.578,0.578);
	...
	this.shape_9.setTransform(203.5,250.3,0.508,0.509);

	this.instance_17 = new lib.ClipGroup();
	this.instance_17.parent = this;
	this.instance_17.setTransform(165.4,254,0.185,0.185,0,0,0,200.2,44.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.shape_9},{t:this.shape_8}]}).wait(326));

	// bg
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("A6PK8IAA13MA0fAAAIAAV3g");
	this.shape_10.setTransform(168,210);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#FFFFFF","#BFBFBF"],[0,1],-0.1,69.9,-0.1,-70).s().p("A6PK8IAA13MA0fAAAIAAV3g");
	this.shape_11.setTransform(168,70);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"336x280_atlas_P_.png", id:"336x280_atlas_P_"},
		{src:"336x280_atlas_NP_.jpg", id:"336x280_atlas_NP_"}
	],
	preloads: []
};

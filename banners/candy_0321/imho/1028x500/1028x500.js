...
lib.ssMetadata = [
		{name:"1028x500_atlas_NP_", frames: [[0,904,520,450],[0,452,520,450],[0,0,520,450]]}
];
...
(lib.p2 = function() {
	this.spriteSheet = ss["1028x500_atlas_NP_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._1028x500 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(298.3,-20,840.8,510);
// library properties:
lib.properties = {
	width: 1028,
	height: 500,
	...
	manifest: [
		...
		{src:"images/1028x500_atlas_NP_.jpg", id:"1028x500_atlas_NP_"}
	],
	preloads: []
};

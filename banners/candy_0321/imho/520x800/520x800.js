...
lib.ssMetadata = [
		{name:"520x800_atlas_NP_", frames: [[0,452,520,450],[0,904,520,450],[0,0,520,450]]}
];
...
(lib.p2 = function() {
	this.spriteSheet = ss["520x800_atlas_NP_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._520x800 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/520x800_atlas_NP_.jpg", id:"520x800_atlas_NP_"}
	],
	preloads: []
};
